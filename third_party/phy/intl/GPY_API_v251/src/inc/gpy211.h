...
/**@{*/
/** \brief 10 Mbps (used by \b speed in \ref gpy211_link) */
#define	SPEED_10	10
/** \brief 100 Mbps (used by \b speed in \ref gpy211_link) */
#define	SPEED_100	100
/** \brief 1 Gbps (used by \b speed in \ref gpy211_link) */
#define	SPEED_1000	1000
/** \brief 2.5 Gbps (used by \b speed in \ref gpy211_link) */
#define	SPEED_2500	2500
/** \brief 5 Gbps (used by \b speed in \ref gpy211_link) */
#define	SPEED_5000	5000
/** @cond INTEL_INTERNAL */
/** \brief Unknown speed (used by \b speed in \ref gpy211_link) */
...
/**@{*/
/** \brief Half duplex (used by \b duplex in \ref gpy211_link) */
#define DUPLEX_HALF	0x00
/** \brief Full duplex (used by \b duplex in \ref gpy211_link) */
#define DUPLEX_FULL	0x01
/** @cond INTEL_INTERNAL */
/** \brief Unknown duplex (used by \b duplex in \ref gpy211_link) */
...
enum gpy211_led_brlvl_mode {
	/** \brief Constant level at max brightness */
	LED_BRLVL_MAX = 0,
	/** \brief Constant level given by lvl_max of \ref gpy211_led_brlvl_cfg */
	LED_BRLVL_CONSTANT = 1,
	/** \brief 2 level brightness switch mode */
	ED_BRLVL_2LVL = 2,
	/** \brief 16 level brightness light sensor mode */
	LED_BRLVL_16LVL = 3,
	/** \brief Combination of 2 and 16 brightness level.
		The lower brightness level is taken from these two mechanisms */
	LED_BRLVL_MIX = 4,
};
/** \cond INTERNAL */
...
#define LED_BRLEVEL_MAX     LED_BRLVL_MIX
/** \endcond */
...
/** \brief LED sensing period */
enum gpy211_led_sensing_prd {
	/** \brief 1360 ms */
	LED_SENSING_1360 = 0,
	/** \brief 680 ms */
	LED_SENSING_680 = 1,
...
/** \cond INTERNAL */
/** \brief Lowest sensing period value */
#define LED_SENSING_MIN		LED_SENSING_1360
/** \brief Highest sensing period value */
#define LED_SENSING_MAX		LED_SENSING_170
/** \endcond */
...
enum gpy211_led_bsrc {
	...
	LED_BSRC_LINK100 = 2,
	/** \brief Blink on 10/100 Mbps link */
	//LED_BSRC_LINK10x = 3,
	/** \brief Blink on 1000 Mbps link */
	LED_BSRC_LINK1000 = 4,
	/** \brief Blink on 10/1000 Mbps link */
	//LED_BSRC_LINK10_0 = 5,
	/** \brief Blink on 100/1000 Mbps link */
	//LED_BSRC_LINK100x = 6,
	/** \brief Blink on 10/100/1000 Mbps link */
	//LED_BSRC_LINK10xx = 7,
	/** \brief Blink on 10/100/1000/2500 Mbps link */
	LED_BSRC_LINK2500 = 8,
	/** \brief Blink when power down */
	//LED_BSRC_PDOWN = 9,
	/** \brief blink when device in EEE mode */
	//LED_BSRC_EEE = 10,
	/** \brief Blink when auto-negotiation is running */
	//LED_BSRC_ANEG = 11,
	/** \brief Blink when analog self-test is running */
	//LED_BSRC_ABIST = 12,
	/** \brief Blink when cable diagnostics are running */
	//LED_BSRC_CDIAG = 13,
};
/** \cond INTERNAL */
...
#define LED_BSRC_MAX	LED_BSRC_LINK2500
/** \endcond */
...
#define LED_PULSE_MAX		((LED_PULSE_COL << 1) - 1)
/** \endcond */
...
enum gpy211_extin_phy_event {
	...
	EXTIN_PHY_LOR     = (1 << 8),
	/** \brief Mailbox transaction complete */
	EXTIN_PHY_MBOX    = (1 << 9),
...
/** \cond INTERNAL */
#define EXTIN_IM2_EVENT_MIN ((EXTIN_IM2_IE_LPI << 1) - 1)
...
/** \brief Test loop modes
	Structure used by API \ref gpy2xx_loopback_cfg */
...
/** \brief Error/event counted
	Enum used by API \ref gpy2xx_errcnt_cfg */
...
/**@{*/
/** \brief Input frequency of reference clock */
enum gpy211_synce_clksrc {
	/** \brief 25 MHz reference clock */
	SYNCE_CLKSRC_REF25MHz = 0,
	/** \brief 40 MHz reference clock */
	SYNCE_CLKSRC_REF40MHz = 1,
	/** \brief TGU_PDI_PD_DIV2 */
	SYNCE_CLKSRC_PD_DIVSEL2 = 2,
	/** \brief TGU_PDI_PD_DIV3 */
	SYNCE_CLKSRC_PD_DIVSEL3 = 3,
};

/** \brief SyncE reference clock input frequency */
enum gpy211_synce_clk  {
	/** \brief E clock frequency is PSTN class: 8kHz */
	SYNCE_CLK_PSTN = 0,
	/** \brief E clock frequency is EEC-1 class: 2.048MHz */
	SYNCE_CLK_EEC1 = 1,
	/** \brief E clock frequency is EEC-2 class: 1.544MHz */
	SYNCE_CLK_EEC2 = 2,
	/** \brief Reserved */
	SYNCE_CLK_RES = 3,
};
...
#define SYNCE_CLKSRC_REF_MIN	SYNCE_CLKSRC_REF25MHz
/** \brief Highest ref clock's i/p frequency value */
#define SYNCE_CLKSRC_REF_MAX	SYNCE_CLKSRC_PD_DIVSEL3

/** \brief Lowest ref clock's i/p frequency value */
#define SYNCE_REFCLK_MIN	SYNCE_CLK_PSTN
/** \brief Highest ref clock's i/p frequency value */
#define SYNCE_REFCLK_MAX	SYNCE_CLK_EEC2
/** \brief SyncE function selected on GPIO pin 10  */
#define GPIO_PIN10_SYNCE_FUN  10
...
/**@{*/
/** \brief Wake up when PHY link is up, used by \ref gpy2xx_wol_cfg, \ref gpy2xx_wol_get */
#define WAKE_PHY	(1 << 0)
/** \brief Wake up when received Unicast frame, used by \ref gpy2xx_wol_cfg, \ref gpy2xx_wol_get */
#define WAKE_UCAST	(1 << 1)
/** \brief Wake up when received Multicast frame, used by \ref gpy2xx_wol_cfg, \ref gpy2xx_wol_get */
#define WAKE_MCAST	(1 << 2)
/** \brief Wake up when received Broadcast frame, used by \ref gpy2xx_wol_cfg, \ref gpy2xx_wol_get */
#define WAKE_BCAST	(1 << 3)
/** \brief Wake up when received ARP frame, used by \ref gpy2xx_wol_cfg, \ref gpy2xx_wol_get */
#define WAKE_ARP	(1 << 4)
/** \brief Wake up when received Magic frame, used by \ref gpy2xx_wol_cfg, \ref gpy2xx_wol_get */
#define WAKE_MAGIC	(1 << 5)
/** \brief Secured wake upOnly meaningful if WAKE_MAGIC is used, used by \ref gpy2xx_wol_cfg, \ref gpy2xx_wol_get */
...
/** \addtogroup GPY211_LED */
/**@{*/
/** \brief LED ID 0 (used by \b id in \ref gpy211_led_cfg)*/
#define LED_ID_0   			0
/** \brief LED ID 1 (used by \b id in \ref gpy211_led_cfg)*/
#define LED_ID_1   			1
/** \brief LED ID 2 (used by \b id in \ref gpy211_led_cfg)*/
#define LED_ID_2   			2
/** \brief LED ID 3 (used by \b id in \ref gpy211_led_cfg)*/
#define LED_ID_3   			3
/** \cond INTERNAL */
...
struct gpy211_led_brlvl_cfg {
	...
	int lvl_max;
	/** \brief Minimum brightness level */
	int lvl_min;
	/** \brief Switch edge detect:
		0 - detect on falling edge, 1 - detect on rising edge */
	enum gpy211_led_edge_detect sw_edge;
	/** \brief LED sensing period for 16-level brightness mode.
		Valid values are defined in \ref gpy211_led_sensing_prd enum */
	enum gpy211_led_sensing_prd sensing_period;
	/** \brief Number of slots for discharge in 16-level brightness mode.
		There are 256 slots in total. The number of slots given in this field
		is for the discharing circuit. */
	int discharge_slots;
};
...
struct gpy211_led_cfg {
	...
	/** \brief Select in which PHY state the LED blinks with slow frequency
		defined by slow_blink_freq of \ref gpy211_led_gcfg. Valid values are defined in
		\ref gpy211_led_bsrc enum. */
	enum gpy211_led_bsrc slow_blink_src;
	/** \brief Select in which PHY state the LED blinks with fast frequency
		defined by fast_blink_freq of \ref gpy211_led_gcfg. Valid values
		are defined in \ref gpy211_led_bsrc enum. */
...
/** \addtogroup GPY211_INT */
/**@{*/
/** \brief External interrupt imask flag used by \ref gpy2xx_extin_get*/
#define EXT_INT_IMASK		00
/** \brief External interrupt istat flag used by \ref gpy2xx_extin_get*/
#define EXT_INT_ISTAT		01
/** \brief External interrupt IM2 imask flag used by \ref gpy2xx_extin_get*/
#define EXT_INT_IM2_IMASK	02
/** \brief External interrupt IM2 istat flag used by \ref gpy2xx_extin_get*/
#define EXT_INT_IM2_ISTAT	03
...
struct gpy211_phy_extin {
	...
	u32 gpio_flags;
#ifdef SMDIO_FOR_PHY
	/** \brief Output pin characteristics when external interrupt is configured
		as output. Value 0 is active high, value 1 is active low */
	char op_char;
#endif
	/** \brief Interrupt trigger mask. Valid values are defined in
		\ref gpy211_extin_phy_event enum */
	enum gpy211_extin_phy_event imask_istat;
	/** \brief IM2 Interrupt enable mask. Valid values are defined in
		\ref gpy211_extin_im2_mask enum */
	enum gpy211_extin_im2_mask im2_imask_istat;
};
/**@}*/ /* GPY211_INT */
...
struct gpy211_id {
	...
	u16 fw_release;
	/** \brief The memory target used for firmware execution.
...
/** \brief CRC & Padding control options */
enum crc_pad_ctrl {
...
/** \brief Smart-AZ Packet Size configuration */
struct gmac_pkt_cfg {
...
struct gpy211_device {
	...
	*/
	...
	void *macsec_data;
	/** \brief PTP clock (in MHz) */
	u32 ptp_clock;
	/** \brief PTP default addend */
	u32 def_addend;
};
/**@}*/ /* GPY211_INIT */
...
/**
	...
	\details Use this API to configure LED brightness level mode and min & max
	brightness levels.
...
/**
	...
	\details Use this API to get LED brightness level mode and min & max
	brightness levels.
...
/**
	...
	\details Use this API to assign an LED configuration (for example, LED remains
	constantly ON, or blinks with slow/fast frequency, etc.) to specific PHY activities and/or link rates.
...
/**
	...
	\details Use this API to get the given LED configuration that was set for specific
	PHY activities and/or link rates using \ref gpy2xx_led_if_cfg. For example, LED remains constantly ON or
	blinks with slow/fast frequency.
