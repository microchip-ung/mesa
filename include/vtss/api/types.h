...
enum {
    ...
    VTSS_RC_ERR_PHY_MEDIA_IF_NOT_SUPPORTED =
    ...
    /**** MACSEC ERRORS ****/
    VTSS_RC_ERR_MACSEC_INVALID_SCI_MACADDR =
...
typedef struct {
    ...
    /**< SIP address. All zero address enables source independent MC groups
     * [*.G] */
    vtss_ipv4_t source;
} vtss_ipv4_mc_t;
...
typedef struct {
    u64 ipv4uc_received_octets; /**< IPv4UC octets received and hardware
                                   forwarded */
    u64 ipv4uc_received_frames; /**< IPv4UC frames received and hardware
                                   forwarded */
    u64 ipv6uc_received_octets; /**< IPv6UC octets received and hardware
                                   forwarded */
    u64 ipv6uc_received_frames; /**< IPv6UC frames received and hardware
                                   forwarded */
    ...
    u64 ipv4mc_received_octets; /**< IPv4MC octets received and hardware
                                   forwarded */
    u64 ipv4mc_received_frames; /**< IPv4MC frames received and hardware
                                   forwarded */
    u64 ipv6mc_received_octets; /**< IPv6MC octets received and hardware
                                   forwarded */
    u64 ipv6mc_received_frames; /**< IPv6MC frames received and hardware
                                   forwarded */
...
typedef enum {
    ...
    VTSS_VCAP_VR_TYPE_RANGE_INCLUSIVE, /**< Used as inclusive range: low <=
                                          range <= high */
    VTSS_VCAP_VR_TYPE_RANGE_EXCLUSIVE  /**< Used as exclusive range: range < low
                                          or range > high */
} vtss_vcap_vr_type_t;
 ...
 *        The UScaledNs type represents unsigned values of time and time
 * interval in units of 2**-16 ns.
 */
typedef struct {
