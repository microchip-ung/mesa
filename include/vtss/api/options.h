...
#define VTSS_FEATURE_PACKET_INJ_ENCAP           /**< Packet Tx supports injection with \
                                                   specific encapsulation */
#define VTSS_FEATURE_PACKET_PORT_REG_DISCARD    /**< Packet discard registration \
                                                   per port */
// #define VTSS_FEATURE_PACKET_PORT_L2CP_REG         /**< Packet registration
// per port and L2CP */
...
#define VTSS_FEATURE_QOS_EGRESS_QUEUE_SHAPERS_EB     /**< QoS: Egress Queue    \
                                                        Shapers has Excess     \
                                                        Bandwidth support */
#define VTSS_FEATURE_QOS_EGRESS_QUEUE_SHAPERS_CRB    /**< QoS: Egress Queue      \
                                                        Shapers has CRedit Based \
                                                        shaper support */
#define VTSS_FEATURE_QOS_EGRESS_SHAPERS_DLB          /**< QoS: Egress shapers has DLB \
                                                        support */
#define VTSS_FEATURE_QOS_EGRESS_SHAPERS_RT           /**< Qos: Egress shapers have rate  \
                                                        type support - line or date rate \
                                                      */
#define VTSS_FEATURE_QOS_DSCP_REMARK_DP_AWARE        /**< QoS: DSCP remarking is DP \
                                                        aware */
...
#define VTSS_FEATURE_QOS_EGRESS_QUEUE_CUT_THROUGH    /**< QoS: Queue has       \
                                                        cut-through support */
...
#define VTSS_FEATURE_TIMESTAMP_LATENCY_COMP          /**< Ingress and egress latency \
                                                        compensation hardwarce support    */
#define VTSS_FEATURE_TIMESTAMP_ORG_TIME              /**< OriginTimestamp update hardware \
                                                        support */
#define VTSS_FEATURE_TIMESTAMP_P2P_DELAY_COMP        /**< Peer-to-peer path delay     \
                                                        compensation hardware support \
                                                      */
#define VTSS_FEATURE_TIMESTAMP_ASYMMETRY_COMP        /**< Path delay asymmetry        \
                                                        compensation hardware support \
                                                      */
#define VTSS_FEATURE_PSFP                            /**< IEEE 802.1Qci: Per-Stream Filtering and \
                                                        Policing */
...
#define VTSS_FEATURE_QCL_DMAC_DIP                  /**< QoS: QoS Control Lists, match on either \
                                                      SMAC/SIP or DMAC/DIP */
#define VTSS_FEATURE_QCL_KEY_TYPE                  /**< QoS: QoS Control Lists, different key \
                                                      types per port */
#define VTSS_FEATURE_QCL_KEY_DMAC                  /**< QoS: QoS Control Lists has destination \
                                                      MAC address */
#define VTSS_FEATURE_QCL_KEY_DIP                   /**< QoS: QoS Control Lists has destination \
                                                      IP address */
#define VTSS_FEATURE_STORM_POLICER_DROP_COUNTER    /**< Storm policers has drop \
                                                      counters */
...
#if defined(VTSS_CHIP_7546) || defined(VTSS_CHIP_7549) ||                      \
    defined(VTSS_CHIP_7552) || defined(VTSS_CHIP_7556) ||                      \
    defined(VTSS_CHIP_7558)
#define VTSS_ARCH_SPARX5 /**< Jaguar-3/SparX-5 architecture */
#endif

#if defined(VTSS_CHIP_7546TSN) || defined(VTSS_CHIP_7549TSN) ||                \
    defined(VTSS_CHIP_7552TSN) || defined(VTSS_CHIP_7556TSN) ||                \
    defined(VTSS_CHIP_7558TSN)
...
#define VTSS_FEATURE_PORT_CNT_BRIDGE                 /**< Bridge counters */
#define VTSS_FEATURE_PORT_CONF_BULK                  /**< Bulk port configuration support for \
                                                        fast configuration */
#define VTSS_FEATURE_PFC                             /**< 802.1Qbb Priority Flow Control */
#define VTSS_FEATURE_LAYER2                          /**< Layer 2 (switching) */
#define VTSS_FEATURE_PACKET                          /**< CPU Rx/Tx frame configuration */
...
#define VTSS_FEATURE_PACKET_PORT_REG_DISCARD         /**< Packet discard registration \
                                                        per port */
#define VTSS_FEATURE_PACKET_PIPELINE_PT              /**< Packet Tx supports injection at \
                                                        specific chip pipeline points */
#define VTSS_FEATURE_QOS                             /**< QoS */
#define VTSS_FEATURE_QOS_PORT_POLICER_EXT_DPBL       /**< QoS: Port Policer has Drop \
                                                        Precedence Bypas Level       \
                                                        support */
#define VTSS_FEATURE_QOS_PORT_POLICER_EXT_TTM_V2     /**< QoS: Port Policer has   \
                                                        Traffic_Type Mask version \
                                                        2 support */
#define VTSS_FEATURE_QOS_SCHEDULER_DWRR_CNT          /**< QoS: Scheduler supports \
                                                        variable number of DWRR inputs    */
...
#define VTSS_FEATURE_QOS_EGRESS_SHAPERS_RT           /**< Qos: Egress shapers have rate  \
                                                        type support - line or date rate \
                                                      */
#define VTSS_FEATURE_QOS_EGRESS_SHAPER_FRAME         /**< Qos: Egress shapers have \
                                                        frame rate type support */
#define VTSS_FEATURE_QOS_EGRESS_QUEUE_SHAPERS_CRB    /**< QoS: Egress Queue      \
                                                        Shapers has CRedit Based \
                                                        shaper support */
#define VTSS_FEATURE_QOS_CPU_PORT_SHAPER             /**< QoS: Has CPU port shaper */
...
#define VTSS_FEATURE_QOS_HSCH_LEAK_LISTS             /**< QoS: Has leak lists for \
                                                        scheduler elements */
#define VTSS_FEATURE_TIMESTAMP                       /**< Packet timestamp feature (for PTP) */
#define VTSS_FEATURE_TIMESTAMP_ONE_STEP              /**< ONESTEP timestamp hardware \
                                                        support */
#define VTSS_FEATURE_TIMESTAMP_LATENCY_COMP          /**< Ingress and egress latency \
                                                        compensation hardware support    */
#define VTSS_FEATURE_TIMESTAMP_ORG_TIME              /**< OriginTimestamp update hardware \
...
#define VTSS_FEATURE_QCL_KEY_DIP       /**< QoS: QoS Control Lists has destination \
                                          IP address */
#define VTSS_FEATURE_QCL_MAP_ACTION    /**< QoS: QoS Control Lists has ingress \
                                          map action */
// WRED is not supported on Fireant #define VTSS_FEATURE_QOS_WRED_V3 /**< QoS:
// WRED global - per queue (0..7), per dpl (1..3), per group (0..2) */
...
#define VTSS_FEATURE_QCL_KEY_S_TAG               /**< QoS: QoS Control Lists has S tag \
                                                    support */
#define VTSS_FEATURE_QCL_PCP_DEI_ACTION          /**< QoS: QoS Control Lists has PCP \
                                                    and DEI action */
#define VTSS_FEATURE_QCL_POLICY_ACTION           /**< QoS: QoS Control Lists has policy \
                                                    action */
#define VTSS_FEATURE_QOS_POLICER_UC_SWITCH       /**< QoS: Unicast policer per \
                                                    switch */
#define VTSS_FEATURE_QOS_POLICER_MC_SWITCH       /**< QoS: Multicast policer per \
                                                    switch */
#define VTSS_FEATURE_QOS_POLICER_BC_SWITCH       /**< QoS: Broadcast policer per \
                                                    switch */
#define VTSS_FEATURE_QOS_PORT_POLICER_EXT        /**< QoS: Port Policer Extensions */
#define VTSS_FEATURE_QOS_PORT_POLICER_EXT_FPS    /**< QoS: Port Policer has frame \
                                                    rate support */
#define VTSS_FEATURE_QOS_PORT_POLICER_EXT_FC     /**< QoS: Port Policer has flow \
                                                    control support */
...
#define VTSS_FEATURE_QOS_CLASSIFICATION_V2       /**< QoS: 2. version of       \
                                                    classification */
#define VTSS_FEATURE_QOS_DSCP_CLASS_DP_AWARE     /**< QoS: DSCP classification is \
                                                    DP aware */
...
#define VTSS_FEATURE_QOS_DSCP_REMARK_V2          /**< QoS: 2. version of DSCP remarking \
                                                  */
#define VTSS_FEATURE_PACKET_PORT_L2CP_REG        /**< Packet registration per port \
                                                    and L2CP */
#define VTSS_FEATURE_PVLAN                       /**< Private VLANs */
...
#define VTSS_FEATURE_QOS_EGRESS_QUEUE_SHAPERS    /**< QoS: Has Egress Queue    \
                                                    Shapers */
#define VTSS_FEATURE_VLAN_COUNTERS               /**< VLAN counters are only supported for \
                                                    SMB devices without OAM */
...
#define VTSS_FEATURE_QOS_CPU_QUEUE_SHAPER /**< QoS: Has CPU queue shaper */
    ...
    defined(VTSS_CHIP_SPARX_IV_34)
#define VTSS_ARCH_JAGUAR_2 /**< Jaguar-2 architecture */
#define VTSS_ARCH_SERVAL_T /**< Serval-T architecture */
#endif                     /* VTSS_CHIP_SERVAL_T/SPARX_IV_34 */

#if defined(VTSS_CHIP_SERVAL_TE) || defined(VTSS_CHIP_SERVAL_TEP) ||           \
    defined(VTSS_CHIP_SERVAL_2_LITE) || defined(VTSS_CHIP_SERVAL_TE10)
#define VTSS_ARCH_JAGUAR_2    /**< Jaguar-2 architecture */
#define VTSS_ARCH_SERVAL_T    /**< Serval-T architecture */
#define VTSS_ARCH_JAGUAR_2_CE /**< Jaguar-2 CE architecture */
...
#if defined(VTSS_CHIP_SERVAL_TP) || defined(VTSS_CHIP_SERVAL_TEP) ||           \
    defined(VTSS_CHIP_SERVAL_TE10)
...
#define VTSS_FEATURE_SERIAL_GPIO                     /**< Serial GPIO control */
#define VTSS_FEATURE_PORT_CONTROL                    /**< Port control */
#define VTSS_FEATURE_PORT_KR                         /**< 10GBase KR, 802.3ap clause 72 (training) and \
                                                        clause 73 (aneg). JR2/Serval-t HW version.  */
#define VTSS_FEATURE_PORT_IFH                        /**< Port IFH control */
#define VTSS_FEATURE_CLAUSE_37                       /**< IEEE 802.3 clause 37 auto-negotiation */
#define VTSS_FEATURE_EXC_COL_CONT                    /**< Excessive collision continuation */
#define VTSS_FEATURE_PORT_CNT_ETHER_LIKE             /**< Ethernet-like counters */
...
#define VTSS_FEATURE_VSTAX_V2                        /**< VStaX stacking, as implemented on Jaguar2 \
                                                        (VStaX2/AF) */
#define VTSS_FEATURE_PORT_MUX                        /**< Port mux between serdes blocks and ports */
#define VTSS_FEATURE_PFC                             /**< 802.1Qbb Priority Flow Control */
#define VTSS_FEATURE_QOS                             /**< QoS */
...
#define VTSS_FEATURE_QOS_DSCP_REMARK_V2              /**< QoS: 2. version of DSCP remarking \
                                                      */
#define VTSS_FEATURE_QOS_WRED_V3                     /**< QoS: WRED global - per queue (0..7), per \
                                                        dpl (1..3), per group (0..2) */
#define VTSS_FEATURE_QOS_INGRESS_MAP                 /**< QoS: Has Ingress Map Table */
#define VTSS_FEATURE_QOS_EGRESS_MAP                  /**< QoS: Has Egress Map Table */
#define VTSS_FEATURE_QOS_HSCH_LEAK_LISTS             /**< QoS: Has leak lists for \
                                                        scheduler elements */
...
#define VTSS_FEATURE_PACKET_GROUPING                 /**< Extraction and injection occurs \
                                                        through extraction and injection  \
                                                        groups rather than queues. */
...
#if defined(VTSS_CHIP_SPARX_III_10_UM) ||                                      \
    defined(VTSS_CHIP_SPARX_III_17_UM) ||                                      \
    defined(VTSS_CHIP_SPARX_III_25_UM) || defined(VTSS_CHIP_SPARX_III_10) ||   \
    defined(VTSS_CHIP_SPARX_III_18) || defined(VTSS_CHIP_SPARX_III_24) ||      \
    defined(VTSS_CHIP_SPARX_III_26) || defined(VTSS_CHIP_SPARX_III_10_01)
#define VTSS_ARCH_SPARX_III /**< SparX-III SME switches */
#endif                      /* SPARX_III */

#if defined(VTSS_CHIP_CARACAL_1) || defined(VTSS_CHIP_CARACAL_2) ||            \
    defined(VTSS_CHIP_CARACAL_LITE)
...
#define VTSS_FEATURE_PACKET_GROUPING                 /**< Extraction and injection occurs \
                                                        ...
                                                        groups rather than queues. */
#define VTSS_FEATURE_PACKET_PORT_REG                 /**< Packet registration per port */
// #define VTSS_FEATURE_PACKET_PORT_REG_DISCARD   /**< Packet discard
// registration per port */ #define VTSS_FEATURE_PACKET_PORT_L2CP_REG      /**<
// Packet registration per port and L2CP */
#define VTSS_FEATURE_LAYER2                    /**< Layer 2 (switching) */
#define VTSS_FEATURE_PVLAN                     /**< Private VLANs */
#define VTSS_FEATURE_VLAN_PORT_V2              /**< VLAN port configuration, V2 features */
#define VTSS_FEATURE_VLAN_TX_TAG               /**< VLAN tagging per (VID, port) */
...
#define VTSS_FEATURE_TIMESTAMP_LATENCY_COMP    /**< Ingress and egress latency \
                                                  compensation hardware support    */
// #define VTSS_FEATURE_TIMESTAMP_P2P_DELAY_COMP  /**< Peer-to-peer path delay
// compensation hardware support */ #define VTSS_FEATURE_TIMESTAMP_ASYMMETRY_COMP
// /**< Path delay asymmetry compensation hardware support */
#define VTSS_MISSING_TX_TIMESTAMP_INTERRUPT    /**< Tx Timestamp interrupt is not \
                                                  supported in Luton26 */
#define VTSS_FEATURE_SYNCE                     /**< SYNCE - L1 syncronization feature */
#define VTSS_FEATURE_NPI                       /**< NPI port */
#define VTSS_FEATURE_IRQ_CONTROL               /**< General IRQ support */
#define VTSS_FEATURE_LED_POW_REDUC             /**< LED power reduction */
...
#define VTSS_FEATURE_PACKET_PORT_REG_DISCARD         /**< Packet discard registration \
                                                        per port */
// #define VTSS_FEATURE_PACKET_PORT_L2CP_REG        /**< Packet registration per
// port and L2CP */
#define VTSS_FEATURE_LAYER2                      /**< Layer 2 (switching) */
#define VTSS_FEATURE_PVLAN                       /**< Private VLANs */
#define VTSS_FEATURE_VLAN_PORT_V2                /**< VLAN port configuration, V2 features */
