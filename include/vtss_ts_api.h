 ...
 *        time counter. (like vtss_ts_timeofday_get but without correction for
...
typedef enum {
    ...
    VTSS_TS_EXT_IO_MODE_ONE_PPS_LOAD,    /**< enable input and load time at
                                            positive edge of input signal */
    VTSS_TS_EXT_IO_MODE_ONE_PPS_SAVE,    /**< enable input and save time at
                                            positive edge of input signal */
 ...
 * \param inst    [IN]          handle to an API instance
 * \param domain  [IN]          ptp domain number
 * [0..VTSS_TS_DOMAIN_ARRAY_SIZE-1]
