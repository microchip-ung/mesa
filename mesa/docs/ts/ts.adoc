...
==== External IO pin (`MESA_CHIP_FAMILY_JAGUAR2` or `MESA_CHIP_FAMILY_SERVALT`)
...
* 'One PPS Input Save': enable save of TOD to _get(), at positive edge of input signal.
* 'One PPS Input Load': enable load of _set() TOD, at positive edge of input signal.
...
It is possible to set TOD as described in <<bookmark-tod,Time Of Day>> +
 +
Is is not supported to _set() TOD to an external IO pin to achive TOD load at a positive edge of input signal.
...
* 'One PPS Input Save': enable save of TOD to _get(), at positive edge of input signal.
In this case the used External IO pin is 1 (`MESA_CHIP_FAMILY_JAGUAR2`) or 4 (`MESA_CHIP_FAMILY_SERVALT`).
...
* 'One PPS Input Save': enable save of TOD to _get(), at positive edge of input signal. In this case the used External IO pin is 2.
* 'One PPS Input Load': enable load of _set() TOD, at positive edge of input signal. In this case the used External IO pin is 2.
...
* 'One PPS Input Save': enable save of TOD to _get(), at positive edge of input signal. In this case the used GPIO pin is 15.
...
* 'One PPS Input Save': enable save of TOD to _get(), at positive edge of input signal. In this case the used GPIO pin is 30.
* 'One PPS Input Load': enable load of _set() TOD, at positive edge of input signal. In this case the used GPIO pin is 30.
...
* 'One PPS Output': enable generation of a one PPS pulse based on TOD. In this case the used External IO pin is 0.
* 'One PPS Input Save': enable save of TOD to _get(), at positive edge of input signal. In this case the used External IO pin is 3.
* 'One PPS Input Load': enable load of _set() TOD, at positive edge of input signal. In this case the used External IO pin is 3.
...
if `MESA_CHIP_FAMILY_JAGUAR2` or `MESA_CHIP_FAMILY_SERVALT`::
