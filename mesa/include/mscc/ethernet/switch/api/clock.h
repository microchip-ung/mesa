...
#ifndef _MSCC_ETHERNET_SWITCH_API_CLOCK_
#define _MSCC_ETHERNET_SWITCH_API_CLOCK_
...
#include <mscc/ethernet/switch/api/hdr_end.h>  // ALL INCLUDE ABOVE THIS LINE
#endif // _MSCC_ETHERNET_SWITCH_API_CLOCK_
