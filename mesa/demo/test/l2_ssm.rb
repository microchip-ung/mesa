...
test "frame-io" do
    ...
    frame_table =
        [
         ...
         {txt: "SIP mismatch", idx_tx: 0, idx_rx: [1,2,3], dmac: "01:00:5e:02:03:04", cmd: "ipv4 sip 1.2.3.5 dip 225.2.3.4"},
         {txt: "DIP mismatch", idx_tx: 0, idx_rx: [1,2,3], dmac: "01:00:5e:02:03:05", cmd: "ipv4 sip 1.2.3.4 dip 225.2.3.5"},
         ...
         {txt: "SIP mismatch", idx_tx: 0, idx_rx: [1,2,3], dmac: "33:33:01:02:03:04", cmd: "ipv6 sip 2000::0102:0305 dip ff00::0102:0304"},
         {txt: "DIP mismatch", idx_tx: 0, idx_rx: [1,2,3], dmac: "33:33:01:02:03:05", cmd: "ipv6 sip 2000::0102:0304 dip ff00::0102:0305"},
    ...
    [0,1].each do |itr|
        ...
        frame_table.each do |frame|
            ...
            idx_tx = frame[:idx_tx]
            idx_list = (itr == 0 ? frame[:idx_rx] : ([0,1,2,3] - [idx_tx]))
