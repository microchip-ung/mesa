...
$systems = [
    ...
    { name: "dk-t34-5", image: "arm64_vsc7558TSN.itb",       branch:"master.laguna-13", parallel: "no", server: "34", started: "no" },
    ...
    { name: "dk-t35-6", image: "armv7_lan969x_sr_bbb.itb",   branch:"master.laguna-13", parallel: "no", server: "35", started: "no" },
