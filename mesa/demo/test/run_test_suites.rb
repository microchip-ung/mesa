...
$systems = [
#           { name: "dk-t11",   image: "mipsel_vsc7514_pcb123.mfi",  branch:"master",     parallel: "yes" },
            { name: "dk-t13",   image: "mipsel_vsc7468_pcb110.mfi",  branch:"master",     parallel: "yes" },
...
#           { name: "dk-t14",   image: "mipsel_vsc7468_48.mfi",      branch:"master",     parallel: "yes" }, MESA-428 / Atom issue
            { name: "dk-t15",   image: "mipsel_vsc7437.mfi",         branch:"master",     parallel: "yes" },
#           { name: "dk-t16",   image: "mipsel_vsc7429.mfi",         branch:"master",     parallel: "yes" } Removed due to Ref-board instability (hangs)
            { name: "dk-t34-1", image: "arm64_ls1046_lan9668.itb",   branch:"master.mas", parallel: "no" },
            { name: "dk-t06",   image: "arm64_ls1046_lan9668.itb",   branch:"master.mas", parallel: "yes" },
