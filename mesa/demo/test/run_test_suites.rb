...
$systems = [
    ...
    { name: "dk-t33-3", image: "armv7_lan966x_bbb.itb",      branch:"master.mas", parallel: "no", server: "33", started: "no" },
    ...
    { name: "dk-t35-4", image: "armv7_lan966x_bbb.itb",      branch:"master.mas", parallel: "no", server: "35", started: "no" },
