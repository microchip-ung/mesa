...
gcc -g -o vtss_api_tesla_vsc8574ev -I ../include -DVTSS_OPSYS_LINUX=1  -DVTSS_OPT_PORT_COUNT=4  -DVTSS_CHIP_CU_PHY -DTESLA_EVAL_BOARD  -D_INCLUDE_DEBUG_TERM_PRINT_  -DVTSS_FEATURE_EEE -DVTSS_SW_OPTION_EEE -DVTSS_FEATURE_SERDES_MACRO_SETTINGS -DVTSS_OPT_PHY_TIMESTAMP appl/vtss_appl_board_tesla_eval.c appl/vtss_appl_vsc_phy_1g.c appl/vtss_appl_ts_demo.c ../base/ail/vtss_api.c  ../base/ail/vtss_common.c  ../base/phy/common/vtss_phy_common.c ../base/phy/ts/vtss_phy_ts_util.c ../base/phy/ts/vtss_phy_ts_api.c  `find ../base/phy/phy_1g -name "*.c"`
## TIMESTAMPING ENABLED ON EVAL BOARD, Board Addr = 0
