...
#ifndef _VTSS_FA_REGS_XQS_H_
#define _VTSS_FA_REGS_XQS_H_
 ...
 */
#define VTSS_XQS_STAT_CNT_CFG                VTSS_IOREG(VTSS_TO_XQS,0x69c)
 ...
 */
#define VTSS_XQS_MAP_CFG_CFG                 VTSS_IOREG(VTSS_TO_XQS,0x69d)
 ...
 */
#define VTSS_XQS_FWD_CTRL                    VTSS_IOREG(VTSS_TO_XQS,0x69e)
 ...
 */
#define VTSS_XQS_FWD_DROP_EVENTS(ri)         VTSS_IOREG(VTSS_TO_XQS,0x69f + (ri))
 ...
 */
#define VTSS_XQS_FWD_STAT_CNT(ri)            VTSS_IOREG(VTSS_TO_XQS,0x6e5 + (ri))
 ...
 */
#define VTSS_XQS_FWD_CPU_DROP_CNT            VTSS_IOREG(VTSS_TO_XQS,0x6ea)
 ...
 */
#define VTSS_XQS_FWD_CT_CFG(ri)              VTSS_IOREG(VTSS_TO_XQS,0x6eb + (ri))
 ...
 * @param ri Replicator: x_GAZ_CORE_PORT_CNT (??), 0-69
 */
#define VTSS_XQS_QMAP_PORT_MODE(ri)          VTSS_IOREG(VTSS_TO_XQS,0x72c + (ri))
 ...
 * index 1024+qos_value.In GROUP mode, a scheduling element is assigned per
 ...
 */
#define VTSS_XQS_QMAP_EACL                   VTSS_IOREG(VTSS_TO_XQS,0x772)
 ...
 */
#define VTSS_XQS_STAT_CFG                    VTSS_IOREG(VTSS_TO_XQS,0x773)
 ...
 */
#define  VTSS_F_XQS_STAT_CFG_STAT_VIEW(x)     VTSS_ENCODE_BITFIELD(x,5,13)
#define  VTSS_M_XQS_STAT_CFG_STAT_VIEW        VTSS_ENCODE_BITMASK(5,13)
#define  VTSS_X_XQS_STAT_CFG_STAT_VIEW(x)     VTSS_EXTRACT_BITFIELD(x,5,13)
 ...
 */
#define VTSS_XQS_MIRROR_CFG                  VTSS_IOREG(VTSS_TO_XQS,0x774)
 ...
 */
#define VTSS_XQS_CPUQ_DISCARD                VTSS_IOREG(VTSS_TO_XQS,0x775)
 ...
 * @param ri Replicator: x_GAZ_CORE_PORT_CNT (??), 0-69
 */
#define VTSS_XQS_QMAP_VPORT_TBL(gi,ri)       VTSS_IOREG_IX(VTSS_TO_XQS,0x400,gi,128,ri,0)
 ...
 */
#define  VTSS_F_XQS_QMAP_VPORT_TBL_QMAP_VPORT_VAL(x)  VTSS_ENCODE_BITFIELD(x,0,13)
#define  VTSS_M_XQS_QMAP_VPORT_TBL_QMAP_VPORT_VAL     VTSS_ENCODE_BITMASK(0,13)
#define  VTSS_X_XQS_QMAP_VPORT_TBL_QMAP_VPORT_VAL(x)  VTSS_EXTRACT_BITFIELD(x,0,13)
 ...
 */
#define VTSS_XQS_QMAP_SE_TBL(gi)             VTSS_IOREG_IX(VTSS_TO_XQS,0x690,gi,2,0,0)
 ...
 */
#define  VTSS_F_XQS_QMAP_SE_TBL_QMAP_SE_VAL(x)  VTSS_ENCODE_BITFIELD(x,0,13)
#define  VTSS_M_XQS_QMAP_SE_TBL_QMAP_SE_VAL     VTSS_ENCODE_BITMASK(0,13)
#define  VTSS_X_XQS_QMAP_SE_TBL_QMAP_SE_VAL(x)  VTSS_EXTRACT_BITFIELD(x,0,13)
 ...
 * @param gi Register: QMAP_SE_TBL (??), 0-3
 */
#define VTSS_XQS_QMAP_CT_ESP(gi)             VTSS_IOREG_IX(VTSS_TO_XQS,0x690,gi,2,0,1)
 ...
 */
#define VTSS_XQS_QMAP_QOS_TBL(gi)            VTSS_IOREG_IX(VTSS_TO_XQS,0x680,gi,4,0,0)
 ...
 * @param gi Register: QMAP_QOS_TBL (??), 0-3
 */
#define VTSS_XQS_QMAP_QOS_SIZE(gi)           VTSS_IOREG_IX(VTSS_TO_XQS,0x680,gi,4,0,1)
 ...
 * @param gi Register: QMAP_QOS_TBL (??), 0-3
 */
#define VTSS_XQS_DROP_STAT_CTRL(gi)          VTSS_IOREG_IX(VTSS_TO_XQS,0x680,gi,4,0,2)
 ...
 */
#define  VTSS_F_XQS_DROP_STAT_CTRL_DROP_STAT_BASE_ADDR(x)  VTSS_ENCODE_BITFIELD(x,6,11)
#define  VTSS_M_XQS_DROP_STAT_CTRL_DROP_STAT_BASE_ADDR     VTSS_ENCODE_BITMASK(6,11)
#define  VTSS_X_XQS_DROP_STAT_CTRL_DROP_STAT_BASE_ADDR(x)  VTSS_EXTRACT_BITFIELD(x,6,11)
 ...
 */
#define VTSS_XQS_QUEUE_SIZE(gi)              VTSS_IOREG_IX(VTSS_TO_XQS,0x698,gi,1,0,0)
 ...
 */
#define  VTSS_F_XQS_QUEUE_SIZE_QUEUE_SIZE(x)  VTSS_ENCODE_BITFIELD(x,2,15)
#define  VTSS_M_XQS_QUEUE_SIZE_QUEUE_SIZE     VTSS_ENCODE_BITMASK(2,15)
#define  VTSS_X_XQS_QUEUE_SIZE_QUEUE_SIZE(x)  VTSS_EXTRACT_BITFIELD(x,2,15)
 ...
 */
#define VTSS_XQS_QLIMIT_SE_CFG(gi)           VTSS_IOREG_IX(VTSS_TO_XQS,0x600,gi,32,0,0)
 ...
 *
 * @param gi Register: QLIMIT_SE (??), 0-3
 * @param ri Replicator: x_GAZ_HSCH_LARGE_RATIO (??), 0-8
 */
#define VTSS_XQS_QLIMIT_SE_USE(gi,ri)        VTSS_IOREG_IX(VTSS_TO_XQS,0x600,gi,32,ri,1)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SE_USE_QLIMIT_SE_USE(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_XQS_QLIMIT_SE_USE_QLIMIT_SE_USE     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_XQS_QLIMIT_SE_USE_QLIMIT_SE_USE(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
 ...
 * @param ri Replicator: x_GAZ_HSCH_LARGE_RATIO (??), 0-8
 */
#define VTSS_XQS_QLIMIT_CONG_CNT(gi,ri)      VTSS_IOREG_IX(VTSS_TO_XQS,0x600,gi,32,ri,10)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_CONG_CNT_QLIMIT_CONG_CNT(x)  VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_XQS_QLIMIT_CONG_CNT_QLIMIT_CONG_CNT     VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_XQS_QLIMIT_CONG_CNT_QLIMIT_CONG_CNT(x)  VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 * @param ri Replicator: x_GAZ_CORE_PORT_CNT (??), 0-69
 */
#define VTSS_XQS_QLIMIT_PORT_CFG(ri)         VTSS_IOREG(VTSS_TO_XQS,0x776 + (ri))
 ...
 */
#define VTSS_XQS_QLIMIT_DP_CFG(ri)           VTSS_IOREG(VTSS_TO_XQS,0x7bc + (ri))
 ...
 */
#define  VTSS_F_XQS_QLIMIT_DP_CFG_QLIMIT_DP_CUT(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_XQS_QLIMIT_DP_CFG_QLIMIT_DP_CUT     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_XQS_QLIMIT_DP_CFG_QLIMIT_DP_CUT(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
 ...
 */
#define VTSS_XQS_QLIMIT_SHR_TOP_CFG(gi)      VTSS_IOREG_IX(VTSS_TO_XQS,0x7c0,gi,12,0,0)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_TOP_CFG_QLIMIT_SHR_TOP(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_XQS_QLIMIT_SHR_TOP_CFG_QLIMIT_SHR_TOP     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_XQS_QLIMIT_SHR_TOP_CFG_QLIMIT_SHR_TOP(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_SHR_ATOP_CFG(gi)     VTSS_IOREG_IX(VTSS_TO_XQS,0x7c0,gi,12,0,1)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_ATOP_CFG_QLIMIT_SHR_ATOP(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_XQS_QLIMIT_SHR_ATOP_CFG_QLIMIT_SHR_ATOP     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_XQS_QLIMIT_SHR_ATOP_CFG_QLIMIT_SHR_ATOP(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_SHR_CTOP_CFG(gi)     VTSS_IOREG_IX(VTSS_TO_XQS,0x7c0,gi,12,0,2)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_CTOP_CFG_QLIMIT_SHR_CTOP(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_XQS_QLIMIT_SHR_CTOP_CFG_QLIMIT_SHR_CTOP     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_XQS_QLIMIT_SHR_CTOP_CFG_QLIMIT_SHR_CTOP(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_SHR_QLIM_CFG(gi)     VTSS_IOREG_IX(VTSS_TO_XQS,0x7c0,gi,12,0,3)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_QLIM_CFG_QLIMIT_SHR_QLIM(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_XQS_QLIMIT_SHR_QLIM_CFG_QLIMIT_SHR_QLIM     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_XQS_QLIMIT_SHR_QLIM_CFG_QLIMIT_SHR_QLIM(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_SHR_QDIV_CFG(gi)     VTSS_IOREG_IX(VTSS_TO_XQS,0x7c0,gi,12,0,4)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_QDIV_CFG_QLIMIT_SHR_QDIV(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_XQS_QLIMIT_SHR_QDIV_CFG_QLIMIT_SHR_QDIV     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_XQS_QLIMIT_SHR_QDIV_CFG_QLIMIT_SHR_QDIV(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_QUE_CONG_CFG(gi)     VTSS_IOREG_IX(VTSS_TO_XQS,0x7c0,gi,12,0,5)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_SE_CONG_CFG(gi)      VTSS_IOREG_IX(VTSS_TO_XQS,0x7c0,gi,12,0,6)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_SHR_QDIVMAX_CFG(gi)  VTSS_IOREG_IX(VTSS_TO_XQS,0x7c0,gi,12,0,7)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_QDIVMAX_CFG_QLIMIT_SHR_QDIVMAX(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_XQS_QLIMIT_SHR_QDIVMAX_CFG_QLIMIT_SHR_QDIVMAX     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_XQS_QLIMIT_SHR_QDIVMAX_CFG_QLIMIT_SHR_QDIVMAX(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_SE_EIR_CFG(gi)       VTSS_IOREG_IX(VTSS_TO_XQS,0x7c0,gi,12,0,8)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_CONG_CNT_STAT(gi)    VTSS_IOREG_IX(VTSS_TO_XQS,0x7c0,gi,12,0,9)

/** 
 * \details 
 * Field: ::VTSS_XQS_QLIMIT_CONG_CNT_STAT . QLIMIT_CONG_CNT
 */
#define  VTSS_F_XQS_QLIMIT_CONG_CNT_STAT_QLIMIT_CONG_CNT(x)  VTSS_ENCODE_BITFIELD(x,0,13)
#define  VTSS_M_XQS_QLIMIT_CONG_CNT_STAT_QLIMIT_CONG_CNT     VTSS_ENCODE_BITMASK(0,13)
#define  VTSS_X_XQS_QLIMIT_CONG_CNT_STAT_QLIMIT_CONG_CNT(x)  VTSS_EXTRACT_BITFIELD(x,0,13)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_SHR_FILL_STAT(gi)    VTSS_IOREG_IX(VTSS_TO_XQS,0x7c0,gi,12,0,10)

/** 
 * \details 
 * Field: ::VTSS_XQS_QLIMIT_SHR_FILL_STAT . QLIMIT_SHR_FILL
 */
#define  VTSS_F_XQS_QLIMIT_SHR_FILL_STAT_QLIMIT_SHR_FILL(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_XQS_QLIMIT_SHR_FILL_STAT_QLIMIT_SHR_FILL     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_XQS_QLIMIT_SHR_FILL_STAT_QLIMIT_SHR_FILL(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_SHR_WM_STAT(gi)      VTSS_IOREG_IX(VTSS_TO_XQS,0x7c0,gi,12,0,11)

/** 
 * \details 
 * Field: ::VTSS_XQS_QLIMIT_SHR_WM_STAT . QLIMIT_SHR_WM
 */
#define  VTSS_F_XQS_QLIMIT_SHR_WM_STAT_QLIMIT_SHR_WM(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_XQS_QLIMIT_SHR_WM_STAT_QLIMIT_SHR_WM     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_XQS_QLIMIT_SHR_WM_STAT_QLIMIT_SHR_WM(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_MON_CFG(gi)          VTSS_IOREG_IX(VTSS_TO_XQS,0x7f0,gi,3,0,0)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_CONG_CNT_MAX_STAT(gi)  VTSS_IOREG_IX(VTSS_TO_XQS,0x7f0,gi,3,0,1)

/** 
 * \details 
 * Field: ::VTSS_XQS_QLIMIT_CONG_CNT_MAX_STAT . QLIMIT_CONG_CNT_MAX
 */
#define  VTSS_F_XQS_QLIMIT_CONG_CNT_MAX_STAT_QLIMIT_CONG_CNT_MAX(x)  VTSS_ENCODE_BITFIELD(x,0,13)
#define  VTSS_M_XQS_QLIMIT_CONG_CNT_MAX_STAT_QLIMIT_CONG_CNT_MAX     VTSS_ENCODE_BITMASK(0,13)
#define  VTSS_X_XQS_QLIMIT_CONG_CNT_MAX_STAT_QLIMIT_CONG_CNT_MAX(x)  VTSS_EXTRACT_BITFIELD(x,0,13)
 ...
 * @param gi Replicator: x_GAZ_CORE_QLIM_SHR_CNT (??), 0-3
 */
#define VTSS_XQS_QLIMIT_SHR_FILL_MAX_STAT(gi)  VTSS_IOREG_IX(VTSS_TO_XQS,0x7f0,gi,3,0,2)

/** 
 * \details 
 * Field: ::VTSS_XQS_QLIMIT_SHR_FILL_MAX_STAT . QLIMIT_SHR_FILL_MAX
 */
#define  VTSS_F_XQS_QLIMIT_SHR_FILL_MAX_STAT_QLIMIT_SHR_FILL_MAX(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_XQS_QLIMIT_SHR_FILL_MAX_STAT_QLIMIT_SHR_FILL_MAX     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_XQS_QLIMIT_SHR_FILL_MAX_STAT_QLIMIT_SHR_FILL_MAX(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
