...
vtss_rc vtss_ant_sd10g28_cmu_reg_cfg(vtss_state_t *vtss_state, u32 cmu_mask)
{
    ...
    for (cmu_num = 0U; cmu_num < RT_CMU_CNT; cmu_num++) {
        ...
        REG_WRM(VTSS_SD10G_CMU_TARGET_CMU_44(cmu_tgt), VTSS_F_SD10G_CMU_TARGET_CMU_44_R_PLL_RSTN(0),
                VTSS_M_SD10G_CMU_TARGET_CMU_44_R_PLL_RSTN);

        REG_WRM(VTSS_SD10G_CMU_TARGET_CMU_44(cmu_tgt), VTSS_F_SD10G_CMU_TARGET_CMU_44_R_PLL_RSTN(1),
                VTSS_M_SD10G_CMU_TARGET_CMU_44_R_PLL_RSTN);
    }
...
static vtss_rc vtss_ant_sd10g28_reg_cfg(vtss_state_t                      *vtss_state,
                                        vtss_sd10g28_setup_struct_t *const res_struct,
                                        vtss_port_no_t                     port_no)
{
    ...
    for (p = VTSS_PORT_NO_START; p < vtss_state->port_count; p++) {
        ...
        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_40(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_40_CFG_LANE_RESERVE_7_0(res_struct
                                                                          ->cfg_lane_reserve_7_0[0]),
                VTSS_M_SD10G_LANE_TARGET_LANE_40_CFG_LANE_RESERVE_7_0);

        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_50(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_50_CFG_SSC_RTL_CLK_SEL(res_struct
                                                                         ->cfg_ssc_rtl_clk_sel[0]),
        ...
        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_0E(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_0E_CFG_EQC_FORCE_3_0(res_struct->cfg_eqC_force_3_0[0]) |
                    VTSS_F_SD10G_LANE_TARGET_LANE_0E_CFG_SUM_SETCM_EN(res_struct
                                                                          ->cfg_sum_setcm_en[0]),
        ...
        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_16(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_16_CFG_PI_EXT_DAC_23_16(res_struct
                                                                          ->cfg_pi_ext_dac_23_16[0]),
                VTSS_M_SD10G_LANE_TARGET_LANE_16_CFG_PI_EXT_DAC_23_16);

        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_15(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_15_CFG_PI_EXT_DAC_15_8(res_struct
                                                                         ->cfg_pi_ext_dac_15_8[0]),
        ...
        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_42(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_42_CFG_CDR_KF_GEN1_2_0(res_struct
                                                                         ->cfg_cdr_kf_gen1_2_0[0]),
        ...
        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_24(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_24_CFG_PI_BW_GEN1_3_0(res_struct
                                                                        ->cfg_pi_bw_gen1_3_0[0]),
                VTSS_M_SD10G_LANE_TARGET_LANE_24_CFG_PI_BW_GEN1_3_0);

        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_14(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_14_CFG_PI_EXT_DAC_7_0(res_struct
                                                                        ->cfg_pi_ext_dac_7_0[0]),
        ...
        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_37(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_37_CFG_IP_PRE_BASE_1_0(res_struct
        ...
        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_9E(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_9E_R_EN_AUTO_CDR_RSTN(res_struct
        ...
        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_0C(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_0C_CFG_OSCAL_AFE(res_struct->cfg_oscal_afe[0]) |
                    VTSS_F_SD10G_LANE_TARGET_LANE_0C_CFG_PD_OSDAC_AFE(res_struct
                                                                          ->cfg_pd_osdac_afe[0]),
                VTSS_M_SD10G_LANE_TARGET_LANE_0C_CFG_OSCAL_AFE |
                    VTSS_M_SD10G_LANE_TARGET_LANE_0C_CFG_PD_OSDAC_AFE);

        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_0B(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_0B_CFG_RESETB_OSCAL_AFE(res_struct
                                                                          ->cfg_resetb_oscal_afe[0]),
                VTSS_M_SD10G_LANE_TARGET_LANE_0B_CFG_RESETB_OSCAL_AFE);

        REG_WRM(VTSS_SD10G_LANE_TARGET_LANE_0B(sd_tgt),
                VTSS_F_SD10G_LANE_TARGET_LANE_0B_CFG_RESETB_OSCAL_AFE(res_struct
                                                                          ->cfg_resetb_oscal_afe[1]),
                VTSS_M_SD10G_LANE_TARGET_LANE_0B_CFG_RESETB_OSCAL_AFE);
