 ...
 */
#define  VTSS_F_ANA_AC_POL_POL_ALL_CFG_POL_ACL_CTRL_ACL_PIPELINE_PT(x)  VTSS_ENCODE_BITFIELD(x,3,5)
#define  VTSS_M_ANA_AC_POL_POL_ALL_CFG_POL_ACL_CTRL_ACL_PIPELINE_PT     VTSS_ENCODE_BITMASK(3,5)
#define  VTSS_X_ANA_AC_POL_POL_ALL_CFG_POL_ACL_CTRL_ACL_PIPELINE_PT(x)  VTSS_EXTRACT_BITFIELD(x,3,5)
 ...
 */
#define  VTSS_F_ANA_AC_POL_POL_ALL_CFG_POL_UPD_INT_CFG_POL_UPD_INT(x)  VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_ANA_AC_POL_POL_ALL_CFG_POL_UPD_INT_CFG_POL_UPD_INT     VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_ANA_AC_POL_POL_ALL_CFG_POL_UPD_INT_CFG_POL_UPD_INT(x)  VTSS_EXTRACT_BITFIELD(x,0,8)
 ...
 *
 * @param ri Replicator: x_FFL_ANA_AC_POL_PORT_TOT_NUM_LB (??), 0-139
 */
#define VTSS_ANA_AC_POL_POL_PORT_CFG_POL_PORT_THRES_CFG_0(ri)  VTSS_IOREG(VTSS_TO_ANA_AC_POL,0x0 + (ri))
 ...
 * @param ri Replicator: x_FFL_ANA_AC_POL_PORT_TOT_NUM_LB (??), 0-139
 */
#define VTSS_ANA_AC_POL_POL_PORT_CFG_POL_PORT_THRES_CFG_1(ri)  VTSS_IOREG(VTSS_TO_ANA_AC_POL,0x200 + (ri))
 ...
 * @param ri Replicator: x_FFL_ANA_AC_POL_PORT_TOT_NUM_LB (??), 0-139
 */
#define VTSS_ANA_AC_POL_POL_PORT_CFG_POL_PORT_RATE_CFG(ri)  VTSS_IOREG(VTSS_TO_ANA_AC_POL,0x400 + (ri))
...
/**
 * \brief
 * Configuration of the drop precedence change for traffic exceeding EIR.
 * By default, such frames are discarded. If EIR_INC_DP_VAL > 0, the DP
 * level is incremented with EIR_INC_DP_VAL instead of discarding.
 *
 * \details
 * 0: Disabled. Frames are discarded when exceeding EIR.
 * n: DP is increased with n for traffic exceeding EIR.
 *
 * Field: ::VTSS_ANA_AC_POL_BDLB_MISC_CFG . EIR_INC_DP_VAL
 */
#define  VTSS_F_ANA_AC_POL_BDLB_MISC_CFG_EIR_INC_DP_VAL(x)  VTSS_ENCODE_BITFIELD(x,4,2)
#define  VTSS_M_ANA_AC_POL_BDLB_MISC_CFG_EIR_INC_DP_VAL     VTSS_ENCODE_BITMASK(4,2)
#define  VTSS_X_ANA_AC_POL_BDLB_MISC_CFG_EIR_INC_DP_VAL(x)  VTSS_EXTRACT_BITFIELD(x,4,2)

/**
 * \brief
 * Increment DP level with DLB_CFG.CIR_INC_DP_VAL for yellow frames when
 * CIR is exceeded.
 *
 * \details
 * 0: DP is incremented for green frames only (frame's DP <=
 * COLOR_AWARE_LVL).
 * 1: DP is incremented for all frames.
 *
 * Field: ::VTSS_ANA_AC_POL_BDLB_MISC_CFG . YELLOW_INC_DP_ENA
 */
#define  VTSS_F_ANA_AC_POL_BDLB_MISC_CFG_YELLOW_INC_DP_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),3,1)
#define  VTSS_M_ANA_AC_POL_BDLB_MISC_CFG_YELLOW_INC_DP_ENA  VTSS_BIT(3)
#define  VTSS_X_ANA_AC_POL_BDLB_MISC_CFG_YELLOW_INC_DP_ENA(x)  VTSS_EXTRACT_BITFIELD(x,3,1)
...
/**
 * \brief
 * Configuration of the drop precedence change for traffic exceeding CIR.
 * Frames accounted for in the EIR bucket are subject to incrementing the
 * DP level with CIR_INC_DP_VAL. This is independent of settings in
 * COLOR_AWARE_LVL.
 *
 * \details
 * 0: DP is not increased.
 * n: DP is increased with n for traffic exceeding CIR.
 *
...
#endif /* _VTSS_LAGUNA_REGS_ANA_AC_POL_H_ */
