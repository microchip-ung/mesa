...
#ifndef _VTSS_LAGUNA_REGS_DEVCPU_ORG_H_
#define _VTSS_LAGUNA_REGS_DEVCPU_ORG_H_
 ...
 */
#define  VTSS_F_DEVCPU_ORG_SEMA_CFG_SEMA_INTR_POL(x)  VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_DEVCPU_ORG_SEMA_CFG_SEMA_INTR_POL     VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_DEVCPU_ORG_SEMA_CFG_SEMA_INTR_POL(x)  VTSS_EXTRACT_BITFIELD(x,0,8)
 ...
 *
 * \details
 * Register: \a DEVCPU_ORG:DEVCPU_ORG:SEMA
 *
 * @param target A \a ::vtss_target_DEVCPU_ORG_e target
 * @param ri Register: SEMA (??), 0-7
 */
#define VTSS_DEVCPU_ORG_SEMA(target,ri)      VTSS_IOREG(target,0xa + (ri))
 ...
 *
 * Field: ::VTSS_DEVCPU_ORG_SEMA . SEMA
 */
#define  VTSS_F_DEVCPU_ORG_SEMA_SEMA(x)       VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_DEVCPU_ORG_SEMA_SEMA          VTSS_BIT(0)
#define  VTSS_X_DEVCPU_ORG_SEMA_SEMA(x)       VTSS_EXTRACT_BITFIELD(x,0,1)


#endif /* _VTSS_LAGUNA_REGS_DEVCPU_ORG_H_ */
