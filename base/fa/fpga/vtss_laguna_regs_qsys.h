 ...
 */
#define  VTSS_F_QSYS_PAUSE_CFG_PAUSE_START(x)  VTSS_ENCODE_BITFIELD(x,7,5)
#define  VTSS_M_QSYS_PAUSE_CFG_PAUSE_START     VTSS_ENCODE_BITMASK(7,5)
#define  VTSS_X_QSYS_PAUSE_CFG_PAUSE_START(x)  VTSS_EXTRACT_BITFIELD(x,7,5)
 ...
 */
#define  VTSS_F_QSYS_PAUSE_CFG_PAUSE_STOP(x)  VTSS_ENCODE_BITFIELD(x,2,5)
#define  VTSS_M_QSYS_PAUSE_CFG_PAUSE_STOP     VTSS_ENCODE_BITMASK(2,5)
#define  VTSS_X_QSYS_PAUSE_CFG_PAUSE_STOP(x)  VTSS_EXTRACT_BITFIELD(x,2,5)
 ...
 */
#define  VTSS_F_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_START(x)  VTSS_ENCODE_BITFIELD(x,5,5)
#define  VTSS_M_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_START     VTSS_ENCODE_BITMASK(5,5)
#define  VTSS_X_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_START(x)  VTSS_EXTRACT_BITFIELD(x,5,5)
 ...
 */
#define  VTSS_F_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_STOP(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_STOP     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_STOP(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define  VTSS_F_QSYS_ATOP_ATOP(x)             VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_QSYS_ATOP_ATOP                VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_QSYS_ATOP_ATOP(x)             VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define  VTSS_F_QSYS_ATOP_TOT_CFG_ATOP_TOT(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_QSYS_ATOP_TOT_CFG_ATOP_TOT     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_QSYS_ATOP_TOT_CFG_ATOP_TOT(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define  VTSS_F_QSYS_MMGT_PORT_USE_MMGT_PORT_USE(x)  VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_QSYS_MMGT_PORT_USE_MMGT_PORT_USE     VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_QSYS_MMGT_PORT_USE_MMGT_PORT_USE(x)  VTSS_EXTRACT_BITFIELD(x,0,8)
 ...
 */
#define  VTSS_F_QSYS_MMGT_PRIO_USE_MMGT_PRIO_USE(x)  VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_QSYS_MMGT_PRIO_USE_MMGT_PRIO_USE     VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_QSYS_MMGT_PRIO_USE_MMGT_PRIO_USE(x)  VTSS_EXTRACT_BITFIELD(x,0,8)
 ...
 */
#define  VTSS_F_QSYS_SOFDATA_STAT_SHR_SOFDATA_SHR_USE(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_QSYS_SOFDATA_STAT_SHR_SOFDATA_SHR_USE     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_QSYS_SOFDATA_STAT_SHR_SOFDATA_SHR_USE(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define  VTSS_F_QSYS_SOFDATA_STAT_SOFDATA_PORT_USE(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_QSYS_SOFDATA_STAT_SOFDATA_PORT_USE     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_QSYS_SOFDATA_STAT_SOFDATA_PORT_USE(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define  VTSS_F_QSYS_SOFDATA_WM_VAL_SOFDATA_WM_VAL(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_QSYS_SOFDATA_WM_VAL_SOFDATA_WM_VAL     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_QSYS_SOFDATA_WM_VAL_SOFDATA_WM_VAL(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
