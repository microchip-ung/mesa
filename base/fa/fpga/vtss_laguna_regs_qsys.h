 ...
 */
#define  VTSS_F_QSYS_PAUSE_CFG_PAUSE_STOP(x)  VTSS_ENCODE_BITFIELD(x,2,7)
#define  VTSS_M_QSYS_PAUSE_CFG_PAUSE_STOP     VTSS_ENCODE_BITMASK(2,7)
#define  VTSS_X_QSYS_PAUSE_CFG_PAUSE_STOP(x)  VTSS_EXTRACT_BITFIELD(x,2,7)
 ...
 */
#define  VTSS_F_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_STOP(x)  VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_STOP     VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_STOP(x)  VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 */
#define  VTSS_F_QSYS_ATOP_ATOP(x)             VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_QSYS_ATOP_ATOP                VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_QSYS_ATOP_ATOP(x)             VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 */
#define  VTSS_F_QSYS_ATOP_TOT_CFG_ATOP_TOT(x)  VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_QSYS_ATOP_TOT_CFG_ATOP_TOT     VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_QSYS_ATOP_TOT_CFG_ATOP_TOT(x)  VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 */
#define  VTSS_F_QSYS_MMGT_PORT_USE_MMGT_PORT_USE(x)  VTSS_ENCODE_BITFIELD(x,0,10)
#define  VTSS_M_QSYS_MMGT_PORT_USE_MMGT_PORT_USE     VTSS_ENCODE_BITMASK(0,10)
#define  VTSS_X_QSYS_MMGT_PORT_USE_MMGT_PORT_USE(x)  VTSS_EXTRACT_BITFIELD(x,0,10)
 ...
 */
#define  VTSS_F_QSYS_MMGT_PRIO_USE_MMGT_PRIO_USE(x)  VTSS_ENCODE_BITFIELD(x,0,10)
#define  VTSS_M_QSYS_MMGT_PRIO_USE_MMGT_PRIO_USE     VTSS_ENCODE_BITMASK(0,10)
#define  VTSS_X_QSYS_MMGT_PRIO_USE_MMGT_PRIO_USE(x)  VTSS_EXTRACT_BITFIELD(x,0,10)
 ...
 * Other speeds will be adjusted relative to this. Default value of 668 ns
 ...
 *
 * Field: ::VTSS_QSYS_RAM_INIT . RAM_TEST_OPT
 */
#define  VTSS_F_QSYS_RAM_INIT_RAM_TEST_OPT(x)  VTSS_ENCODE_BITFIELD(x,2,3)
#define  VTSS_M_QSYS_RAM_INIT_RAM_TEST_OPT     VTSS_ENCODE_BITMASK(2,3)
#define  VTSS_X_QSYS_RAM_INIT_RAM_TEST_OPT(x)  VTSS_EXTRACT_BITFIELD(x,2,3)
