...
#ifndef _VTSS_LAGUNA_REGS_ASM_H_
#define _VTSS_LAGUNA_REGS_ASM_H_
 ...
 *
 * @param gi Replicator: x_NUM_DEVS_PER_STATS_BLOCK (??), 0-29
 */
 ...
 */
#define  VTSS_F_ASM_DBG_CFG_FIFO_RST(x)       VTSS_ENCODE_BITFIELD(x,3,6)
#define  VTSS_M_ASM_DBG_CFG_FIFO_RST          VTSS_ENCODE_BITMASK(3,6)
#define  VTSS_X_ASM_DBG_CFG_FIFO_RST(x)       VTSS_EXTRACT_BITFIELD(x,3,6)
 ...
 *
 * @param gi Replicator: x_NUM_ETHERNET_PORTS (??), 0-29
 */
#define VTSS_ASM_PFC_CFG(gi)                 VTSS_IOREG_IX(VTSS_TO_ASM,0x1000,gi,16,0,0)
 ...
 */
#define VTSS_ASM_PFC_TIMER(gi,ri)            VTSS_IOREG_IX(VTSS_TO_ASM,0x1000,gi,16,ri,1)
...
#endif /* _VTSS_LAGUNA_REGS_ASM_H_ */
