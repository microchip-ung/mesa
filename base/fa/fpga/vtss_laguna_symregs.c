...
static const vtss_symreg_reggrp_t reggrps_within_CPU[] = {
    ...
    {"INTR"                                 , 0x00000000, 0x00000001, 0x00000071, regs_within_CPU_INTR},
    {NULL, 0, 0, 0, NULL}
};
...
static const vtss_symreg_reggrp_t reggrps_within_ANA_AC[] = {
    ...
    {"STAT_GLOBAL_CFG_ISDX"                 , 0x00005516, 0x00000001, 0x00000015, regs_within_ANA_AC_STAT_GLOBAL_CFG_ISDX},
    {"STAT_CNT_CFG_ISDX"                    , 0x00004a00, 0x00000020, 0x00000010, regs_within_ANA_AC_STAT_CNT_CFG_ISDX},
    {"STAT_GLOBAL_CFG_BDLB"                 , 0x0000552b, 0x00000001, 0x00000006, regs_within_ANA_AC_STAT_GLOBAL_CFG_BDLB},
    {"STAT_CNT_CFG_BDLB"                    , 0x00004f00, 0x00000010, 0x00000004, regs_within_ANA_AC_STAT_CNT_CFG_BDLB},
    {"STAT_GLOBAL_CFG_BUM"                  , 0x00005531, 0x00000001, 0x00000012, regs_within_ANA_AC_STAT_GLOBAL_CFG_BUM},
    {"STAT_CNT_CFG_BUM"                     , 0x00004900, 0x00000010, 0x00000010, regs_within_ANA_AC_STAT_CNT_CFG_BUM},
    {"STAT_GLOBAL_CFG_IRLEG"                , 0x00005543, 0x00000001, 0x00000018, regs_within_ANA_AC_STAT_GLOBAL_CFG_IRLEG},
    {"STAT_CNT_CFG_IRLEG"                   , 0x00005600, 0x00000020, 0x00000010, regs_within_ANA_AC_STAT_CNT_CFG_IRLEG},
    {"STAT_GLOBAL_CFG_ERLEG"                , 0x0000555b, 0x00000001, 0x00000018, regs_within_ANA_AC_STAT_GLOBAL_CFG_ERLEG},
...
static const vtss_symreg_reggrp_t reggrps_within_ANA_L2[] = {
    //reggrp name                           , base_addr , repl_cnt  , repl_width, reg list
    {"COMMON"                               , 0x000221c2, 0x00000001, 0x000000b2, regs_within_ANA_L2_COMMON},
    ...
    {"STICKY"                               , 0x00022274, 0x00000001, 0x00000001, regs_within_ANA_L2_STICKY},
    {"STICKY_MASK"                          , 0x00022275, 0x00000004, 0x00000001, regs_within_ANA_L2_STICKY_MASK},
    {"PMAC"                                 , 0x00022279, 0x00000001, 0x00000009, regs_within_ANA_L2_PMAC},
    {NULL, 0, 0, 0, NULL}
};
...
static const vtss_symreg_reg_t regs_within_DEVCPU_GCB_CHIP_REGS[] = {
    ...
    {"BUILDID"                              , 0x0000002a, 0x00000001, 0x00000001},
    {NULL, 0, 0, 0}
};
...
static const vtss_symreg_reggrp_t reggrps_within_DEVCPU_GCB[] = {
    //reggrp name                           , base_addr , repl_cnt  , repl_width, reg list
    {"CHIP_REGS"                            , 0x00000000, 0x00000001, 0x0000002b, regs_within_DEVCPU_GCB_CHIP_REGS},
    {"SI_REGS"                              , 0x0000002b, 0x00000001, 0x00000002, regs_within_DEVCPU_GCB_SI_REGS},
    {"MIIM"                                 , 0x0000002d, 0x00000002, 0x00000009, regs_within_DEVCPU_GCB_MIIM},
    {"MIIM_READ_SCAN"                       , 0x0000003f, 0x00000001, 0x00000002, regs_within_DEVCPU_GCB_MIIM_READ_SCAN},
    {"SIO_CTRL"                             , 0x00000041, 0x00000001, 0x00000046, regs_within_DEVCPU_GCB_SIO_CTRL},
    {NULL, 0, 0, 0, NULL}
};
...
static const vtss_symreg_reggrp_t reggrps_within_REW[] = {
    //reggrp name                           , base_addr , repl_cnt  , repl_width, reg list
    {"COMMON"                               , 0x00003e80, 0x00000001, 0x00000134, regs_within_REW_COMMON},
    {"MAP_RES_A"                            , 0x00002a00, 0x00000100, 0x00000002, regs_within_REW_MAP_RES_A},
    {"MAP_RES_B"                            , 0x00004000, 0x00000100, 0x00000002, regs_within_REW_MAP_RES_B},
    ...
    {"VOE_SRV_LM_CNT"                       , 0x00003bc0, 0x00000040, 0x00000001, regs_within_REW_VOE_SRV_LM_CNT},
...
#endif
    {"PDU_MOD_CFG"                          , 0x00003fb4, 0x00000001, 0x00000048, regs_within_REW_PDU_MOD_CFG},
    {"RAM_CTRL"                             , 0x00003e08, 0x00000001, 0x00000001, regs_within_REW_RAM_CTRL},
#ifndef VTSS_RELEASE
    {"COREMEM"                              , 0x00003e09, 0x00000001, 0x00000004, regs_within_REW_COREMEM},
#endif
    {"GPTP_DOM"                             , 0x00003e40, 0x00000004, 0x00000010, regs_within_REW_GPTP_DOM},
    {"GPTP_COMMON_CFG"                      , 0x00004200, 0x00000001, 0x00000040, regs_within_REW_GPTP_COMMON_CFG},
    {NULL, 0, 0, 0, NULL}
};
...
static const vtss_symreg_reggrp_t reggrps_within_VOP_MRP[] = {
    //reggrp name                           , base_addr , repl_cnt  , repl_width, reg list
    {"VOE_CONF_MRP"                         , 0x00000800, 0x00000026, 0x00000010, regs_within_VOP_MRP_VOE_CONF_MRP},
    {"VOE_STAT_MRP"                         , 0x00000000, 0x00000026, 0x00000020, regs_within_VOP_MRP_VOE_STAT_MRP},
    {NULL, 0, 0, 0, NULL}
};
...
static const vtss_symreg_reggrp_t reggrps_within_VOP_DLR[] = {
    //reggrp name                           , base_addr , repl_cnt  , repl_width, reg list
    {"VOE_CONF_DLR"                         , 0x00000000, 0x00000026, 0x00000010, regs_within_VOP_DLR_VOE_CONF_DLR},
    {"VOE_STAT_DLR"                         , 0x00000400, 0x00000026, 0x00000010, regs_within_VOP_DLR_VOE_STAT_DLR},
    {NULL, 0, 0, 0, NULL}
};
