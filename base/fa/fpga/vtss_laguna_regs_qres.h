 ...
 */
#define  VTSS_F_QRES_WRED_PROFILE_WM_RED_LOW(x)  VTSS_ENCODE_BITFIELD(x,4,4)
#define  VTSS_M_QRES_WRED_PROFILE_WM_RED_LOW     VTSS_ENCODE_BITMASK(4,4)
#define  VTSS_X_QRES_WRED_PROFILE_WM_RED_LOW(x)  VTSS_EXTRACT_BITFIELD(x,4,4)
 ...
 */
#define  VTSS_F_QRES_WRED_PROFILE_WM_RED_HIGH(x)  VTSS_ENCODE_BITFIELD(x,0,4)
#define  VTSS_M_QRES_WRED_PROFILE_WM_RED_HIGH     VTSS_ENCODE_BITMASK(0,4)
#define  VTSS_X_QRES_WRED_PROFILE_WM_RED_HIGH(x)  VTSS_EXTRACT_BITFIELD(x,0,4)
 ...
 */
#define VTSS_QRES_RES_QOS_MODE               VTSS_IOREG(VTSS_TO_QRES,0x506b)
 ...
 */
#define VTSS_QRES_RES_DLB_OFFSET             VTSS_IOREG(VTSS_TO_QRES,0x506c)
 ...
 */
#define  VTSS_F_QRES_RES_CFG_WM_HIGH(x)       VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_QRES_RES_CFG_WM_HIGH          VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_QRES_RES_CFG_WM_HIGH(x)       VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define  VTSS_F_QRES_RES_STAT_MAXUSE(x)       VTSS_ENCODE_BITFIELD(x,0,13)
#define  VTSS_M_QRES_RES_STAT_MAXUSE          VTSS_ENCODE_BITMASK(0,13)
#define  VTSS_X_QRES_RES_STAT_MAXUSE(x)       VTSS_EXTRACT_BITFIELD(x,0,13)
 ...
 */
#define  VTSS_F_QRES_RES_STAT_CUR_INUSE(x)    VTSS_ENCODE_BITFIELD(x,0,13)
#define  VTSS_M_QRES_RES_STAT_CUR_INUSE       VTSS_ENCODE_BITMASK(0,13)
#define  VTSS_X_QRES_RES_STAT_CUR_INUSE(x)    VTSS_EXTRACT_BITFIELD(x,0,13)
