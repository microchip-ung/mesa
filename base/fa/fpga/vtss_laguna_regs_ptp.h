 ...
 */
#define VTSS_DEVCPU_PTP_PTP_PIN_INTR                VTSS_IOREG(VTSS_TO_DEVCPU_PTP,0x80)
 ...
 */
#define  VTSS_F_DEVCPU_PTP_PTP_PIN_INTR_INTR_PTP(x)  VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_DEVCPU_PTP_PTP_PIN_INTR_INTR_PTP     VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_DEVCPU_PTP_PTP_PIN_INTR_INTR_PTP(x)  VTSS_EXTRACT_BITFIELD(x,0,8)
 ...
 */
#define VTSS_DEVCPU_PTP_PTP_PIN_INTR_ENA            VTSS_IOREG(VTSS_TO_DEVCPU_PTP,0x81)
 ...
 */
#define  VTSS_F_DEVCPU_PTP_PTP_PIN_INTR_ENA_INTR_PTP_ENA(x)  VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_DEVCPU_PTP_PTP_PIN_INTR_ENA_INTR_PTP_ENA     VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_DEVCPU_PTP_PTP_PIN_INTR_ENA_INTR_PTP_ENA(x)  VTSS_EXTRACT_BITFIELD(x,0,8)
 ...
 */
#define VTSS_DEVCPU_PTP_PTP_INTR_IDENT              VTSS_IOREG(VTSS_TO_DEVCPU_PTP,0x82)
 ...
 */
#define  VTSS_F_DEVCPU_PTP_PTP_INTR_IDENT_INTR_PTP_IDENT(x)  VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_DEVCPU_PTP_PTP_INTR_IDENT_INTR_PTP_IDENT     VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_DEVCPU_PTP_PTP_INTR_IDENT_INTR_PTP_IDENT(x)  VTSS_EXTRACT_BITFIELD(x,0,8)
 ...
 */
#define VTSS_DEVCPU_PTP_PTP_DOM_CFG                 VTSS_IOREG(VTSS_TO_DEVCPU_PTP,0x83)
 ...
 */
#define VTSS_DEVCPU_PTP_CLK_PER_CFG(gi,ri)          VTSS_IOREG_IX(VTSS_TO_DEVCPU_PTP,0x84,gi,7,ri,0)
 ...
 * @param gi Replicator: x_PTP_CFG_NUM_TOD_DOMAINS (??), 0-2
 */
#define VTSS_DEVCPU_PTP_PTP_CUR_NSEC(gi)            VTSS_IOREG_IX(VTSS_TO_DEVCPU_PTP,0x84,gi,7,0,2)
 ...
 * @param gi Replicator: x_PTP_CFG_NUM_TOD_DOMAINS (??), 0-2
 */
#define VTSS_DEVCPU_PTP_PTP_CUR_NSEC_FRAC(gi)       VTSS_IOREG_IX(VTSS_TO_DEVCPU_PTP,0x84,gi,7,0,3)
 ...
 * @param gi Replicator: x_PTP_CFG_NUM_TOD_DOMAINS (??), 0-2
 */
#define VTSS_DEVCPU_PTP_PTP_CUR_SEC_LSB(gi)         VTSS_IOREG_IX(VTSS_TO_DEVCPU_PTP,0x84,gi,7,0,4)
 ...
 * @param gi Replicator: x_PTP_CFG_NUM_TOD_DOMAINS (??), 0-2
 */
#define VTSS_DEVCPU_PTP_PTP_CUR_SEC_MSB(gi)         VTSS_IOREG_IX(VTSS_TO_DEVCPU_PTP,0x84,gi,7,0,5)
 ...
 * @param gi Replicator: x_PTP_CFG_NUM_TOD_DOMAINS (??), 0-2
 */
#define VTSS_DEVCPU_PTP_NTP_CUR_NSEC(gi)            VTSS_IOREG_IX(VTSS_TO_DEVCPU_PTP,0x84,gi,7,0,6)
 ...
 */
#define  VTSS_F_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_ACTION(x)  VTSS_ENCODE_BITFIELD(x,27,3)
#define  VTSS_M_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_ACTION     VTSS_ENCODE_BITMASK(27,3)
#define  VTSS_X_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_ACTION(x)  VTSS_EXTRACT_BITFIELD(x,27,3)
 ...
 */
#define  VTSS_F_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_SYNC(x)  VTSS_ENCODE_BITFIELD(x,25,2)
#define  VTSS_M_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_SYNC     VTSS_ENCODE_BITMASK(25,2)
#define  VTSS_X_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_SYNC(x)  VTSS_EXTRACT_BITFIELD(x,25,2)
 ...
 */
#define  VTSS_F_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_INV_POL(x)  VTSS_ENCODE_BITFIELD(!!(x),24,1)
#define  VTSS_M_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_INV_POL  VTSS_BIT(24)
#define  VTSS_X_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_INV_POL(x)  VTSS_EXTRACT_BITFIELD(x,24,1)
 ...
 */
#define  VTSS_F_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_SELECT(x)  VTSS_ENCODE_BITFIELD(x,21,3)
#define  VTSS_M_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_SELECT     VTSS_ENCODE_BITMASK(21,3)
#define  VTSS_X_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_SELECT(x)  VTSS_EXTRACT_BITFIELD(x,21,3)
 ...
 */
#define VTSS_REW_PTP_CTRL_PTP_TWOSTEP_CTRL            VTSS_IOREG(VTSS_TO_DEVCPU_PTP,0x99)
 ...
 *
 * \details
 * Field: ::VTSS_DEVCPU_PTP_PTP_TWOSTEP_CTRL . PTP_OVFL
 */
 ...
 */
#define VTSS_REW_PTP_CTRL_PTP_TWOSTEP_STAMP      VTSS_IOREG(VTSS_TO_DEVCPU_PTP,0x9a)
 ...
 *
 * \details
 * Field: ::VTSS_DEVCPU_PTP_PTP_TWOSTEP_STAMP_NSEC . STAMP_NSEC
 */
#define  VTSS_F_DEVCPU_PTP_PTP_TWOSTEP_STAMP_NSEC_STAMP_NSEC(x)  VTSS_ENCODE_BITFIELD(x,0,30)
#define  VTSS_M_DEVCPU_PTP_PTP_TWOSTEP_STAMP_NSEC_STAMP_NSEC     VTSS_ENCODE_BITMASK(0,30)
#define  VTSS_X_DEVCPU_PTP_PTP_TWOSTEP_STAMP_NSEC_STAMP_NSEC(x)  VTSS_EXTRACT_BITFIELD(x,0,30)
 ...
 */
#define VTSS_REW_PTP_CTRL_PTP_TWOSTEP_STAMP_SUBNS     VTSS_IOREG(VTSS_TO_DEVCPU_PTP,0x9b)
 ...
 *
 * \details
 * Field: ::VTSS_DEVCPU_PTP_PTP_TWOSTEP_STAMP_SUBNS . STAMP_SUB_NSEC
 */
#define  VTSS_F_DEVCPU_PTP_PTP_TWOSTEP_STAMP_SUBNS_STAMP_SUB_NSEC(x)  VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_DEVCPU_PTP_PTP_TWOSTEP_STAMP_SUBNS_STAMP_SUB_NSEC     VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_DEVCPU_PTP_PTP_TWOSTEP_STAMP_SUBNS_STAMP_SUB_NSEC(x)  VTSS_EXTRACT_BITFIELD(x,0,8)
 ...
 */
#define VTSS_DEVCPU_PTP_PTP_WRP                     VTSS_IOREG(VTSS_TO_DEVCPU_PTP,0x9c)
 ...
 *
 * \details
 * Field: ::VTSS_DEVCPU_PTP_PTP_WRP . PTP_WRP
 */
#define  VTSS_F_DEVCPU_PTP_PTP_WRP_PTP_WRP(x)        VTSS_ENCODE_BITFIELD(x,0,16)
#define  VTSS_M_DEVCPU_PTP_PTP_WRP_PTP_WRP           VTSS_ENCODE_BITMASK(0,16)
#define  VTSS_X_DEVCPU_PTP_PTP_WRP_PTP_WRP(x)        VTSS_EXTRACT_BITFIELD(x,0,16)
 ...
 */
#define VTSS_DEVCPU_PTP_PHAD_CTRL(gi)               VTSS_IOREG_IX(VTSS_TO_DEVCPU_PTP,0x9d,gi,3,0,0)
 ...
 *
 * \details
 * Field: ::VTSS_DEVCPU_PTP_PHAD_CTRL . PHAD_LOCK
 */
#define  VTSS_F_DEVCPU_PTP_PHAD_CTRL_PHAD_LOCK(x)    VTSS_ENCODE_BITFIELD(!!(x),18,1)
#define  VTSS_M_DEVCPU_PTP_PHAD_CTRL_PHAD_LOCK       VTSS_BIT(18)
#define  VTSS_X_DEVCPU_PTP_PHAD_CTRL_PHAD_LOCK(x)    VTSS_EXTRACT_BITFIELD(x,18,1)
 ...
 *
 * \details
 * Field: ::VTSS_DEVCPU_PTP_PHAD_CTRL . DIV_STATE
 */
#define  VTSS_F_DEVCPU_PTP_PHAD_CTRL_DIV_STATE(x)    VTSS_ENCODE_BITFIELD(x,15,3)
#define  VTSS_M_DEVCPU_PTP_PHAD_CTRL_DIV_STATE       VTSS_ENCODE_BITMASK(15,3)
#define  VTSS_X_DEVCPU_PTP_PHAD_CTRL_DIV_STATE(x)    VTSS_EXTRACT_BITFIELD(x,15,3)
 ...
 *
 * \details
 * Field: ::VTSS_DEVCPU_PTP_PHAD_CTRL . PHAD_ADJ
 */
#define  VTSS_F_DEVCPU_PTP_PHAD_CTRL_PHAD_ADJ(x)     VTSS_ENCODE_BITFIELD(x,13,2)
#define  VTSS_M_DEVCPU_PTP_PHAD_CTRL_PHAD_ADJ        VTSS_ENCODE_BITMASK(13,2)
#define  VTSS_X_DEVCPU_PTP_PHAD_CTRL_PHAD_ADJ(x)     VTSS_EXTRACT_BITFIELD(x,13,2)
 ...
 *
 * Field: ::VTSS_DEVCPU_PTP_PHAD_CTRL . ERR_MAX_ENA
 */
#define  VTSS_F_DEVCPU_PTP_PHAD_CTRL_ERR_MAX_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),12,1)
#define  VTSS_M_DEVCPU_PTP_PHAD_CTRL_ERR_MAX_ENA     VTSS_BIT(12)
#define  VTSS_X_DEVCPU_PTP_PHAD_CTRL_ERR_MAX_ENA(x)  VTSS_EXTRACT_BITFIELD(x,12,1)
 ...
 *
 * Field: ::VTSS_DEVCPU_PTP_PHAD_CTRL . DIV_CFG
 */
#define  VTSS_F_DEVCPU_PTP_PHAD_CTRL_DIV_CFG(x)      VTSS_ENCODE_BITFIELD(x,9,3)
#define  VTSS_M_DEVCPU_PTP_PHAD_CTRL_DIV_CFG         VTSS_ENCODE_BITMASK(9,3)
#define  VTSS_X_DEVCPU_PTP_PHAD_CTRL_DIV_CFG(x)      VTSS_EXTRACT_BITFIELD(x,9,3)
 ...
 *
 * Field: ::VTSS_DEVCPU_PTP_PHAD_CTRL . TWEAKS
 */
#define  VTSS_F_DEVCPU_PTP_PHAD_CTRL_TWEAKS(x)       VTSS_ENCODE_BITFIELD(x,6,3)
#define  VTSS_M_DEVCPU_PTP_PHAD_CTRL_TWEAKS          VTSS_ENCODE_BITMASK(6,3)
#define  VTSS_X_DEVCPU_PTP_PHAD_CTRL_TWEAKS(x)       VTSS_EXTRACT_BITFIELD(x,6,3)
 ...
 */
#define  VTSS_F_DEVCPU_PTP_PHAD_CTRL_PHAD_ENA(x)     VTSS_ENCODE_BITFIELD(!!(x),5,1)
#define  VTSS_M_DEVCPU_PTP_PHAD_CTRL_PHAD_ENA        VTSS_BIT(5)
#define  VTSS_X_DEVCPU_PTP_PHAD_CTRL_PHAD_ENA(x)     VTSS_EXTRACT_BITFIELD(x,5,1)
 ...
 *
 * \details
 * Field: ::VTSS_DEVCPU_PTP_PHAD_CTRL . PHAD_MODE
 */
#define  VTSS_F_DEVCPU_PTP_PHAD_CTRL_PHAD_MODE(x)    VTSS_ENCODE_BITFIELD(!!(x),4,1)
#define  VTSS_M_DEVCPU_PTP_PHAD_CTRL_PHAD_MODE       VTSS_BIT(4)
#define  VTSS_X_DEVCPU_PTP_PHAD_CTRL_PHAD_MODE(x)    VTSS_EXTRACT_BITFIELD(x,4,1)
 ...
 */
#define  VTSS_F_DEVCPU_PTP_PHAD_CTRL_PHAD_FAILED(x)  VTSS_ENCODE_BITFIELD(!!(x),3,1)
#define  VTSS_M_DEVCPU_PTP_PHAD_CTRL_PHAD_FAILED     VTSS_BIT(3)
#define  VTSS_X_DEVCPU_PTP_PHAD_CTRL_PHAD_FAILED(x)  VTSS_EXTRACT_BITFIELD(x,3,1)
 ...
 * @param gi Replicator: x_PHASE_DETECTOR_INSTANCES (??), 0-7
 */
#define VTSS_DEVCPU_PTP_PHAD_CYC_STAT(gi)           VTSS_IOREG_IX(VTSS_TO_DEVCPU_PTP,0x9d,gi,3,0,1)
 ...
 * @param gi Replicator: x_PHASE_DETECTOR_INSTANCES (??), 0-7
 */
#define VTSS_DEVCPU_PTP_PHAD_ERR_STAT(gi)           VTSS_IOREG_IX(VTSS_TO_DEVCPU_PTP,0x9d,gi,3,0,2)
 ...
 *
 * \details
 * Field: ::VTSS_DEVCPU_PTP_PHAD_ERR_STAT . PHAD_ERR_STAT
 */
#define  VTSS_F_DEVCPU_PTP_PHAD_ERR_STAT_PHAD_ERR_STAT(x)  VTSS_ENCODE_BITFIELD(x,0,19)
#define  VTSS_M_DEVCPU_PTP_PHAD_ERR_STAT_PHAD_ERR_STAT     VTSS_ENCODE_BITMASK(0,19)
#define  VTSS_X_DEVCPU_PTP_PHAD_ERR_STAT_PHAD_ERR_STAT(x)  VTSS_EXTRACT_BITFIELD(x,0,19)
