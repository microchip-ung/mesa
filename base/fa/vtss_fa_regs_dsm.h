...
#ifndef _VTSS_FA_REGS_DSM_H_
#define _VTSS_FA_REGS_DSM_H_
 ...
 *
 * @param ri Replicator: x_DSM_EPORTS (??), 0-66
 */
 ...
 *
 * @param ri Replicator: x_DSM_CELL_BUFS_DIV32_CEIL (??), 0-4
 */
 ...
 *
 * @param ri Replicator: x_DSM_NUM_PAUSE_FRM_MAC_ADDR (??), 0-64
 */
 ...
 *
 * @param ri Replicator: x_DSM_NUM_OF_TAXI (??), 0-8
 */
 ...
 *
 * @param ri Replicator: x_DSM_CELL_BUFS (??), 0-134
 */
 ...
 *
 * @param ri Replicator: x_DSM_EPORTS_DIV32_CEIL (??), 0-2
 */
#define VTSS_DSM_TX_RATE_LIMIT_STICKY(ri)    VTSS_IOREG(VTSS_TO_DSM,0x55b + (ri))
