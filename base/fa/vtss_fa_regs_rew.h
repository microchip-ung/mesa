...
#ifndef _VTSS_FA_REGS_REW_H_
#define _VTSS_FA_REGS_REW_H_
 ...
 */
#define VTSS_REW_OWN_UPSID(ri)               VTSS_IOREG(VTSS_TO_REW,0x17a30 + (ri))
 ...
 */
#define VTSS_REW_COMMON_CTRL                 VTSS_IOREG(VTSS_TO_REW,0x17a33)
 ...
 *
 * @param ri Replicator: x_FFL_REW_NUM_ETH_PORTS (??), 0-64
 */
#define VTSS_REW_IFH_CTRL(ri)                VTSS_IOREG(VTSS_TO_REW,0x17a34 + (ri))
 ...
 */
#define VTSS_REW_IFH_CTRL_CPUVD              VTSS_IOREG(VTSS_TO_REW,0x17a75)
 ...
 *
 * @param ri Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_PORT_CTRL(ri)               VTSS_IOREG(VTSS_TO_REW,0x17a76 + (ri))
 ...
 */
#define  VTSS_F_REW_PORT_CTRL_ES0_LPORT_NUM(x)  VTSS_ENCODE_BITFIELD(x,25,7)
#define  VTSS_M_REW_PORT_CTRL_ES0_LPORT_NUM     VTSS_ENCODE_BITMASK(25,7)
#define  VTSS_X_REW_PORT_CTRL_ES0_LPORT_NUM(x)  VTSS_EXTRACT_BITFIELD(x,25,7)
 ...
 * @param ri Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_RTAG_ETAG_CTRL(ri)          VTSS_IOREG(VTSS_TO_REW,0x17abc + (ri))
 ...
 */
#define  VTSS_F_REW_RTAG_ETAG_CTRL_IPE_TBL(x)  VTSS_ENCODE_BITFIELD(x,3,7)
#define  VTSS_M_REW_RTAG_ETAG_CTRL_IPE_TBL     VTSS_ENCODE_BITMASK(3,7)
#define  VTSS_X_REW_RTAG_ETAG_CTRL_IPE_TBL(x)  VTSS_EXTRACT_BITFIELD(x,3,7)
 ...
 */
#define VTSS_REW_TPID_CFG(ri)                VTSS_IOREG(VTSS_TO_REW,0x17b02 + (ri))
 ...
 */
#define VTSS_REW_ES0_CTRL                    VTSS_IOREG(VTSS_TO_REW,0x17b05)
 ...
 */
#define VTSS_REW_MIP_CTRL                    VTSS_IOREG(VTSS_TO_REW,0x17b06)
 ...
 */
#define VTSS_REW_MIRROR_PROBE_CFG(ri)        VTSS_IOREG(VTSS_TO_REW,0x17b07 + (ri))
 ...
 */
#define  VTSS_F_REW_MIRROR_PROBE_CFG_MIRROR_TX_PORT(x)  VTSS_ENCODE_BITFIELD(x,12,7)
#define  VTSS_M_REW_MIRROR_PROBE_CFG_MIRROR_TX_PORT     VTSS_ENCODE_BITMASK(12,7)
#define  VTSS_X_REW_MIRROR_PROBE_CFG_MIRROR_TX_PORT(x)  VTSS_EXTRACT_BITFIELD(x,12,7)
 ...
 */
#define  VTSS_F_REW_MIRROR_PROBE_CFG_REMOTE_ENCAP_ID(x)  VTSS_ENCODE_BITFIELD(x,2,10)
#define  VTSS_M_REW_MIRROR_PROBE_CFG_REMOTE_ENCAP_ID     VTSS_ENCODE_BITMASK(2,10)
#define  VTSS_X_REW_MIRROR_PROBE_CFG_REMOTE_ENCAP_ID(x)  VTSS_EXTRACT_BITFIELD(x,2,10)
 ...
 * @param ri Replicator: x_FFL_CHIP_NUM_MIR_PROBES (??), 0-2
 */
#define VTSS_REW_MIRROR_TAG_A_CFG(ri)        VTSS_IOREG(VTSS_TO_REW,0x17b0a + (ri))
 ...
 * @param ri Replicator: x_FFL_CHIP_NUM_MIR_PROBES (??), 0-2
 */
#define VTSS_REW_MIRROR_TAG_B_CFG(ri)        VTSS_IOREG(VTSS_TO_REW,0x17b0d + (ri))
 ...
 */
#define VTSS_REW_DP_MAP                      VTSS_IOREG(VTSS_TO_REW,0x17b10)
 ...
 */
#define VTSS_REW_DSCP_REMAP(ri)              VTSS_IOREG(VTSS_TO_REW,0x17b11 + (ri))
 ...
 */
#define VTSS_REW_RLEG_CFG_0                  VTSS_IOREG(VTSS_TO_REW,0x17b51)
 ...
 */
#define VTSS_REW_RLEG_CFG_1                  VTSS_IOREG(VTSS_TO_REW,0x17b52)
 ...
 */
#define VTSS_REW_CNT_CTRL                    VTSS_IOREG(VTSS_TO_REW,0x17b53)
 ...
 */
#define  VTSS_F_REW_CNT_CTRL_EVENT_CNT_PORT(x)  VTSS_ENCODE_BITFIELD(x,5,7)
#define  VTSS_M_REW_CNT_CTRL_EVENT_CNT_PORT     VTSS_ENCODE_BITMASK(5,7)
#define  VTSS_X_REW_CNT_CTRL_EVENT_CNT_PORT(x)  VTSS_EXTRACT_BITFIELD(x,5,7)
 ...
 */
#define VTSS_REW_STICKY_EVENT_COUNT          VTSS_IOREG(VTSS_TO_REW,0x17b54)
 ...
 */
#define VTSS_REW_STICKY_EVENT_CNT_MASK_CFG   VTSS_IOREG(VTSS_TO_REW,0x17b55)
 ...
 */
#define VTSS_REW_STICKY_EVENT                VTSS_IOREG(VTSS_TO_REW,0x17b56)
 ...
 */
#define VTSS_REW_GCPU_CFG(ri)                VTSS_IOREG(VTSS_TO_REW,0x17b57 + (ri))
 ...
 */
#define VTSS_REW_VSTAX_PORT_GRP_CFG(ri)      VTSS_IOREG(VTSS_TO_REW,0x17b5f + (ri))
 ...
 */
#define VTSS_REW_GCPU_TAG_CFG(ri)            VTSS_IOREG(VTSS_TO_REW,0x17b61 + (ri))
 ...
 */
#define VTSS_REW_MIP_STICKY_EVENT            VTSS_IOREG(VTSS_TO_REW,0x17b63)
 ...
 *
 * @param gi Replicator: x_FFL_REW_NUM_MAP_TBL_ENTRIES (??), 0-4095
 */
#define VTSS_REW_MAP_VAL_A(gi)               VTSS_IOREG_IX(VTSS_TO_REW,0xc000,gi,2,0,0)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_MAP_TBL_ENTRIES (??), 0-4095
 */
#define VTSS_REW_MAP_LBL_A(gi)               VTSS_IOREG_IX(VTSS_TO_REW,0xc000,gi,2,0,1)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_MAP_TBL_ENTRIES (??), 0-4095
 */
#define VTSS_REW_MAP_VAL_B(gi)               VTSS_IOREG_IX(VTSS_TO_REW,0xe000,gi,2,0,0)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_MAP_TBL_ENTRIES (??), 0-4095
 */
#define VTSS_REW_MAP_LBL_B(gi)               VTSS_IOREG_IX(VTSS_TO_REW,0xe000,gi,2,0,1)
 ...
 *
 * @param gi Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_PORT_VLAN_CFG(gi)           VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,0,0)
 ...
 */
#define VTSS_REW_PCP_MAP_DE0(gi,ri)          VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,ri,1)
 ...
 */
#define VTSS_REW_PCP_MAP_DE1(gi,ri)          VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,ri,9)
 ...
 */
#define VTSS_REW_DEI_MAP_DE0(gi,ri)          VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,ri,17)
 ...
 */
#define VTSS_REW_DEI_MAP_DE1(gi,ri)          VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,ri,25)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_TAG_CTRL(gi)                VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,0,33)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_DSCP_MAP(gi)                VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,0,34)
 ...
 */
#define VTSS_REW_PTP_MODE_CFG(gi,ri)         VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,ri,35)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_PTP_MISC_CFG(gi)            VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,0,37)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_PTP_EDLY_CFG(gi)            VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,0,38)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_PTP_EDLY_CFG1(gi)           VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,0,39)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_PTP_IDLY1_CFG(gi)           VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,0,40)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_PTP_IDLY1_CFG1(gi)          VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,0,41)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_PTP_IDLY2_CFG(gi)           VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,0,42)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_PTP_IDLY2_CFG1(gi)          VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,0,43)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_PTP_SMAC_LOW(gi)            VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,0,44)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_PHYS_PORTS (??), 0-69
 */
#define VTSS_REW_PTP_SMAC_HIGH(gi)           VTSS_IOREG_IX(VTSS_TO_REW,0x16000,gi,64,0,45)
 ...
 *
 * @param gi Replicator: x_FFL_REW_NUM_MIP_TBL_ENTRIES (??), 0-1023
 */
#define VTSS_REW_MIP_CFG(gi)                 VTSS_IOREG_IX(VTSS_TO_REW,0x10000,gi,8,0,0)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_MIP_TBL_ENTRIES (??), 0-1023
 */
#define VTSS_REW_CCM_HMO_CTRL(gi)            VTSS_IOREG_IX(VTSS_TO_REW,0x10000,gi,8,0,1)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_MIP_TBL_ENTRIES (??), 0-1023
 */
#define VTSS_REW_MIP_VID_CTRL(gi)            VTSS_IOREG_IX(VTSS_TO_REW,0x10000,gi,8,0,2)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_MIP_TBL_ENTRIES (??), 0-1023
 */
#define VTSS_REW_LBM_MAC_HIGH(gi)            VTSS_IOREG_IX(VTSS_TO_REW,0x10000,gi,8,0,3)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_MIP_TBL_ENTRIES (??), 0-1023
 */
#define VTSS_REW_LBM_MAC_LOW(gi)             VTSS_IOREG_IX(VTSS_TO_REW,0x10000,gi,8,0,4)
 ...
 */
#define VTSS_REW_MAC_TBL_CFG(gi)             VTSS_IOREG_IX(VTSS_TO_REW,0x17200,gi,4,0,0)
 ...
 * @param gi Replicator: x_FFL_REW_MAC_TBL_ENTRY_CNT (??), 0-127
 */
#define VTSS_REW_EACL_MAC_HIGH(gi)           VTSS_IOREG_IX(VTSS_TO_REW,0x17200,gi,4,0,1)
 ...
 * @param gi Replicator: x_FFL_REW_MAC_TBL_ENTRY_CNT (??), 0-127
 */
#define VTSS_REW_EACL_MAC_LOW(gi)            VTSS_IOREG_IX(VTSS_TO_REW,0x17200,gi,4,0,2)
 ...
 */
#define VTSS_REW_COS_CTRL(gi,ri)             VTSS_IOREG_IX(VTSS_TO_REW,0x8000,gi,4,ri,0)
 ...
 */
#define VTSS_REW_PTP_TWOSTEP_CTRL            VTSS_IOREG(VTSS_TO_REW,0x17180)
 ...
 *
 * \details 
 * Field: ::VTSS_REW_PTP_TWOSTEP_CTRL . PTP_OVWR_ENA
 */
#define  VTSS_F_REW_PTP_TWOSTEP_CTRL_PTP_OVWR_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),12,1)
#define  VTSS_M_REW_PTP_TWOSTEP_CTRL_PTP_OVWR_ENA  VTSS_BIT(12)
#define  VTSS_X_REW_PTP_TWOSTEP_CTRL_PTP_OVWR_ENA(x)  VTSS_EXTRACT_BITFIELD(x,12,1)
 ...
 *
 * \details 
 * Field: ::VTSS_REW_PTP_TWOSTEP_CTRL . PTP_NXT
 */
#define  VTSS_F_REW_PTP_TWOSTEP_CTRL_PTP_NXT(x)  VTSS_ENCODE_BITFIELD(!!(x),11,1)
#define  VTSS_M_REW_PTP_TWOSTEP_CTRL_PTP_NXT  VTSS_BIT(11)
#define  VTSS_X_REW_PTP_TWOSTEP_CTRL_PTP_NXT(x)  VTSS_EXTRACT_BITFIELD(x,11,1)
 ...
 *
 * \details 
 * Field: ::VTSS_REW_PTP_TWOSTEP_CTRL . PTP_VLD
 */
#define  VTSS_F_REW_PTP_TWOSTEP_CTRL_PTP_VLD(x)  VTSS_ENCODE_BITFIELD(!!(x),10,1)
#define  VTSS_M_REW_PTP_TWOSTEP_CTRL_PTP_VLD  VTSS_BIT(10)
#define  VTSS_X_REW_PTP_TWOSTEP_CTRL_PTP_VLD(x)  VTSS_EXTRACT_BITFIELD(x,10,1)
 ...
 *
 * \details 
 * Field: ::VTSS_REW_PTP_TWOSTEP_CTRL . STAMP_TX
 */
#define  VTSS_F_REW_PTP_TWOSTEP_CTRL_STAMP_TX(x)  VTSS_ENCODE_BITFIELD(!!(x),9,1)
#define  VTSS_M_REW_PTP_TWOSTEP_CTRL_STAMP_TX  VTSS_BIT(9)
#define  VTSS_X_REW_PTP_TWOSTEP_CTRL_STAMP_TX(x)  VTSS_EXTRACT_BITFIELD(x,9,1)
 ...
 *
 * \details 
 * Field: ::VTSS_REW_PTP_TWOSTEP_CTRL . STAMP_PORT
 */
#define  VTSS_F_REW_PTP_TWOSTEP_CTRL_STAMP_PORT(x)  VTSS_ENCODE_BITFIELD(x,1,8)
#define  VTSS_M_REW_PTP_TWOSTEP_CTRL_STAMP_PORT     VTSS_ENCODE_BITMASK(1,8)
#define  VTSS_X_REW_PTP_TWOSTEP_CTRL_STAMP_PORT(x)  VTSS_EXTRACT_BITFIELD(x,1,8)
 ...
 *
 * \details 
 * Field: ::VTSS_REW_PTP_TWOSTEP_CTRL . PTP_OVFL
 */
#define  VTSS_F_REW_PTP_TWOSTEP_CTRL_PTP_OVFL(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_REW_PTP_TWOSTEP_CTRL_PTP_OVFL  VTSS_BIT(0)
#define  VTSS_X_REW_PTP_TWOSTEP_CTRL_PTP_OVFL(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 */
#define VTSS_REW_PTP_TWOSTEP_STAMP           VTSS_IOREG(VTSS_TO_REW,0x17181)
 ...
 *
 * \details 
 * Field: ::VTSS_REW_PTP_TWOSTEP_STAMP . STAMP_NSEC
 */
#define  VTSS_F_REW_PTP_TWOSTEP_STAMP_STAMP_NSEC(x)  VTSS_ENCODE_BITFIELD(x,0,30)
#define  VTSS_M_REW_PTP_TWOSTEP_STAMP_STAMP_NSEC     VTSS_ENCODE_BITMASK(0,30)
#define  VTSS_X_REW_PTP_TWOSTEP_STAMP_STAMP_NSEC(x)  VTSS_EXTRACT_BITFIELD(x,0,30)
 ...
 *
 * \details
 * Register: \a REW:PTP_CTRL:PTP_TWOSTEP_STAMP_SUBNS
 */
#define VTSS_REW_PTP_TWOSTEP_STAMP_SUBNS     VTSS_IOREG(VTSS_TO_REW,0x17182)

/** 
 * \brief
 * Contains the 8 bit sub-nano time stamp.
 *
 * \details 
 * Field: ::VTSS_REW_PTP_TWOSTEP_STAMP_SUBNS . STAMP_SUB_NSEC
 */
#define  VTSS_F_REW_PTP_TWOSTEP_STAMP_SUBNS_STAMP_SUB_NSEC(x)  VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_REW_PTP_TWOSTEP_STAMP_SUBNS_STAMP_SUB_NSEC     VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_REW_PTP_TWOSTEP_STAMP_SUBNS_STAMP_SUB_NSEC(x)  VTSS_EXTRACT_BITFIELD(x,0,8)
 ...
 */
#define VTSS_REW_PTP_RSRV_NOT_ZERO           VTSS_IOREG(VTSS_TO_REW,0x17183)
 ...
 */
#define VTSS_REW_PTP_RSRV_NOT_ZERO1          VTSS_IOREG(VTSS_TO_REW,0x17184)
 ...
 */
#define  VTSS_F_REW_PTP_RSRV_NOT_ZERO1_PTP_RSRV_NOT_ZERO1(x)  (x)
#define  VTSS_M_REW_PTP_RSRV_NOT_ZERO1_PTP_RSRV_NOT_ZERO1     0xffffffff
#define  VTSS_X_REW_PTP_RSRV_NOT_ZERO1_PTP_RSRV_NOT_ZERO1(x)  (x)
 ...
 *
 * \details
 * Register: \a REW:PTP_CTRL:PTP_RSRV_NOT_ZERO2
 */
#define VTSS_REW_PTP_RSRV_NOT_ZERO2          VTSS_IOREG(VTSS_TO_REW,0x17185)
 ...
 *
 * \details 
 * Field: ::VTSS_REW_PTP_RSRV_NOT_ZERO2 . PTP_RSRV_NOT_ZERO2
 */
#define  VTSS_F_REW_PTP_RSRV_NOT_ZERO2_PTP_RSRV_NOT_ZERO2(x)  VTSS_ENCODE_BITFIELD(x,0,6)
#define  VTSS_M_REW_PTP_RSRV_NOT_ZERO2_PTP_RSRV_NOT_ZERO2     VTSS_ENCODE_BITMASK(0,6)
#define  VTSS_X_REW_PTP_RSRV_NOT_ZERO2_PTP_RSRV_NOT_ZERO2(x)  VTSS_EXTRACT_BITFIELD(x,0,6)
 ...
 */
#define VTSS_REW_PTP_GEN_STAMP_FMT(ri)       VTSS_IOREG(VTSS_TO_REW,0x17186 + (ri))
 ...
 *
 * @param gi Replicator: x_FFL_REW_NUM_ENCAP_ENTRIES (??), 0-1023
 */
 ...
 * @param gi Replicator: x_FFL_REW_NUM_ENCAP_ENTRIES (??), 0-1023
 */
#define VTSS_REW_IPV4_ENCAP_CFG(gi)          VTSS_IOREG_IX(VTSS_TO_REW,0x12000,gi,8,0,0)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_ENCAP_ENTRIES (??), 0-1023
 */
#define VTSS_REW_IP_HDR_CFG(gi)              VTSS_IOREG_IX(VTSS_TO_REW,0x12000,gi,8,0,1)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_ENCAP_ENTRIES (??), 0-1023
 */
#define VTSS_REW_GRE_PROTOCOL_CFG(gi)        VTSS_IOREG_IX(VTSS_TO_REW,0x12000,gi,8,0,2)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_ENCAP_ENTRIES (??), 0-1023
 */
#define VTSS_REW_SIP_CFG(gi)                 VTSS_IOREG_IX(VTSS_TO_REW,0x12000,gi,8,0,3)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_ENCAP_ENTRIES (??), 0-1023
 */
#define VTSS_REW_DIP_CFG(gi)                 VTSS_IOREG_IX(VTSS_TO_REW,0x12000,gi,8,0,4)
 ...
 * @param gi Replicator: x_FFL_REW_NUM_ENCAP_ENTRIES (??), 0-1023
 */
#define VTSS_REW_IRLEG_CFG(gi)               VTSS_IOREG_IX(VTSS_TO_REW,0x12000,gi,8,0,5)
 ...
 */
#define VTSS_REW_RLEG_CTRL(gi)               VTSS_IOREG_IX(VTSS_TO_REW,0x17c00,gi,1,0,0)
 ...
 */
#define  VTSS_F_REW_RLEG_CTRL_DECAP_IRLEG(x)  VTSS_ENCODE_BITFIELD(x,13,9)
#define  VTSS_M_REW_RLEG_CTRL_DECAP_IRLEG     VTSS_ENCODE_BITMASK(13,9)
#define  VTSS_X_REW_RLEG_CTRL_DECAP_IRLEG(x)  VTSS_EXTRACT_BITFIELD(x,13,9)
 ...
 */
#define VTSS_REW_PTP_SEQ_NO(ri)              VTSS_IOREG(VTSS_TO_REW,0x17400 + (ri))
 ...
 */
#define VTSS_REW_SRV_LM_CNT_LSB(gi)          VTSS_IOREG_IX(VTSS_TO_REW,0x14000,gi,1,0,0)
 ...
 */
#define VTSS_REW_PORT_LM_CNT_LSB(gi)         VTSS_IOREG_IX(VTSS_TO_REW,0x18000,gi,4,0,0)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_ETH_PORTS_X_NUM_PRIO (??), 0-519
 */
#define VTSS_REW_PORT_FRM_CNT_LSB(gi)        VTSS_IOREG_IX(VTSS_TO_REW,0x18000,gi,4,0,1)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_ETH_PORTS_X_NUM_PRIO (??), 0-519
 */
#define VTSS_REW_PORT_BYTE_CNT_MSB(gi)       VTSS_IOREG_IX(VTSS_TO_REW,0x18000,gi,4,0,2)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_ETH_PORTS_X_NUM_PRIO (??), 0-519
 */
#define VTSS_REW_PORT_BYTE_CNT_LSB(gi)       VTSS_IOREG_IX(VTSS_TO_REW,0x18000,gi,4,0,3)
 ...
 *
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_CONTEXT_PORTS (??), 0-69
 */
#define VTSS_REW_TEMP_CNT_REG(gi)            VTSS_IOREG_IX(VTSS_TO_REW,0x17800,gi,8,0,0)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_CONTEXT_PORTS (??), 0-69
 */
#define VTSS_REW_LM_CNT_FRAME(gi)            VTSS_IOREG_IX(VTSS_TO_REW,0x17800,gi,8,0,1)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_CONTEXT_PORTS (??), 0-69
 */
#define VTSS_REW_CCM_LM_INFO_REG(gi)         VTSS_IOREG_IX(VTSS_TO_REW,0x17800,gi,8,0,2)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_CONTEXT_PORTS (??), 0-69
 */
#define VTSS_REW_CCM_LM_TX_B_REG(gi)         VTSS_IOREG_IX(VTSS_TO_REW,0x17800,gi,8,0,3)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_CONTEXT_PORTS (??), 0-69
 */
#define VTSS_REW_CCM_LM_RX_B_REG(gi)         VTSS_IOREG_IX(VTSS_TO_REW,0x17800,gi,8,0,4)
 ...
 */
#define VTSS_REW_DM_PTP_DOMAIN_CFG(ri)       VTSS_IOREG(VTSS_TO_REW,0x1718a + (ri))
 ...
 */
#define VTSS_REW_PTP_NTP_OFFSET_CFG(ri)      VTSS_IOREG(VTSS_TO_REW,0x171cb + (ri))
 ...
 */
#define VTSS_REW_RD_LAST_PORT_LM_CNT_LSB     VTSS_IOREG(VTSS_TO_REW,0x171ce)
 ...
 */
#define VTSS_REW_RD_LAST_PORT_FRM_CNT_LSB    VTSS_IOREG(VTSS_TO_REW,0x171cf)
 ...
 */
#define VTSS_REW_RD_LAST_PORT_BYTE_CNT_MSB   VTSS_IOREG(VTSS_TO_REW,0x171d0)
 ...
 */
#define VTSS_REW_RD_LAST_PORT_BYTE_CNT_LSB   VTSS_IOREG(VTSS_TO_REW,0x171d1)
 ...
 */
#define VTSS_REW_RAM_INIT                    VTSS_IOREG(VTSS_TO_REW,0x171d2)
 ...
 */
#define VTSS_REW_CM_ADDR                     VTSS_IOREG(VTSS_TO_REW,0x171d3)
 ...
 */
#define VTSS_REW_CM_DATA_WR                  VTSS_IOREG(VTSS_TO_REW,0x171d4)
 ...
 */
#define VTSS_REW_CM_DATA_RD                  VTSS_IOREG(VTSS_TO_REW,0x171d5)
 ...
 */
#define VTSS_REW_CM_OP                       VTSS_IOREG(VTSS_TO_REW,0x171d6)
