...
void fla_init_regs(vtss_state_t *vtss_state, BOOL FA)
{
	...
	fla_unstable_flds[FLD_W_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_SELECT] = FA ? FA_FLD_W_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_SELECT : LA_FLD_W_DEVCPU_PTP_PTP_PIN_CFG_PTP_PIN_SELECT;
	fla_unstable_flds[FLD_W_VOP_VOE_MISC_CONFIG_VOE_ENA] = FA ? FA_FLD_W_VOP_VOE_MISC_CONFIG_VOE_ENA : LA_FLD_W_VOP_VOE_MISC_CONFIG_VOE_ENA;
	...
	fla_grp_regs_cnt[GRP_PTP_PTP_PIN_CNT] = FA ? FA_GRP_PTP_PTP_PIN_CNT : LA_GRP_PTP_PTP_PIN_CNT;
