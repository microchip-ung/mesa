...
#ifndef _VTSS_FA_REGS_QSYS_H_
#define _VTSS_FA_REGS_QSYS_H_
 ...
 */
#define  VTSS_F_QSYS_PAUSE_CFG_PAUSE_START(x)  VTSS_ENCODE_BITFIELD(x,14,12)
#define  VTSS_M_QSYS_PAUSE_CFG_PAUSE_START     VTSS_ENCODE_BITMASK(14,12)
#define  VTSS_X_QSYS_PAUSE_CFG_PAUSE_START(x)  VTSS_EXTRACT_BITFIELD(x,14,12)
 ...
 */
#define  VTSS_F_QSYS_PAUSE_CFG_PAUSE_STOP(x)  VTSS_ENCODE_BITFIELD(x,2,12)
#define  VTSS_M_QSYS_PAUSE_CFG_PAUSE_STOP     VTSS_ENCODE_BITMASK(2,12)
#define  VTSS_X_QSYS_PAUSE_CFG_PAUSE_STOP(x)  VTSS_EXTRACT_BITFIELD(x,2,12)
 ...
 */
#define  VTSS_F_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_START(x)  VTSS_ENCODE_BITFIELD(x,12,12)
#define  VTSS_M_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_START     VTSS_ENCODE_BITMASK(12,12)
#define  VTSS_X_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_START(x)  VTSS_EXTRACT_BITFIELD(x,12,12)
 ...
 */
#define  VTSS_F_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_STOP(x)  VTSS_ENCODE_BITFIELD(x,0,12)
#define  VTSS_M_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_STOP     VTSS_ENCODE_BITMASK(0,12)
#define  VTSS_X_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_STOP(x)  VTSS_EXTRACT_BITFIELD(x,0,12)
 ...
 */
#define  VTSS_F_QSYS_ATOP_ATOP(x)             VTSS_ENCODE_BITFIELD(x,0,12)
#define  VTSS_M_QSYS_ATOP_ATOP                VTSS_ENCODE_BITMASK(0,12)
#define  VTSS_X_QSYS_ATOP_ATOP(x)             VTSS_EXTRACT_BITFIELD(x,0,12)
 ...
 */
#define  VTSS_F_QSYS_ATOP_TOT_CFG_ATOP_TOT(x)  VTSS_ENCODE_BITFIELD(x,0,12)
#define  VTSS_M_QSYS_ATOP_TOT_CFG_ATOP_TOT     VTSS_ENCODE_BITMASK(0,12)
#define  VTSS_X_QSYS_ATOP_TOT_CFG_ATOP_TOT(x)  VTSS_EXTRACT_BITFIELD(x,0,12)
 ...
 */
#define VTSS_QSYS_MMGT_PORT_VIEW             VTSS_IOREG(VTSS_TO_QSYS,0x1a2)
 ...
 */
#define  VTSS_F_QSYS_MMGT_PORT_VIEW_MMGT_PORT_VIEW(x)  VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_QSYS_MMGT_PORT_VIEW_MMGT_PORT_VIEW     VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_QSYS_MMGT_PORT_VIEW_MMGT_PORT_VIEW(x)  VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 */
#define VTSS_QSYS_MMGT_PORT_USE              VTSS_IOREG(VTSS_TO_QSYS,0x1a3)
 ...
 */
#define  VTSS_F_QSYS_MMGT_PORT_USE_MMGT_PORT_USE(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_QSYS_MMGT_PORT_USE_MMGT_PORT_USE     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_QSYS_MMGT_PORT_USE_MMGT_PORT_USE(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
 ...
 */
#define VTSS_QSYS_MMGT_PRIO_USE(ri)          VTSS_IOREG(VTSS_TO_QSYS,0x1a4 + (ri))
 ...
 */
#define  VTSS_F_QSYS_MMGT_PRIO_USE_MMGT_PRIO_USE(x)  VTSS_ENCODE_BITFIELD(x,0,15)
#define  VTSS_M_QSYS_MMGT_PRIO_USE_MMGT_PRIO_USE     VTSS_ENCODE_BITMASK(0,15)
#define  VTSS_X_QSYS_MMGT_PRIO_USE_MMGT_PRIO_USE(x)  VTSS_EXTRACT_BITFIELD(x,0,15)
 ...
 */
#define VTSS_QSYS_MMGT_IQ_STAT               VTSS_IOREG(VTSS_TO_QSYS,0x1ac)
 ...
 */
#define VTSS_QSYS_MMGT_TAILDROP_CNT          VTSS_IOREG(VTSS_TO_QSYS,0x1ad)
 ...
 */
#define VTSS_QSYS_SOFDATA_STAT_SHR           VTSS_IOREG(VTSS_TO_QSYS,0x1ae)
 ...
 */
#define  VTSS_F_QSYS_SOFDATA_STAT_SHR_SOFDATA_SHR_USE(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_QSYS_SOFDATA_STAT_SHR_SOFDATA_SHR_USE     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_QSYS_SOFDATA_STAT_SHR_SOFDATA_SHR_USE(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 * @param ri Replicator: x_GAZ_CORE_PORT_CNT (??), 0-69
 */
#define VTSS_QSYS_SOFDATA_STAT(ri)           VTSS_IOREG(VTSS_TO_QSYS,0x1af + (ri))
 ...
 */
#define  VTSS_F_QSYS_SOFDATA_STAT_SOFDATA_PORT_USE(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_QSYS_SOFDATA_STAT_SOFDATA_PORT_USE     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_QSYS_SOFDATA_STAT_SOFDATA_PORT_USE(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 * @param ri Replicator: x_GAZ_CORE_PORT_CNT (??), 0-69
 */
#define VTSS_QSYS_SOFDATA_CFG(ri)            VTSS_IOREG(VTSS_TO_QSYS,0x1f5 + (ri))
 ...
 */
#define VTSS_QSYS_SOFDATA_WM_VAL(ri)         VTSS_IOREG(VTSS_TO_QSYS,0x23b + (ri))
 ...
 */
#define  VTSS_F_QSYS_SOFDATA_WM_VAL_SOFDATA_WM_VAL(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_QSYS_SOFDATA_WM_VAL_SOFDATA_WM_VAL     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_QSYS_SOFDATA_WM_VAL_SOFDATA_WM_VAL(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 *
 * @param ri Replicator: x_GAZ_CORE_CBC_AUTO_REGS (??), 0-6
 */
#define VTSS_QSYS_CAL_AUTO(ri)               VTSS_IOREG(VTSS_TO_QSYS,0x240 + (ri))
 ...
 */
#define VTSS_QSYS_CAL_SEQ                    VTSS_IOREG(VTSS_TO_QSYS,0x247)
 ...
 */
#define  VTSS_F_QSYS_CAL_SEQ_CAL_SEQ_CUR_VAL(x)  VTSS_ENCODE_BITFIELD(x,8,7)
#define  VTSS_M_QSYS_CAL_SEQ_CAL_SEQ_CUR_VAL     VTSS_ENCODE_BITMASK(8,7)
#define  VTSS_X_QSYS_CAL_SEQ_CAL_SEQ_CUR_VAL(x)  VTSS_EXTRACT_BITFIELD(x,8,7)
 ...
 */
#define  VTSS_F_QSYS_CAL_SEQ_CAL_SEQ_PGM_VAL(x)  VTSS_ENCODE_BITFIELD(x,1,7)
#define  VTSS_M_QSYS_CAL_SEQ_CAL_SEQ_PGM_VAL     VTSS_ENCODE_BITMASK(1,7)
#define  VTSS_X_QSYS_CAL_SEQ_CAL_SEQ_PGM_VAL(x)  VTSS_EXTRACT_BITFIELD(x,1,7)
 ...
 */
#define VTSS_QSYS_CAL_SEQ_SEL_CFG            VTSS_IOREG(VTSS_TO_QSYS,0x248)
 ...
 */
#define VTSS_QSYS_CAL_CTRL                   VTSS_IOREG(VTSS_TO_QSYS,0x249)
 ...
 */
#define VTSS_QSYS_RAM_INIT                   VTSS_IOREG(VTSS_TO_QSYS,0x24a)
 ...
 */
#define VTSS_QSYS_CM_ADDR                    VTSS_IOREG(VTSS_TO_QSYS,0x24b)
 ...
 */
#define VTSS_QSYS_CM_DATA_WR                 VTSS_IOREG(VTSS_TO_QSYS,0x24c)
 ...
 */
#define VTSS_QSYS_CM_DATA_RD                 VTSS_IOREG(VTSS_TO_QSYS,0x24d)
 ...
 */
#define VTSS_QSYS_CM_OP                      VTSS_IOREG(VTSS_TO_QSYS,0x24e)
