 ...
 */
#define VTSS_ANA_CL_CSC_CFG(gi)              VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,0)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_INB_PORTS (??), 0-34
 */
#define VTSS_ANA_CL_FILTER_CTRL(gi)          VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,1)
 ...
 */
#define VTSS_ANA_CL_VLAN_FILTER_CTRL(gi,ri)  VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,ri,2)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_INB_PORTS (??), 0-34
 */
#define VTSS_ANA_CL_ETAG_FILTER_CTRL(gi)     VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,5)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_INB_PORTS (??), 0-34
 */
#define VTSS_ANA_CL_STACKING_CTRL(gi)        VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,6)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_INB_PORTS (??), 0-34
 */
#define VTSS_ANA_CL_VLAN_TPID_CTRL(gi)       VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,7)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_INB_PORTS (??), 0-34
 */
#define VTSS_ANA_CL_VLAN_CTRL(gi)            VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,8)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_INB_PORTS (??), 0-34
 */
#define VTSS_ANA_CL_VLAN_CTRL_2(gi)          VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,9)
 ...
 */
#define VTSS_ANA_CL_PCP_DEI_TRANS_CFG(gi,ri)  VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,ri,10)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_INB_PORTS (??), 0-34
 */
#define VTSS_ANA_CL_PORT_ID_CFG(gi)          VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,26)
 ...
 */
#define  VTSS_F_ANA_CL_PORT_ID_CFG_LPORT_NUM(x)  VTSS_ENCODE_BITFIELD(x,0,6)
#define  VTSS_M_ANA_CL_PORT_ID_CFG_LPORT_NUM     VTSS_ENCODE_BITMASK(0,6)
#define  VTSS_X_ANA_CL_PORT_ID_CFG_LPORT_NUM(x)  VTSS_EXTRACT_BITFIELD(x,0,6)
 ...
 */
#define VTSS_ANA_CL_PCP_DEI_MAP_CFG(gi,ri)   VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,ri,27)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_INB_PORTS (??), 0-34
 */
#define VTSS_ANA_CL_QOS_CFG(gi)              VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,43)

/**
 * \brief
 * If set, DEI is only interpreted from S-tagged frames for QoS
 * classification. For C-tagged frames, DEI is interpreted as 0 indepedent
 * of tag contents. This affects QoS classification when PCP_DEI_DP_ENA or
 * PCP_QOS_DP_ENA are set.
 *
 * \details
 * Field: ::VTSS_ANA_CL_QOS_CFG . DEI_STAG_ONLY_ENA
 */
#define  VTSS_F_ANA_CL_QOS_CFG_DEI_STAG_ONLY_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),18,1)
#define  VTSS_M_ANA_CL_QOS_CFG_DEI_STAG_ONLY_ENA  VTSS_BIT(18)
#define  VTSS_X_ANA_CL_QOS_CFG_DEI_STAG_ONLY_ENA(x)  VTSS_EXTRACT_BITFIELD(x,18,1)
 ...
 */
#define VTSS_ANA_CL_MAP_CFG(gi,ri)           VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,ri,44)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_INB_PORTS (??), 0-34
 */
#define VTSS_ANA_CL_CAPTURE_CFG(gi)          VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,46)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_INB_PORTS (??), 0-34
 */
#define VTSS_ANA_CL_CAPTURE_Y1731_AG_CFG(gi)  VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,47)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_INB_PORTS (??), 0-34
 */
#define VTSS_ANA_CL_CAPTURE_GXRP_CFG(gi)     VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,48)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_INB_PORTS (??), 0-34
 */
#define VTSS_ANA_CL_CAPTURE_BPDU_CFG(gi)     VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,0,49)
 ...
 */
#define VTSS_ANA_CL_ADV_CL_CFG_2(gi,ri)      VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,ri,50)
 ...
 * @param ri Replicator: x_FFL_ANA_CLM_CNT (??), 0-5
 */
#define VTSS_ANA_CL_ADV_CL_CFG(gi,ri)        VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,ri,56)
 ...
 */
#define VTSS_ANA_CL_ADV_PORT_RNG_CTRL(gi,ri)  VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,ri,62)
 ...
 * @param ri Replicator: x_FFL_ANA_CLM_NUM_TCP_RANGES (??), 0-7
 */
#define VTSS_ANA_CL_ADV_PORT_RNG_VALUE_CFG(gi,ri)  VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x4000,gi,128,ri,70)
 ...
 */
#define  VTSS_F_ANA_CL_ISDX_CFG_IGR_LPORT_NUM(x)  VTSS_ENCODE_BITFIELD(x,1,6)
#define  VTSS_M_ANA_CL_ISDX_CFG_IGR_LPORT_NUM     VTSS_ENCODE_BITMASK(1,6)
#define  VTSS_X_ANA_CL_ISDX_CFG_IGR_LPORT_NUM(x)  VTSS_EXTRACT_BITFIELD(x,1,6)
 ...
 */
#define  VTSS_F_ANA_CL_IPT_PPT_IDX(x)         VTSS_ENCODE_BITFIELD(x,0,4)
#define  VTSS_M_ANA_CL_IPT_PPT_IDX            VTSS_ENCODE_BITMASK(0,4)
#define  VTSS_X_ANA_CL_IPT_PPT_IDX(x)         VTSS_EXTRACT_BITFIELD(x,0,4)
 ...
 */
#define VTSS_ANA_CL_CSC_DISC_CFG(gi)         VTSS_IOREG_IX(VTSS_TO_ANA_CL,0x0,gi,4,0,0)
 ...
 */
#define  VTSS_F_ANA_CL_CSC_DISC_CFG_CSC_PORT_MASK(x)  VTSS_ENCODE_BITFIELD(x,0,30)
#define  VTSS_M_ANA_CL_CSC_DISC_CFG_CSC_PORT_MASK     VTSS_ENCODE_BITMASK(0,30)
#define  VTSS_X_ANA_CL_CSC_DISC_CFG_CSC_PORT_MASK(x)  VTSS_EXTRACT_BITFIELD(x,0,30)
...
#endif /* _VTSS_LAGUNA_REGS_ANA_CL_H_ */
