...
#ifndef _VTSS_FA_REGS_QFWD_H_
#define _VTSS_FA_REGS_QFWD_H_
 ...
 */
#define  VTSS_F_QFWD_FRAME_COPY_CFG_FRMC_PORT_VAL(x)  VTSS_ENCODE_BITFIELD(x,6,7)
#define  VTSS_M_QFWD_FRAME_COPY_CFG_FRMC_PORT_VAL     VTSS_ENCODE_BITMASK(6,7)
#define  VTSS_X_QFWD_FRAME_COPY_CFG_FRMC_PORT_VAL(x)  VTSS_EXTRACT_BITFIELD(x,6,7)
