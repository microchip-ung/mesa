...
#ifndef _VTSS_FA_REGS_AFI_H_
#define _VTSS_FA_REGS_AFI_H_
 ...
 */
#define VTSS_AFI_MISC_CTRL                   VTSS_IOREG(VTSS_TO_AFI,0xc18c)
 ...
 */
#define VTSS_AFI_NEW_FRM_CTRL                VTSS_IOREG(VTSS_TO_AFI,0xc18d)
 ...
 */
#define VTSS_AFI_NEW_FRM_INFO                VTSS_IOREG(VTSS_TO_AFI,0xc18e)
 ...
 */
#define  VTSS_F_AFI_NEW_FRM_INFO_FRM_INFO(x)  VTSS_ENCODE_BITFIELD(x,0,26)
#define  VTSS_M_AFI_NEW_FRM_INFO_FRM_INFO     VTSS_ENCODE_BITMASK(0,26)
#define  VTSS_X_AFI_NEW_FRM_INFO_FRM_INFO(x)  VTSS_EXTRACT_BITFIELD(x,0,26)
 ...
 */
#define VTSS_AFI_ERR                         VTSS_IOREG(VTSS_TO_AFI,0xc18f)
 ...
 */
#define VTSS_AFI_WARN                        VTSS_IOREG(VTSS_TO_AFI,0xc190)
 ...
 */
#define VTSS_AFI_STICKY_INFO                 VTSS_IOREG(VTSS_TO_AFI,0xc191)
 ...
 */
#define  VTSS_F_AFI_STICKY_INFO_PORT_NUM(x)   VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_AFI_STICKY_INFO_PORT_NUM      VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_AFI_STICKY_INFO_PORT_NUM(x)   VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 */
#define VTSS_AFI_STICKY_INFO_ENA             VTSS_IOREG(VTSS_TO_AFI,0xc192)
 ...
 */
#define VTSS_AFI_DTI_DURATION_TICK_LEN       VTSS_IOREG(VTSS_TO_AFI,0xc193)
 ...
 */
#define  VTSS_F_AFI_DTI_DURATION_TICK_LEN_DTI_DURATION_TICK_LEN(x)  VTSS_ENCODE_BITFIELD(x,0,20)
#define  VTSS_M_AFI_DTI_DURATION_TICK_LEN_DTI_DURATION_TICK_LEN     VTSS_ENCODE_BITMASK(0,20)
#define  VTSS_X_AFI_DTI_DURATION_TICK_LEN_DTI_DURATION_TICK_LEN(x)  VTSS_EXTRACT_BITFIELD(x,0,20)
 ...
 */
#define  VTSS_F_AFI_DTI_PORT_QU_PORT_NUM(x)   VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_AFI_DTI_PORT_QU_PORT_NUM      VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_AFI_DTI_PORT_QU_PORT_NUM(x)   VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 */
#define  VTSS_F_AFI_DTI_PORT_QU_QU_NUM(x)     VTSS_ENCODE_BITFIELD(x,8,16)
#define  VTSS_M_AFI_DTI_PORT_QU_QU_NUM        VTSS_ENCODE_BITMASK(8,16)
#define  VTSS_X_AFI_DTI_PORT_QU_QU_NUM(x)     VTSS_EXTRACT_BITFIELD(x,8,16)
 ...
 * @param gi Replicator: x_GAZ_AFI_DTI_TBL_DEPTH (??), 0-31
 */
#define VTSS_AFI_DTI_FC_CNT_DOWN(gi)         VTSS_IOREG_IX(VTSS_TO_AFI,0xc194,gi,3,0,0)
 ...
 * @param gi Replicator: x_GAZ_AFI_DTI_TBL_DEPTH (??), 0-31
 */
#define VTSS_AFI_DTI_CNT_DOWN(gi)            VTSS_IOREG_IX(VTSS_TO_AFI,0xc194,gi,3,0,1)
 ...
 * @param gi Replicator: x_GAZ_AFI_DTI_TBL_DEPTH (??), 0-31
 */
#define VTSS_AFI_DTI_CTRL(gi)                VTSS_IOREG_IX(VTSS_TO_AFI,0xc194,gi,3,0,2)
 ...
 */
#define  VTSS_F_AFI_TTI_PORT_QU_PORT_NUM(x)   VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_AFI_TTI_PORT_QU_PORT_NUM      VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_AFI_TTI_PORT_QU_PORT_NUM(x)   VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 */
#define  VTSS_F_AFI_TTI_PORT_QU_QU_NUM(x)     VTSS_ENCODE_BITFIELD(x,8,16)
#define  VTSS_M_AFI_TTI_PORT_QU_QU_NUM        VTSS_ENCODE_BITMASK(8,16)
#define  VTSS_X_AFI_TTI_PORT_QU_QU_NUM(x)     VTSS_EXTRACT_BITFIELD(x,8,16)
 ...
 */
#define VTSS_AFI_TTI_TICK_BASE               VTSS_IOREG(VTSS_TO_AFI,0xc1f4)

/** 
 * \brief
 * Length of TTI Base Tick.Unit: One system clock cycle.In default
 * configuration and a clock cycle of 1597 ps, the tick length corresponds
 ...
 */
#define VTSS_AFI_TTI_TICK_LEN_0_3            VTSS_IOREG(VTSS_TO_AFI,0xc1f5)
 ...
 */
#define VTSS_AFI_TTI_TICK_LEN_4_7            VTSS_IOREG(VTSS_TO_AFI,0xc1f6)
 ...
 */
#define VTSS_AFI_TTI_TICK_STATE(ri)          VTSS_IOREG(VTSS_TO_AFI,0xc1f7 + (ri))
 ...
 */
#define VTSS_AFI_TTI_CAL_SLOT_PTRS(ri)       VTSS_IOREG(VTSS_TO_AFI,0xc1ff + (ri))
 ...
 * @param ri Replicator: x_GAZ_AFI_TTI_CAL_DEPTH (??), 0-3
 */
#define VTSS_AFI_TTI_CAL_SLOT_CNT(ri)        VTSS_IOREG(VTSS_TO_AFI,0xc203 + (ri))
 ...
 * @param ri Replicator: x_GAZ_AFI_TTI_CAL_DEPTH (??), 0-3
 */
#define VTSS_AFI_TTI_CAL_STATE(ri)           VTSS_IOREG(VTSS_TO_AFI,0xc207 + (ri))
 ...
 */
#define VTSS_AFI_TTI_CTRL                    VTSS_IOREG(VTSS_TO_AFI,0xc20b)
 ...
 */
#define VTSS_AFI_TTI_CTRL2                   VTSS_IOREG(VTSS_TO_AFI,0xc20c)
 ...
 */
#define VTSS_AFI_TTI_INJ_CNT                 VTSS_IOREG(VTSS_TO_AFI,0xc20d)
 ...
 */
#define VTSS_AFI_TTI_RAND_STATE              VTSS_IOREG(VTSS_TO_AFI,0xc20e)
 ...
 */
#define VTSS_AFI_TTI_PORT_FRM_OUT            VTSS_IOREG(VTSS_TO_AFI,0xc20f)
 ...
 *
 * @param gi Replicator: x_GAZ_AFI_PORT_CNT (??), 0-69
 */
 ...
 */
#define VTSS_AFI_TUPE_MISC                   VTSS_IOREG(VTSS_TO_AFI,0xc210)
 ...
 */
#define VTSS_AFI_TUPE_ADDR                   VTSS_IOREG(VTSS_TO_AFI,0xc211)
 ...
 */
#define VTSS_AFI_TUPE_CRIT1                  VTSS_IOREG(VTSS_TO_AFI,0xc212)
 ...
 */
#define  VTSS_F_AFI_TUPE_CRIT1_CRIT_PORT_NUM_VAL(x)  VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_AFI_TUPE_CRIT1_CRIT_PORT_NUM_VAL     VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_AFI_TUPE_CRIT1_CRIT_PORT_NUM_VAL(x)  VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 */
#define  VTSS_F_AFI_TUPE_CRIT1_CRIT_QU_NUM_VAL(x)  VTSS_ENCODE_BITFIELD(x,8,16)
#define  VTSS_M_AFI_TUPE_CRIT1_CRIT_QU_NUM_VAL     VTSS_ENCODE_BITMASK(8,16)
#define  VTSS_X_AFI_TUPE_CRIT1_CRIT_QU_NUM_VAL(x)  VTSS_EXTRACT_BITFIELD(x,8,16)
 ...
 */
#define VTSS_AFI_TUPE_CRIT2                  VTSS_IOREG(VTSS_TO_AFI,0xc213)
 ...
 */
#define VTSS_AFI_TUPE_CRIT3(ri)              VTSS_IOREG(VTSS_TO_AFI,0xc214 + (ri))
 ...
 */
#define VTSS_AFI_TUPE_CMD1                   VTSS_IOREG(VTSS_TO_AFI,0xc216)
 ...
 */
#define  VTSS_F_AFI_TUPE_CMD1_CMD_PORT_NUM_VAL(x)  VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_AFI_TUPE_CMD1_CMD_PORT_NUM_VAL     VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_AFI_TUPE_CMD1_CMD_PORT_NUM_VAL(x)  VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 */
#define  VTSS_F_AFI_TUPE_CMD1_CMD_QU_NUM_VAL(x)  VTSS_ENCODE_BITFIELD(x,8,16)
#define  VTSS_M_AFI_TUPE_CMD1_CMD_QU_NUM_VAL     VTSS_ENCODE_BITMASK(8,16)
#define  VTSS_X_AFI_TUPE_CMD1_CMD_QU_NUM_VAL(x)  VTSS_EXTRACT_BITFIELD(x,8,16)


#endif /* _VTSS_FA_REGS_AFI_H_ */
