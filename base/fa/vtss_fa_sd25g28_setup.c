...
#ifndef VTSS_ANT__API_SD25G28_UTE
#define VTSS_ANT__API_SD25G28_UTE
...
static vtss_rc vtss_ant_sd25g28_reg_cfg(vtss_state_t                      *vtss_state,
                                        vtss_sd25g28_setup_struct_t *const res_struct,
                                        vtss_port_no_t                     port_no)
{
    ...
    for (p = VTSS_PORT_NO_START; p < vtss_state->port_count; p++) {
        ...
        REG_WRM(VTSS_SD25G_TARGET_CMU_1A(sd25g_tgt),
                VTSS_F_SD25G_TARGET_CMU_1A_R_DWIDTHCTRL_FROM_HWT(res_struct
                                                                     ->r_DwidthCtrl_from_hwt[0]) |
        ...
        REG_WRM(VTSS_SD25G_TARGET_CMU_31(sd25g_tgt),
                VTSS_F_SD25G_TARGET_CMU_31_CFG_COMMON_RESERVE_7_0(res_struct
                                                                      ->cfg_common_reserve_7_0[0]),
        ...
        REG_WRM(VTSS_SD25G_TARGET_CMU_46(sd25g_tgt),
                VTSS_F_SD25G_TARGET_CMU_46_L0_CFG_TX_RESERVE_15_8(res_struct
                                                                      ->l0_cfg_tx_reserve_15_8[0]),
                VTSS_M_SD25G_TARGET_CMU_46_L0_CFG_TX_RESERVE_15_8);

        REG_WRM(VTSS_SD25G_TARGET_CMU_45(sd25g_tgt),
                VTSS_F_SD25G_TARGET_CMU_45_L0_CFG_TX_RESERVE_7_0(res_struct
                                                                     ->l0_cfg_tx_reserve_7_0[0]),
        ...
        REG_WRM(VTSS_SD25G_TARGET_CMU_19(sd25g_tgt), VTSS_F_SD25G_TARGET_CMU_19_R_CK_RESETB(0),
                VTSS_M_SD25G_TARGET_CMU_19_R_CK_RESETB);

        REG_WRM(VTSS_SD25G_TARGET_CMU_19(sd25g_tgt), VTSS_F_SD25G_TARGET_CMU_19_R_CK_RESETB(1),
                VTSS_M_SD25G_TARGET_CMU_19_R_CK_RESETB);

        REG_WRM(VTSS_SD25G_TARGET_CMU_18(sd25g_tgt), VTSS_F_SD25G_TARGET_CMU_18_R_PLL_RSTN(0),
                VTSS_M_SD25G_TARGET_CMU_18_R_PLL_RSTN);

        REG_WRM(VTSS_SD25G_TARGET_CMU_18(sd25g_tgt), VTSS_F_SD25G_TARGET_CMU_18_R_PLL_RSTN(1),
                VTSS_M_SD25G_TARGET_CMU_18_R_PLL_RSTN);

        if (res_struct->reg_ctrl[0] == 0) {
            REG_WRM(
                VTSS_SD25G_CFG_TARGET_SD_LANE_CFG2(sd_lane_tgt),
                VTSS_F_SD25G_CFG_TARGET_SD_LANE_CFG2_HWT_VCO_DIV_SEL(res_struct
                                                                         ->cfg_vco_div_mode_1_0[0]) |
                    VTSS_F_SD25G_CFG_TARGET_SD_LANE_CFG2_HWT_PRE_DIVSEL(res_struct
                                                                            ->cfg_pre_divsel_1_0[0]) |
                    VTSS_F_SD25G_CFG_TARGET_SD_LANE_CFG2_HWT_CFG_SEL_DIV(res_struct
                                                                             ->cfg_sel_div_3_0[0]) |
                    VTSS_F_SD25G_CFG_TARGET_SD_LANE_CFG2_DATA_WIDTH_SEL(res_struct
                                                                            ->r_DwidthCtrl_2_0[0]) |
                    ...
                    VTSS_F_SD25G_CFG_TARGET_SD_LANE_CFG2_TXRATE_SEL(res_struct
                                                                        ->ln_cfg_tx_subrate_2_0[0]) |
                    VTSS_F_SD25G_CFG_TARGET_SD_LANE_CFG2_RXRATE_SEL(res_struct
                                                                        ->ln_cfg_rx_subrate_2_0[0]) |
            ...
            REG_WRM(VTSS_SD25G_TARGET_CMU_0F(sd25g_tgt),
                    VTSS_F_SD25G_TARGET_CMU_0F_CFG_ICP_BASE_SEL_3_0(res_struct
                                                                        ->cfg_icp_base_sel_3_0[0]),
            ...
            REG_WRM(VTSS_SD25G_TARGET_LANE_2C(sd25g_tgt),
                    VTSS_F_SD25G_TARGET_LANE_2C_LN_CFG_DIS_2NDORDER(res_struct
                                                                        ->ln_cfg_dis_2ndorder[0]),
            ...
            REG_WRM(VTSS_SD25G_TARGET_LANE_01(sd25g_tgt),
                    VTSS_F_SD25G_TARGET_LANE_01_LN_CFG_TX_PREDIV_1_0(res_struct
                                                                         ->ln_cfg_tx_prediv_1_0[0]),
                    VTSS_M_SD25G_TARGET_LANE_01_LN_CFG_TX_PREDIV_1_0);

            REG_WRM(VTSS_SD25G_TARGET_LANE_18(sd25g_tgt),
                    VTSS_F_SD25G_TARGET_LANE_18_LN_CFG_RXDIV_SEL_2_0(res_struct
                                                                         ->ln_cfg_rxdiv_sel_2_0[0]),
                    VTSS_M_SD25G_TARGET_LANE_18_LN_CFG_RXDIV_SEL_2_0);

            REG_WRM(VTSS_SD25G_TARGET_LANE_2C(sd25g_tgt),
                    VTSS_F_SD25G_TARGET_LANE_2C_LN_CFG_TX_SUBRATE_2_0(res_struct
                                                                          ->ln_cfg_tx_subrate_2_0[0]),
                    VTSS_M_SD25G_TARGET_LANE_2C_LN_CFG_TX_SUBRATE_2_0);

            REG_WRM(VTSS_SD25G_TARGET_LANE_28(sd25g_tgt),
                    VTSS_F_SD25G_TARGET_LANE_28_LN_CFG_RX_SUBRATE_2_0(res_struct
                                                                          ->ln_cfg_rx_subrate_2_0[0]),
        ...
        if (res_struct->reg_ctrl[0] == 0) {
            ...
            REG_WRM(
                VTSS_SD25G_CFG_TARGET_SD_LANE_CFG(sd_lane_tgt),
                VTSS_F_SD25G_CFG_TARGET_SD_LANE_CFG_PCS2PMA_TXMARGIN(
                    res_struct->ln_cfg_itx_ipdriver_base_2_0[0]) |
                    VTSS_F_SD25G_CFG_TARGET_SD_LANE_CFG_PCS_TAP_DLY(res_struct
                                                                        ->ln_cfg_tap_dly_4_0[0]) |
                    VTSS_F_SD25G_CFG_TARGET_SD_LANE_CFG_PCS_TAP_ADV(res_struct
                                                                        ->ln_cfg_tap_adv_3_0[0]) |
            ...
            REG_WRM(VTSS_SD25G_TARGET_LANE_0F(sd25g_tgt),
                    VTSS_F_SD25G_TARGET_LANE_0F_LN_CFG_DFETAP_EN_5_1(res_struct
                                                                         ->ln_cfg_dfetap_en_5_1[0]),
            ...
            REG_WRM(VTSS_SD25G_TARGET_LANE_03(sd25g_tgt),
                    VTSS_F_SD25G_TARGET_LANE_03_LN_CFG_TAP_DLY_4_0(res_struct
                                                                       ->ln_cfg_tap_dly_4_0[0]),
                    VTSS_M_SD25G_TARGET_LANE_03_LN_CFG_TAP_DLY_4_0);

            REG_WRM(VTSS_SD25G_TARGET_LANE_06(sd25g_tgt),
                    VTSS_F_SD25G_TARGET_LANE_06_LN_CFG_TAP_ADV_3_0(res_struct
                                                                       ->ln_cfg_tap_adv_3_0[0]),
        ...
        REG_WRM(VTSS_SD25G_TARGET_LANE_43(sd25g_tgt),
                VTSS_F_SD25G_TARGET_LANE_43_LN_CFG_TX_RESERVE_15_8(res_struct
                                                                       ->ln_cfg_tx_reserve_15_8[0]),
                VTSS_M_SD25G_TARGET_LANE_43_LN_CFG_TX_RESERVE_15_8);

        REG_WRM(VTSS_SD25G_TARGET_LANE_42(sd25g_tgt),
                VTSS_F_SD25G_TARGET_LANE_42_LN_CFG_TX_RESERVE_7_0(res_struct
                                                                      ->ln_cfg_tx_reserve_7_0[0]),
        ...
        REG_WRM(VTSS_SD25G_TARGET_LANE_44(sd25g_tgt),
                VTSS_F_SD25G_TARGET_LANE_44_LN_CFG_RX_RESERVE_7_0(res_struct
                                                                      ->ln_cfg_rx_reserve_7_0[0]),
                VTSS_M_SD25G_TARGET_LANE_44_LN_CFG_RX_RESERVE_7_0);

        REG_WRM(VTSS_SD25G_TARGET_LANE_45(sd25g_tgt),
                VTSS_F_SD25G_TARGET_LANE_45_LN_CFG_RX_RESERVE_15_8(res_struct
                                                                       ->ln_cfg_rx_reserve_15_8[0]),
        ...
        REG_WRM(VTSS_SD25G_TARGET_LANE_21(sd25g_tgt),
                VTSS_F_SD25G_TARGET_LANE_21_LN_CFG_VGA_CTRL_BYP_4_0(res_struct
                                                                        ->ln_cfg_vga_ctrl_byp_4_0[0]),
                VTSS_M_SD25G_TARGET_LANE_21_LN_CFG_VGA_CTRL_BYP_4_0);

        REG_WRM(VTSS_SD25G_TARGET_LANE_22(sd25g_tgt),
                VTSS_F_SD25G_TARGET_LANE_22_LN_CFG_EQR_FORCE_3_0(res_struct
                                                                     ->ln_cfg_eqr_force_3_0[0]),
                VTSS_M_SD25G_TARGET_LANE_22_LN_CFG_EQR_FORCE_3_0);

        REG_WRM(VTSS_SD25G_TARGET_LANE_1C(sd25g_tgt),
                VTSS_F_SD25G_TARGET_LANE_1C_LN_CFG_EQC_FORCE_3_0(res_struct
                                                                     ->ln_cfg_eqc_force_3_0[0]) |
        ...
        REG_WRM(VTSS_SD25G_TARGET_LANE_26(sd25g_tgt),
                VTSS_F_SD25G_TARGET_LANE_26_LN_CFG_INIT_POS_IPI_6_0(res_struct
                                                                        ->ln_cfg_init_pos_ipi_6_0[0]),
        ...
        REG_WRM(VTSS_SD25G_TARGET_LANE_04(sd25g_tgt),
                VTSS_F_SD25G_TARGET_LANE_04_LN_CFG_RX2TX_LP_EN(res_struct->ln_cfg_rx2tx_lp_en[0]) |
                    VTSS_F_SD25G_TARGET_LANE_04_LN_CFG_TX2RX_LP_EN(res_struct
                                                                       ->ln_cfg_tx2rx_lp_en[0]),
    ...
    for (p = VTSS_PORT_NO_START; p < vtss_state->port_count; p++) {
        ...
        REG_WRM(VTSS_SD25G_TARGET_LANE_2E(sd25g_tgt), VTSS_F_SD25G_TARGET_LANE_2E_LN_CFG_DIS_SQ(0),
                VTSS_M_SD25G_TARGET_LANE_2E_LN_CFG_DIS_SQ);

        REG_WRM(VTSS_SD25G_TARGET_LANE_2E(sd25g_tgt), VTSS_F_SD25G_TARGET_LANE_2E_LN_CFG_PD_SQ(0),
