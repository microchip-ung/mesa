 ...
 */
#define VTSS_REW_COMMON_IFH_CTRL(ri)                VTSS_IOREG(VTSS_TO_REW,0x6004 + (ri))
 ...
 */
#define  VTSS_F_REW_COMMON_IFH_CTRL_KEEP_IFH_SEL(x)  VTSS_ENCODE_BITFIELD(x,0,2)
#define  VTSS_M_REW_COMMON_IFH_CTRL_KEEP_IFH_SEL     VTSS_ENCODE_BITMASK(0,2)
#define  VTSS_X_REW_COMMON_IFH_CTRL_KEEP_IFH_SEL(x)  VTSS_EXTRACT_BITFIELD(x,0,2)
 ...
 */
#define VTSS_REW_MIP_TBL_MIP_CFG(gi)                 VTSS_IOREG_IX(VTSS_TO_REW,0x3900,gi,8,0,0)
 ...
 * @param gi Register: GPTP_DOM (??), 0-3
 */
#define VTSS_REW_GM_DELAY(gi)                VTSS_IOREG_IX(VTSS_TO_REW,0x38c0,gi,16,0,11)
