...
#ifndef _VTSS_LAGUNA_REGS_VCAP_SUPER_H_
#define _VTSS_LAGUNA_REGS_VCAP_SUPER_H_
 ...
 *
 * Field: ::VTSS_VCAP_SUPER_RAM_INIT . RAM_TEST_OPT
 */
#define  VTSS_F_VCAP_SUPER_RAM_INIT_RAM_TEST_OPT(x)  VTSS_ENCODE_BITFIELD(x,2,3)
#define  VTSS_M_VCAP_SUPER_RAM_INIT_RAM_TEST_OPT     VTSS_ENCODE_BITMASK(2,3)
#define  VTSS_X_VCAP_SUPER_RAM_INIT_RAM_TEST_OPT(x)  VTSS_EXTRACT_BITFIELD(x,2,3)
...
#endif /* _VTSS_LAGUNA_REGS_VCAP_SUPER_H_ */
