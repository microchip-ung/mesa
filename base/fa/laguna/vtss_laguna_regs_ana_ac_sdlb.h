 ...
 */
#define VTSS_ANA_AC_SDLB_XLB_NEXT_TR_CTRL    VTSS_IOREG(VTSS_TO_ANA_AC_SDLB,0x4f00)
 ...
 */
#define VTSS_ANA_AC_SDLB_XLB_NEXT_TR_ORG     VTSS_IOREG(VTSS_TO_ANA_AC_SDLB,0x4f01)
 ...
 */
#define  VTSS_F_ANA_AC_SDLB_XLB_NEXT_TR_ORG_LBSET_NEXT_TR_ORG(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_AC_SDLB_XLB_NEXT_TR_ORG_LBSET_NEXT_TR_ORG     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_AC_SDLB_XLB_NEXT_TR_ORG_LBSET_NEXT_TR_ORG(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_ANA_AC_SDLB_XLB_NEXT_TR_NEW     VTSS_IOREG(VTSS_TO_ANA_AC_SDLB,0x4f02)
 ...
 */
#define  VTSS_F_ANA_AC_SDLB_XLB_NEXT_TR_NEW_LBSET_NEXT_TR_NEW(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_AC_SDLB_XLB_NEXT_TR_NEW_LBSET_NEXT_TR_NEW     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_AC_SDLB_XLB_NEXT_TR_NEW_LBSET_NEXT_TR_NEW(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_ANA_AC_SDLB_MISC_CTRL           VTSS_IOREG(VTSS_TO_ANA_AC_SDLB,0x4f03)
 ...
 */
#define VTSS_ANA_AC_SDLB_MISC_RATE_CTRL      VTSS_IOREG(VTSS_TO_ANA_AC_SDLB,0x4f04)
 ...
 */
#define VTSS_ANA_AC_SDLB_MARK_ALL_FRMS_RED_SET  VTSS_IOREG(VTSS_TO_ANA_AC_SDLB,0x4f05)
 ...
 */
#define  VTSS_F_ANA_AC_SDLB_MARK_ALL_FRMS_RED_SET_MARK_ALL_FRMS_RED_SET_LBSET(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_AC_SDLB_MARK_ALL_FRMS_RED_SET_MARK_ALL_FRMS_RED_SET_LBSET     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_AC_SDLB_MARK_ALL_FRMS_RED_SET_MARK_ALL_FRMS_RED_SET_LBSET(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_ANA_AC_SDLB_MARK_ALL_FRMS_RED_CLR  VTSS_IOREG(VTSS_TO_ANA_AC_SDLB,0x4f06)
 ...
 */
#define  VTSS_F_ANA_AC_SDLB_MARK_ALL_FRMS_RED_CLR_MARK_ALL_FRMS_RED_CLR_LBSET(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_AC_SDLB_MARK_ALL_FRMS_RED_CLR_MARK_ALL_FRMS_RED_CLR_LBSET     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_AC_SDLB_MARK_ALL_FRMS_RED_CLR_MARK_ALL_FRMS_RED_CLR_LBSET(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_ANA_AC_SDLB_WARN                VTSS_IOREG(VTSS_TO_ANA_AC_SDLB,0x4f07)
 ...
 */
#define VTSS_ANA_AC_SDLB_FAIL                VTSS_IOREG(VTSS_TO_ANA_AC_SDLB,0x4f08)
 ...
 */
#define VTSS_ANA_AC_SDLB_TBL_ACC_CTRL        VTSS_IOREG(VTSS_TO_ANA_AC_SDLB,0x4f09)
 ...
 */
#define  VTSS_F_ANA_AC_SDLB_TBL_ACC_CTRL_TBL_LBSET_ADDR(x)  VTSS_ENCODE_BITFIELD(x,5,11)
#define  VTSS_M_ANA_AC_SDLB_TBL_ACC_CTRL_TBL_LBSET_ADDR     VTSS_ENCODE_BITMASK(5,11)
#define  VTSS_X_ANA_AC_SDLB_TBL_ACC_CTRL_TBL_LBSET_ADDR(x)  VTSS_EXTRACT_BITFIELD(x,5,11)
 ...
 */
#define VTSS_ANA_AC_SDLB_TBL_ACC_VAL         VTSS_IOREG(VTSS_TO_ANA_AC_SDLB,0x4f0a)
 ...
 *
 * @param gi Replicator: x_LB_2CYCLES_TYPE2_LBGRP_CNT (??), 0-7
 */
#define VTSS_ANA_AC_SDLB_XLB_START(gi)       VTSS_IOREG_IX(VTSS_TO_ANA_AC_SDLB,0x4f0b,gi,6,0,0)
 ...
 */
#define  VTSS_F_ANA_AC_SDLB_XLB_START_LBSET_START(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_AC_SDLB_XLB_START_LBSET_START     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_AC_SDLB_XLB_START_LBSET_START(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 * @param gi Replicator: x_LB_2CYCLES_TYPE2_LBGRP_CNT (??), 0-7
 */
#define VTSS_ANA_AC_SDLB_PUP_INTERVAL(gi)    VTSS_IOREG_IX(VTSS_TO_ANA_AC_SDLB,0x4f0b,gi,6,0,1)
 ...
 * @param gi Replicator: x_LB_2CYCLES_TYPE2_LBGRP_CNT (??), 0-7
 */
#define VTSS_ANA_AC_SDLB_PUP_CTRL(gi)        VTSS_IOREG_IX(VTSS_TO_ANA_AC_SDLB,0x4f0b,gi,6,0,2)
 ...
 * @param gi Replicator: x_LB_2CYCLES_TYPE2_LBGRP_CNT (??), 0-7
 */
#define VTSS_ANA_AC_SDLB_LBGRP_MISC(gi)      VTSS_IOREG_IX(VTSS_TO_ANA_AC_SDLB,0x4f0b,gi,6,0,3)
 ...
 * @param gi Replicator: x_LB_2CYCLES_TYPE2_LBGRP_CNT (??), 0-7
 */
#define VTSS_ANA_AC_SDLB_FRM_RATE_TOKENS(gi)  VTSS_IOREG_IX(VTSS_TO_ANA_AC_SDLB,0x4f0b,gi,6,0,4)
 ...
 * @param gi Replicator: x_LB_2CYCLES_TYPE2_LBGRP_CNT (??), 0-7
 */
#define VTSS_ANA_AC_SDLB_LBGRP_STATE_TBL(gi)  VTSS_IOREG_IX(VTSS_TO_ANA_AC_SDLB,0x4f0b,gi,6,0,5)
 ...
 */
#define  VTSS_F_ANA_AC_SDLB_LBGRP_STATE_TBL_PUP_LBSET_NEXT(x)  VTSS_ENCODE_BITFIELD(x,16,11)
#define  VTSS_M_ANA_AC_SDLB_LBGRP_STATE_TBL_PUP_LBSET_NEXT     VTSS_ENCODE_BITMASK(16,11)
#define  VTSS_X_ANA_AC_SDLB_LBGRP_STATE_TBL_PUP_LBSET_NEXT(x)  VTSS_EXTRACT_BITFIELD(x,16,11)
 ...
 *
 * @param gi Replicator: x_LB_2CYCLES_TYPE2_LBSET_CNT (??), 0-1263
 ...
 */
#define  VTSS_F_ANA_AC_SDLB_XLB_NEXT_LBSET_NEXT(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_AC_SDLB_XLB_NEXT_LBSET_NEXT     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_AC_SDLB_XLB_NEXT_LBSET_NEXT(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define  VTSS_F_ANA_AC_SDLB_INH_LBSET_ADDR_INH_LBSET_ADDR(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_ANA_AC_SDLB_INH_LBSET_ADDR_INH_LBSET_ADDR     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_ANA_AC_SDLB_INH_LBSET_ADDR_INH_LBSET_ADDR(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
