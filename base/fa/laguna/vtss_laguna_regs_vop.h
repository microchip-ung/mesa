 ...
 */
#define VTSS_VOP_HMO_PERIOD_CFG(ri)          VTSS_IOREG(VTSS_TO_VOP,0x35b5 + (ri))
 ...
 * @param ri Replicator: x_VTSS_OAM_MEP_NUM_HMO_SCAN_CNT (??), 0-1
 */
#define VTSS_VOP_HMO_FORCE_SLOT_CFG(ri)      VTSS_IOREG(VTSS_TO_VOP,0x35b7 + (ri))
 ...
 */
#define VTSS_VOP_HMO_TIMER_CFG               VTSS_IOREG(VTSS_TO_VOP,0x35b9)
 ...
 */
#define VTSS_VOP_LOC_SCAN_STICKY             VTSS_IOREG(VTSS_TO_VOP,0x35ba)
 ...
 */
#define VTSS_VOP_MASTER_INTR_CTRL            VTSS_IOREG(VTSS_TO_VOP,0x35bb)
 ...
 */
#define VTSS_VOP_VOE32_INTR                  VTSS_IOREG(VTSS_TO_VOP,0x35bc)
 ...
 */
#define VTSS_VOP_INTR(ri)                    VTSS_IOREG(VTSS_TO_VOP,0x35be + (ri))
 ...
 */
#define VTSS_VOP_COMMON_MEP_MC_MAC_LSB       VTSS_IOREG(VTSS_TO_VOP,0x35e1)
 ...
 */
#define VTSS_VOP_COMMON_MEP_MC_MAC_MSB       VTSS_IOREG(VTSS_TO_VOP,0x35e2)
 ...
 */
#define VTSS_VOP_CPU_EXTR_MRP                VTSS_IOREG(VTSS_TO_VOP,0x35e3)
 ...
 */
#define VTSS_VOP_CPU_EXTR_DLR                VTSS_IOREG(VTSS_TO_VOP,0x35e4)
 ...
 */
#define VTSS_VOP_TICK_CFG                    VTSS_IOREG(VTSS_TO_VOP,0x35e5)
 ...
 */
#define VTSS_VOP_MRP_TS_CFG                  VTSS_IOREG(VTSS_TO_VOP,0x35e6)
