 ...
 * index 128+qos_value.In GROUP mode, a scheduling element is assigned per
 ...
 */
#define  VTSS_F_XQS_STAT_CFG_STAT_VIEW(x)     VTSS_ENCODE_BITFIELD(x,5,10)
#define  VTSS_M_XQS_STAT_CFG_STAT_VIEW        VTSS_ENCODE_BITMASK(5,10)
#define  VTSS_X_XQS_STAT_CFG_STAT_VIEW(x)     VTSS_EXTRACT_BITFIELD(x,5,10)
 ...
 */
#define  VTSS_F_XQS_DROP_STAT_CTRL_DROP_STAT_BASE_ADDR(x)  VTSS_ENCODE_BITFIELD(x,6,8)
#define  VTSS_M_XQS_DROP_STAT_CTRL_DROP_STAT_BASE_ADDR     VTSS_ENCODE_BITMASK(6,8)
#define  VTSS_X_XQS_DROP_STAT_CTRL_DROP_STAT_BASE_ADDR(x)  VTSS_EXTRACT_BITFIELD(x,6,8)
 ...
 */
#define  VTSS_F_XQS_QUEUE_SIZE_QUEUE_SIZE(x)  VTSS_ENCODE_BITFIELD(x,2,14)
#define  VTSS_M_XQS_QUEUE_SIZE_QUEUE_SIZE     VTSS_ENCODE_BITMASK(2,14)
#define  VTSS_X_XQS_QUEUE_SIZE_QUEUE_SIZE(x)  VTSS_EXTRACT_BITFIELD(x,2,14)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SE_USE_QLIMIT_SE_USE(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_XQS_QLIMIT_SE_USE_QLIMIT_SE_USE     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_XQS_QLIMIT_SE_USE_QLIMIT_SE_USE(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_DP_CFG_QLIMIT_DP_CUT(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_XQS_QLIMIT_DP_CFG_QLIMIT_DP_CUT     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_XQS_QLIMIT_DP_CFG_QLIMIT_DP_CUT(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_TOP_CFG_QLIMIT_SHR_TOP(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_XQS_QLIMIT_SHR_TOP_CFG_QLIMIT_SHR_TOP     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_XQS_QLIMIT_SHR_TOP_CFG_QLIMIT_SHR_TOP(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_ATOP_CFG_QLIMIT_SHR_ATOP(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_XQS_QLIMIT_SHR_ATOP_CFG_QLIMIT_SHR_ATOP     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_XQS_QLIMIT_SHR_ATOP_CFG_QLIMIT_SHR_ATOP(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_CTOP_CFG_QLIMIT_SHR_CTOP(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_XQS_QLIMIT_SHR_CTOP_CFG_QLIMIT_SHR_CTOP     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_XQS_QLIMIT_SHR_CTOP_CFG_QLIMIT_SHR_CTOP(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_QLIM_CFG_QLIMIT_SHR_QLIM(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_XQS_QLIMIT_SHR_QLIM_CFG_QLIMIT_SHR_QLIM     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_XQS_QLIMIT_SHR_QLIM_CFG_QLIMIT_SHR_QLIM(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_QDIV_CFG_QLIMIT_SHR_QDIV(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_XQS_QLIMIT_SHR_QDIV_CFG_QLIMIT_SHR_QDIV     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_XQS_QLIMIT_SHR_QDIV_CFG_QLIMIT_SHR_QDIV(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_QDIVMAX_CFG_QLIMIT_SHR_QDIVMAX(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_XQS_QLIMIT_SHR_QDIVMAX_CFG_QLIMIT_SHR_QDIVMAX     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_XQS_QLIMIT_SHR_QDIVMAX_CFG_QLIMIT_SHR_QDIVMAX(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_FILL_STAT_QLIMIT_SHR_FILL(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_XQS_QLIMIT_SHR_FILL_STAT_QLIMIT_SHR_FILL     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_XQS_QLIMIT_SHR_FILL_STAT_QLIMIT_SHR_FILL(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_WM_STAT_QLIMIT_SHR_WM(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_XQS_QLIMIT_SHR_WM_STAT_QLIMIT_SHR_WM     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_XQS_QLIMIT_SHR_WM_STAT_QLIMIT_SHR_WM(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
 ...
 */
#define  VTSS_F_XQS_QLIMIT_SHR_FILL_MAX_STAT_QLIMIT_SHR_FILL_MAX(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_XQS_QLIMIT_SHR_FILL_MAX_STAT_QLIMIT_SHR_FILL_MAX     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_XQS_QLIMIT_SHR_FILL_MAX_STAT_QLIMIT_SHR_FILL_MAX(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
