 ...
 */
#define  VTSS_F_QRES_WRED_PROFILE_WM_RED_LOW(x)  VTSS_ENCODE_BITFIELD(x,11,10)
#define  VTSS_M_QRES_WRED_PROFILE_WM_RED_LOW     VTSS_ENCODE_BITMASK(11,10)
#define  VTSS_X_QRES_WRED_PROFILE_WM_RED_LOW(x)  VTSS_EXTRACT_BITFIELD(x,11,10)
