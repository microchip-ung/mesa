 ...
 */
#define  VTSS_F_DEV10G_PHAD_CTRL_TWEAKS(x)    VTSS_ENCODE_BITFIELD(x,8,3)
#define  VTSS_M_DEV10G_PHAD_CTRL_TWEAKS       VTSS_ENCODE_BITMASK(8,3)
#define  VTSS_X_DEV10G_PHAD_CTRL_TWEAKS(x)    VTSS_EXTRACT_BITFIELD(x,8,3)
 ...
 */
#define  VTSS_F_DEV10G_PHAD_CTRL_REALIGN_OFS(x)  VTSS_ENCODE_BITFIELD(x,3,3)
#define  VTSS_M_DEV10G_PHAD_CTRL_REALIGN_OFS     VTSS_ENCODE_BITMASK(3,3)
#define  VTSS_X_DEV10G_PHAD_CTRL_REALIGN_OFS(x)  VTSS_EXTRACT_BITFIELD(x,3,3)
