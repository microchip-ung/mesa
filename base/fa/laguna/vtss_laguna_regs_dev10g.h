 ...
 */
#define  VTSS_F_DEV10G_PTP_CFG_PCH_ERR_MODE(x)  VTSS_ENCODE_BITFIELD(x,12,2)
#define  VTSS_M_DEV10G_PTP_CFG_PCH_ERR_MODE     VTSS_ENCODE_BITMASK(12,2)
#define  VTSS_X_DEV10G_PTP_CFG_PCH_ERR_MODE(x)  VTSS_EXTRACT_BITFIELD(x,12,2)
