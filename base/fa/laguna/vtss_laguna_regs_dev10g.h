...
#ifndef _VTSS_LAGUNA_REGS_DEV10G_H_
#define _VTSS_LAGUNA_REGS_DEV10G_H_
 ...
 *
 * \details
 * Field: ::VTSS_DEV10G_MAC_MODE_CFG . RX_RAW_ENA
 */
#define  VTSS_F_DEV10G_MAC_MODE_CFG_RX_RAW_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_DEV10G_MAC_MODE_CFG_RX_RAW_ENA  VTSS_BIT(1)
#define  VTSS_X_DEV10G_MAC_MODE_CFG_RX_RAW_ENA(x)  VTSS_EXTRACT_BITFIELD(x,1,1)
 ...
 *
 * Field: ::VTSS_DEV10G_PTP_CFG . PCH_ERR_MODE
 */
#define  VTSS_F_DEV10G_PTP_CFG_PCH_ERR_MODE(x)  VTSS_ENCODE_BITFIELD(x,13,2)
#define  VTSS_M_DEV10G_PTP_CFG_PCH_ERR_MODE     VTSS_ENCODE_BITMASK(13,2)
#define  VTSS_X_DEV10G_PTP_CFG_PCH_ERR_MODE(x)  VTSS_EXTRACT_BITFIELD(x,13,2)
 ...
 */
#define VTSS_DEV10G_PHAD_CTRL(target,gi)     VTSS_IOREG_IX(target,0x90,gi,3,0,0)
 ...
 */
#define  VTSS_F_DEV10G_PHAD_CTRL_PHAD_LOCK(x)  VTSS_ENCODE_BITFIELD(!!(x),18,1)
#define  VTSS_M_DEV10G_PHAD_CTRL_PHAD_LOCK    VTSS_BIT(18)
#define  VTSS_X_DEV10G_PHAD_CTRL_PHAD_LOCK(x)  VTSS_EXTRACT_BITFIELD(x,18,1)
 ...
 */
#define  VTSS_F_DEV10G_PHAD_CTRL_DIV_STATE(x)  VTSS_ENCODE_BITFIELD(x,15,3)
#define  VTSS_M_DEV10G_PHAD_CTRL_DIV_STATE     VTSS_ENCODE_BITMASK(15,3)
#define  VTSS_X_DEV10G_PHAD_CTRL_DIV_STATE(x)  VTSS_EXTRACT_BITFIELD(x,15,3)
 ...
 */
#define  VTSS_F_DEV10G_PHAD_CTRL_PHAD_ADJ(x)  VTSS_ENCODE_BITFIELD(x,13,2)
#define  VTSS_M_DEV10G_PHAD_CTRL_PHAD_ADJ     VTSS_ENCODE_BITMASK(13,2)
#define  VTSS_X_DEV10G_PHAD_CTRL_PHAD_ADJ(x)  VTSS_EXTRACT_BITFIELD(x,13,2)
 ...
 */
#define  VTSS_F_DEV10G_PHAD_CTRL_ERR_MAX_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),12,1)
#define  VTSS_M_DEV10G_PHAD_CTRL_ERR_MAX_ENA  VTSS_BIT(12)
#define  VTSS_X_DEV10G_PHAD_CTRL_ERR_MAX_ENA(x)  VTSS_EXTRACT_BITFIELD(x,12,1)
 ...
 */
#define  VTSS_F_DEV10G_PHAD_CTRL_DIV_CFG(x)   VTSS_ENCODE_BITFIELD(x,9,3)
#define  VTSS_M_DEV10G_PHAD_CTRL_DIV_CFG      VTSS_ENCODE_BITMASK(9,3)
#define  VTSS_X_DEV10G_PHAD_CTRL_DIV_CFG(x)   VTSS_EXTRACT_BITFIELD(x,9,3)
 ...
 */
#define  VTSS_F_DEV10G_PHAD_CTRL_TWEAKS(x)    VTSS_ENCODE_BITFIELD(x,6,3)
#define  VTSS_M_DEV10G_PHAD_CTRL_TWEAKS       VTSS_ENCODE_BITMASK(6,3)
#define  VTSS_X_DEV10G_PHAD_CTRL_TWEAKS(x)    VTSS_EXTRACT_BITFIELD(x,6,3)
 ...
 */
#define  VTSS_F_DEV10G_PHAD_CTRL_PHAD_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),5,1)
#define  VTSS_M_DEV10G_PHAD_CTRL_PHAD_ENA     VTSS_BIT(5)
#define  VTSS_X_DEV10G_PHAD_CTRL_PHAD_ENA(x)  VTSS_EXTRACT_BITFIELD(x,5,1)
 ...
 *
 * \details
 * Field: ::VTSS_DEV10G_PHAD_CTRL . PHAD_MODE
 */
#define  VTSS_F_DEV10G_PHAD_CTRL_PHAD_MODE(x)  VTSS_ENCODE_BITFIELD(!!(x),4,1)
#define  VTSS_M_DEV10G_PHAD_CTRL_PHAD_MODE    VTSS_BIT(4)
#define  VTSS_X_DEV10G_PHAD_CTRL_PHAD_MODE(x)  VTSS_EXTRACT_BITFIELD(x,4,1)
 ...
 */
#define  VTSS_F_DEV10G_PHAD_CTRL_PHAD_FAILED(x)  VTSS_ENCODE_BITFIELD(!!(x),3,1)
#define  VTSS_M_DEV10G_PHAD_CTRL_PHAD_FAILED  VTSS_BIT(3)
#define  VTSS_X_DEV10G_PHAD_CTRL_PHAD_FAILED(x)  VTSS_EXTRACT_BITFIELD(x,3,1)
 ...
 * @param gi Replicator: x_PHASE_DETECTOR_INSTANCES (??), 0-1
 */
#define VTSS_DEV10G_PHAD_CYC_STAT(target,gi)  VTSS_IOREG_IX(target,0x90,gi,3,0,1)
 ...
 * Cycle time detected
 *
 * Register: \a DEV10G:PHASE_DETECTOR_CTRL:PHAD_ERR_STAT
 *
 * @param target A \a ::vtss_target_DEV10G_e target
 * @param gi Replicator: x_PHASE_DETECTOR_INSTANCES (??), 0-1
 */
#define VTSS_DEV10G_PHAD_ERR_STAT(target,gi)  VTSS_IOREG_IX(target,0x90,gi,3,0,2)
 ...
 *
 * \details
 * Field: ::VTSS_DEV10G_PHAD_ERR_STAT . PHAD_ERR_STAT
 */
#define  VTSS_F_DEV10G_PHAD_ERR_STAT_PHAD_ERR_STAT(x)  VTSS_ENCODE_BITFIELD(x,0,19)
#define  VTSS_M_DEV10G_PHAD_ERR_STAT_PHAD_ERR_STAT     VTSS_ENCODE_BITMASK(0,19)
#define  VTSS_X_DEV10G_PHAD_ERR_STAT_PHAD_ERR_STAT(x)  VTSS_EXTRACT_BITFIELD(x,0,19)


#endif /* _VTSS_LAGUNA_REGS_DEV10G_H_ */
