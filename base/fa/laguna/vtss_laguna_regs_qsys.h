 ...
 */
#define  VTSS_F_QSYS_PAUSE_CFG_PAUSE_START(x)  VTSS_ENCODE_BITFIELD(x,13,11)
#define  VTSS_M_QSYS_PAUSE_CFG_PAUSE_START     VTSS_ENCODE_BITMASK(13,11)
#define  VTSS_X_QSYS_PAUSE_CFG_PAUSE_START(x)  VTSS_EXTRACT_BITFIELD(x,13,11)
 ...
 */
#define  VTSS_F_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_START(x)  VTSS_ENCODE_BITFIELD(x,11,11)
#define  VTSS_M_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_START     VTSS_ENCODE_BITMASK(11,11)
#define  VTSS_X_QSYS_PAUSE_TOT_CFG_PAUSE_TOT_START(x)  VTSS_EXTRACT_BITFIELD(x,11,11)
