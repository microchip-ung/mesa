 ...
 */
#define  VTSS_F_DEV1G_PHAD_CTRL_PHAD_LOCK(x)  VTSS_ENCODE_BITFIELD(!!(x),22,1)
#define  VTSS_M_DEV1G_PHAD_CTRL_PHAD_LOCK     VTSS_BIT(22)
#define  VTSS_X_DEV1G_PHAD_CTRL_PHAD_LOCK(x)  VTSS_EXTRACT_BITFIELD(x,22,1)
 ...
 */
#define  VTSS_F_DEV1G_PHAD_CTRL_DIV_STATE(x)  VTSS_ENCODE_BITFIELD(x,18,4)
#define  VTSS_M_DEV1G_PHAD_CTRL_DIV_STATE     VTSS_ENCODE_BITMASK(18,4)
#define  VTSS_X_DEV1G_PHAD_CTRL_DIV_STATE(x)  VTSS_EXTRACT_BITFIELD(x,18,4)
 ...
 */
#define  VTSS_F_DEV1G_PHAD_CTRL_PHAD_ENA(x)   VTSS_ENCODE_BITFIELD(!!(x),17,1)
#define  VTSS_M_DEV1G_PHAD_CTRL_PHAD_ENA      VTSS_BIT(17)
#define  VTSS_X_DEV1G_PHAD_CTRL_PHAD_ENA(x)   VTSS_EXTRACT_BITFIELD(x,17,1)
 ...
 */
#define  VTSS_F_DEV1G_PHAD_CTRL_PHAD_FAILED(x)  VTSS_ENCODE_BITFIELD(!!(x),16,1)
#define  VTSS_M_DEV1G_PHAD_CTRL_PHAD_FAILED   VTSS_BIT(16)
#define  VTSS_X_DEV1G_PHAD_CTRL_PHAD_FAILED(x)  VTSS_EXTRACT_BITFIELD(x,16,1)
 ...
 */
#define  VTSS_F_DEV1G_PHAD_CTRL_PHAD_ADJ(x)   VTSS_ENCODE_BITFIELD(x,14,2)
#define  VTSS_M_DEV1G_PHAD_CTRL_PHAD_ADJ      VTSS_ENCODE_BITMASK(14,2)
#define  VTSS_X_DEV1G_PHAD_CTRL_PHAD_ADJ(x)   VTSS_EXTRACT_BITFIELD(x,14,2)
 ...
 */
#define  VTSS_F_DEV1G_PHAD_CTRL_ERR_MAX_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),13,1)
#define  VTSS_M_DEV1G_PHAD_CTRL_ERR_MAX_ENA   VTSS_BIT(13)
#define  VTSS_X_DEV1G_PHAD_CTRL_ERR_MAX_ENA(x)  VTSS_EXTRACT_BITFIELD(x,13,1)
 ...
 */
#define  VTSS_F_DEV1G_PHAD_CTRL_LOCK_ACC(x)   VTSS_ENCODE_BITFIELD(x,10,3)
#define  VTSS_M_DEV1G_PHAD_CTRL_LOCK_ACC      VTSS_ENCODE_BITMASK(10,3)
#define  VTSS_X_DEV1G_PHAD_CTRL_LOCK_ACC(x)   VTSS_EXTRACT_BITFIELD(x,10,3)
 ...
 */
#define  VTSS_F_DEV1G_PHAD_CTRL_REALIGN_OFS(x)  VTSS_ENCODE_BITFIELD(x,7,3)
#define  VTSS_M_DEV1G_PHAD_CTRL_REALIGN_OFS     VTSS_ENCODE_BITMASK(7,3)
#define  VTSS_X_DEV1G_PHAD_CTRL_REALIGN_OFS(x)  VTSS_EXTRACT_BITFIELD(x,7,3)
 ...
 */
#define  VTSS_F_DEV1G_PHAD_CTRL_TWEAKS(x)     VTSS_ENCODE_BITFIELD(x,4,3)
#define  VTSS_M_DEV1G_PHAD_CTRL_TWEAKS        VTSS_ENCODE_BITMASK(4,3)
#define  VTSS_X_DEV1G_PHAD_CTRL_TWEAKS(x)     VTSS_EXTRACT_BITFIELD(x,4,3)
 ...
 */
#define  VTSS_F_DEV1G_PHAD_CTRL_DIV_CFG(x)    VTSS_ENCODE_BITFIELD(x,0,4)
#define  VTSS_M_DEV1G_PHAD_CTRL_DIV_CFG       VTSS_ENCODE_BITMASK(0,4)
#define  VTSS_X_DEV1G_PHAD_CTRL_DIV_CFG(x)    VTSS_EXTRACT_BITFIELD(x,0,4)
