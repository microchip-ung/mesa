...
#endif
#ifndef VTSS_IO_OFFSET0
#define VTSS_IO_OFFSET0(offset) 0x000000000
#endif
...
static const vtss_symreg_reggrp_t reggrps_within_CPU[] = {
    ...
    {"SFR_REGS"                             , 0x000000b4, 0x00000001, 0x00000007, regs_within_CPU_SFR_REGS},
    {NULL, 0, 0, 0, NULL}
};
...
static const vtss_symreg_reg_t regs_within_DDR4_PHY_DWC_DDRPHY_PUB[] = {
    //reg name                              , addr      , repl_cnt  , repl_width
...
static const vtss_symreg_reggrp_t reggrps_within_DDR4_PHY[] = {
    //reggrp name                           , base_addr , repl_cnt  , repl_width, reg list
    {"DWC_DDRPHY_PUB"                       , 0x00000000, 0x00000001, 0x00000400, regs_within_DDR4_PHY_DWC_DDRPHY_PUB},
    {NULL, 0, 0, 0, NULL}
};
...
static const vtss_symreg_reg_t regs_within_USB3_DWC_USB3_BLOCK_DEV[] = {
    ...
    {"RSVD"                                 , 0x00000009, 0x00000001, 0x00000001},
    {"DEPCMDPAR2"                           , 0x00000040, 0x00000001, 0x00000001},
    {"DEPCMDPAR1"                           , 0x00000041, 0x00000001, 0x00000001},
    {"DEPCMDPAR0"                           , 0x00000042, 0x00000001, 0x00000001},
    {"DEPCMD"                               , 0x00000043, 0x00000001, 0x00000001},
...
static const vtss_symreg_reg_t regs_within_USB3_DWC_USB3_BLOCK_DOORBELL_REGISTER[] = {
    //reg name                              , addr      , repl_cnt  , repl_width
    {"DB"                                   , 0x00000000, 0x00000001, 0x00000001},
    {NULL, 0, 0, 0}
};
...
static const vtss_symreg_reggrp_t reggrps_within_HSCH[] = {
    ...
    {"HSCH_LEAK_LISTS"                      , 0x000023b6, 0x00000004, 0x00000008, regs_within_HSCH_HSCH_LEAK_LISTS},
    {"SYSTEM"                               , 0x00002d02, 0x00000001, 0x0000004e, regs_within_HSCH_SYSTEM},
    {"MMGT"                                 , 0x000023d6, 0x00000001, 0x00000004, regs_within_HSCH_MMGT},
    {"TAS_CONFIG"                           , 0x000023da, 0x00000001, 0x00000004, regs_within_HSCH_TAS_CONFIG},
...
static const vtss_symreg_reggrp_t reggrps_within_VOP[] = {
    //reggrp name                           , base_addr , repl_cnt  , repl_width, reg list
    {"COMMON"                               , 0x0000357e, 0x00000001, 0x00000066, regs_within_VOP_COMMON},
...
static const vtss_symreg_target_t vtss_symreg_targets[] = {
    ...
    {"DDR4_PHY"           ,   -1, 0x00000012, VTSS_IO_OFFSET2(0x00084000), reggrps_within_DDR4_PHY},
    ...
    {"GIC500"             ,   -1, 0x0000002f, VTSS_IO_OFFSET2(0x02304000), reggrps_within_GIC500},
    ...
    {"USB3"               ,   -1, 0x0000001f, VTSS_IO_OFFSET0(0x0007c000), reggrps_within_USB3},
