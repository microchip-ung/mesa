 ...
 */
#define  VTSS_F_IP_KRANEG_AN_HIST_AN_SM_HIST(x)  VTSS_ENCODE_BITFIELD(x,0,16)
#define  VTSS_M_IP_KRANEG_AN_HIST_AN_SM_HIST     VTSS_ENCODE_BITMASK(0,16)
#define  VTSS_X_IP_KRANEG_AN_HIST_AN_SM_HIST(x)  VTSS_EXTRACT_BITFIELD(x,0,16)
