 ...
 */
#define VTSS_ANA_AC_OAM_MOD_PORT_LM_CNT_LSB(gi)  VTSS_IOREG_IX(VTSS_TO_ANA_AC_OAM_MOD,0x400,gi,4,0,0)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_ETH_PORTS_X_NUM_PRIO (??), 0-239
 */
#define VTSS_ANA_AC_OAM_MOD_PORT_FRM_CNT_LSB(gi)  VTSS_IOREG_IX(VTSS_TO_ANA_AC_OAM_MOD,0x400,gi,4,0,1)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_ETH_PORTS_X_NUM_PRIO (??), 0-239
 */
#define VTSS_ANA_AC_OAM_MOD_PORT_BYTE_CNT_MSB(gi)  VTSS_IOREG_IX(VTSS_TO_ANA_AC_OAM_MOD,0x400,gi,4,0,2)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_ETH_PORTS_X_NUM_PRIO (??), 0-239
 */
#define VTSS_ANA_AC_OAM_MOD_PORT_BYTE_CNT_LSB(gi)  VTSS_IOREG_IX(VTSS_TO_ANA_AC_OAM_MOD,0x400,gi,4,0,3)
 ...
 *
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_CONTEXT_PORTS (??), 0-124
 */
#define VTSS_ANA_AC_OAM_MOD_TEMP_CNT_REG(gi)  VTSS_IOREG_IX(VTSS_TO_ANA_AC_OAM_MOD,0x0,gi,8,0,0)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_CONTEXT_PORTS (??), 0-124
 */
#define VTSS_ANA_AC_OAM_MOD_LM_CNT_FRAME(gi)  VTSS_IOREG_IX(VTSS_TO_ANA_AC_OAM_MOD,0x0,gi,8,0,1)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_CONTEXT_PORTS (??), 0-124
 */
#define VTSS_ANA_AC_OAM_MOD_CCM_LM_INFO_REG(gi)  VTSS_IOREG_IX(VTSS_TO_ANA_AC_OAM_MOD,0x0,gi,8,0,2)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_CONTEXT_PORTS (??), 0-124
 */
#define VTSS_ANA_AC_OAM_MOD_CCM_LM_TX_B_REG(gi)  VTSS_IOREG_IX(VTSS_TO_ANA_AC_OAM_MOD,0x0,gi,8,0,3)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_CONTEXT_PORTS (??), 0-124
 */
#define VTSS_ANA_AC_OAM_MOD_CCM_LM_RX_B_REG(gi)  VTSS_IOREG_IX(VTSS_TO_ANA_AC_OAM_MOD,0x0,gi,8,0,4)
...
#endif /* _VTSS_LAGUNA_REGS_ANA_AC_OAM_MOD_H_ */
