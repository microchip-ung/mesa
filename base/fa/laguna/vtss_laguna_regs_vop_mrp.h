 ...
 */
#define  VTSS_F_VOP_MRP_VOE_COMMON_CFG_PATH_VOEID(x)  VTSS_ENCODE_BITFIELD(x,1,5)
#define  VTSS_M_VOP_MRP_VOE_COMMON_CFG_PATH_VOEID     VTSS_ENCODE_BITMASK(1,5)
#define  VTSS_X_VOP_MRP_VOE_COMMON_CFG_PATH_VOEID(x)  VTSS_EXTRACT_BITFIELD(x,1,5)
 ...
 */
#define  VTSS_F_VOP_MRP_TST_CFG_SAMPLE_LO_PRIO_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),9,1)
#define  VTSS_M_VOP_MRP_TST_CFG_SAMPLE_LO_PRIO_ENA  VTSS_BIT(9)
#define  VTSS_X_VOP_MRP_TST_CFG_SAMPLE_LO_PRIO_ENA(x)  VTSS_EXTRACT_BITFIELD(x,9,1)
 ...
 */
#define  VTSS_F_VOP_MRP_TST_CFG_SAMPLE_HI_PRIO_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),8,1)
#define  VTSS_M_VOP_MRP_TST_CFG_SAMPLE_HI_PRIO_ENA  VTSS_BIT(8)
#define  VTSS_X_VOP_MRP_TST_CFG_SAMPLE_HI_PRIO_ENA(x)  VTSS_EXTRACT_BITFIELD(x,8,1)
 ...
 */
#define  VTSS_F_VOP_MRP_TST_CFG_CHK_REM_PRIO_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),7,1)
#define  VTSS_M_VOP_MRP_TST_CFG_CHK_REM_PRIO_ENA  VTSS_BIT(7)
#define  VTSS_X_VOP_MRP_TST_CFG_CHK_REM_PRIO_ENA(x)  VTSS_EXTRACT_BITFIELD(x,7,1)
 ...
 */
#define  VTSS_F_VOP_MRP_TST_CFG_CHK_BEST_MRM_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),6,1)
#define  VTSS_M_VOP_MRP_TST_CFG_CHK_BEST_MRM_ENA  VTSS_BIT(6)
#define  VTSS_X_VOP_MRP_TST_CFG_CHK_BEST_MRM_ENA(x)  VTSS_EXTRACT_BITFIELD(x,6,1)
 ...
 */
#define  VTSS_F_VOP_MRP_TST_CFG_CLR_MISS_CNT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),5,1)
#define  VTSS_M_VOP_MRP_TST_CFG_CLR_MISS_CNT_ENA  VTSS_BIT(5)
#define  VTSS_X_VOP_MRP_TST_CFG_CLR_MISS_CNT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,5,1)
 ...
 */
#define  VTSS_F_VOP_MRP_TST_CFG_LOC_PERIOD(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_VOP_MRP_TST_CFG_LOC_PERIOD     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_VOP_MRP_TST_CFG_LOC_PERIOD(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define  VTSS_F_VOP_MRP_ITST_CFG_ITST_CLR_MISS_CNT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),5,1)
#define  VTSS_M_VOP_MRP_ITST_CFG_ITST_CLR_MISS_CNT_ENA  VTSS_BIT(5)
#define  VTSS_X_VOP_MRP_ITST_CFG_ITST_CLR_MISS_CNT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,5,1)
 ...
 */
#define  VTSS_F_VOP_MRP_ITST_CFG_ITST_LOC_PERIOD(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_VOP_MRP_ITST_CFG_ITST_LOC_PERIOD     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_VOP_MRP_ITST_CFG_ITST_LOC_PERIOD(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
