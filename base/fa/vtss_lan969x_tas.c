                                     ...
                                     const vtss_port_no_t  port_no)
{
    ...
    if (gcl_state->curr_list_idx != TAS_LIST_IDX_NONE) {    /* Check if there is a current list active */
        ...
        REG_WRM(VTSS_HSCH_TAS_PROFILE_CONFIG(profile_idx), VTSS_F_HSCH_TAS_PROFILE_CONFIG_HOLDADVANCE(hold_advance), VTSS_M_HSCH_TAS_PROFILE_CONFIG_HOLDADVANCE); /* Update the hold_advance configuration */
    }
