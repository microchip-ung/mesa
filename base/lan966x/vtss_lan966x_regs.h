 ...
 * Commit ID: d7c62089fdf6c7e3ec42d041e89b9ca4f93bb1ba (dirty)
 */
...
#define LAN966x_BUILD_ID 1580832688
...
/*      ANA:ANA:ADVLEARN */
#define ANA_ADVLEARN              TARGET_ANA,0,1,28688,0,1,216,0,0,1,4
...
/*      ANA:ANA:VLANMASK */
#define ANA_VLANMASK              TARGET_ANA,0,1,28688,0,1,216,4,0,1,4
...
/*      ANA:ANA:ANAGEFIL */
#define ANA_ANAGEFIL              TARGET_ANA,0,1,28688,0,1,216,8,0,1,4
...
/*      ANA:ANA:ANAINTR */
#define ANA_ANAINTR               TARGET_ANA,0,1,28688,0,1,216,12,0,1,4
...
/*      ANA:ANA:ANEVENTS */
#define ANA_ANEVENTS              TARGET_ANA,0,1,28688,0,1,216,16,0,1,4
...
/*      ANA:ANA:RT_EVENTS */
#define ANA_RT_EVENTS(r)          TARGET_ANA,0,1,28688,0,1,216,20,r,2,4
...
#define ANA_ISOLATED_PORTS        TARGET_ANA,0,1,28688,0,1,216,28,0,1,4
...
#define ANA_COMMUNITY_PORTS       TARGET_ANA,0,1,28688,0,1,216,32,0,1,4
...
/*      ANA:ANA:AUTOAGE */
#define ANA_AUTOAGE               TARGET_ANA,0,1,28688,0,1,216,36,0,1,4
...
/*      ANA:ANA:MACTOPTIONS */
#define ANA_MACTOPTIONS           TARGET_ANA,0,1,28688,0,1,216,40,0,1,4
...
/*      ANA:ANA:LEARNDISC */
#define ANA_LEARNDISC             TARGET_ANA,0,1,28688,0,1,216,44,0,1,4

/*      ANA:ANA:AGENCTRL */
#define ANA_AGENCTRL              TARGET_ANA,0,1,28688,0,1,216,48,0,1,4
...
/*      ANA:ANA:MIRRORPORTS */
#define ANA_MIRRORPORTS           TARGET_ANA,0,1,28688,0,1,216,52,0,1,4
...
#define ANA_EMIRRORPORTS          TARGET_ANA,0,1,28688,0,1,216,56,0,1,4
...
/*      ANA:ANA:FLOODING */
#define ANA_FLOODING(r)           TARGET_ANA,0,1,28688,0,1,216,60,r,8,4
...
#define ANA_FLOODING_IPMC         TARGET_ANA,0,1,28688,0,1,216,92,0,1,4
...
/*      ANA:ANA:STORM_CFG */
#define ANA_STORM_CFG             TARGET_ANA,0,1,28688,0,1,216,96,0,1,4
...
/*      ANA:ANA:SFLOW_CFG */
#define ANA_SFLOW_CFG(r)          TARGET_ANA,0,1,28688,0,1,216,100,r,9,4
...
/*      ANA:ANA:PORT_MODE */
#define ANA_PORT_MODE(r)          TARGET_ANA,0,1,28688,0,1,216,136,r,10,4
...
#define ANA_CUT_THRU_CFG(r)       TARGET_ANA,0,1,28688,0,1,216,176,r,9,4
...
/*      ANA:ANA:TEST_UTIL */
#define ANA_TEST_UTIL             TARGET_ANA,0,1,28688,0,1,216,212,0,1,4
...
/*      ANA:PGID:PGID */
#define ANA_PGID(r)               TARGET_ANA,0,1,27136,0,1,512,0,r,89,4
...
#define ANA_ANMOVED               TARGET_ANA,0,1,26880,0,1,128,36,0,1,4
...
#define ANA_MACHDATA              TARGET_ANA,0,1,26880,0,1,128,40,0,1,4
...
#define ANA_MACLDATA              TARGET_ANA,0,1,26880,0,1,128,44,0,1,4

/*      ANA:ANA_TABLES:STREAMDATA */
#define ANA_STREAMDATA            TARGET_ANA,0,1,26880,0,1,128,48,0,1,4

#define ANA_STREAMDATA_SSID_VALID(x)             (((x) << 8) & GENMASK(8, 8))
#define ANA_STREAMDATA_SSID_VALID_M              GENMASK(8, 8)
#define ANA_STREAMDATA_SSID_VALID_X(x)           (((x) & GENMASK(8, 8)) >> 8)

#define ANA_STREAMDATA_SSID(x)                   ((x) & GENMASK(7, 0))
#define ANA_STREAMDATA_SSID_M                    GENMASK(7, 0)
#define ANA_STREAMDATA_SSID_X(x)                 ((x) & GENMASK(7, 0))

/*      ANA:ANA_TABLES:MACACCESS */
#define ANA_MACACCESS             TARGET_ANA,0,1,26880,0,1,128,52,0,1,4
...
#define ANA_MACTINDX              TARGET_ANA,0,1,26880,0,1,128,56,0,1,4
...
#define ANA_VLANACCESS            TARGET_ANA,0,1,26880,0,1,128,60,0,1,4
...
#define ANA_VLANTIDX              TARGET_ANA,0,1,26880,0,1,128,64,0,1,4
...
#define ANA_ENTRYLIM(r)           TARGET_ANA,0,1,26880,0,1,128,0,r,9,4
...
#define ANA_STREAMACCESS          TARGET_ANA,0,1,26880,0,1,128,68,0,1,4
...
#define ANA_STREAMTIDX            TARGET_ANA,0,1,26880,0,1,128,72,0,1,4
...
#define ANA_SEQ_MASK              TARGET_ANA,0,1,26880,0,1,128,76,0,1,4
...
#define ANA_SFIDACCESS            TARGET_ANA,0,1,26880,0,1,128,80,0,1,4
...
#define ANA_SFIDTIDX              TARGET_ANA,0,1,26880,0,1,128,84,0,1,4
...
#define ANA_MSTI_STATE(r)         TARGET_ANA,0,1,27648,0,1,512,0,r,128,4
...
#define ANA_SG_ACCESS_CTRL        TARGET_ANA,0,1,28904,0,1,4,0,0,1,4
...
#define ANA_SG_CFG_1              TARGET_ANA,0,1,27008,0,1,128,48,0,1,4

/*      ANA:SG_CONFIG:SG_CFG_2 */
#define ANA_SG_CFG_2              TARGET_ANA,0,1,27008,0,1,128,52,0,1,4

/*      ANA:SG_CONFIG:SG_CFG_3 */
#define ANA_SG_CFG_3              TARGET_ANA,0,1,27008,0,1,128,56,0,1,4
...
#define ANA_SG_CFG_4              TARGET_ANA,0,1,27008,0,1,128,60,0,1,4

/*      ANA:SG_CONFIG:SG_CFG_5 */
#define ANA_SG_CFG_5              TARGET_ANA,0,1,27008,0,1,128,64,0,1,4

/*      ANA:SG_CONFIG:SG_GCL_GS_CFG */
#define ANA_SG_GCL_GS_CFG(r)      TARGET_ANA,0,1,27008,0,1,128,0,r,4,4
...
#define ANA_SG_GCL_TI_CFG(r)      TARGET_ANA,0,1,27008,0,1,128,16,r,4,4

/*      ANA:SG_CONFIG:SG_GCL_OCT_CFG */
#define ANA_SG_GCL_OCT_CFG(r)     TARGET_ANA,0,1,27008,0,1,128,32,r,4,4

/*      ANA:SG_STATUS:SG_STS_1 */
#define ANA_SG_STS_1              TARGET_ANA,0,1,28672,0,1,16,0,0,1,4

/*      ANA:SG_STATUS:SG_STS_2 */
#define ANA_SG_STS_2              TARGET_ANA,0,1,28672,0,1,16,4,0,1,4

/*      ANA:SG_STATUS:SG_STS_3 */
#define ANA_SG_STS_3              TARGET_ANA,0,1,28672,0,1,16,8,0,1,4
...
#define ANA_SG_STS_4              TARGET_ANA,0,1,28672,0,1,16,12,0,1,4
...
/*      ANA:PFC:PFC_CFG */
#define ANA_PFC_CFG(g)            TARGET_ANA,0,1,28160,g,8,64,0,0,1,4
...
/*      ANA:PFC:PFC_TIMER */
#define ANA_PFC_TIMER(g,r)        TARGET_ANA,0,1,28160,g,8,64,4,r,8,4
...
/*      ANA:COMMON:AGGR_CFG */
#define ANA_AGGR_CFG              TARGET_ANA,0,1,28908,0,1,552,0,0,1,4
...
/*      ANA:COMMON:CPUQ_CFG */
#define ANA_CPUQ_CFG              TARGET_ANA,0,1,28908,0,1,552,4,0,1,4
...
#define ANA_CPUQ_CFG2             TARGET_ANA,0,1,28908,0,1,552,8,0,1,4
...
#define ANA_CPUQ_8021_CFG(r)      TARGET_ANA,0,1,28908,0,1,552,12,r,16,4
...
/*      ANA:COMMON:DSCP_CFG */
#define ANA_DSCP_CFG(r)           TARGET_ANA,0,1,28908,0,1,552,76,r,64,4
...
#define ANA_DSCP_REWR_CFG(r)      TARGET_ANA,0,1,28908,0,1,552,332,r,16,4
...
#define ANA_VCAP_RNG_CFG(r)       TARGET_ANA,0,1,28908,0,1,552,396,r,8,4
...
#define ANA_VCAP_RNG_VAL_CFG(r)   TARGET_ANA,0,1,28908,0,1,552,428,r,8,4
...
/*      ANA:COMMON:VRAP_CFG */
#define ANA_VRAP_CFG              TARGET_ANA,0,1,28908,0,1,552,460,0,1,4
...
#define ANA_VRAP_HDR_DATA         TARGET_ANA,0,1,28908,0,1,552,464,0,1,4

/*      ANA:COMMON:VRAP_HDR_MASK */
#define ANA_VRAP_HDR_MASK         TARGET_ANA,0,1,28908,0,1,552,468,0,1,4

/*      ANA:COMMON:DISCARD_CFG */
#define ANA_DISCARD_CFG           TARGET_ANA,0,1,28908,0,1,552,472,0,1,4
...
/*      ANA:COMMON:FID_CFG */
#define ANA_FID_CFG               TARGET_ANA,0,1,28908,0,1,552,476,0,1,4
...
#define ANA_VLAN_ETYPE_CFG        TARGET_ANA,0,1,28908,0,1,552,480,0,1,4
...
#define ANA_RT_VLAN_PCP(r)        TARGET_ANA,0,1,28908,0,1,552,484,r,8,4
...
#define ANA_RT_CUSTOM             TARGET_ANA,0,1,28908,0,1,552,516,0,1,4
...
#define ANA_RT_MISC_CFG(r)        TARGET_ANA,0,1,28908,0,1,552,520,r,8,4
...
/*      ANA:POL:POL_PIR_CFG */
#define ANA_POL_PIR_CFG(g)        TARGET_ANA,0,1,16384,g,256,32,0,0,1,4
...
/*      ANA:POL:POL_CIR_CFG */
#define ANA_POL_CIR_CFG(g)        TARGET_ANA,0,1,16384,g,256,32,4,0,1,4
...
/*      ANA:POL:POL_MODE */
#define ANA_POL_MODE(g)           TARGET_ANA,0,1,16384,g,256,32,8,0,1,4
...
#define ANA_POL_PIR_STATE(g)      TARGET_ANA,0,1,16384,g,256,32,12,0,1,4
...
#define ANA_POL_CIR_STATE(g)      TARGET_ANA,0,1,16384,g,256,32,16,0,1,4
...
/*      ANA:POL:POL_STATE */
#define ANA_POL_STATE(g)          TARGET_ANA,0,1,16384,g,256,32,20,0,1,4
...
#define ANA_POL_FLOWC(r)          TARGET_ANA,0,1,29460,0,1,116,0,r,27,4
...
#define ANA_POL_HYST              TARGET_ANA,0,1,29460,0,1,116,108,0,1,4
...
#define ANA_POL_MISC_CFG          TARGET_ANA,0,1,29460,0,1,116,112,0,1,4
...
#define QSYS_PORT_MODE(r)         TARGET_QSYS,0,1,28008,0,1,168,0,r,10,4
...
#define QSYS_SW_PORT_MODE(r)      TARGET_QSYS,0,1,28008,0,1,168,40,r,9,4
...
#define QSYS_STAT_CFG             TARGET_QSYS,0,1,28008,0,1,168,76,0,1,4
...
/*      QSYS:SYSTEM:EEE_CFG */
#define QSYS_EEE_CFG(r)           TARGET_QSYS,0,1,28008,0,1,168,80,r,8,4
...
#define QSYS_EEE_THRES            TARGET_QSYS,0,1,28008,0,1,168,112,0,1,4
...
#define QSYS_IGR_NO_SHARING       TARGET_QSYS,0,1,28008,0,1,168,116,0,1,4
...
#define QSYS_EGR_NO_SHARING       TARGET_QSYS,0,1,28008,0,1,168,120,0,1,4
...
#define QSYS_SW_STATUS(r)         TARGET_QSYS,0,1,28008,0,1,168,124,r,9,4
...
#define QSYS_EXT_CPU_CFG          TARGET_QSYS,0,1,28008,0,1,168,160,0,1,4
...
#define QSYS_CPU_GROUP_MAP        TARGET_QSYS,0,1,28008,0,1,168,164,0,1,4
...
/*      QSYS:QMAP:QMAP */
#define QSYS_QMAP(g)              TARGET_QSYS,0,1,28176,g,10,4,0,0,1,4
...
#define QSYS_RED_PROFILE(r)       TARGET_QSYS,0,1,28216,0,1,68,0,r,16,4
...
#define QSYS_RES_QOS_MODE         TARGET_QSYS,0,1,28216,0,1,68,64,0,1,4
...
#define QSYS_EGR_DROP_MODE        TARGET_QSYS,0,1,28284,0,1,4,0,0,1,4
...
/*      QSYS:MMGT:EQ_CTRL */
#define QSYS_EQ_CTRL              TARGET_QSYS,0,1,28288,0,1,4,0,0,1,4
...
#define QSYS_EVENTS_CORE          TARGET_QSYS,0,1,28292,0,1,4,0,0,1,4
...
#define QSYS_QMAXSDU_CFG_0(r)     TARGET_QSYS,0,1,28296,0,1,288,0,r,9,4
...
#define QSYS_QMAXSDU_CFG_1(r)     TARGET_QSYS,0,1,28296,0,1,288,36,r,9,4
...
#define QSYS_QMAXSDU_CFG_2(r)     TARGET_QSYS,0,1,28296,0,1,288,72,r,9,4
...
#define QSYS_QMAXSDU_CFG_3(r)     TARGET_QSYS,0,1,28296,0,1,288,108,r,9,4
...
#define QSYS_QMAXSDU_CFG_4(r)     TARGET_QSYS,0,1,28296,0,1,288,144,r,9,4
...
#define QSYS_QMAXSDU_CFG_5(r)     TARGET_QSYS,0,1,28296,0,1,288,180,r,9,4
...
#define QSYS_QMAXSDU_CFG_6(r)     TARGET_QSYS,0,1,28296,0,1,288,216,r,9,4
...
#define QSYS_QMAXSDU_CFG_7(r)     TARGET_QSYS,0,1,28296,0,1,288,252,r,9,4
...
#define QSYS_PREEMPT_CFG(r)       TARGET_QSYS,0,1,28584,0,1,32,0,r,8,4
...
#define QSYS_STORMLIM_BURST       TARGET_QSYS,0,1,28616,0,1,28,0,0,1,4
...
#define QSYS_STORMLIM_CFG(r)      TARGET_QSYS,0,1,28616,0,1,28,4,r,3,4
...
#define QSYS_STORMLIM_STAT(r)     TARGET_QSYS,0,1,28616,0,1,28,16,r,3,4
...
#define QSYS_HSCH_MISC_CFG        TARGET_QSYS,0,1,28644,0,1,4,0,0,1,4
...
#define QSYS_TAS_CFG_CTRL         TARGET_QSYS,0,1,28648,0,1,12,0,0,1,4
...
#define QSYS_TAS_GS_CTRL          TARGET_QSYS,0,1,28648,0,1,12,4,0,1,4
...
#define QSYS_TAS_STM_CFG          TARGET_QSYS,0,1,28648,0,1,12,8,0,1,4
...
#define QSYS_FRER_CFG             TARGET_QSYS,0,1,28660,0,1,4,0,0,1,4
...
#define VCAP_TCAM_CFG(t)          TARGET_VCAP,t,3,964,0,1,116,0,0,1,4
...
#define VCAP_TCAM_CTRL(t)         TARGET_VCAP,t,3,964,0,1,116,4,0,1,4
...
#define VCAP_BIST_CTRL(t)         TARGET_VCAP,t,3,964,0,1,116,8,0,1,4
...
#define VCAP_BIST_CFG(t)          TARGET_VCAP,t,3,964,0,1,116,12,0,1,4
...
#define VCAP_BIST_STAT(t)         TARGET_VCAP,t,3,964,0,1,116,16,0,1,4
...
#define VCAP_BIST_FAIL_STAT(t,r)  TARGET_VCAP,t,3,964,0,1,116,20,r,16,4

/*      VCAP:TCAM_BIST:BIST_DIAG_CTRL */
#define VCAP_BIST_DIAG_CTRL(t)    TARGET_VCAP,t,3,964,0,1,116,84,0,1,4
...
#define VCAP_BIST_DIAG_STAT(t)    TARGET_VCAP,t,3,964,0,1,116,88,0,1,4

#define VCAP_BIST_DIAG_STAT_BIST_DIAG_FAIL_SEQ(x) (((x) << 18) & GENMASK(25, 18))
#define VCAP_BIST_DIAG_STAT_BIST_DIAG_FAIL_SEQ_M GENMASK(25, 18)
#define VCAP_BIST_DIAG_STAT_BIST_DIAG_FAIL_SEQ_X(x) (((x) & GENMASK(25, 18)) >> 18)

#define VCAP_BIST_DIAG_STAT_BIST_DIAG_FAIL_ADDR(x) (((x) << 10) & GENMASK(17, 10))
#define VCAP_BIST_DIAG_STAT_BIST_DIAG_FAIL_ADDR_M GENMASK(17, 10)
#define VCAP_BIST_DIAG_STAT_BIST_DIAG_FAIL_ADDR_X(x) (((x) & GENMASK(17, 10)) >> 10)
...
#define VCAP_BIST_DIAG_STAT_BIST_DIAG_HITA_FAIL_X(x) (((x) & GENMASK(9, 9)) >> 9)
...
#define VCAP_BIST_DIAG_STAT_BIST_DIAG_HITB_FAIL_X(x) (((x) & GENMASK(8, 8)) >> 8)
...
#define VCAP_BIST_DIAG_STAT_BIST_DIAG_VBITA_FAIL_X(x) (((x) & GENMASK(7, 7)) >> 7)
...
#define VCAP_BIST_DIAG_STAT_BIST_DIAG_VBITB_FAIL_X(x) (((x) & GENMASK(6, 6)) >> 6)
...
#define VCAP_BIST_DIAG_STAT_BIST_DIAG_MASKA_FAIL_X(x) (((x) & GENMASK(5, 5)) >> 5)
...
#define VCAP_BIST_DIAG_STAT_BIST_DIAG_MASKB_FAIL_X(x) (((x) & GENMASK(4, 4)) >> 4)
...
#define VCAP_BIST_DIAG_STAT_BIST_DIAG_DATAA_FAIL_X(x) (((x) & GENMASK(3, 3)) >> 3)
...
#define VCAP_BIST_DIAG_STAT_BIST_DIAG_DATAB_FAIL_X(x) (((x) & GENMASK(2, 2)) >> 2)
...
#define VCAP_BIST_DIAG_BITMAPA_STAT(t,r) TARGET_VCAP,t,3,964,0,1,116,92,r,2,4

/*      VCAP:TCAM_BIST:BIST_DIAG_BITMAPB_STAT */
#define VCAP_BIST_DIAG_BITMAPB_STAT(t,r) TARGET_VCAP,t,3,964,0,1,116,100,r,2,4

/*      VCAP:TCAM_BIST:RCR_CTRL */
#define VCAP_RCR_CTRL(t)          TARGET_VCAP,t,3,964,0,1,116,108,0,1,4
...
#define VCAP_RCR_STAT(t)          TARGET_VCAP,t,3,964,0,1,116,112,0,1,4
...
#define VCAP_ECC_CTRL(t)          TARGET_VCAP,t,3,1080,0,1,16,0,0,1,4
...
#define VCAP_ECC_STAT(t)          TARGET_VCAP,t,3,1080,0,1,16,4,0,1,4
...
#define VCAP_ECC_BLK_DLY(t)       TARGET_VCAP,t,3,1080,0,1,16,8,0,1,4

/*      VCAP:ECC_CHK:ECC_INV */
#define VCAP_ECC_INV(t)           TARGET_VCAP,t,3,1080,0,1,16,12,0,1,4
...
#define VCAP_MEMITGR_CTRL(t)      TARGET_VCAP,t,3,1096,0,1,24,0,0,1,4
...
#define VCAP_MEMITGR_STAT(t)      TARGET_VCAP,t,3,1096,0,1,24,4,0,1,4
...
#define VCAP_MEMITGR_INFO(t)      TARGET_VCAP,t,3,1096,0,1,24,8,0,1,4
...
#define VCAP_MEMITGR_IDX(t)       TARGET_VCAP,t,3,1096,0,1,24,12,0,1,4
...
#define VCAP_MEMITGR_DIV(t)       TARGET_VCAP,t,3,1096,0,1,24,16,0,1,4
...
#define VCAP_MEMITGR_DBG(t)       TARGET_VCAP,t,3,1096,0,1,24,20,0,1,4
