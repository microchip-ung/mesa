 ...
 * Commit ID: da78768d66af19ee2d8599d936de4a1ccba8a419
 */
...
/*      ANA:ANA:ANAGEFIL */
#define ANA_ANAGEFIL              TARGET_ANA,0,1,26880,0,1,204,8,0,1,4
...
/*      ANA:ANA:ANEVENTS */
#define ANA_ANEVENTS              TARGET_ANA,0,1,26880,0,1,204,12,0,1,4

#define ANA_ANEVENTS_FLOOD_DISCARD(x)            (((x) << 29) & GENMASK(29, 29))
#define ANA_ANEVENTS_FLOOD_DISCARD_M             GENMASK(29, 29)
#define ANA_ANEVENTS_FLOOD_DISCARD_X(x)          (((x) & GENMASK(29, 29)) >> 29)

#define ANA_ANEVENTS_MSTI_DROP(x)                (((x) << 28) & GENMASK(28, 28))
#define ANA_ANEVENTS_MSTI_DROP_M                 GENMASK(28, 28)
#define ANA_ANEVENTS_MSTI_DROP_X(x)              (((x) & GENMASK(28, 28)) >> 28)

#define ANA_ANEVENTS_ACLKILL(x)                  (((x) << 27) & GENMASK(27, 27))
#define ANA_ANEVENTS_ACLKILL_M                   GENMASK(27, 27)
#define ANA_ANEVENTS_ACLKILL_X(x)                (((x) & GENMASK(27, 27)) >> 27)

#define ANA_ANEVENTS_ACLUSED(x)                  (((x) << 26) & GENMASK(26, 26))
#define ANA_ANEVENTS_ACLUSED_M                   GENMASK(26, 26)
#define ANA_ANEVENTS_ACLUSED_X(x)                (((x) & GENMASK(26, 26)) >> 26)

#define ANA_ANEVENTS_AUTOAGE(x)                  (((x) << 25) & GENMASK(25, 25))
#define ANA_ANEVENTS_AUTOAGE_M                   GENMASK(25, 25)
#define ANA_ANEVENTS_AUTOAGE_X(x)                (((x) & GENMASK(25, 25)) >> 25)

#define ANA_ANEVENTS_VS2TTL1(x)                  (((x) << 24) & GENMASK(24, 24))
#define ANA_ANEVENTS_VS2TTL1_M                   GENMASK(24, 24)
#define ANA_ANEVENTS_VS2TTL1_X(x)                (((x) & GENMASK(24, 24)) >> 24)
...
#define ANA_ISOLATED_PORTS        TARGET_ANA,0,1,26880,0,1,204,16,0,1,4
...
#define ANA_COMMUNITY_PORTS       TARGET_ANA,0,1,26880,0,1,204,20,0,1,4
...
/*      ANA:ANA:MACTOPTIONS */
#define ANA_MACTOPTIONS           TARGET_ANA,0,1,26880,0,1,204,28,0,1,4
...
/*      ANA:ANA:LEARNDISC */
#define ANA_LEARNDISC             TARGET_ANA,0,1,26880,0,1,204,32,0,1,4
...
/*      ANA:ANA:MIRRORPORTS */
#define ANA_MIRRORPORTS           TARGET_ANA,0,1,26880,0,1,204,40,0,1,4
...
#define ANA_EMIRRORPORTS          TARGET_ANA,0,1,26880,0,1,204,44,0,1,4
...
/*      ANA:ANA:STORM_CFG */
#define ANA_STORM_CFG             TARGET_ANA,0,1,26880,0,1,204,84,0,1,4
...
/*      ANA:ANA:SFLOW_CFG */
#define ANA_SFLOW_CFG(r)          TARGET_ANA,0,1,26880,0,1,204,88,r,9,4
...
/*      ANA:ANA:PORT_MODE */
#define ANA_PORT_MODE(r)          TARGET_ANA,0,1,26880,0,1,204,124,r,10,4
...
#define ANA_CUT_THRU_CFG(r)       TARGET_ANA,0,1,26880,0,1,204,164,r,9,4
...
/*      ANA:ANA:TEST_UTIL */
#define ANA_TEST_UTIL             TARGET_ANA,0,1,26880,0,1,204,200,0,1,4
...
#define ANA_ANMOVED               TARGET_ANA,0,1,23680,0,1,128,36,0,1,4
...
/*      ANA:ANA_TABLES:STREAMDATA */
#define ANA_STREAMDATA            TARGET_ANA,0,1,23680,0,1,128,48,0,1,4

#define ANA_STREAMDATA_SSID_VALID(x)             (((x) << 7) & GENMASK(7, 7))
#define ANA_STREAMDATA_SSID_VALID_M              GENMASK(7, 7)
#define ANA_STREAMDATA_SSID_VALID_X(x)           (((x) & GENMASK(7, 7)) >> 7)

#define ANA_STREAMDATA_SSID(x)                   ((x) & GENMASK(6, 0))
#define ANA_STREAMDATA_SSID_M                    GENMASK(6, 0)
#define ANA_STREAMDATA_SSID_X(x)                 ((x) & GENMASK(6, 0))
...
#define ANA_ENTRYLIM(r)           TARGET_ANA,0,1,23680,0,1,128,0,r,9,4
...
#define ANA_STREAMACCESS          TARGET_ANA,0,1,23680,0,1,128,68,0,1,4
...
#define ANA_STREAMTIDX            TARGET_ANA,0,1,23680,0,1,128,72,0,1,4
...
#define ANA_STREAMTIDX_S_INDEX(x)                (((x) << 16) & GENMASK(22, 16))
#define ANA_STREAMTIDX_S_INDEX_M                 GENMASK(22, 16)
#define ANA_STREAMTIDX_S_INDEX_X(x)              (((x) & GENMASK(22, 16)) >> 16)
...
#define ANA_SEQ_MASK              TARGET_ANA,0,1,23680,0,1,128,76,0,1,4
...
#define ANA_SFIDACCESS            TARGET_ANA,0,1,23680,0,1,128,80,0,1,4
...
#define ANA_SFIDTIDX              TARGET_ANA,0,1,23680,0,1,128,84,0,1,4

#define ANA_SFIDTIDX_POL_ENA(x)                  (((x) << 16) & GENMASK(16, 16))
#define ANA_SFIDTIDX_POL_ENA_M                   GENMASK(16, 16)
#define ANA_SFIDTIDX_POL_ENA_X(x)                (((x) & GENMASK(16, 16)) >> 16)

#define ANA_SFIDTIDX_POL_IDX(x)                  (((x) << 8) & GENMASK(15, 8))
#define ANA_SFIDTIDX_POL_IDX_M                   GENMASK(15, 8)
#define ANA_SFIDTIDX_POL_IDX_X(x)                (((x) & GENMASK(15, 8)) >> 8)
...
#define ANA_MSTI_STATE(r)         TARGET_ANA,0,1,27136,0,1,512,0,r,128,4
...
#define ANA_SG_ACCESS_CTRL        TARGET_ANA,0,1,23600,0,1,4,0,0,1,4
...
#define ANA_SG_CFG_1              TARGET_ANA,0,1,23808,0,1,128,48,0,1,4

/*      ANA:SG_CONFIG:SG_CFG_2 */
#define ANA_SG_CFG_2              TARGET_ANA,0,1,23808,0,1,128,52,0,1,4

/*      ANA:SG_CONFIG:SG_CFG_3 */
#define ANA_SG_CFG_3              TARGET_ANA,0,1,23808,0,1,128,56,0,1,4
...
#define ANA_SG_CFG_4              TARGET_ANA,0,1,23808,0,1,128,60,0,1,4

/*      ANA:SG_CONFIG:SG_CFG_5 */
#define ANA_SG_CFG_5              TARGET_ANA,0,1,23808,0,1,128,64,0,1,4

/*      ANA:SG_CONFIG:SG_GCL_GS_CFG */
#define ANA_SG_GCL_GS_CFG(r)      TARGET_ANA,0,1,23808,0,1,128,0,r,4,4
...
#define ANA_SG_GCL_TI_CFG(r)      TARGET_ANA,0,1,23808,0,1,128,16,r,4,4

/*      ANA:SG_CONFIG:SG_GCL_OCT_CFG */
#define ANA_SG_GCL_OCT_CFG(r)     TARGET_ANA,0,1,23808,0,1,128,32,r,4,4

/*      ANA:SG_STATUS:SG_STS_1 */
#define ANA_SG_STS_1              TARGET_ANA,0,1,23584,0,1,16,0,0,1,4

/*      ANA:SG_STATUS:SG_STS_2 */
#define ANA_SG_STS_2              TARGET_ANA,0,1,23584,0,1,16,4,0,1,4

/*      ANA:SG_STATUS:SG_STS_3 */
#define ANA_SG_STS_3              TARGET_ANA,0,1,23584,0,1,16,8,0,1,4
...
#define ANA_SG_STS_4              TARGET_ANA,0,1,23584,0,1,16,12,0,1,4
...
#define ANA_CPU_FWD_GARP_CFG(g)   TARGET_ANA,0,1,24576,g,9,256,104,0,1,4
...
#define ANA_CPU_FWD_CCM_CFG(g)    TARGET_ANA,0,1,24576,g,9,256,108,0,1,4
...
/*      ANA:PORT:PTP_CFG */
#define ANA_PTP_CFG(g)            TARGET_ANA,0,1,24576,g,9,256,120,0,1,4
...
/*      ANA:PORT:LLCT_CFG */
#define ANA_LLCT_CFG(g)           TARGET_ANA,0,1,24576,g,9,256,124,0,1,4
...
/*      ANA:PFC:PFC_TIMER */
#define ANA_PFC_TIMER(g,r)        TARGET_ANA,0,1,27648,g,8,64,4,r,8,4
...
/*      ANA:COMMON:AGGR_CFG */
#define ANA_AGGR_CFG              TARGET_ANA,0,1,28160,0,1,520,0,0,1,4
...
/*      ANA:COMMON:CPUQ_CFG */
#define ANA_CPUQ_CFG              TARGET_ANA,0,1,28160,0,1,520,4,0,1,4
...
#define ANA_CPUQ_CFG2             TARGET_ANA,0,1,28160,0,1,520,8,0,1,4
...
#define ANA_CPUQ_8021_CFG(r)      TARGET_ANA,0,1,28160,0,1,520,12,r,16,4
...
/*      ANA:COMMON:DSCP_CFG */
#define ANA_DSCP_CFG(r)           TARGET_ANA,0,1,28160,0,1,520,76,r,64,4
...
#define ANA_DSCP_REWR_CFG(r)      TARGET_ANA,0,1,28160,0,1,520,332,r,16,4
...
#define ANA_VCAP_RNG_CFG(r)       TARGET_ANA,0,1,28160,0,1,520,396,r,8,4
...
#define ANA_VCAP_RNG_VAL_CFG(r)   TARGET_ANA,0,1,28160,0,1,520,428,r,8,4
...
/*      ANA:COMMON:VRAP_CFG */
#define ANA_VRAP_CFG              TARGET_ANA,0,1,28160,0,1,520,460,0,1,4
...
#define ANA_VRAP_HDR_DATA         TARGET_ANA,0,1,28160,0,1,520,464,0,1,4

/*      ANA:COMMON:VRAP_HDR_MASK */
#define ANA_VRAP_HDR_MASK         TARGET_ANA,0,1,28160,0,1,520,468,0,1,4

/*      ANA:COMMON:DISCARD_CFG */
#define ANA_DISCARD_CFG           TARGET_ANA,0,1,28160,0,1,520,472,0,1,4
...
/*      ANA:COMMON:FID_CFG */
#define ANA_FID_CFG               TARGET_ANA,0,1,28160,0,1,520,476,0,1,4
...
#define ANA_VLAN_ETYPE_CFG        TARGET_ANA,0,1,28160,0,1,520,480,0,1,4
...
/*      ANA:COMMON:RT_VLANS */
#define ANA_RT_VLANS(r)           TARGET_ANA,0,1,28160,0,1,520,484,r,8,4

#define ANA_RT_VLANS_VLAN_ID(x)                  (((x) << 1) & GENMASK(12, 1))
#define ANA_RT_VLANS_VLAN_ID_M                   GENMASK(12, 1)
#define ANA_RT_VLANS_VLAN_ID_X(x)                (((x) & GENMASK(12, 1)) >> 1)

#define ANA_RT_VLANS_ENA(x)                      ((x) & GENMASK(0, 0))
#define ANA_RT_VLANS_ENA_M                       GENMASK(0, 0)
#define ANA_RT_VLANS_ENA_X(x)                    ((x) & GENMASK(0, 0))

/*      ANA:COMMON:RT_CUSTOM */
#define ANA_RT_CUSTOM             TARGET_ANA,0,1,28160,0,1,520,516,0,1,4
...
/*      ANA:POL:POL_MODE */
#define ANA_POL_MODE(g)           TARGET_ANA,0,1,16384,g,225,32,8,0,1,4
...
#define DEV_PORT_MISC_FWD_ERROR_ENA(x)           (((x) << 6) & GENMASK(6, 6))
#define DEV_PORT_MISC_FWD_ERROR_ENA_M            GENMASK(6, 6)
#define DEV_PORT_MISC_FWD_ERROR_ENA_X(x)         (((x) & GENMASK(6, 6)) >> 6)

#define DEV_PORT_MISC_FWD_PAUSE_ENA(x)           (((x) << 5) & GENMASK(5, 5))
#define DEV_PORT_MISC_FWD_PAUSE_ENA_M            GENMASK(5, 5)
#define DEV_PORT_MISC_FWD_PAUSE_ENA_X(x)         (((x) & GENMASK(5, 5)) >> 5)

#define DEV_PORT_MISC_FWD_CTRL_ENA(x)            (((x) << 4) & GENMASK(4, 4))
#define DEV_PORT_MISC_FWD_CTRL_ENA_M             GENMASK(4, 4)
#define DEV_PORT_MISC_FWD_CTRL_ENA_X(x)          (((x) & GENMASK(4, 4)) >> 4)

#define DEV_PORT_MISC_DEV_LOOP_ENA(x)            (((x) << 3) & GENMASK(3, 3))
#define DEV_PORT_MISC_DEV_LOOP_ENA_M             GENMASK(3, 3)
#define DEV_PORT_MISC_DEV_LOOP_ENA_X(x)          (((x) & GENMASK(3, 3)) >> 3)
...
/*      MEP:COMMON:CPU_CFG */
#define MEP_CPU_CFG               TARGET_MEP,0,1,4352,0,1,160,4,0,1,4
...
#define MEP_CPU_CFG_1             TARGET_MEP,0,1,4352,0,1,160,8,0,1,4
...
#define MEP_MRP_CPU_CFG           TARGET_MEP,0,1,4352,0,1,160,12,0,1,4
...
#define MEP_DLR_CPU_CFG           TARGET_MEP,0,1,4352,0,1,160,16,0,1,4
...
#define MEP_GENERIC_CFG(r)        TARGET_MEP,0,1,4352,0,1,160,20,r,8,4
...
/*      MEP:COMMON:LOC_CTRL */
#define MEP_LOC_CTRL              TARGET_MEP,0,1,4352,0,1,160,92,0,1,4
...
#define MEP_LOC_SCAN_STICKY       TARGET_MEP,0,1,4352,0,1,160,96,0,1,4
...
#define MEP_MASTER_INTR_CTRL      TARGET_MEP,0,1,4352,0,1,160,100,0,1,4
...
/*      MEP:COMMON:INTR */
#define MEP_INTR                  TARGET_MEP,0,1,4352,0,1,160,104,0,1,4
...
#define MEP_VOE_CNT_CTRL(r)       TARGET_MEP,0,1,4352,0,1,160,108,r,8,4
...
#define MEP_MC_MAC_LSB            TARGET_MEP,0,1,4352,0,1,160,140,0,1,4
...
#define MEP_MC_MAC_MSB            TARGET_MEP,0,1,4352,0,1,160,144,0,1,4
...
/*      MEP:COMMON:TICK_CFG */
#define MEP_TICK_CFG              TARGET_MEP,0,1,4352,0,1,160,148,0,1,4
...
#define MEP_MRP_RX_TS_CFG         TARGET_MEP,0,1,4352,0,1,160,152,0,1,4

/*      MEP:COMMON:DBG_STICKY */
#define MEP_DBG_STICKY            TARGET_MEP,0,1,4352,0,1,160,156,0,1,4
...
/*      MEP:VOE:BASIC_CTRL */
#define MEP_BASIC_CTRL(g)         TARGET_MEP,0,1,0,g,8,256,0,0,1,4
...
/*      MEP:VOE:MEL_CTRL */
#define MEP_MEL_CTRL(g)           TARGET_MEP,0,1,0,g,8,256,4,0,1,4
...
#define MEP_CPU_COPY_CTRL(g)      TARGET_MEP,0,1,0,g,8,256,8,0,1,4
...
/*      MEP:VOE:FWD_CTRL */
#define MEP_FWD_CTRL(g)           TARGET_MEP,0,1,0,g,8,256,12,0,1,4
...
#define MEP_CNT_OAM_CTRL(g)       TARGET_MEP,0,1,0,g,8,256,16,0,1,4
...
#define MEP_CNT_DATA_CTRL(g)      TARGET_MEP,0,1,0,g,8,256,20,0,1,4
...
/*      MEP:VOE:UC_MAC_LSB */
#define MEP_UC_MAC_LSB(g)         TARGET_MEP,0,1,0,g,8,256,24,0,1,4

/*      MEP:VOE:UC_MAC_MSB */
#define MEP_UC_MAC_MSB(g)         TARGET_MEP,0,1,0,g,8,256,28,0,1,4
...
/*      MEP:VOE:LBR_RX_FRM_CNT */
#define MEP_LBR_RX_FRM_CNT(g)     TARGET_MEP,0,1,0,g,8,256,36,0,1,4

/*      MEP:VOE:LBR_RX_TID_CFG */
#define MEP_LBR_RX_TID_CFG(g)     TARGET_MEP,0,1,0,g,8,256,40,0,1,4

/*      MEP:VOE:LBM_TX_TID_UPD */
#define MEP_LBM_TX_TID_UPD(g)     TARGET_MEP,0,1,0,g,8,256,44,0,1,4

#define MEP_LBM_TX_TID_UPD_UPDATE_ENA(x)         ((x) & GENMASK(0, 0))
#define MEP_LBM_TX_TID_UPD_UPDATE_ENA_M          GENMASK(0, 0)
#define MEP_LBM_TX_TID_UPD_UPDATE_ENA_X(x)       ((x) & GENMASK(0, 0))

/*      MEP:VOE:LBM_TX_TID_CFG */
#define MEP_LBM_TX_TID_CFG(g)     TARGET_MEP,0,1,0,g,8,256,48,0,1,4
...
#define MEP_CCM_RX_VL_FC_CNT(g)   TARGET_MEP,0,1,0,g,8,256,56,0,1,4

/*      MEP:VOE:CCM_RX_IV_FC_CNT */
#define MEP_CCM_RX_IV_FC_CNT(g)   TARGET_MEP,0,1,0,g,8,256,60,0,1,4

/*      MEP:VOE:CCM_TX_SEQ_CFG */
#define MEP_CCM_TX_SEQ_CFG(g)     TARGET_MEP,0,1,0,g,8,256,64,0,1,4

/*      MEP:VOE:CCM_RX_SEQ_CFG */
#define MEP_CCM_RX_SEQ_CFG(g)     TARGET_MEP,0,1,0,g,8,256,68,0,1,4

/*      MEP:VOE:CCM_MEPID_CFG */
#define MEP_CCM_MEPID_CFG(g)      TARGET_MEP,0,1,0,g,8,256,72,0,1,4
...
#define MEP_CCM_MEGID_CFG(g,r)    TARGET_MEP,0,1,0,g,8,256,76,r,12,4

/*      MEP:VOE:RX_STICKY */
#define MEP_RX_STICKY(g)          TARGET_MEP,0,1,0,g,8,256,124,0,1,4

#define MEP_RX_STICKY_GENERIC_RX_MASK(x)         (((x) << 12) & GENMASK(19, 12))
#define MEP_RX_STICKY_GENERIC_RX_MASK_M          GENMASK(19, 12)
#define MEP_RX_STICKY_GENERIC_RX_MASK_X(x)       (((x) & GENMASK(19, 12)) >> 12)

#define MEP_RX_STICKY_UNK_OPCODE_RX_STICKY(x)    (((x) << 11) & GENMASK(11, 11))
#define MEP_RX_STICKY_UNK_OPCODE_RX_STICKY_M     GENMASK(11, 11)
#define MEP_RX_STICKY_UNK_OPCODE_RX_STICKY_X(x)  (((x) & GENMASK(11, 11)) >> 11)

#define MEP_RX_STICKY_LTM_RX_STICKY(x)           (((x) << 10) & GENMASK(10, 10))
#define MEP_RX_STICKY_LTM_RX_STICKY_M            GENMASK(10, 10)
#define MEP_RX_STICKY_LTM_RX_STICKY_X(x)         (((x) & GENMASK(10, 10)) >> 10)

#define MEP_RX_STICKY_LTR_RX_STICKY(x)           (((x) << 9) & GENMASK(9, 9))
#define MEP_RX_STICKY_LTR_RX_STICKY_M            GENMASK(9, 9)
#define MEP_RX_STICKY_LTR_RX_STICKY_X(x)         (((x) & GENMASK(9, 9)) >> 9)

#define MEP_RX_STICKY_LBM_RX_STICKY(x)           (((x) << 8) & GENMASK(8, 8))
#define MEP_RX_STICKY_LBM_RX_STICKY_M            GENMASK(8, 8)
#define MEP_RX_STICKY_LBM_RX_STICKY_X(x)         (((x) & GENMASK(8, 8)) >> 8)

#define MEP_RX_STICKY_LBR_RX_STICKY(x)           (((x) << 7) & GENMASK(7, 7))
#define MEP_RX_STICKY_LBR_RX_STICKY_M            GENMASK(7, 7)
#define MEP_RX_STICKY_LBR_RX_STICKY_X(x)         (((x) & GENMASK(7, 7)) >> 7)

#define MEP_RX_STICKY_CCM_RX_STICKY(x)           (((x) << 6) & GENMASK(6, 6))
#define MEP_RX_STICKY_CCM_RX_STICKY_M            GENMASK(6, 6)
#define MEP_RX_STICKY_CCM_RX_STICKY_X(x)         (((x) & GENMASK(6, 6)) >> 6)

#define MEP_RX_STICKY_CCM_LM_RX_STICKY(x)        (((x) << 5) & GENMASK(5, 5))
#define MEP_RX_STICKY_CCM_LM_RX_STICKY_M         GENMASK(5, 5)
#define MEP_RX_STICKY_CCM_LM_RX_STICKY_X(x)      (((x) & GENMASK(5, 5)) >> 5)

#define MEP_RX_STICKY_LBR_TID_ERR(x)             (((x) << 4) & GENMASK(4, 4))
#define MEP_RX_STICKY_LBR_TID_ERR_M              GENMASK(4, 4)
#define MEP_RX_STICKY_LBR_TID_ERR_X(x)           (((x) & GENMASK(4, 4)) >> 4)
...
/*      MEP:VOE:INTR_ENA */
#define MEP_INTR_ENA(g)           TARGET_MEP,0,1,0,g,8,256,132,0,1,4
...
/*      MEP:VOE:RX_SEL_CNT */
#define MEP_RX_SEL_CNT(g)         TARGET_MEP,0,1,0,g,8,256,136,0,1,4

/*      MEP:VOE:RX_FRM_CNT */
#define MEP_RX_FRM_CNT(g)         TARGET_MEP,0,1,0,g,8,256,140,0,1,4

/*      MEP:VOE:TX_SEL_CNT */
#define MEP_TX_SEL_CNT(g)         TARGET_MEP,0,1,0,g,8,256,144,0,1,4

/*      MEP:VOE:TX_FRM_CNT */
#define MEP_TX_FRM_CNT(g)         TARGET_MEP,0,1,0,g,8,256,148,0,1,4

/*      MEP:PORT_PM:PORT_RX_FRM_CNT */
#define MEP_PORT_RX_FRM_CNT(g)    TARGET_MEP,0,1,4096,g,64,4,0,0,1,4
...
#define MEP_MRP_RX_SEQ_CFG(g)     TARGET_MEP,0,1,2048,g,8,128,36,0,1,4
...
/*      MEP:MRP:TST_RX_CNT */
#define MEP_TST_RX_CNT(g)         TARGET_MEP,0,1,2048,g,8,128,56,0,1,4

/*      MEP:MRP:TST_RX_LOC_CNT */
#define MEP_TST_RX_LOC_CNT(g)     TARGET_MEP,0,1,2048,g,8,128,60,0,1,4

/*      MEP:MRP:ITST_RX_CNT */
#define MEP_ITST_RX_CNT(g)        TARGET_MEP,0,1,2048,g,8,128,64,0,1,4

/*      MEP:MRP:ITST_RX_LOC_CNT */
#define MEP_ITST_RX_LOC_CNT(g)    TARGET_MEP,0,1,2048,g,8,128,68,0,1,4

/*      MEP:MRP:TST_DELTA_TS */
#define MEP_TST_DELTA_TS(g)       TARGET_MEP,0,1,2048,g,8,128,72,0,1,4

/*      MEP:MRP:ITST_DELTA_TS */
#define MEP_ITST_DELTA_TS(g)      TARGET_MEP,0,1,2048,g,8,128,76,0,1,4

/*      MEP:MRP:TST_RX_TS */
#define MEP_TST_RX_TS(g)          TARGET_MEP,0,1,2048,g,8,128,80,0,1,4

/*      MEP:MRP:TST_TX_TS */
#define MEP_TST_TX_TS(g)          TARGET_MEP,0,1,2048,g,8,128,84,0,1,4

/*      MEP:MRP:ITST_RX_TS */
#define MEP_ITST_RX_TS(g)         TARGET_MEP,0,1,2048,g,8,128,88,0,1,4

/*      MEP:MRP:ITST_TX_TS */
#define MEP_ITST_TX_TS(g)         TARGET_MEP,0,1,2048,g,8,128,92,0,1,4
...
#define MEP_MRP_INTR_ENA(g)       TARGET_MEP,0,1,2048,g,8,128,100,0,1,4
...
/*      MEP:DLR:DLR_CTRL */
#define MEP_DLR_CTRL(g)           TARGET_MEP,0,1,3072,g,8,128,0,0,1,4
...
#define MEP_DLR_FWD_CTRL(g)       TARGET_MEP,0,1,3072,g,8,128,4,0,1,4
...
#define MEP_DLR_MASK_CFG(g)       TARGET_MEP,0,1,3072,g,8,128,8,0,1,4
...
#define MEP_BCN_FWD_CTRL(g)       TARGET_MEP,0,1,3072,g,8,128,12,0,1,4
...
/*      MEP:DLR:BCN_CFG */
#define MEP_BCN_CFG(g)            TARGET_MEP,0,1,3072,g,8,128,16,0,1,4
...
#define MEP_ADV_FWD_CTRL(g)       TARGET_MEP,0,1,3072,g,8,128,20,0,1,4
...
/*      MEP:DLR:ADV_CFG */
#define MEP_ADV_CFG(g)            TARGET_MEP,0,1,3072,g,8,128,24,0,1,4
...
#define MEP_DLR_RX_SEQ_CFG(g)     TARGET_MEP,0,1,3072,g,8,128,28,0,1,4

/*      MEP:DLR:DLR_PREC_CFG */
#define MEP_DLR_PREC_CFG(g)       TARGET_MEP,0,1,3072,g,8,128,32,0,1,4
...
/*      MEP:DLR:DLR_MAC_LSB */
#define MEP_DLR_MAC_LSB(g)        TARGET_MEP,0,1,3072,g,8,128,36,0,1,4

/*      MEP:DLR:DLR_MAC_MSB */
#define MEP_DLR_MAC_MSB(g)        TARGET_MEP,0,1,3072,g,8,128,40,0,1,4
...
/*      MEP:DLR:GW_MAC_LSB */
#define MEP_GW_MAC_LSB(g)         TARGET_MEP,0,1,3072,g,8,128,44,0,1,4

/*      MEP:DLR:GW_MAC_MSB */
#define MEP_GW_MAC_MSB(g)         TARGET_MEP,0,1,3072,g,8,128,48,0,1,4
...
/*      MEP:DLR:BCN_RX_CNT */
#define MEP_BCN_RX_CNT(g)         TARGET_MEP,0,1,3072,g,8,128,52,0,1,4

/*      MEP:DLR:BCN_RX_LOC_CNT */
#define MEP_BCN_RX_LOC_CNT(g)     TARGET_MEP,0,1,3072,g,8,128,56,0,1,4

/*      MEP:DLR:ADV_RX_CNT */
#define MEP_ADV_RX_CNT(g)         TARGET_MEP,0,1,3072,g,8,128,60,0,1,4

/*      MEP:DLR:ADV_RX_LOC_CNT */
#define MEP_ADV_RX_LOC_CNT(g)     TARGET_MEP,0,1,3072,g,8,128,64,0,1,4

/*      MEP:DLR:DLR_STICKY */
#define MEP_DLR_STICKY(g)         TARGET_MEP,0,1,3072,g,8,128,68,0,1,4
...
#define MEP_DLR_INTR_ENA(g)       TARGET_MEP,0,1,3072,g,8,128,72,0,1,4
...
#define PTP_INTR_IDENT            TARGET_PTP,0,1,320,0,1,16,8,0,1,4

#define PTP_INTR_IDENT_INTR_IDENT(x)             ((x) & GENMASK(4, 0))
#define PTP_INTR_IDENT_INTR_IDENT_M              GENMASK(4, 0)
#define PTP_INTR_IDENT_INTR_IDENT_X(x)           ((x) & GENMASK(4, 0))
...
#define PTP_CUR_NSEC(g)           TARGET_PTP,0,1,336,g,3,28,8,0,1,4
...
#define PTP_CUR_NSEC_FRAC(g)      TARGET_PTP,0,1,336,g,3,28,12,0,1,4
...
#define PTP_CUR_SEC_LSB(g)        TARGET_PTP,0,1,336,g,3,28,16,0,1,4

/*      PTP:PTP_TOD_DOMAINS:CUR_SEC_MSB */
#define PTP_CUR_SEC_MSB(g)        TARGET_PTP,0,1,336,g,3,28,20,0,1,4
...
#define PTP_NTP_CUR_NSEC(g)       TARGET_PTP,0,1,336,g,3,28,24,0,1,4
...
#define PTP_NTP_NSEC(g)           TARGET_PTP,0,1,0,g,5,64,20,0,1,4
...
#define PTP_PIN_IO_DELAY(g)       TARGET_PTP,0,1,0,g,5,64,32,0,1,4
...
/*      PTP:PTP_TS_FIFO:WRP */
#define PTP_WRP                   TARGET_PTP,0,1,420,0,1,12,8,0,1,4
...
#define PTP_PHAD_CTRL(g)          TARGET_PTP,0,1,432,g,5,8,0,0,1,4

#define PTP_PHAD_CTRL_PHAD_ENA(x)                (((x) << 10) & GENMASK(10, 10))
#define PTP_PHAD_CTRL_PHAD_ENA_M                 GENMASK(10, 10)
#define PTP_PHAD_CTRL_PHAD_ENA_X(x)              (((x) & GENMASK(10, 10)) >> 10)

#define PTP_PHAD_CTRL_PHAD_FAILED(x)             (((x) << 9) & GENMASK(9, 9))
#define PTP_PHAD_CTRL_PHAD_FAILED_M              GENMASK(9, 9)
#define PTP_PHAD_CTRL_PHAD_FAILED_X(x)           (((x) & GENMASK(9, 9)) >> 9)

#define PTP_PHAD_CTRL_REDUCED_RES(x)             (((x) << 6) & GENMASK(8, 6))
#define PTP_PHAD_CTRL_REDUCED_RES_M              GENMASK(8, 6)
#define PTP_PHAD_CTRL_REDUCED_RES_X(x)           (((x) & GENMASK(8, 6)) >> 6)

#define PTP_PHAD_CTRL_LOCK_ACC(x)                (((x) << 3) & GENMASK(5, 3))
#define PTP_PHAD_CTRL_LOCK_ACC_M                 GENMASK(5, 3)
#define PTP_PHAD_CTRL_LOCK_ACC_X(x)              (((x) & GENMASK(5, 3)) >> 3)

#define PTP_PHAD_CTRL_REALIGN_OFS(x)             ((x) & GENMASK(2, 0))
#define PTP_PHAD_CTRL_REALIGN_OFS_M              GENMASK(2, 0)
#define PTP_PHAD_CTRL_REALIGN_OFS_X(x)           ((x) & GENMASK(2, 0))

/*      PTP:PHASE_DETECTOR_CTRL:PHAD_CYC_STAT */
#define PTP_PHAD_CYC_STAT(g)      TARGET_PTP,0,1,432,g,5,8,4,0,1,4
...
#define QSYS_PORT_MODE(r)         TARGET_QSYS,0,1,38912,0,1,168,0,r,10,4
...
#define QSYS_STAT_CFG             TARGET_QSYS,0,1,38912,0,1,168,76,0,1,4
...
/*      QSYS:SYSTEM:EEE_CFG */
#define QSYS_EEE_CFG(r)           TARGET_QSYS,0,1,38912,0,1,168,80,r,8,4
...
#define QSYS_EEE_THRES            TARGET_QSYS,0,1,38912,0,1,168,112,0,1,4
...
#define QSYS_IGR_NO_SHARING       TARGET_QSYS,0,1,38912,0,1,168,116,0,1,4
...
#define QSYS_EXT_CPU_CFG          TARGET_QSYS,0,1,38912,0,1,168,160,0,1,4
...
/*      QSYS:QMAP:QMAP */
#define QSYS_QMAP(g)              TARGET_QSYS,0,1,11624,g,10,4,0,0,1,4
...
#define QSYS_FLOW_QUEUE_GRP       TARGET_QSYS,0,1,11616,0,1,4,0,0,1,4
...
#define QSYS_RED_PROFILE(r)       TARGET_QSYS,0,1,11664,0,1,68,0,r,16,4
...
#define QSYS_RES_QOS_MODE         TARGET_QSYS,0,1,11664,0,1,68,64,0,1,4
...
#define QSYS_RES_CFG(g)           TARGET_QSYS,0,1,16384,g,1024,8,0,0,1,4
...
#define QSYS_RES_STAT(g)          TARGET_QSYS,0,1,16384,g,1024,8,4,0,1,4
...
#define QSYS_EGR_DROP_MODE        TARGET_QSYS,0,1,11732,0,1,4,0,0,1,4
...
/*      QSYS:MMGT:EQ_CTRL */
#define QSYS_EQ_CTRL              TARGET_QSYS,0,1,11736,0,1,4,0,0,1,4
...
#define QSYS_EVENTS_CORE          TARGET_QSYS,0,1,11740,0,1,4,0,0,1,4
...
#define QSYS_STORMLIM_BURST       TARGET_QSYS,0,1,39368,0,1,28,0,0,1,4
...
#define QSYS_STORMLIM_CFG(r)      TARGET_QSYS,0,1,39368,0,1,28,4,r,3,4
...
#define QSYS_STORMLIM_STAT(r)     TARGET_QSYS,0,1,39368,0,1,28,16,r,3,4
...
#define QSYS_FRER_FIRST(g)        TARGET_QSYS,0,1,12288,g,128,32,0,0,1,4

#define QSYS_FRER_FIRST_FRER_FIRST_MEMBER(x)     ((x) & GENMASK(7, 0))
#define QSYS_FRER_FIRST_FRER_FIRST_MEMBER_M      GENMASK(7, 0)
#define QSYS_FRER_FIRST_FRER_FIRST_MEMBER_X(x)   ((x) & GENMASK(7, 0))

/*      QSYS:FRER_MAP:FRER_PORT */
#define QSYS_FRER_PORT(g,r)       TARGET_QSYS,0,1,12288,g,128,32,4,r,4,4

#define QSYS_FRER_PORT_FRER_IGR_PORT(x)          (((x) << 4) & GENMASK(7, 4))
#define QSYS_FRER_PORT_FRER_IGR_PORT_M           GENMASK(7, 4)
#define QSYS_FRER_PORT_FRER_IGR_PORT_X(x)        (((x) & GENMASK(7, 4)) >> 4)
...
#define QSYS_FRER_CFG             TARGET_QSYS,0,1,39412,0,1,4,0,0,1,4

#define QSYS_FRER_CFG_WATCHDOG_PRESCALER(x)      (((x) << 8) & GENMASK(23, 8))
#define QSYS_FRER_CFG_WATCHDOG_PRESCALER_M       GENMASK(23, 8)
#define QSYS_FRER_CFG_WATCHDOG_PRESCALER_X(x)    (((x) & GENMASK(23, 8)) >> 8)

#define QSYS_FRER_CFG_ADDR(x)                    ((x) & GENMASK(7, 0))
#define QSYS_FRER_CFG_ADDR_M                     GENMASK(7, 0)
#define QSYS_FRER_CFG_ADDR_X(x)                  ((x) & GENMASK(7, 0))

/*      QSYS:FRER_CFG_COMPOUND:FRER_CFG_CMP */
#define QSYS_FRER_CFG_CMP(g)      TARGET_QSYS,0,1,11776,g,128,4,0,0,1,4
...
#define QSYS_FRER_CFG_MBM(g)      TARGET_QSYS,0,1,37888,g,256,4,0,0,1,4

#define QSYS_FRER_CFG_MBM_TAKE_NO_SEQUENCE(x)    (((x) << 27) & GENMASK(27, 27))
#define QSYS_FRER_CFG_MBM_TAKE_NO_SEQUENCE_M     GENMASK(27, 27)
#define QSYS_FRER_CFG_MBM_TAKE_NO_SEQUENCE_X(x)  (((x) & GENMASK(27, 27)) >> 27)

#define QSYS_FRER_CFG_MBM_VECTOR_ALGORITHM(x)    (((x) << 26) & GENMASK(26, 26))
#define QSYS_FRER_CFG_MBM_VECTOR_ALGORITHM_M     GENMASK(26, 26)
#define QSYS_FRER_CFG_MBM_VECTOR_ALGORITHM_X(x)  (((x) & GENMASK(26, 26)) >> 26)

#define QSYS_FRER_CFG_MBM_HISTORY_LENGTH(x)      (((x) << 21) & GENMASK(25, 21))
#define QSYS_FRER_CFG_MBM_HISTORY_LENGTH_M       GENMASK(25, 21)
#define QSYS_FRER_CFG_MBM_HISTORY_LENGTH_X(x)    (((x) & GENMASK(25, 21)) >> 21)

#define QSYS_FRER_CFG_MBM_RESET_TICKS(x)         (((x) << 9) & GENMASK(20, 9))
#define QSYS_FRER_CFG_MBM_RESET_TICKS_M          GENMASK(20, 9)
#define QSYS_FRER_CFG_MBM_RESET_TICKS_X(x)       (((x) & GENMASK(20, 9)) >> 9)

#define QSYS_FRER_CFG_MBM_RESET(x)               (((x) << 8) & GENMASK(8, 8))
#define QSYS_FRER_CFG_MBM_RESET_M                GENMASK(8, 8)
#define QSYS_FRER_CFG_MBM_RESET_X(x)             (((x) & GENMASK(8, 8)) >> 8)

#define QSYS_FRER_CFG_MBM_ENABLE(x)              (((x) << 7) & GENMASK(7, 7))
#define QSYS_FRER_CFG_MBM_ENABLE_M               GENMASK(7, 7)
#define QSYS_FRER_CFG_MBM_ENABLE_X(x)            (((x) & GENMASK(7, 7)) >> 7)

#define QSYS_FRER_CFG_MBM_COMPOUND_HANDLE(x)     ((x) & GENMASK(6, 0))
#define QSYS_FRER_CFG_MBM_COMPOUND_HANDLE_M      GENMASK(6, 0)
#define QSYS_FRER_CFG_MBM_COMPOUND_HANDLE_X(x)   ((x) & GENMASK(6, 0))

/*      QSYS:FRER_STA_COMPOUND:FRER_STA_CMP */
#define QSYS_FRER_STA_CMP         TARGET_QSYS,0,1,11600,0,1,8,0,0,1,4
...
#define QSYS_FRER_HST_CMP         TARGET_QSYS,0,1,11600,0,1,8,4,0,1,4

/*      QSYS:FRER_STA_MEMBER:FRER_STA_MBM */
#define QSYS_FRER_STA_MBM         TARGET_QSYS,0,1,11608,0,1,8,0,0,1,4
...
#define QSYS_FRER_HST_MBM         TARGET_QSYS,0,1,11608,0,1,8,4,0,1,4

/*      QSYS:FRER_CNT_COMPOUND:CNT_CMP_RS */
#define QSYS_CNT_CMP_RS(g)        TARGET_QSYS,0,1,32768,g,128,32,0,0,1,4

/*      QSYS:FRER_CNT_COMPOUND:CNT_CMP_TL */
#define QSYS_CNT_CMP_TL(g)        TARGET_QSYS,0,1,32768,g,128,32,4,0,1,4

/*      QSYS:FRER_CNT_COMPOUND:CNT_CMP_PS */
#define QSYS_CNT_CMP_PS(g)        TARGET_QSYS,0,1,32768,g,128,32,8,0,1,4

/*      QSYS:FRER_CNT_COMPOUND:CNT_CMP_DC */
#define QSYS_CNT_CMP_DC(g)        TARGET_QSYS,0,1,32768,g,128,32,12,0,1,4

/*      QSYS:FRER_CNT_COMPOUND:CNT_CMP_OO */
#define QSYS_CNT_CMP_OO(g)        TARGET_QSYS,0,1,32768,g,128,32,16,0,1,4

/*      QSYS:FRER_CNT_COMPOUND:CNT_CMP_RG */
#define QSYS_CNT_CMP_RG(g)        TARGET_QSYS,0,1,32768,g,128,32,20,0,1,4

/*      QSYS:FRER_CNT_COMPOUND:CNT_CMP_LS */
#define QSYS_CNT_CMP_LS(g)        TARGET_QSYS,0,1,32768,g,128,32,24,0,1,4

/*      QSYS:FRER_CNT_MEMBER:CNT_MBM_RS */
#define QSYS_CNT_MBM_RS(g)        TARGET_QSYS,0,1,24576,g,256,32,0,0,1,4

/*      QSYS:FRER_CNT_MEMBER:CNT_MBM_TL */
#define QSYS_CNT_MBM_TL(g)        TARGET_QSYS,0,1,24576,g,256,32,4,0,1,4

/*      QSYS:FRER_CNT_MEMBER:CNT_MBM_PS */
#define QSYS_CNT_MBM_PS(g)        TARGET_QSYS,0,1,24576,g,256,32,8,0,1,4

/*      QSYS:FRER_CNT_MEMBER:CNT_MBM_DC */
#define QSYS_CNT_MBM_DC(g)        TARGET_QSYS,0,1,24576,g,256,32,12,0,1,4

/*      QSYS:FRER_CNT_MEMBER:CNT_MBM_OO */
#define QSYS_CNT_MBM_OO(g)        TARGET_QSYS,0,1,24576,g,256,32,16,0,1,4

/*      QSYS:FRER_CNT_MEMBER:CNT_MBM_RG */
#define QSYS_CNT_MBM_RG(g)        TARGET_QSYS,0,1,24576,g,256,32,20,0,1,4

/*      QSYS:FRER_CNT_MEMBER:CNT_MBM_LS */
#define QSYS_CNT_MBM_LS(g)        TARGET_QSYS,0,1,24576,g,256,32,24,0,1,4
...
#define REW_PTP_MISC_CFG_PTP_UDP6_CSUM_DIS(x)    (((x) << 4) & GENMASK(4, 4))
#define REW_PTP_MISC_CFG_PTP_UDP6_CSUM_DIS_M     GENMASK(4, 4)
#define REW_PTP_MISC_CFG_PTP_UDP6_CSUM_DIS_X(x)  (((x) & GENMASK(4, 4)) >> 4)

#define REW_PTP_MISC_CFG_PTP_UDP4_CSUM_DIS(x)    (((x) << 3) & GENMASK(3, 3))
#define REW_PTP_MISC_CFG_PTP_UDP4_CSUM_DIS_M     GENMASK(3, 3)
#define REW_PTP_MISC_CFG_PTP_UDP4_CSUM_DIS_X(x)  (((x) & GENMASK(3, 3)) >> 3)
...
#define SYS_PTP_EVENTS(g)         TARGET_SYS,0,1,3900,g,10,24,12,0,1,4

#define SYS_PTP_EVENTS_PCH_SUB_PORT_ID_ERR(x)    (((x) << 2) & GENMASK(2, 2))
#define SYS_PTP_EVENTS_PCH_SUB_PORT_ID_ERR_M     GENMASK(2, 2)
#define SYS_PTP_EVENTS_PCH_SUB_PORT_ID_ERR_X(x)  (((x) & GENMASK(2, 2)) >> 2)

#define SYS_PTP_EVENTS_CF_TOO_BIG(x)             (((x) << 1) & GENMASK(1, 1))
#define SYS_PTP_EVENTS_CF_TOO_BIG_M              GENMASK(1, 1)
#define SYS_PTP_EVENTS_CF_TOO_BIG_X(x)           (((x) & GENMASK(1, 1)) >> 1)
...
#define SYS_PTP_MODE_CFG(g,r)     TARGET_SYS,0,1,3900,g,10,24,16,r,2,4
...
#define VCAP_TCAM_CTRL(t)         TARGET_VCAP,t,3,964,0,1,12,0,0,1,4

#define VCAP_TCAM_CTRL_TCAM_BIST(x)              (((x) << 1) & GENMASK(1, 1))
#define VCAP_TCAM_CTRL_TCAM_BIST_M               GENMASK(1, 1)
#define VCAP_TCAM_CTRL_TCAM_BIST_X(x)            (((x) & GENMASK(1, 1)) >> 1)

#define VCAP_TCAM_CTRL_TCAM_INIT(x)              ((x) & GENMASK(0, 0))
#define VCAP_TCAM_CTRL_TCAM_INIT_M               GENMASK(0, 0)
#define VCAP_TCAM_CTRL_TCAM_INIT_X(x)            ((x) & GENMASK(0, 0))

/*      VCAP:TCAM_BIST:TCAM_CFG */
#define VCAP_TCAM_CFG(t)          TARGET_VCAP,t,3,964,0,1,12,4,0,1,4

#define VCAP_TCAM_CFG_TCAM_BIST_SOE_ENA(x)       (((x) << 8) & GENMASK(8, 8))
#define VCAP_TCAM_CFG_TCAM_BIST_SOE_ENA_M        GENMASK(8, 8)
#define VCAP_TCAM_CFG_TCAM_BIST_SOE_ENA_X(x)     (((x) & GENMASK(8, 8)) >> 8)

#define VCAP_TCAM_CFG_TCAM_HCG_DIS(x)            (((x) << 7) & GENMASK(7, 7))
#define VCAP_TCAM_CFG_TCAM_HCG_DIS_M             GENMASK(7, 7)
#define VCAP_TCAM_CFG_TCAM_HCG_DIS_X(x)          (((x) & GENMASK(7, 7)) >> 7)

#define VCAP_TCAM_CFG_TCAM_CG_DIS(x)             (((x) << 6) & GENMASK(6, 6))
#define VCAP_TCAM_CFG_TCAM_CG_DIS_M              GENMASK(6, 6)
#define VCAP_TCAM_CFG_TCAM_CG_DIS_X(x)           (((x) & GENMASK(6, 6)) >> 6)

#define VCAP_TCAM_CFG_TCAM_BIAS(x)               ((x) & GENMASK(5, 0))
#define VCAP_TCAM_CFG_TCAM_BIAS_M                GENMASK(5, 0)
#define VCAP_TCAM_CFG_TCAM_BIAS_X(x)             ((x) & GENMASK(5, 0))

/*      VCAP:TCAM_BIST:TCAM_STAT */
#define VCAP_TCAM_STAT(t)         TARGET_VCAP,t,3,964,0,1,12,8,0,1,4

#define VCAP_TCAM_STAT_BIST_RT_ERR(x)            (((x) << 15) & GENMASK(15, 15))
#define VCAP_TCAM_STAT_BIST_RT_ERR_M             GENMASK(15, 15)
#define VCAP_TCAM_STAT_BIST_RT_ERR_X(x)          (((x) & GENMASK(15, 15)) >> 15)

#define VCAP_TCAM_STAT_BIST_PENC_ERR(x)          (((x) << 14) & GENMASK(14, 14))
#define VCAP_TCAM_STAT_BIST_PENC_ERR_M           GENMASK(14, 14)
#define VCAP_TCAM_STAT_BIST_PENC_ERR_X(x)        (((x) & GENMASK(14, 14)) >> 14)

#define VCAP_TCAM_STAT_BIST_COMP_ERR(x)          (((x) << 13) & GENMASK(13, 13))
#define VCAP_TCAM_STAT_BIST_COMP_ERR_M           GENMASK(13, 13)
#define VCAP_TCAM_STAT_BIST_COMP_ERR_X(x)        (((x) & GENMASK(13, 13)) >> 13)

#define VCAP_TCAM_STAT_BIST_ADDR_ERR(x)          (((x) << 12) & GENMASK(12, 12))
#define VCAP_TCAM_STAT_BIST_ADDR_ERR_M           GENMASK(12, 12)
#define VCAP_TCAM_STAT_BIST_ADDR_ERR_X(x)        (((x) & GENMASK(12, 12)) >> 12)

#define VCAP_TCAM_STAT_BIST_BL1E_ERR(x)          (((x) << 11) & GENMASK(11, 11))
#define VCAP_TCAM_STAT_BIST_BL1E_ERR_M           GENMASK(11, 11)
#define VCAP_TCAM_STAT_BIST_BL1E_ERR_X(x)        (((x) & GENMASK(11, 11)) >> 11)

#define VCAP_TCAM_STAT_BIST_BL1_ERR(x)           (((x) << 10) & GENMASK(10, 10))
#define VCAP_TCAM_STAT_BIST_BL1_ERR_M            GENMASK(10, 10)
#define VCAP_TCAM_STAT_BIST_BL1_ERR_X(x)         (((x) & GENMASK(10, 10)) >> 10)

#define VCAP_TCAM_STAT_BIST_BL0E_ERR(x)          (((x) << 9) & GENMASK(9, 9))
#define VCAP_TCAM_STAT_BIST_BL0E_ERR_M           GENMASK(9, 9)
#define VCAP_TCAM_STAT_BIST_BL0E_ERR_X(x)        (((x) & GENMASK(9, 9)) >> 9)

#define VCAP_TCAM_STAT_BIST_BL0_ERR(x)           (((x) << 8) & GENMASK(8, 8))
#define VCAP_TCAM_STAT_BIST_BL0_ERR_M            GENMASK(8, 8)
#define VCAP_TCAM_STAT_BIST_BL0_ERR_X(x)         (((x) & GENMASK(8, 8)) >> 8)

#define VCAP_TCAM_STAT_BIST_PH1_ERR(x)           (((x) << 7) & GENMASK(7, 7))
#define VCAP_TCAM_STAT_BIST_PH1_ERR_M            GENMASK(7, 7)
#define VCAP_TCAM_STAT_BIST_PH1_ERR_X(x)         (((x) & GENMASK(7, 7)) >> 7)

#define VCAP_TCAM_STAT_BIST_PH0_ERR(x)           (((x) << 6) & GENMASK(6, 6))
#define VCAP_TCAM_STAT_BIST_PH0_ERR_M            GENMASK(6, 6)
#define VCAP_TCAM_STAT_BIST_PH0_ERR_X(x)         (((x) & GENMASK(6, 6)) >> 6)

#define VCAP_TCAM_STAT_BIST_PV1_ERR(x)           (((x) << 5) & GENMASK(5, 5))
#define VCAP_TCAM_STAT_BIST_PV1_ERR_M            GENMASK(5, 5)
#define VCAP_TCAM_STAT_BIST_PV1_ERR_X(x)         (((x) & GENMASK(5, 5)) >> 5)

#define VCAP_TCAM_STAT_BIST_PV0_ERR(x)           (((x) << 4) & GENMASK(4, 4))
#define VCAP_TCAM_STAT_BIST_PV0_ERR_M            GENMASK(4, 4)
#define VCAP_TCAM_STAT_BIST_PV0_ERR_X(x)         (((x) & GENMASK(4, 4)) >> 4)

#define VCAP_TCAM_STAT_BIST_RUN(x)               (((x) << 3) & GENMASK(3, 3))
#define VCAP_TCAM_STAT_BIST_RUN_M                GENMASK(3, 3)
#define VCAP_TCAM_STAT_BIST_RUN_X(x)             (((x) & GENMASK(3, 3)) >> 3)

#define VCAP_TCAM_STAT_BIST_ERR(x)               (((x) << 2) & GENMASK(2, 2))
#define VCAP_TCAM_STAT_BIST_ERR_M                GENMASK(2, 2)
#define VCAP_TCAM_STAT_BIST_ERR_X(x)             (((x) & GENMASK(2, 2)) >> 2)

#define VCAP_TCAM_STAT_BIST_BUSY(x)              (((x) << 1) & GENMASK(1, 1))
#define VCAP_TCAM_STAT_BIST_BUSY_M               GENMASK(1, 1)
#define VCAP_TCAM_STAT_BIST_BUSY_X(x)            (((x) & GENMASK(1, 1)) >> 1)

#define VCAP_TCAM_STAT_TCAM_RDY(x)               ((x) & GENMASK(0, 0))
#define VCAP_TCAM_STAT_TCAM_RDY_M                GENMASK(0, 0)
#define VCAP_TCAM_STAT_TCAM_RDY_X(x)             ((x) & GENMASK(0, 0))
