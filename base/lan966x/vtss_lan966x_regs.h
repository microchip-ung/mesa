...
#define DEV_PHAD_CTRL_PHAD_LOCK(x)               (((x) << 19) & GENMASK(19, 19))
#define DEV_PHAD_CTRL_PHAD_LOCK_M                GENMASK(19, 19)
#define DEV_PHAD_CTRL_PHAD_LOCK_X(x)             (((x) & GENMASK(19, 19)) >> 19)

#define DEV_PHAD_CTRL_DIV4_ACT(x)                (((x) << 18) & GENMASK(18, 18))
#define DEV_PHAD_CTRL_DIV4_ACT_M                 GENMASK(18, 18)
#define DEV_PHAD_CTRL_DIV4_ACT_X(x)              (((x) & GENMASK(18, 18)) >> 18)
...
#define PTP_PHAD_CTRL_PHAD_LOCK(x)               (((x) << 19) & GENMASK(19, 19))
#define PTP_PHAD_CTRL_PHAD_LOCK_M                GENMASK(19, 19)
#define PTP_PHAD_CTRL_PHAD_LOCK_X(x)             (((x) & GENMASK(19, 19)) >> 19)

#define PTP_PHAD_CTRL_DIV4_ACT(x)                (((x) << 18) & GENMASK(18, 18))
#define PTP_PHAD_CTRL_DIV4_ACT_M                 GENMASK(18, 18)
#define PTP_PHAD_CTRL_DIV4_ACT_X(x)              (((x) & GENMASK(18, 18)) >> 18)
