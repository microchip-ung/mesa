...
#define ANA_LEARNDISC             __REG(TARGET_ANA,\
					0, 1, 29952, 0, 1, 240, 48, 0, 1, 4)

/*      ANA:ANA:AGENCTRL */
#define ANA_AGENCTRL              __REG(TARGET_ANA,\
					0, 1, 29952, 0, 1, 240, 52, 0, 1, 4)
...
/*      ANA:PGID:PGID */
#define ANA_PGID(r)               __REG(TARGET_ANA,\
					0, 1, 27648, 0, 1, 512, 0, r, 89, 4)
...
#define ANA_SEQ_MASK              __REG(TARGET_ANA,\
...
#define GCB_GPIO_OUT_SET(r)       __REG(TARGET_GCB,\
					0, 1, 12, 0, 1, 256, 0, r, 8, 4)
...
#define GCB_GPIO_OUT_CLR(r)       __REG(TARGET_GCB,\
					0, 1, 12, 0, 1, 256, 32, r, 8, 4)
...
/*      GCB:GPIO:GPIO_IN */
#define GCB_GPIO_IN(r)            __REG(TARGET_GCB,\
					0, 1, 12, 0, 1, 256, 96, r, 8, 4)
...
/*      GCB:GPIO:GPIO_OE */
#define GCB_GPIO_OE(r)            __REG(TARGET_GCB,\
					0, 1, 12, 0, 1, 256, 128, r, 8, 4)
...
/*      GCB:GPIO:GPIO_INTR */
#define GCB_GPIO_INTR(r)          __REG(TARGET_GCB,\
					0, 1, 12, 0, 1, 256, 160, r, 8, 4)
...
#define GCB_GPIO_INTR_ENA(r)      __REG(TARGET_GCB,\
					0, 1, 12, 0, 1, 256, 192, r, 8, 4)
...
#define GCB_GPIO_INTR_IDENT(r)    __REG(TARGET_GCB,\
					0, 1, 12, 0, 1, 256, 224, r, 8, 4)
...
#define MEP_LOC_PERIOD_CFG(r)     __REG(TARGET_MEP,\
					0, 1, 3328, 0, 1, 192, 52, r, 10, 4)

/*      MEP:COMMON:LOC_CTRL */
#define MEP_LOC_CTRL              __REG(TARGET_MEP,\
					0, 1, 3328, 0, 1, 192, 92, 0, 1, 4)
