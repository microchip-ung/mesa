...
#define QSYS_PORT_MODE(r)         TARGET_QSYS,0,1,28008,0,1,216,0,r,10,4
...
#define QSYS_PORT_DBG(r)          TARGET_QSYS,0,1,28008,0,1,216,40,r,10,4
...
#define QSYS_SW_PORT_MODE(r)      TARGET_QSYS,0,1,28008,0,1,216,80,r,9,4
...
#define QSYS_STAT_CFG             TARGET_QSYS,0,1,28008,0,1,216,116,0,1,4
...
/*      QSYS:SYSTEM:EEE_CFG */
#define QSYS_EEE_CFG(r)           TARGET_QSYS,0,1,28008,0,1,216,120,r,8,4
...
#define QSYS_EEE_THRES            TARGET_QSYS,0,1,28008,0,1,216,152,0,1,4
...
#define QSYS_IGR_NO_SHARING       TARGET_QSYS,0,1,28008,0,1,216,156,0,1,4
...
#define QSYS_EGR_NO_SHARING       TARGET_QSYS,0,1,28008,0,1,216,160,0,1,4
...
#define QSYS_SW_STATUS(r)         TARGET_QSYS,0,1,28008,0,1,216,164,r,9,4
...
#define QSYS_EXT_CPU_CFG          TARGET_QSYS,0,1,28008,0,1,216,200,0,1,4
...
#define QSYS_CPU_GROUP_MAP        TARGET_QSYS,0,1,28008,0,1,216,204,0,1,4
...
#define QSYS_PTP_DOMAIN_CFG       TARGET_QSYS,0,1,28008,0,1,216,208,0,1,4
...
#define QSYS_PTP_CYCLE_CNT_VAL    TARGET_QSYS,0,1,28008,0,1,216,212,0,1,4
...
/*      QSYS:QMAP:QMAP */
#define QSYS_QMAP(g)              TARGET_QSYS,0,1,28224,g,10,4,0,0,1,4
...
#define QSYS_RED_PROFILE(r)       TARGET_QSYS,0,1,28264,0,1,68,0,r,16,4
...
#define QSYS_RES_QOS_MODE         TARGET_QSYS,0,1,28264,0,1,68,64,0,1,4
...
#define QSYS_EGR_DROP_MODE        TARGET_QSYS,0,1,28332,0,1,8,0,0,1,4
...
#define QSYS_MISC_DROP_CFG        TARGET_QSYS,0,1,28332,0,1,8,4,0,1,4
...
/*      QSYS:MMGT:EQ_CTRL */
#define QSYS_EQ_CTRL              TARGET_QSYS,0,1,28340,0,1,4,0,0,1,4
...
#define QSYS_EVENTS_CORE          TARGET_QSYS,0,1,28344,0,1,4,0,0,1,4
...
#define QSYS_QMAXSDU_CFG_0(r)     TARGET_QSYS,0,1,28348,0,1,288,0,r,9,4
...
#define QSYS_QMAXSDU_CFG_1(r)     TARGET_QSYS,0,1,28348,0,1,288,36,r,9,4
...
#define QSYS_QMAXSDU_CFG_2(r)     TARGET_QSYS,0,1,28348,0,1,288,72,r,9,4
...
#define QSYS_QMAXSDU_CFG_3(r)     TARGET_QSYS,0,1,28348,0,1,288,108,r,9,4
...
#define QSYS_QMAXSDU_CFG_4(r)     TARGET_QSYS,0,1,28348,0,1,288,144,r,9,4
...
#define QSYS_QMAXSDU_CFG_5(r)     TARGET_QSYS,0,1,28348,0,1,288,180,r,9,4
...
#define QSYS_QMAXSDU_CFG_6(r)     TARGET_QSYS,0,1,28348,0,1,288,216,r,9,4
...
#define QSYS_QMAXSDU_CFG_7(r)     TARGET_QSYS,0,1,28348,0,1,288,252,r,9,4
...
#define QSYS_PREEMPT_CFG(r)       TARGET_QSYS,0,1,28636,0,1,32,0,r,8,4
...
#define QSYS_HSCH_MISC_CFG        TARGET_QSYS,0,1,28668,0,1,4,0,0,1,4
...
#define QSYS_FRER_CFG             TARGET_QSYS,0,1,57384,0,1,4,0,0,1,4
