...
/*
 * This file is autogenerated by cml-utils 2020-05-26 14:54:52 +0000.
 * Commit ID: 5900971c0e78a90b300eb9c2cf0e6cfb37cc5155 (dirty)
 */
...
struct lan966x_tgt_offset {
	off_t offset;
	enum lan966x_region region;
};

static const struct lan966x_tgt_offset lan966x_tgt_offsets[] = {
	{ 0x0004c000, REGION_AMBA_AXI_TOP }, /* AES */
	{ 0x00050000, REGION_AMBA_AXI_TOP }, /* AESB_ASC */
	{ 0x00120000, REGION_DEFAULT      }, /* AFI */
	{ 0x00140000, REGION_DEFAULT      }, /* ANA */
	{ 0x00010000, REGION_DEFAULT      }, /* CHIP_TOP */
	{ 0x000c0000, REGION_AMBA_AXI_TOP }, /* CPU */
	{ 0x08843000, REGION_AMBA_AXI_TOP }, /* CPU_SYSCNT */
	{ 0x08900000, REGION_AMBA_AXI_TOP }, /* CPU_SYSCNT_RO */
	{ 0x00084000, REGION_AMBA_AXI_TOP }, /* DDR_PHY */
	{ 0x00080000, REGION_AMBA_AXI_TOP }, /* DDR_UMCTL2 */
	{ 0x00000000, REGION_DEFAULT      }, /* DEVCPU_ORG_0 */
	{ 0x00400000, REGION_DEFAULT      }, /* DEVCPU_ORG_1 */
	{ 0x00034000, REGION_DEFAULT      }, /* DEV_0 */
	{ 0x00038000, REGION_DEFAULT      }, /* DEV_1 */
	{ 0x0003c000, REGION_DEFAULT      }, /* DEV_2 */
	{ 0x00040000, REGION_DEFAULT      }, /* DEV_3 */
	{ 0x00044000, REGION_DEFAULT      }, /* DEV_4 */
	{ 0x00048000, REGION_DEFAULT      }, /* DEV_5 */
	{ 0x0004c000, REGION_DEFAULT      }, /* DEV_6 */
	{ 0x00050000, REGION_DEFAULT      }, /* DEV_7 */
	{ 0x00300000, REGION_AMBA_AXI_TOP }, /* DWC_USB3_HOST */
	{ 0x000c0400, REGION_AMBA_AXI_TOP }, /* FDMA */
	{ 0x00040000, REGION_AMBA_AXI_TOP }, /* FLEXCOM_0 */
	{ 0x00044000, REGION_AMBA_AXI_TOP }, /* FLEXCOM_1 */
	{ 0x00060000, REGION_AMBA_AXI_TOP }, /* FLEXCOM_2 */
	{ 0x00064000, REGION_AMBA_AXI_TOP }, /* FLEXCOM_3 */
	{ 0x00070000, REGION_AMBA_AXI_TOP }, /* FLEXCOM_4 */
	{ 0x00004000, REGION_DEFAULT      }, /* GCB */
	{ 0x08b00000, REGION_AMBA_AXI_TOP }, /* GPV */
	{ 0x00810000, REGION_AMBA_AXI_TOP }, /* HICM */
	{ 0x00800000, REGION_AMBA_AXI_TOP }, /* HMATRIX2 */
	{ 0x0002c000, REGION_DEFAULT      }, /* HSIO */
	{ 0x0081c000, REGION_AMBA_AXI_TOP }, /* MCAN_0 */
	{ 0x00820000, REGION_AMBA_AXI_TOP }, /* MCAN_1 */
	{ 0x0001c000, REGION_DEFAULT      }, /* MEP */
	{ 0x00021000, REGION_AMBA_AXI_TOP }, /* OTP */
	{ 0x000d0000, REGION_AMBA_AXI_TOP }, /* PCIE_CFG */
	{ 0x00400000, REGION_AMBA_AXI_TOP }, /* PCIE_DBI */
	{ 0x0000c000, REGION_DEFAULT      }, /* PTP */
	{ 0x00008000, REGION_DEFAULT      }, /* QS */
	{ 0x00804000, REGION_AMBA_AXI_TOP }, /* QSPI_0 */
	{ 0x00054000, REGION_AMBA_AXI_TOP }, /* QSPI_1 */
	{ 0x00834000, REGION_AMBA_AXI_TOP }, /* QSPI_2 */
	{ 0x00100000, REGION_DEFAULT      }, /* QSYS */
	{ 0x00014000, REGION_DEFAULT      }, /* REW */
	{ 0x00600000, REGION_DEFAULT      }, /* RTE */
	{ 0x00830000, REGION_AMBA_AXI_TOP }, /* SDMMC */
	{ 0x0006c000, REGION_AMBA_AXI_TOP }, /* SHA */
	{ 0x00030000, REGION_DEFAULT      }, /* SUNRISE_TOP */
	{ 0x00028000, REGION_DEFAULT      }, /* SYS */
	{ 0x0008c000, REGION_AMBA_AXI_TOP }, /* TIMERS */
	{ 0x00048000, REGION_AMBA_AXI_TOP }, /* TRNG */
	{ 0x00814000, REGION_AMBA_AXI_TOP }, /* TZAESBNS */
	{ 0x00818000, REGION_AMBA_AXI_TOP }, /* TZAESBS */
	{ 0x00004000, REGION_AMBA_AXI_TOP }, /* TZPM */
	{ 0x00808000, REGION_AMBA_AXI_TOP }, /* UDPHS0 */
	{ 0x00094000, REGION_AMBA_AXI_TOP }, /* UVOV */
	{ 0x00018000, REGION_DEFAULT      }, /* VCAP_0 */
	{ 0x00020000, REGION_DEFAULT      }, /* VCAP_1 */
	{ 0x00024000, REGION_DEFAULT      }, /* VCAP_2 */
	{ 0x00090000, REGION_AMBA_AXI_TOP }, /* WDT */
	{ 0x00068000, REGION_AMBA_AXI_TOP }, /* XDMAC */
};
