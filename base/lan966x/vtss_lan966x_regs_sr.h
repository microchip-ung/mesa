...
#define CPU_GCK_CFG(r)            TARGET_CPU,0,1,168,0,1,56,0,r,14,4
...
#define CPU_USB_CFG               TARGET_CPU,0,1,224,0,1,48,0,0,1,4
...
#define CPU_USB_CTRL              TARGET_CPU,0,1,224,0,1,48,4,0,1,4
...
#define CPU_USB_STAT              TARGET_CPU,0,1,224,0,1,48,8,0,1,4
...
#define CPU_USB_INTR              TARGET_CPU,0,1,224,0,1,48,12,0,1,4
...
#define CPU_USB_INTR_ENA          TARGET_CPU,0,1,224,0,1,48,16,0,1,4
...
#define CPU_USB_INTR_IDENT        TARGET_CPU,0,1,224,0,1,48,20,0,1,4
...
#define CPU_USB_DEBUG1            TARGET_CPU,0,1,224,0,1,48,24,0,1,4

/*      CPU:USB_REGS:USB_DEBUG2 */
#define CPU_USB_DEBUG2            TARGET_CPU,0,1,224,0,1,48,28,0,1,4

/*      CPU:USB_REGS:USB_DEBUG3 */
#define CPU_USB_DEBUG3            TARGET_CPU,0,1,224,0,1,48,32,0,1,4
...
#define CPU_USB_LA_TRACE1         TARGET_CPU,0,1,224,0,1,48,36,0,1,4

/*      CPU:USB_REGS:USB_LA_TRACE2 */
#define CPU_USB_LA_TRACE2         TARGET_CPU,0,1,224,0,1,48,40,0,1,4

/*      CPU:USB_REGS:USB_GGPIO */
#define CPU_USB_GGPIO             TARGET_CPU,0,1,224,0,1,48,44,0,1,4
...
#define CPU_MIIM_SLAVE_CFG        TARGET_CPU,0,1,272,0,1,4,0,0,1,4
...
#define CPU_VCORE_ACC_CFG         TARGET_CPU,0,1,276,0,1,4,0,0,1,4
...
#define CPU_MSIX_ACC_CFG          TARGET_CPU,0,1,280,0,1,4,0,0,1,4
...
#define CPU_EXT_IF_ACC_STAT       TARGET_CPU,0,1,284,0,1,4,0,0,1,4
...
/*      CPU:INTR:INTR_RAW */
#define CPU_INTR_RAW              TARGET_CPU,0,1,288,0,1,400,0,0,1,4

/*      CPU:INTR:INTR_RAW1 */
#define CPU_INTR_RAW1             TARGET_CPU,0,1,288,0,1,400,4,0,1,4

/*      CPU:INTR:INTR_RAW2 */
#define CPU_INTR_RAW2             TARGET_CPU,0,1,288,0,1,400,8,0,1,4

/*      CPU:INTR:INTR_TRIGGER */
#define CPU_INTR_TRIGGER(r)       TARGET_CPU,0,1,288,0,1,400,12,r,2,4

/*      CPU:INTR:INTR_TRIGGER1 */
#define CPU_INTR_TRIGGER1(r)      TARGET_CPU,0,1,288,0,1,400,20,r,2,4

/*      CPU:INTR:INTR_TRIGGER2 */
#define CPU_INTR_TRIGGER2(r)      TARGET_CPU,0,1,288,0,1,400,28,r,2,4

/*      CPU:INTR:INTR_FORCE */
#define CPU_INTR_FORCE            TARGET_CPU,0,1,288,0,1,400,36,0,1,4

/*      CPU:INTR:INTR_FORCE1 */
#define CPU_INTR_FORCE1           TARGET_CPU,0,1,288,0,1,400,40,0,1,4

/*      CPU:INTR:INTR_FORCE2 */
#define CPU_INTR_FORCE2           TARGET_CPU,0,1,288,0,1,400,44,0,1,4

/*      CPU:INTR:INTR_STICKY */
#define CPU_INTR_STICKY           TARGET_CPU,0,1,288,0,1,400,48,0,1,4

/*      CPU:INTR:INTR_STICKY1 */
#define CPU_INTR_STICKY1          TARGET_CPU,0,1,288,0,1,400,52,0,1,4

/*      CPU:INTR:INTR_STICKY2 */
#define CPU_INTR_STICKY2          TARGET_CPU,0,1,288,0,1,400,56,0,1,4

/*      CPU:INTR:INTR_BYPASS */
#define CPU_INTR_BYPASS           TARGET_CPU,0,1,288,0,1,400,60,0,1,4

/*      CPU:INTR:INTR_BYPASS1 */
#define CPU_INTR_BYPASS1          TARGET_CPU,0,1,288,0,1,400,64,0,1,4

/*      CPU:INTR:INTR_BYPASS2 */
#define CPU_INTR_BYPASS2          TARGET_CPU,0,1,288,0,1,400,68,0,1,4

/*      CPU:INTR:INTR_ENA */
#define CPU_INTR_ENA              TARGET_CPU,0,1,288,0,1,400,72,0,1,4

/*      CPU:INTR:INTR_ENA1 */
#define CPU_INTR_ENA1             TARGET_CPU,0,1,288,0,1,400,76,0,1,4

/*      CPU:INTR:INTR_ENA2 */
#define CPU_INTR_ENA2             TARGET_CPU,0,1,288,0,1,400,80,0,1,4

/*      CPU:INTR:INTR_ENA_CLR */
#define CPU_INTR_ENA_CLR          TARGET_CPU,0,1,288,0,1,400,84,0,1,4

/*      CPU:INTR:INTR_ENA_CLR1 */
#define CPU_INTR_ENA_CLR1         TARGET_CPU,0,1,288,0,1,400,88,0,1,4

/*      CPU:INTR:INTR_ENA_CLR2 */
#define CPU_INTR_ENA_CLR2         TARGET_CPU,0,1,288,0,1,400,92,0,1,4

/*      CPU:INTR:INTR_ENA_SET */
#define CPU_INTR_ENA_SET          TARGET_CPU,0,1,288,0,1,400,96,0,1,4

/*      CPU:INTR:INTR_ENA_SET1 */
#define CPU_INTR_ENA_SET1         TARGET_CPU,0,1,288,0,1,400,100,0,1,4

/*      CPU:INTR:INTR_ENA_SET2 */
#define CPU_INTR_ENA_SET2         TARGET_CPU,0,1,288,0,1,400,104,0,1,4

/*      CPU:INTR:INTR_IDENT */
#define CPU_INTR_IDENT            TARGET_CPU,0,1,288,0,1,400,108,0,1,4

/*      CPU:INTR:INTR_IDENT1 */
#define CPU_INTR_IDENT1           TARGET_CPU,0,1,288,0,1,400,112,0,1,4

/*      CPU:INTR:INTR_IDENT2 */
#define CPU_INTR_IDENT2           TARGET_CPU,0,1,288,0,1,400,116,0,1,4

/*      CPU:INTR:DST_INTR_MAP */
#define CPU_DST_INTR_MAP(r)       TARGET_CPU,0,1,288,0,1,400,120,r,9,4

/*      CPU:INTR:DST_INTR_MAP1 */
#define CPU_DST_INTR_MAP1(r)      TARGET_CPU,0,1,288,0,1,400,156,r,9,4

/*      CPU:INTR:DST_INTR_MAP2 */
#define CPU_DST_INTR_MAP2(r)      TARGET_CPU,0,1,288,0,1,400,192,r,9,4

/*      CPU:INTR:DST_INTR_IDENT */
#define CPU_DST_INTR_IDENT(r)     TARGET_CPU,0,1,288,0,1,400,228,r,9,4

/*      CPU:INTR:DST_INTR_IDENT1 */
#define CPU_DST_INTR_IDENT1(r)    TARGET_CPU,0,1,288,0,1,400,264,r,9,4

/*      CPU:INTR:DST_INTR_IDENT2 */
#define CPU_DST_INTR_IDENT2(r)    TARGET_CPU,0,1,288,0,1,400,300,r,9,4

/*      CPU:INTR:EXT_SRC_INTR_POL */
#define CPU_EXT_SRC_INTR_POL      TARGET_CPU,0,1,288,0,1,400,336,0,1,4
...
#define CPU_EXT_DST_INTR_POL      TARGET_CPU,0,1,288,0,1,400,340,0,1,4
...
#define CPU_EXT_DST_INTR_DRV      TARGET_CPU,0,1,288,0,1,400,344,0,1,4
...
#define CPU_DEV_INTR_POL          TARGET_CPU,0,1,288,0,1,400,348,0,1,4
...
#define CPU_DEV_INTR_RAW          TARGET_CPU,0,1,288,0,1,400,352,0,1,4
...
#define CPU_DEV_INTR_TRIGGER(r)   TARGET_CPU,0,1,288,0,1,400,356,r,2,4
...
#define CPU_DEV_INTR_STICKY       TARGET_CPU,0,1,288,0,1,400,364,0,1,4
...
#define CPU_DEV_INTR_BYPASS       TARGET_CPU,0,1,288,0,1,400,368,0,1,4
...
#define CPU_DEV_INTR_ENA          TARGET_CPU,0,1,288,0,1,400,372,0,1,4
...
#define CPU_DEV_INTR_IDENT        TARGET_CPU,0,1,288,0,1,400,376,0,1,4
...
/*      CPU:INTR:MSIX_CFG */
#define CPU_MSIX_CFG              TARGET_CPU,0,1,288,0,1,400,380,0,1,4
...
#define CPU_MSIX_DOORBELL_ADDR    TARGET_CPU,0,1,288,0,1,400,384,0,1,4

/*      CPU:INTR:MSIX_INTR_PENDING */
#define CPU_MSIX_INTR_PENDING     TARGET_CPU,0,1,288,0,1,400,388,0,1,4

/*      CPU:INTR:MSIX_INTR_PENDING1 */
#define CPU_MSIX_INTR_PENDING1    TARGET_CPU,0,1,288,0,1,400,392,0,1,4

/*      CPU:INTR:MSIX_INTR_PENDING2 */
#define CPU_MSIX_INTR_PENDING2    TARGET_CPU,0,1,288,0,1,400,396,0,1,4

/*      CPU:DDRCTRL:DDRCTRL_CLK */
#define CPU_DDRCTRL_CLK           TARGET_CPU,0,1,688,0,1,20,0,0,1,4
...
#define CPU_DDRCTRL_RST           TARGET_CPU,0,1,688,0,1,20,4,0,1,4
...
#define CPU_DDRC_INTR_RAW_STAT    TARGET_CPU,0,1,688,0,1,20,8,0,1,4
...
#define CPU_DDRC_INTR_MASK        TARGET_CPU,0,1,688,0,1,20,12,0,1,4
...
#define CPU_DDRC_INTR_MASKED_STAT TARGET_CPU,0,1,688,0,1,20,16,0,1,4
...
/*      CPU:PI_REG:PI_CON */
#define CPU_PI_CON                TARGET_CPU,0,1,708,0,1,8,0,0,1,4
...
/*      CPU:PI_REG:PI_MODE */
#define CPU_PI_MODE               TARGET_CPU,0,1,708,0,1,8,4,0,1,4
...
#define CPU_CLK_GATING            TARGET_CPU,0,1,716,0,1,28,0,0,1,4
...
#define CPU_AHBLITE2AXI           TARGET_CPU,0,1,716,0,1,28,4,0,1,4
...
/*      CPU:SFR_REGS:TZAESB */
#define CPU_TZAESB                TARGET_CPU,0,1,716,0,1,28,8,0,1,4
...
/*      CPU:SFR_REGS:MCAN */
#define CPU_MCAN                  TARGET_CPU,0,1,716,0,1,28,12,0,1,4
...
/*      CPU:SFR_REGS:HICM */
#define CPU_HICM                  TARGET_CPU,0,1,716,0,1,28,16,0,1,4
...
/*      CPU:SFR_REGS:UDPHS */
#define CPU_UDPHS                 TARGET_CPU,0,1,716,0,1,28,20,0,1,4
...
/*      CPU:SFR_REGS:UDDR */
#define CPU_UDDR                  TARGET_CPU,0,1,716,0,1,28,24,0,1,4
...
#define CPU_com_bias_bg_TC_trim   TARGET_CPU,0,1,744,0,1,36,0,0,1,4
...
#define CPU_com_bias_bg_MAG_trim  TARGET_CPU,0,1,744,0,1,36,4,0,1,4
...
#define CPU_com_rbias_MAG_trim    TARGET_CPU,0,1,744,0,1,36,8,0,1,4
...
#define CPU_com_bias_az_clk_sel   TARGET_CPU,0,1,744,0,1,36,12,0,1,4
...
#define CPU_com_atest_sel         TARGET_CPU,0,1,744,0,1,36,16,0,1,4
...
#define CPU_com_suspendb          TARGET_CPU,0,1,744,0,1,36,20,0,1,4
...
#define CPU_com_xtal_suspendb     TARGET_CPU,0,1,744,0,1,36,24,0,1,4
...
#define CPU_com_pll_lpm_mode      TARGET_CPU,0,1,744,0,1,36,28,0,1,4
...
#define CPU_com_pll_en            TARGET_CPU,0,1,744,0,1,36,32,0,1,4
...
#define CPU_usb2_hs_disc_p0       TARGET_CPU,0,1,780,0,1,24,0,0,1,4
...
#define CPU_usb2_sq_tune_p0       TARGET_CPU,0,1,780,0,1,24,4,0,1,4
...
#define CPU_usb2_hs_drive_p0      TARGET_CPU,0,1,780,0,1,24,8,0,1,4
...
#define CPU_usb2_HSOS_scan_en_p0  TARGET_CPU,0,1,780,0,1,24,12,0,1,4
...
#define CPU_usb2_HSOS_scan_data_p0 TARGET_CPU,0,1,780,0,1,24,16,0,1,4
...
#define CPU_usb2_hs_ovsmp_p0      TARGET_CPU,0,1,780,0,1,24,20,0,1,4
...
#define CPU_PROG_BITS             TARGET_CPU,0,1,804,0,1,4,0,0,1,4
...
#define CPU_ULPI_RST              TARGET_CPU,0,1,808,0,1,4,0,0,1,4
...
#define CPU_PHY_CFG               TARGET_CPU,0,1,812,0,1,20,0,0,1,4
...
#define CPU_PHY_TUNE              TARGET_CPU,0,1,812,0,1,20,4,0,1,4
...
#define CPU_PCS_CFG               TARGET_CPU,0,1,812,0,1,20,8,0,1,4
...
#define CPU_PHY_CR_CTRL           TARGET_CPU,0,1,812,0,1,20,12,0,1,4
...
#define CPU_PHY_CR_DATA           TARGET_CPU,0,1,812,0,1,20,16,0,1,4
...
#define SYS_RESET_CFG             TARGET_SYS,0,1,4128,0,1,168,0,0,1,4
...
/*      SYS:SYSTEM:PORT_DBG */
#define SYS_PORT_DBG(r)           TARGET_SYS,0,1,4128,0,1,168,4,r,10,4
...
#define SYS_PORT_MODE(r)          TARGET_SYS,0,1,4128,0,1,168,44,r,10,4
...
#define SYS_FRONT_PORT_MODE(r)    TARGET_SYS,0,1,4128,0,1,168,84,r,8,4
...
#define SYS_FRM_AGING             TARGET_SYS,0,1,4128,0,1,168,116,0,1,4
...
/*      SYS:SYSTEM:STAT_CFG */
#define SYS_STAT_CFG              TARGET_SYS,0,1,4128,0,1,168,120,0,1,4
...
#define SYS_SW_STATUS(r)          TARGET_SYS,0,1,4128,0,1,168,124,r,9,4
...
/*      SYS:SYSTEM:MISC_CFG */
#define SYS_MISC_CFG              TARGET_SYS,0,1,4128,0,1,168,160,0,1,4
...
#define SYS_TIMESTAMP_OFFSET      TARGET_SYS,0,1,4128,0,1,168,164,0,1,4
...
#define SYS_PAUSE_CFG(r)          TARGET_SYS,0,1,4296,0,1,112,0,r,9,4
...
#define SYS_PAUSE_TOT_CFG         TARGET_SYS,0,1,4296,0,1,112,36,0,1,4
...
/*      SYS:PAUSE_CFG:ATOP */
#define SYS_ATOP(r)               TARGET_SYS,0,1,4296,0,1,112,40,r,9,4
...
#define SYS_ATOP_TOT_CFG          TARGET_SYS,0,1,4296,0,1,112,76,0,1,4
...
#define SYS_MAC_FC_CFG(r)         TARGET_SYS,0,1,4296,0,1,112,80,r,8,4
...
/*      SYS:MMGT:MMGT */
#define SYS_MMGT                  TARGET_SYS,0,1,4408,0,1,8,0,0,1,4
...
/*      SYS:MMGT:MMGT_FAST */
#define SYS_MMGT_FAST             TARGET_SYS,0,1,4408,0,1,8,4,0,1,4
...
/*      SYS:MISC:EVENTS_DIF */
#define SYS_EVENTS_DIF(r)         TARGET_SYS,0,1,4416,0,1,16,0,r,3,4
...
#define SYS_EVENTS_CORE           TARGET_SYS,0,1,4416,0,1,16,12,0,1,4
...
#define SYS_FPORT_STATE(r)        TARGET_SYS,0,1,4096,0,1,32,0,r,8,4
...
/*      SYS:CAL_CFG:CAL_CFG */
#define SYS_CAL_CFG(r)            TARGET_SYS,0,1,3584,0,1,512,0,r,112,4
...
#define SYS_RAM_INIT              TARGET_SYS,0,1,4432,0,1,4,0,0,1,4
...
/*      SYS:COREMEM:CM_ADDR */
#define SYS_CM_ADDR               TARGET_SYS,0,1,4436,0,1,16,0,0,1,4

/*      SYS:COREMEM:CM_DATA_WR */
#define SYS_CM_DATA_WR            TARGET_SYS,0,1,4436,0,1,16,4,0,1,4

/*      SYS:COREMEM:CM_DATA_RD */
#define SYS_CM_DATA_RD            TARGET_SYS,0,1,4436,0,1,16,8,0,1,4

/*      SYS:COREMEM:CM_OP */
#define SYS_CM_OP                 TARGET_SYS,0,1,4436,0,1,16,12,0,1,4
...
/*      SYS:PTPPORT:PCH_CFG */
#define SYS_PCH_CFG(g)            TARGET_SYS,0,1,4452,g,10,28,0,0,1,4
...
/*      SYS:PTPPORT:PTP_CFG */
#define SYS_PTP_CFG(g)            TARGET_SYS,0,1,4452,g,10,28,4,0,1,4
...
#define SYS_PTP_RXDLY_CFG(g)      TARGET_SYS,0,1,4452,g,10,28,8,0,1,4
...
#define SYS_PTP_TXDLY_CFG(g)      TARGET_SYS,0,1,4452,g,10,28,12,0,1,4
...
#define SYS_PTP_EVENTS(g)         TARGET_SYS,0,1,4452,g,10,28,16,0,1,4
...
#define SYS_PTP_MODE_CFG(g,r)     TARGET_SYS,0,1,4452,g,10,28,20,r,2,4
