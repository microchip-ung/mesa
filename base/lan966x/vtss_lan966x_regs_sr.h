...
/*
 * This file is autogenerated by cml-utils 2020-08-13 10:56:11 +0000.
 * Commit ID: a78fe80d67e6b140b13e6a7b2b35de2dc9f0c163
 */
...
/*      CPU:CPU_REGS:GPR */
#define CPU_GPR(r)                TARGET_CPU,0,1,0,0,1,168,0,r,32,4

/*      CPU:CPU_REGS:BUILDID */
#define CPU_BUILDID               TARGET_CPU,0,1,0,0,1,168,128,0,1,4

/*      CPU:CPU_REGS:RESET */
#define CPU_RESET                 TARGET_CPU,0,1,0,0,1,168,132,0,1,4
...
#define CPU_RESET_PROT_STAT       TARGET_CPU,0,1,0,0,1,168,136,0,1,4

#define CPU_RESET_PROT_STAT_SYS_RST_PROT_VCORE(x) (((x) << 4) & GENMASK(4, 4))
#define CPU_RESET_PROT_STAT_SYS_RST_PROT_VCORE_M GENMASK(4, 4)
#define CPU_RESET_PROT_STAT_SYS_RST_PROT_VCORE_X(x) (((x) & GENMASK(4, 4)) >> 4)

#define CPU_RESET_PROT_STAT_VCORE_RST_PROT_AMBA(x) (((x) << 3) & GENMASK(3, 3))
#define CPU_RESET_PROT_STAT_VCORE_RST_PROT_AMBA_M GENMASK(3, 3)
#define CPU_RESET_PROT_STAT_VCORE_RST_PROT_AMBA_X(x)\
	(((x) & GENMASK(3, 3)) >> 3)

#define CPU_RESET_PROT_STAT_VCORE_RST_PROT_WDT(x) (((x) << 2) & GENMASK(2, 2))
#define CPU_RESET_PROT_STAT_VCORE_RST_PROT_WDT_M GENMASK(2, 2)
#define CPU_RESET_PROT_STAT_VCORE_RST_PROT_WDT_X(x) (((x) & GENMASK(2, 2)) >> 2)

#define CPU_RESET_PROT_STAT_VCORE_WDT_RST_PROT_WDT(x)\
	(((x) << 1) & GENMASK(1, 1))
#define CPU_RESET_PROT_STAT_VCORE_WDT_RST_PROT_WDT_M GENMASK(1, 1)
#define CPU_RESET_PROT_STAT_VCORE_WDT_RST_PROT_WDT_X(x)\
	(((x) & GENMASK(1, 1)) >> 1)

#define CPU_RESET_PROT_STAT_VCORE_WDT_RST_STAT(x) ((x) & GENMASK(0, 0))
#define CPU_RESET_PROT_STAT_VCORE_WDT_RST_STAT_M GENMASK(0, 0)
#define CPU_RESET_PROT_STAT_VCORE_WDT_RST_STAT_X(x) ((x) & GENMASK(0, 0))

/*      CPU:CPU_REGS:GENERAL_CTRL */
#define CPU_GENERAL_CTRL          TARGET_CPU,0,1,0,0,1,168,140,0,1,4
...
#define CPU_GENERAL_STAT          TARGET_CPU,0,1,0,0,1,168,144,0,1,4
...
#define CPU_OTP_STAT              TARGET_CPU,0,1,0,0,1,168,148,0,1,4

#define CPU_OTP_STAT_OTP_PROGRAMMED(x)           (((x) << 3) & GENMASK(3, 3))
#define CPU_OTP_STAT_OTP_PROGRAMMED_M            GENMASK(3, 3)
#define CPU_OTP_STAT_OTP_PROGRAMMED_X(x)         (((x) & GENMASK(3, 3)) >> 3)

#define CPU_OTP_STAT_OTP_CPU_DISABLED(x)         (((x) << 2) & GENMASK(2, 2))
#define CPU_OTP_STAT_OTP_CPU_DISABLED_M          GENMASK(2, 2)
#define CPU_OTP_STAT_OTP_CPU_DISABLED_X(x)       (((x) & GENMASK(2, 2)) >> 2)

#define CPU_OTP_STAT_OTP_CPU_DBG_DISABLED(x)     (((x) << 1) & GENMASK(1, 1))
#define CPU_OTP_STAT_OTP_CPU_DBG_DISABLED_M      GENMASK(1, 1)
#define CPU_OTP_STAT_OTP_CPU_DBG_DISABLED_X(x)   (((x) & GENMASK(1, 1)) >> 1)

#define CPU_OTP_STAT_OTP_CPU_SEC_DBG_DISABLED(x) ((x) & GENMASK(0, 0))
#define CPU_OTP_STAT_OTP_CPU_SEC_DBG_DISABLED_M  GENMASK(0, 0)
#define CPU_OTP_STAT_OTP_CPU_SEC_DBG_DISABLED_X(x) ((x) & GENMASK(0, 0))

/*      CPU:CPU_REGS:CPU_DBG */
#define CPU_CPU_DBG               TARGET_CPU,0,1,0,0,1,168,152,0,1,4
...
#define CPU_ENDIANNESS            TARGET_CPU,0,1,0,0,1,168,156,0,1,4
...
#define CPU_PROC_CTRL             TARGET_CPU,0,1,0,0,1,168,160,0,1,4
...
#define CPU_PROC_STAT             TARGET_CPU,0,1,0,0,1,168,164,0,1,4
...
#define CPU_GCK_CFG(r)            TARGET_CPU,0,1,168,0,1,48,0,r,12,4
...
#define CPU_USB_CFG               TARGET_CPU,0,1,216,0,1,48,0,0,1,4
...
#define CPU_USB_CTRL              TARGET_CPU,0,1,216,0,1,48,4,0,1,4

#define CPU_USB_CTRL_FLADJ_30MHZ_REG(x)          (((x) << 1) & GENMASK(6, 1))
#define CPU_USB_CTRL_FLADJ_30MHZ_REG_M           GENMASK(6, 1)
#define CPU_USB_CTRL_FLADJ_30MHZ_REG_X(x)        (((x) & GENMASK(6, 1)) >> 1)
...
#define CPU_USB_STAT              TARGET_CPU,0,1,216,0,1,48,8,0,1,4
...
#define CPU_USB_INTR              TARGET_CPU,0,1,216,0,1,48,12,0,1,4
...
#define CPU_USB_INTR_ENA          TARGET_CPU,0,1,216,0,1,48,16,0,1,4
...
#define CPU_USB_INTR_IDENT        TARGET_CPU,0,1,216,0,1,48,20,0,1,4
...
#define CPU_USB_DEBUG1            TARGET_CPU,0,1,216,0,1,48,24,0,1,4

/*      CPU:USB_REGS:USB_DEBUG2 */
#define CPU_USB_DEBUG2            TARGET_CPU,0,1,216,0,1,48,28,0,1,4

/*      CPU:USB_REGS:USB_DEBUG3 */
#define CPU_USB_DEBUG3            TARGET_CPU,0,1,216,0,1,48,32,0,1,4
...
#define CPU_USB_LA_TRACE1         TARGET_CPU,0,1,216,0,1,48,36,0,1,4

/*      CPU:USB_REGS:USB_LA_TRACE2 */
#define CPU_USB_LA_TRACE2         TARGET_CPU,0,1,216,0,1,48,40,0,1,4

/*      CPU:USB_REGS:USB_GGPIO */
#define CPU_USB_GGPIO             TARGET_CPU,0,1,216,0,1,48,44,0,1,4
...
/*      CPU:MIIM_SLAVE:MIIM_SLAVE_CFG */
#define CPU_MIIM_SLAVE_CFG        TARGET_CPU,0,1,264,0,1,4,0,0,1,4

#define CPU_MIIM_SLAVE_CFG_SPIKE_FILTER_CFG(x)   (((x) << 1) & GENMASK(5, 1))
#define CPU_MIIM_SLAVE_CFG_SPIKE_FILTER_CFG_M    GENMASK(5, 1)
#define CPU_MIIM_SLAVE_CFG_SPIKE_FILTER_CFG_X(x) (((x) & GENMASK(5, 1)) >> 1)

#define CPU_MIIM_SLAVE_CFG_SPIKE_FILTER_ENA(x)   ((x) & GENMASK(0, 0))
#define CPU_MIIM_SLAVE_CFG_SPIKE_FILTER_ENA_M    GENMASK(0, 0)
#define CPU_MIIM_SLAVE_CFG_SPIKE_FILTER_ENA_X(x) ((x) & GENMASK(0, 0))

/*      CPU:VCORE_ACC:VCORE_ACC_CFG */
#define CPU_VCORE_ACC_CFG         TARGET_CPU,0,1,268,0,1,4,0,0,1,4
...
#define CPU_MSIX_ACC_CFG          TARGET_CPU,0,1,272,0,1,4,0,0,1,4
...
#define CPU_EXT_IF_ACC_STAT       TARGET_CPU,0,1,276,0,1,4,0,0,1,4
...
/*      CPU:INTR:INTR_RAW */
#define CPU_INTR_RAW              TARGET_CPU,0,1,280,0,1,400,0,0,1,4

/*      CPU:INTR:INTR_RAW1 */
#define CPU_INTR_RAW1             TARGET_CPU,0,1,280,0,1,400,4,0,1,4

/*      CPU:INTR:INTR_RAW2 */
#define CPU_INTR_RAW2             TARGET_CPU,0,1,280,0,1,400,8,0,1,4

/*      CPU:INTR:INTR_TRIGGER */
#define CPU_INTR_TRIGGER(r)       TARGET_CPU,0,1,280,0,1,400,12,r,2,4

/*      CPU:INTR:INTR_TRIGGER1 */
#define CPU_INTR_TRIGGER1(r)      TARGET_CPU,0,1,280,0,1,400,20,r,2,4

/*      CPU:INTR:INTR_TRIGGER2 */
#define CPU_INTR_TRIGGER2(r)      TARGET_CPU,0,1,280,0,1,400,28,r,2,4

/*      CPU:INTR:INTR_FORCE */
#define CPU_INTR_FORCE            TARGET_CPU,0,1,280,0,1,400,36,0,1,4

/*      CPU:INTR:INTR_FORCE1 */
#define CPU_INTR_FORCE1           TARGET_CPU,0,1,280,0,1,400,40,0,1,4

/*      CPU:INTR:INTR_FORCE2 */
#define CPU_INTR_FORCE2           TARGET_CPU,0,1,280,0,1,400,44,0,1,4

/*      CPU:INTR:INTR_STICKY */
#define CPU_INTR_STICKY           TARGET_CPU,0,1,280,0,1,400,48,0,1,4

/*      CPU:INTR:INTR_STICKY1 */
#define CPU_INTR_STICKY1          TARGET_CPU,0,1,280,0,1,400,52,0,1,4

/*      CPU:INTR:INTR_STICKY2 */
#define CPU_INTR_STICKY2          TARGET_CPU,0,1,280,0,1,400,56,0,1,4

/*      CPU:INTR:INTR_BYPASS */
#define CPU_INTR_BYPASS           TARGET_CPU,0,1,280,0,1,400,60,0,1,4

/*      CPU:INTR:INTR_BYPASS1 */
#define CPU_INTR_BYPASS1          TARGET_CPU,0,1,280,0,1,400,64,0,1,4

/*      CPU:INTR:INTR_BYPASS2 */
#define CPU_INTR_BYPASS2          TARGET_CPU,0,1,280,0,1,400,68,0,1,4

/*      CPU:INTR:INTR_ENA */
#define CPU_INTR_ENA              TARGET_CPU,0,1,280,0,1,400,72,0,1,4

/*      CPU:INTR:INTR_ENA1 */
#define CPU_INTR_ENA1             TARGET_CPU,0,1,280,0,1,400,76,0,1,4

/*      CPU:INTR:INTR_ENA2 */
#define CPU_INTR_ENA2             TARGET_CPU,0,1,280,0,1,400,80,0,1,4

/*      CPU:INTR:INTR_ENA_CLR */
#define CPU_INTR_ENA_CLR          TARGET_CPU,0,1,280,0,1,400,84,0,1,4

/*      CPU:INTR:INTR_ENA_CLR1 */
#define CPU_INTR_ENA_CLR1         TARGET_CPU,0,1,280,0,1,400,88,0,1,4

/*      CPU:INTR:INTR_ENA_CLR2 */
#define CPU_INTR_ENA_CLR2         TARGET_CPU,0,1,280,0,1,400,92,0,1,4

/*      CPU:INTR:INTR_ENA_SET */
#define CPU_INTR_ENA_SET          TARGET_CPU,0,1,280,0,1,400,96,0,1,4

/*      CPU:INTR:INTR_ENA_SET1 */
#define CPU_INTR_ENA_SET1         TARGET_CPU,0,1,280,0,1,400,100,0,1,4

/*      CPU:INTR:INTR_ENA_SET2 */
#define CPU_INTR_ENA_SET2         TARGET_CPU,0,1,280,0,1,400,104,0,1,4

/*      CPU:INTR:INTR_IDENT */
#define CPU_INTR_IDENT            TARGET_CPU,0,1,280,0,1,400,108,0,1,4

/*      CPU:INTR:INTR_IDENT1 */
#define CPU_INTR_IDENT1           TARGET_CPU,0,1,280,0,1,400,112,0,1,4

/*      CPU:INTR:INTR_IDENT2 */
#define CPU_INTR_IDENT2           TARGET_CPU,0,1,280,0,1,400,116,0,1,4

/*      CPU:INTR:DST_INTR_MAP */
#define CPU_DST_INTR_MAP(r)       TARGET_CPU,0,1,280,0,1,400,120,r,9,4

/*      CPU:INTR:DST_INTR_MAP1 */
#define CPU_DST_INTR_MAP1(r)      TARGET_CPU,0,1,280,0,1,400,156,r,9,4

/*      CPU:INTR:DST_INTR_MAP2 */
#define CPU_DST_INTR_MAP2(r)      TARGET_CPU,0,1,280,0,1,400,192,r,9,4

/*      CPU:INTR:DST_INTR_IDENT */
#define CPU_DST_INTR_IDENT(r)     TARGET_CPU,0,1,280,0,1,400,228,r,9,4

/*      CPU:INTR:DST_INTR_IDENT1 */
#define CPU_DST_INTR_IDENT1(r)    TARGET_CPU,0,1,280,0,1,400,264,r,9,4

/*      CPU:INTR:DST_INTR_IDENT2 */
#define CPU_DST_INTR_IDENT2(r)    TARGET_CPU,0,1,280,0,1,400,300,r,9,4

/*      CPU:INTR:EXT_SRC_INTR_POL */
#define CPU_EXT_SRC_INTR_POL      TARGET_CPU,0,1,280,0,1,400,336,0,1,4
...
#define CPU_EXT_DST_INTR_POL      TARGET_CPU,0,1,280,0,1,400,340,0,1,4
...
#define CPU_EXT_DST_INTR_DRV      TARGET_CPU,0,1,280,0,1,400,344,0,1,4
...
#define CPU_DEV_INTR_POL          TARGET_CPU,0,1,280,0,1,400,348,0,1,4
...
#define CPU_DEV_INTR_RAW          TARGET_CPU,0,1,280,0,1,400,352,0,1,4
...
#define CPU_DEV_INTR_TRIGGER(r)   TARGET_CPU,0,1,280,0,1,400,356,r,2,4
...
#define CPU_DEV_INTR_STICKY       TARGET_CPU,0,1,280,0,1,400,364,0,1,4
...
#define CPU_DEV_INTR_BYPASS       TARGET_CPU,0,1,280,0,1,400,368,0,1,4
...
#define CPU_DEV_INTR_ENA          TARGET_CPU,0,1,280,0,1,400,372,0,1,4
...
#define CPU_DEV_INTR_IDENT        TARGET_CPU,0,1,280,0,1,400,376,0,1,4
...
/*      CPU:INTR:MSIX_CFG */
#define CPU_MSIX_CFG              TARGET_CPU,0,1,280,0,1,400,380,0,1,4
...
#define CPU_MSIX_DOORBELL_ADDR    TARGET_CPU,0,1,280,0,1,400,384,0,1,4

/*      CPU:INTR:MSIX_INTR_PENDING */
#define CPU_MSIX_INTR_PENDING     TARGET_CPU,0,1,280,0,1,400,388,0,1,4

/*      CPU:INTR:MSIX_INTR_PENDING1 */
#define CPU_MSIX_INTR_PENDING1    TARGET_CPU,0,1,280,0,1,400,392,0,1,4

/*      CPU:INTR:MSIX_INTR_PENDING2 */
#define CPU_MSIX_INTR_PENDING2    TARGET_CPU,0,1,280,0,1,400,396,0,1,4

/*      CPU:DDRCTRL:DDRCTRL_CLK */
#define CPU_DDRCTRL_CLK           TARGET_CPU,0,1,680,0,1,20,0,0,1,4
...
#define CPU_DDRCTRL_RST           TARGET_CPU,0,1,680,0,1,20,4,0,1,4
...
#define CPU_DDRC_INTR_RAW_STAT    TARGET_CPU,0,1,680,0,1,20,8,0,1,4
...
#define CPU_DDRC_INTR_MASK        TARGET_CPU,0,1,680,0,1,20,12,0,1,4
...
#define CPU_DDRC_INTR_MASKED_STAT TARGET_CPU,0,1,680,0,1,20,16,0,1,4
...
/*      CPU:PI_REG:PI_CON */
#define CPU_PI_CON                TARGET_CPU,0,1,700,0,1,8,0,0,1,4
...
/*      CPU:PI_REG:PI_MODE */
#define CPU_PI_MODE               TARGET_CPU,0,1,700,0,1,8,4,0,1,4
...
/*      CPU:SFR_REGS:CLK_GATING_DIS */
#define CPU_CLK_GATING_DIS        TARGET_CPU,0,1,708,0,1,28,0,0,1,4

#define CPU_CLK_GATING_DIS_uhphs_clk_gating_dis(x)\
	(((x) << 11) & GENMASK(11, 11))
#define CPU_CLK_GATING_DIS_uhphs_clk_gating_dis_M GENMASK(11, 11)
#define CPU_CLK_GATING_DIS_uhphs_clk_gating_dis_X(x)\
	(((x) & GENMASK(11, 11)) >> 11)

#define CPU_CLK_GATING_DIS_udphs_clk_gating_dis(x)\
	(((x) << 10) & GENMASK(10, 10))
#define CPU_CLK_GATING_DIS_udphs_clk_gating_dis_M GENMASK(10, 10)
#define CPU_CLK_GATING_DIS_udphs_clk_gating_dis_X(x)\
	(((x) & GENMASK(10, 10)) >> 10)

#define CPU_CLK_GATING_DIS_mcramc_clk_gating_dis(x) (((x) << 9) & GENMASK(9, 9))
#define CPU_CLK_GATING_DIS_mcramc_clk_gating_dis_M GENMASK(9, 9)
#define CPU_CLK_GATING_DIS_mcramc_clk_gating_dis_X(x)\
	(((x) & GENMASK(9, 9)) >> 9)

#define CPU_CLK_GATING_DIS_hmatrix_clk_gating_dis(x)\
	(((x) << 8) & GENMASK(8, 8))
#define CPU_CLK_GATING_DIS_hmatrix_clk_gating_dis_M GENMASK(8, 8)
#define CPU_CLK_GATING_DIS_hmatrix_clk_gating_dis_X(x)\
	(((x) & GENMASK(8, 8)) >> 8)

#define CPU_CLK_GATING_DIS_hbridge_clk_gating_dis(x) ((x) & GENMASK(3, 0))
#define CPU_CLK_GATING_DIS_hbridge_clk_gating_dis_M GENMASK(3, 0)
#define CPU_CLK_GATING_DIS_hbridge_clk_gating_dis_X(x) ((x) & GENMASK(3, 0))

/*      CPU:SFR_REGS:AHBLITE2AXI */
#define CPU_AHBLITE2AXI           TARGET_CPU,0,1,708,0,1,28,4,0,1,4
...
/*      CPU:SFR_REGS:TZAESB */
#define CPU_TZAESB                TARGET_CPU,0,1,708,0,1,28,8,0,1,4
...
/*      CPU:SFR_REGS:MCAN */
#define CPU_MCAN                  TARGET_CPU,0,1,708,0,1,28,12,0,1,4
...
/*      CPU:SFR_REGS:HICM */
#define CPU_HICM                  TARGET_CPU,0,1,708,0,1,28,16,0,1,4
...
/*      CPU:SFR_REGS:UDPHS */
#define CPU_UDPHS                 TARGET_CPU,0,1,708,0,1,28,20,0,1,4
...
/*      CPU:SFR_REGS:UDDR */
#define CPU_UDDR                  TARGET_CPU,0,1,708,0,1,28,24,0,1,4
...
#define CPU_com_bias_bg_TC_trim   TARGET_CPU,0,1,736,0,1,36,0,0,1,4
...
#define CPU_com_bias_bg_MAG_trim  TARGET_CPU,0,1,736,0,1,36,4,0,1,4
...
#define CPU_com_rbias_MAG_trim    TARGET_CPU,0,1,736,0,1,36,8,0,1,4
...
#define CPU_com_bias_az_clk_sel   TARGET_CPU,0,1,736,0,1,36,12,0,1,4
...
#define CPU_com_atest_sel         TARGET_CPU,0,1,736,0,1,36,16,0,1,4
...
#define CPU_com_suspendb          TARGET_CPU,0,1,736,0,1,36,20,0,1,4
...
#define CPU_com_xtal_suspendb     TARGET_CPU,0,1,736,0,1,36,24,0,1,4
...
#define CPU_com_pll_lpm_mode      TARGET_CPU,0,1,736,0,1,36,28,0,1,4
...
#define CPU_com_pll_en            TARGET_CPU,0,1,736,0,1,36,32,0,1,4
...
#define CPU_usb2_hs_disc_p0       TARGET_CPU,0,1,772,0,1,24,0,0,1,4
...
#define CPU_usb2_sq_tune_p0       TARGET_CPU,0,1,772,0,1,24,4,0,1,4
...
#define CPU_usb2_hs_drive_p0      TARGET_CPU,0,1,772,0,1,24,8,0,1,4
...
#define CPU_usb2_HSOS_scan_en_p0  TARGET_CPU,0,1,772,0,1,24,12,0,1,4
...
#define CPU_usb2_HSOS_scan_data_p0 TARGET_CPU,0,1,772,0,1,24,16,0,1,4
...
#define CPU_usb2_hs_ovsmp_p0      TARGET_CPU,0,1,772,0,1,24,20,0,1,4
...
#define CPU_PROG_BITS             TARGET_CPU,0,1,796,0,1,4,0,0,1,4
...
#define CPU_ULPI_RST              TARGET_CPU,0,1,800,0,1,4,0,0,1,4
...
#define CPU_PHY_CFG               TARGET_CPU,0,1,804,0,1,20,0,0,1,4
...
#define CPU_PHY_TUNE              TARGET_CPU,0,1,804,0,1,20,4,0,1,4
...
#define CPU_PCS_CFG               TARGET_CPU,0,1,804,0,1,20,8,0,1,4
...
#define CPU_PHY_CR_CTRL           TARGET_CPU,0,1,804,0,1,20,12,0,1,4
...
#define CPU_PHY_CR_DATA           TARGET_CPU,0,1,804,0,1,20,16,0,1,4
...
#define GCB_CHIP_ID               TARGET_GCB,0,1,0,0,1,68,0,0,1,4
...
#define GCB_REVID_RAW             TARGET_GCB,0,1,0,0,1,68,4,0,1,4
...
/*      GCB:CHIP_REGS:GPR */
#define GCB_GPR                   TARGET_GCB,0,1,0,0,1,68,8,0,1,4

/*      GCB:CHIP_REGS:SOFT_RST */
#define GCB_SOFT_RST              TARGET_GCB,0,1,0,0,1,68,12,0,1,4
...
#define GCB_HW_STAT               TARGET_GCB,0,1,0,0,1,68,16,0,1,4
...
#define GCB_HW_SGPIO_TO_SD_MAP_CFG(r) TARGET_GCB,0,1,0,0,1,68,20,r,8,4
...
#define GCB_HW_SGPIO_TO_SERDES_SD_MAP_CFG(r) TARGET_GCB,0,1,0,0,1,68,52,r,3,4
...
/*      GCB:SI_REGS:IF_CTRL */
#define GCB_IF_CTRL               TARGET_GCB,0,1,68,0,1,8,0,0,1,4
...
#define GCB_IF_CFGSTAT            TARGET_GCB,0,1,68,0,1,8,4,0,1,4
...
/*      GCB:SW_REGS:SW_INTR */
#define GCB_SW_INTR               TARGET_GCB,0,1,76,0,1,4,0,0,1,4
...
#define GCB_VA_CTRL               TARGET_GCB,0,1,80,0,1,20,0,0,1,4
...
#define GCB_VA_ADDR               TARGET_GCB,0,1,80,0,1,20,4,0,1,4

/*      GCB:VCORE_ACCESS:VA_DATA */
#define GCB_VA_DATA               TARGET_GCB,0,1,80,0,1,20,8,0,1,4

/*      GCB:VCORE_ACCESS:VA_DATA_INCR */
#define GCB_VA_DATA_INCR          TARGET_GCB,0,1,80,0,1,20,12,0,1,4

/*      GCB:VCORE_ACCESS:VA_DATA_INERT */
#define GCB_VA_DATA_INERT         TARGET_GCB,0,1,80,0,1,20,16,0,1,4

/*      GCB:GPIO:GPIO_OUT_SET */
#define GCB_GPIO_OUT_SET          TARGET_GCB,0,1,100,0,1,180,0,0,1,4

/*      GCB:GPIO:GPIO_OUT_SET1 */
#define GCB_GPIO_OUT_SET1         TARGET_GCB,0,1,100,0,1,180,4,0,1,4

/*      GCB:GPIO:GPIO_OUT_SET2 */
#define GCB_GPIO_OUT_SET2         TARGET_GCB,0,1,100,0,1,180,8,0,1,4
...
#define GCB_GPIO_OUT_CLR          TARGET_GCB,0,1,100,0,1,180,12,0,1,4

/*      GCB:GPIO:GPIO_OUT_CLR1 */
#define GCB_GPIO_OUT_CLR1         TARGET_GCB,0,1,100,0,1,180,16,0,1,4

/*      GCB:GPIO:GPIO_OUT_CLR2 */
#define GCB_GPIO_OUT_CLR2         TARGET_GCB,0,1,100,0,1,180,20,0,1,4
...
/*      GCB:GPIO:GPIO_OUT */
#define GCB_GPIO_OUT              TARGET_GCB,0,1,100,0,1,180,24,0,1,4

/*      GCB:GPIO:GPIO_OUT1 */
#define GCB_GPIO_OUT1             TARGET_GCB,0,1,100,0,1,180,28,0,1,4

/*      GCB:GPIO:GPIO_OUT2 */
#define GCB_GPIO_OUT2             TARGET_GCB,0,1,100,0,1,180,32,0,1,4
...
/*      GCB:GPIO:GPIO_IN */
#define GCB_GPIO_IN               TARGET_GCB,0,1,100,0,1,180,36,0,1,4

/*      GCB:GPIO:GPIO_IN1 */
#define GCB_GPIO_IN1              TARGET_GCB,0,1,100,0,1,180,40,0,1,4

/*      GCB:GPIO:GPIO_IN2 */
#define GCB_GPIO_IN2              TARGET_GCB,0,1,100,0,1,180,44,0,1,4
...
/*      GCB:GPIO:GPIO_OE */
#define GCB_GPIO_OE               TARGET_GCB,0,1,100,0,1,180,48,0,1,4

/*      GCB:GPIO:GPIO_OE1 */
#define GCB_GPIO_OE1              TARGET_GCB,0,1,100,0,1,180,52,0,1,4

/*      GCB:GPIO:GPIO_OE2 */
#define GCB_GPIO_OE2              TARGET_GCB,0,1,100,0,1,180,56,0,1,4
...
/*      GCB:GPIO:GPIO_INTR */
#define GCB_GPIO_INTR             TARGET_GCB,0,1,100,0,1,180,60,0,1,4

/*      GCB:GPIO:GPIO_INTR1 */
#define GCB_GPIO_INTR1            TARGET_GCB,0,1,100,0,1,180,64,0,1,4

/*      GCB:GPIO:GPIO_INTR2 */
#define GCB_GPIO_INTR2            TARGET_GCB,0,1,100,0,1,180,68,0,1,4
...
#define GCB_GPIO_INTR_ENA         TARGET_GCB,0,1,100,0,1,180,72,0,1,4

/*      GCB:GPIO:GPIO_INTR_ENA1 */
#define GCB_GPIO_INTR_ENA1        TARGET_GCB,0,1,100,0,1,180,76,0,1,4

/*      GCB:GPIO:GPIO_INTR_ENA2 */
#define GCB_GPIO_INTR_ENA2        TARGET_GCB,0,1,100,0,1,180,80,0,1,4
...
#define GCB_GPIO_INTR_IDENT       TARGET_GCB,0,1,100,0,1,180,84,0,1,4

/*      GCB:GPIO:GPIO_INTR_IDENT1 */
#define GCB_GPIO_INTR_IDENT1      TARGET_GCB,0,1,100,0,1,180,88,0,1,4

/*      GCB:GPIO:GPIO_INTR_IDENT2 */
#define GCB_GPIO_INTR_IDENT2      TARGET_GCB,0,1,100,0,1,180,92,0,1,4
...
/*      GCB:GPIO:GPIO_ALT */
#define GCB_GPIO_ALT(r)           TARGET_GCB,0,1,100,0,1,180,96,r,3,4

/*      GCB:GPIO:GPIO_ALT1 */
#define GCB_GPIO_ALT1(r)          TARGET_GCB,0,1,100,0,1,180,108,r,3,4

/*      GCB:GPIO:GPIO_ALT2 */
#define GCB_GPIO_ALT2(r)          TARGET_GCB,0,1,100,0,1,180,120,r,3,4
...
#define GCB_GPIO_SD_DEV_MAP(r)    TARGET_GCB,0,1,100,0,1,180,132,r,6,4
...
#define GCB_GPIO_SD_SERDES_MAP(r) TARGET_GCB,0,1,100,0,1,180,156,r,6,4
...
/*      GCB:MIIM:MII_STATUS */
#define GCB_MII_STATUS(g)         TARGET_GCB,0,1,280,g,2,36,0,0,1,4
...
#define GCB_MII_CFG_7226(g)       TARGET_GCB,0,1,280,g,2,36,4,0,1,4
...
/*      GCB:MIIM:MII_CMD */
#define GCB_MII_CMD(g)            TARGET_GCB,0,1,280,g,2,36,8,0,1,4
...
/*      GCB:MIIM:MII_DATA */
#define GCB_MII_DATA(g)           TARGET_GCB,0,1,280,g,2,36,12,0,1,4
...
/*      GCB:MIIM:MII_CFG */
#define GCB_MII_CFG(g)            TARGET_GCB,0,1,280,g,2,36,16,0,1,4
...
/*      GCB:MIIM:MII_SCAN_0 */
#define GCB_MII_SCAN_0(g)         TARGET_GCB,0,1,280,g,2,36,20,0,1,4
...
/*      GCB:MIIM:MII_SCAN_1 */
#define GCB_MII_SCAN_1(g)         TARGET_GCB,0,1,280,g,2,36,24,0,1,4
...
/*      GCB:MIIM:MII_RSLTS */
#define GCB_MII_RSLTS(g)          TARGET_GCB,0,1,280,g,2,36,28,0,1,4

/*      GCB:MIIM:MII_RSLTS_VLD */
#define GCB_MII_RSLTS_VLD(g)      TARGET_GCB,0,1,280,g,2,36,32,0,1,4

/*      GCB:MIIM_READ_SCAN:MII_STICKY */
#define GCB_MII_STICKY(r)         TARGET_GCB,0,1,352,0,1,8,0,r,2,4

/*      GCB:FLEXCOM_SHARED:SS_MASK */
#define GCB_SS_MASK(g,r)          TARGET_GCB,0,1,360,g,5,8,0,r,2,4
...
#define GCB_SIO_INPUT_DATA(r)     TARGET_GCB,0,1,400,0,1,280,0,r,4,4

/*      GCB:SIO_CTRL:SIO_CFG */
#define GCB_SIO_CFG               TARGET_GCB,0,1,400,0,1,280,16,0,1,4
...
#define GCB_SIO_CFG_SIO_MASTER_INTR_ENA(x)       ((x) & GENMASK(0, 0))
#define GCB_SIO_CFG_SIO_MASTER_INTR_ENA_M        GENMASK(0, 0)
#define GCB_SIO_CFG_SIO_MASTER_INTR_ENA_X(x)     ((x) & GENMASK(0, 0))

/*      GCB:SIO_CTRL:SIO_CLOCK */
#define GCB_SIO_CLOCK             TARGET_GCB,0,1,400,0,1,280,20,0,1,4
...
#define GCB_SIO_PORT_CFG(r)       TARGET_GCB,0,1,400,0,1,280,24,r,32,4
...
#define GCB_SIO_PORT_ENA          TARGET_GCB,0,1,400,0,1,280,152,0,1,4

/*      GCB:SIO_CTRL:SIO_PWM_CFG */
#define GCB_SIO_PWM_CFG(r)        TARGET_GCB,0,1,400,0,1,280,156,r,3,4
...
#define GCB_SIO_INTR_POL(r)       TARGET_GCB,0,1,400,0,1,280,168,r,4,4

/*      GCB:SIO_CTRL:SIO_INTR_RAW */
#define GCB_SIO_INTR_RAW(r)       TARGET_GCB,0,1,400,0,1,280,184,r,4,4

/*      GCB:SIO_CTRL:SIO_INTR_TRIGGER0 */
#define GCB_SIO_INTR_TRIGGER0(r)  TARGET_GCB,0,1,400,0,1,280,200,r,4,4

/*      GCB:SIO_CTRL:SIO_INTR_TRIGGER1 */
#define GCB_SIO_INTR_TRIGGER1(r)  TARGET_GCB,0,1,400,0,1,280,216,r,4,4

/*      GCB:SIO_CTRL:SIO_INTR */
#define GCB_SIO_INTR(r)           TARGET_GCB,0,1,400,0,1,280,232,r,4,4

/*      GCB:SIO_CTRL:SIO_INTR_ENA */
#define GCB_SIO_INTR_ENA(r)       TARGET_GCB,0,1,400,0,1,280,248,r,4,4

/*      GCB:SIO_CTRL:SIO_INTR_IDENT */
#define GCB_SIO_INTR_IDENT(r)     TARGET_GCB,0,1,400,0,1,280,264,r,4,4

/*      GCB:FAN_CTRL:FAN_CFG */
#define GCB_FAN_CFG               TARGET_GCB,0,1,680,0,1,12,0,0,1,4
...
#define GCB_PWM_FREQ              TARGET_GCB,0,1,680,0,1,12,4,0,1,4
...
#define GCB_FAN_CNT               TARGET_GCB,0,1,680,0,1,12,8,0,1,4
...
#define GCB_MEMITGR_CTRL          TARGET_GCB,0,1,692,0,1,24,0,0,1,4
...
#define GCB_MEMITGR_STAT          TARGET_GCB,0,1,692,0,1,24,4,0,1,4
...
#define GCB_MEMITGR_INFO          TARGET_GCB,0,1,692,0,1,24,8,0,1,4
...
#define GCB_MEMITGR_IDX           TARGET_GCB,0,1,692,0,1,24,12,0,1,4
...
#define GCB_MEMITGR_DIV           TARGET_GCB,0,1,692,0,1,24,16,0,1,4
...
#define GCB_MEMITGR_DBG           TARGET_GCB,0,1,692,0,1,24,20,0,1,4
...
#define GCB_VRAP_ACCESS_STAT      TARGET_GCB,0,1,716,0,1,4,0,0,1,4
...
/*      ORG:ORG:IF_CTRL */
#define ORG_IF_CTRL(t)            TARGET_ORG,t,2,0,0,1,72,0,0,1,4
...
/*      ORG:ORG:IF_CFGSTAT */
#define ORG_IF_CFGSTAT(t)         TARGET_ORG,t,2,0,0,1,72,4,0,1,4
...
/*      ORG:ORG:ORG_CFG */
#define ORG_ORG_CFG(t)            TARGET_ORG,t,2,0,0,1,72,8,0,1,4
...
/*      ORG:ORG:ERR_CNTS */
#define ORG_ERR_CNTS(t)           TARGET_ORG,t,2,0,0,1,72,12,0,1,4
...
/*      ORG:ORG:TIMEOUT_CFG */
#define ORG_TIMEOUT_CFG(t)        TARGET_ORG,t,2,0,0,1,72,16,0,1,4
...
/*      ORG:ORG:GPR */
#define ORG_GPR(t)                TARGET_ORG,t,2,0,0,1,72,20,0,1,4

/*      ORG:ORG:MAILBOX_SET */
#define ORG_MAILBOX_SET(t)        TARGET_ORG,t,2,0,0,1,72,24,0,1,4

/*      ORG:ORG:MAILBOX_CLR */
#define ORG_MAILBOX_CLR(t)        TARGET_ORG,t,2,0,0,1,72,28,0,1,4

/*      ORG:ORG:MAILBOX */
#define ORG_MAILBOX(t)            TARGET_ORG,t,2,0,0,1,72,32,0,1,4

/*      ORG:ORG:SEMA_CFG */
#define ORG_SEMA_CFG(t)           TARGET_ORG,t,2,0,0,1,72,36,0,1,4
...
/*      ORG:ORG:SEMA */
#define ORG_SEMA(t,r)             TARGET_ORG,t,2,0,0,1,72,40,r,8,4
