...
#define CPU_ENDIANNESS            TARGET_CPU,0,1,0,0,1,168,148,0,1,4
...
#define CPU_PROC_CTRL             TARGET_CPU,0,1,0,0,1,168,152,0,1,4
...
#define CPU_CPU0_RVBAR_LSB        TARGET_CPU,0,1,0,0,1,168,156,0,1,4

/*      CPU:CPU_REGS:CPU0_RVBAR_MSB */
#define CPU_CPU0_RVBAR_MSB        TARGET_CPU,0,1,0,0,1,168,160,0,1,4
...
#define CPU_DDRC_INTR_RAW_STAT_ECC_CORRECTED_ERR_INTR_RAW_STAT(x)\
	((x) & GENMASK(0, 0))
#define CPU_DDRC_INTR_RAW_STAT_ECC_CORRECTED_ERR_INTR_RAW_STAT_M GENMASK(0, 0)
...
#define CPU_DDRC_INTR_RAW_STAT_ECC_UNCORRECTED_ERR_INTR_RAW_STAT(x)\
	(((x) << 1) & GENMASK(1, 1))
#define CPU_DDRC_INTR_RAW_STAT_ECC_UNCORRECTED_ERR_INTR_RAW_STAT_M GENMASK(1, 1)
...
#define CPU_DDRC_INTR_MASK_ECC_CORRECTED_ERR_INTR_MASK(x) ((x) & GENMASK(0, 0))
#define CPU_DDRC_INTR_MASK_ECC_CORRECTED_ERR_INTR_MASK_M GENMASK(0, 0)
#define CPU_DDRC_INTR_MASK_ECC_CORRECTED_ERR_INTR_MASK_X(x)\
	((x) & GENMASK(0, 0))

#define CPU_DDRC_INTR_MASK_ECC_UNCORRECTED_ERR_INTR_MASK(x)\
	(((x) << 1) & GENMASK(1, 1))
#define CPU_DDRC_INTR_MASK_ECC_UNCORRECTED_ERR_INTR_MASK_M GENMASK(1, 1)
...
#define CPU_DDRC_INTR_MASKED_STAT_ECC_CORRECTED_ERR_INTR_STAT(x)\
	((x) & GENMASK(0, 0))
#define CPU_DDRC_INTR_MASKED_STAT_ECC_CORRECTED_ERR_INTR_STAT_M GENMASK(0, 0)
...
#define CPU_DDRC_INTR_MASKED_STAT_ECC_UNCORRECTED_ERR_INTR_STAT(x)\
	(((x) << 1) & GENMASK(1, 1))
#define CPU_DDRC_INTR_MASKED_STAT_ECC_UNCORRECTED_ERR_INTR_STAT_M GENMASK(1, 1)
...
#define CPU_CLK_GATING_DIS_mcramc_clk_gating_dis(x)\
	(((x) << 16) & GENMASK(16, 16))
#define CPU_CLK_GATING_DIS_mcramc_clk_gating_dis_M GENMASK(16, 16)
...
#define CPU_PHY_CFG               TARGET_CPU,0,1,800,0,1,20,0,0,1,4
...
#define CPU_PHY_TUNE              TARGET_CPU,0,1,800,0,1,20,4,0,1,4
...
#define CPU_PCS_CFG               TARGET_CPU,0,1,800,0,1,20,8,0,1,4
...
#define CPU_PHY_CR_CTRL           TARGET_CPU,0,1,800,0,1,20,12,0,1,4
...
#define CPU_PHY_CR_DATA           TARGET_CPU,0,1,800,0,1,20,16,0,1,4
...
#define DEV_PCS1G_LPI_STATUS_RX_LPI_EVENT_STICKY(x)\
	(((x) << 12) & GENMASK(12, 12))
#define DEV_PCS1G_LPI_STATUS_RX_LPI_EVENT_STICKY_M GENMASK(12, 12)
#define DEV_PCS1G_LPI_STATUS_RX_LPI_EVENT_STICKY_X(x)\
	(((x) & GENMASK(12, 12)) >> 12)
...
#define DEV_PCS1G_LPI_STATUS_TX_LPI_EVENT_STICKY(x) (((x) << 4) & GENMASK(4, 4))
#define DEV_PCS1G_LPI_STATUS_TX_LPI_EVENT_STICKY_M GENMASK(4, 4)
#define DEV_PCS1G_LPI_STATUS_TX_LPI_EVENT_STICKY_X(x)\
	(((x) & GENMASK(4, 4)) >> 4)
...
#define GCB_CHIP_ID               TARGET_GCB,0,1,0,0,1,80,0,0,1,4
...
#define GCB_REVID_RAW             TARGET_GCB,0,1,0,0,1,80,4,0,1,4
...
/*      GCB:CHIP_REGS:GPR */
#define GCB_GPR                   TARGET_GCB,0,1,0,0,1,80,8,0,1,4

/*      GCB:CHIP_REGS:SOFT_RST */
#define GCB_SOFT_RST              TARGET_GCB,0,1,0,0,1,80,12,0,1,4
...
#define GCB_HW_STAT               TARGET_GCB,0,1,0,0,1,80,16,0,1,4
...
/*      GCB:CHIP_REGS:HW_SGPIO_SD_CFG */
#define GCB_HW_SGPIO_SD_CFG       TARGET_GCB,0,1,0,0,1,80,20,0,1,4

#define GCB_HW_SGPIO_SD_CFG_SD_HIGH_ENA(x)       (((x) << 1) & GENMASK(1, 1))
#define GCB_HW_SGPIO_SD_CFG_SD_HIGH_ENA_M        GENMASK(1, 1)
#define GCB_HW_SGPIO_SD_CFG_SD_HIGH_ENA_X(x)     (((x) & GENMASK(1, 1)) >> 1)

#define GCB_HW_SGPIO_SD_CFG_SD_MAP_SEL(x)        ((x) & GENMASK(0, 0))
#define GCB_HW_SGPIO_SD_CFG_SD_MAP_SEL_M         GENMASK(0, 0)
#define GCB_HW_SGPIO_SD_CFG_SD_MAP_SEL_X(x)      ((x) & GENMASK(0, 0))

/*      GCB:CHIP_REGS:HW_SGPIO_TO_SD_MAP_CFG */
#define GCB_HW_SGPIO_TO_SD_MAP_CFG(r) TARGET_GCB,0,1,0,0,1,80,24,r,8,4
...
#define GCB_HW_SGPIO_TO_SERDES_SD_MAP_CFG(r) TARGET_GCB,0,1,0,0,1,80,56,r,3,4
...
/*      GCB:CHIP_REGS:FEA_STAT */
#define GCB_FEA_STAT              TARGET_GCB,0,1,0,0,1,80,68,0,1,4

/*      GCB:CHIP_REGS:FEA_DIS */
#define GCB_FEA_DIS               TARGET_GCB,0,1,0,0,1,80,72,0,1,4

/*      GCB:CHIP_REGS:BUILDID */
#define GCB_BUILDID               TARGET_GCB,0,1,0,0,1,80,76,0,1,4

/*      GCB:SI_REGS:IF_CTRL */
#define GCB_IF_CTRL               TARGET_GCB,0,1,80,0,1,8,0,0,1,4
...
#define GCB_IF_CFGSTAT            TARGET_GCB,0,1,80,0,1,8,4,0,1,4
...
/*      GCB:SW_REGS:SW_INTR */
#define GCB_SW_INTR               TARGET_GCB,0,1,88,0,1,4,0,0,1,4
...
#define GCB_VA_CTRL               TARGET_GCB,0,1,92,0,1,20,0,0,1,4
...
#define GCB_VA_ADDR               TARGET_GCB,0,1,92,0,1,20,4,0,1,4

/*      GCB:VCORE_ACCESS:VA_DATA */
#define GCB_VA_DATA               TARGET_GCB,0,1,92,0,1,20,8,0,1,4

/*      GCB:VCORE_ACCESS:VA_DATA_INCR */
#define GCB_VA_DATA_INCR          TARGET_GCB,0,1,92,0,1,20,12,0,1,4

/*      GCB:VCORE_ACCESS:VA_DATA_INERT */
#define GCB_VA_DATA_INERT         TARGET_GCB,0,1,92,0,1,20,16,0,1,4

/*      GCB:GPIO:GPIO_OUT_SET */
#define GCB_GPIO_OUT_SET          TARGET_GCB,0,1,112,0,1,180,0,0,1,4

/*      GCB:GPIO:GPIO_OUT_SET1 */
#define GCB_GPIO_OUT_SET1         TARGET_GCB,0,1,112,0,1,180,4,0,1,4

/*      GCB:GPIO:GPIO_OUT_SET2 */
#define GCB_GPIO_OUT_SET2         TARGET_GCB,0,1,112,0,1,180,8,0,1,4
...
#define GCB_GPIO_OUT_CLR          TARGET_GCB,0,1,112,0,1,180,12,0,1,4

/*      GCB:GPIO:GPIO_OUT_CLR1 */
#define GCB_GPIO_OUT_CLR1         TARGET_GCB,0,1,112,0,1,180,16,0,1,4

/*      GCB:GPIO:GPIO_OUT_CLR2 */
#define GCB_GPIO_OUT_CLR2         TARGET_GCB,0,1,112,0,1,180,20,0,1,4
...
/*      GCB:GPIO:GPIO_OUT */
#define GCB_GPIO_OUT              TARGET_GCB,0,1,112,0,1,180,24,0,1,4

/*      GCB:GPIO:GPIO_OUT1 */
#define GCB_GPIO_OUT1             TARGET_GCB,0,1,112,0,1,180,28,0,1,4

/*      GCB:GPIO:GPIO_OUT2 */
#define GCB_GPIO_OUT2             TARGET_GCB,0,1,112,0,1,180,32,0,1,4
...
/*      GCB:GPIO:GPIO_IN */
#define GCB_GPIO_IN               TARGET_GCB,0,1,112,0,1,180,36,0,1,4

/*      GCB:GPIO:GPIO_IN1 */
#define GCB_GPIO_IN1              TARGET_GCB,0,1,112,0,1,180,40,0,1,4

/*      GCB:GPIO:GPIO_IN2 */
#define GCB_GPIO_IN2              TARGET_GCB,0,1,112,0,1,180,44,0,1,4
...
/*      GCB:GPIO:GPIO_OE */
#define GCB_GPIO_OE               TARGET_GCB,0,1,112,0,1,180,48,0,1,4

/*      GCB:GPIO:GPIO_OE1 */
#define GCB_GPIO_OE1              TARGET_GCB,0,1,112,0,1,180,52,0,1,4

/*      GCB:GPIO:GPIO_OE2 */
#define GCB_GPIO_OE2              TARGET_GCB,0,1,112,0,1,180,56,0,1,4
...
/*      GCB:GPIO:GPIO_INTR */
#define GCB_GPIO_INTR             TARGET_GCB,0,1,112,0,1,180,60,0,1,4

/*      GCB:GPIO:GPIO_INTR1 */
#define GCB_GPIO_INTR1            TARGET_GCB,0,1,112,0,1,180,64,0,1,4

/*      GCB:GPIO:GPIO_INTR2 */
#define GCB_GPIO_INTR2            TARGET_GCB,0,1,112,0,1,180,68,0,1,4
...
#define GCB_GPIO_INTR_ENA         TARGET_GCB,0,1,112,0,1,180,72,0,1,4

/*      GCB:GPIO:GPIO_INTR_ENA1 */
#define GCB_GPIO_INTR_ENA1        TARGET_GCB,0,1,112,0,1,180,76,0,1,4

/*      GCB:GPIO:GPIO_INTR_ENA2 */
#define GCB_GPIO_INTR_ENA2        TARGET_GCB,0,1,112,0,1,180,80,0,1,4
...
#define GCB_GPIO_INTR_IDENT       TARGET_GCB,0,1,112,0,1,180,84,0,1,4

/*      GCB:GPIO:GPIO_INTR_IDENT1 */
#define GCB_GPIO_INTR_IDENT1      TARGET_GCB,0,1,112,0,1,180,88,0,1,4

/*      GCB:GPIO:GPIO_INTR_IDENT2 */
#define GCB_GPIO_INTR_IDENT2      TARGET_GCB,0,1,112,0,1,180,92,0,1,4
...
/*      GCB:GPIO:GPIO_ALT */
#define GCB_GPIO_ALT(r)           TARGET_GCB,0,1,112,0,1,180,96,r,3,4

/*      GCB:GPIO:GPIO_ALT1 */
#define GCB_GPIO_ALT1(r)          TARGET_GCB,0,1,112,0,1,180,108,r,3,4

/*      GCB:GPIO:GPIO_ALT2 */
#define GCB_GPIO_ALT2(r)          TARGET_GCB,0,1,112,0,1,180,120,r,3,4
...
#define GCB_GPIO_SD_DEV_MAP(r)    TARGET_GCB,0,1,112,0,1,180,132,r,6,4
...
#define GCB_GPIO_SD_SERDES_MAP(r) TARGET_GCB,0,1,112,0,1,180,156,r,6,4
...
/*      GCB:MIIM:MII_STATUS */
#define GCB_MII_STATUS(g)         TARGET_GCB,0,1,292,g,2,36,0,0,1,4
...
#define GCB_MII_CFG_7226(g)       TARGET_GCB,0,1,292,g,2,36,4,0,1,4
...
/*      GCB:MIIM:MII_CMD */
#define GCB_MII_CMD(g)            TARGET_GCB,0,1,292,g,2,36,8,0,1,4
...
/*      GCB:MIIM:MII_DATA */
#define GCB_MII_DATA(g)           TARGET_GCB,0,1,292,g,2,36,12,0,1,4
...
/*      GCB:MIIM:MII_CFG */
#define GCB_MII_CFG(g)            TARGET_GCB,0,1,292,g,2,36,16,0,1,4
...
/*      GCB:MIIM:MII_SCAN_0 */
#define GCB_MII_SCAN_0(g)         TARGET_GCB,0,1,292,g,2,36,20,0,1,4
...
/*      GCB:MIIM:MII_SCAN_1 */
#define GCB_MII_SCAN_1(g)         TARGET_GCB,0,1,292,g,2,36,24,0,1,4
...
/*      GCB:MIIM:MII_RSLTS */
#define GCB_MII_RSLTS(g)          TARGET_GCB,0,1,292,g,2,36,28,0,1,4

/*      GCB:MIIM:MII_RSLTS_VLD */
#define GCB_MII_RSLTS_VLD(g)      TARGET_GCB,0,1,292,g,2,36,32,0,1,4

/*      GCB:MIIM_READ_SCAN:MII_STICKY */
#define GCB_MII_STICKY(r)         TARGET_GCB,0,1,364,0,1,8,0,r,2,4

/*      GCB:FLEXCOM_SHARED:SS_MASK */
#define GCB_SS_MASK(g,r)          TARGET_GCB,0,1,372,g,5,8,0,r,2,4
...
#define GCB_SIO_INPUT_DATA(r)     TARGET_GCB,0,1,412,0,1,280,0,r,4,4

/*      GCB:SIO_CTRL:SIO_CFG */
#define GCB_SIO_CFG               TARGET_GCB,0,1,412,0,1,280,16,0,1,4
...
#define GCB_SIO_CLOCK             TARGET_GCB,0,1,412,0,1,280,20,0,1,4
...
#define GCB_SIO_PORT_CFG(r)       TARGET_GCB,0,1,412,0,1,280,24,r,32,4
...
#define GCB_SIO_PORT_ENA          TARGET_GCB,0,1,412,0,1,280,152,0,1,4

/*      GCB:SIO_CTRL:SIO_PWM_CFG */
#define GCB_SIO_PWM_CFG(r)        TARGET_GCB,0,1,412,0,1,280,156,r,3,4
...
#define GCB_SIO_INTR_POL(r)       TARGET_GCB,0,1,412,0,1,280,168,r,4,4

/*      GCB:SIO_CTRL:SIO_INTR_RAW */
#define GCB_SIO_INTR_RAW(r)       TARGET_GCB,0,1,412,0,1,280,184,r,4,4

/*      GCB:SIO_CTRL:SIO_INTR_TRIGGER0 */
#define GCB_SIO_INTR_TRIGGER0(r)  TARGET_GCB,0,1,412,0,1,280,200,r,4,4

/*      GCB:SIO_CTRL:SIO_INTR_TRIGGER1 */
#define GCB_SIO_INTR_TRIGGER1(r)  TARGET_GCB,0,1,412,0,1,280,216,r,4,4

/*      GCB:SIO_CTRL:SIO_INTR */
#define GCB_SIO_INTR(r)           TARGET_GCB,0,1,412,0,1,280,232,r,4,4

/*      GCB:SIO_CTRL:SIO_INTR_ENA */
#define GCB_SIO_INTR_ENA(r)       TARGET_GCB,0,1,412,0,1,280,248,r,4,4

/*      GCB:SIO_CTRL:SIO_INTR_IDENT */
#define GCB_SIO_INTR_IDENT(r)     TARGET_GCB,0,1,412,0,1,280,264,r,4,4

/*      GCB:FAN_CTRL:FAN_CFG */
#define GCB_FAN_CFG               TARGET_GCB,0,1,692,0,1,12,0,0,1,4
...
#define GCB_PWM_FREQ              TARGET_GCB,0,1,692,0,1,12,4,0,1,4
...
#define GCB_FAN_CNT               TARGET_GCB,0,1,692,0,1,12,8,0,1,4
...
#define GCB_MEMITGR_CTRL          TARGET_GCB,0,1,704,0,1,24,0,0,1,4
...
#define GCB_MEMITGR_STAT          TARGET_GCB,0,1,704,0,1,24,4,0,1,4
...
#define GCB_MEMITGR_INFO          TARGET_GCB,0,1,704,0,1,24,8,0,1,4
...
#define GCB_MEMITGR_IDX           TARGET_GCB,0,1,704,0,1,24,12,0,1,4
...
#define GCB_MEMITGR_DIV           TARGET_GCB,0,1,704,0,1,24,16,0,1,4
...
#define GCB_MEMITGR_DBG           TARGET_GCB,0,1,704,0,1,24,20,0,1,4
...
#define GCB_VRAP_ACCESS_STAT      TARGET_GCB,0,1,728,0,1,4,0,0,1,4
...
#define MEP_LOC_CTRL_SPACE_BETWEEN_ENTRY_SCAN(x) (((x) << 16) & GENMASK(23, 16))
#define MEP_LOC_CTRL_SPACE_BETWEEN_ENTRY_SCAN_M  GENMASK(23, 16)
#define MEP_LOC_CTRL_SPACE_BETWEEN_ENTRY_SCAN_X(x)\
	(((x) & GENMASK(23, 16)) >> 16)
...
#define MEP_BCN_FWD_CTRL_NXT_FAULT_CPU_HITME_ONCE(x)\
	(((x) << 9) & GENMASK(9, 9))
#define MEP_BCN_FWD_CTRL_NXT_FAULT_CPU_HITME_ONCE_M GENMASK(9, 9)
#define MEP_BCN_FWD_CTRL_NXT_FAULT_CPU_HITME_ONCE_X(x)\
	(((x) & GENMASK(9, 9)) >> 9)

#define MEP_BCN_FWD_CTRL_NXT_LOC_CPU_HITME_ONCE(x) (((x) << 8) & GENMASK(8, 8))
#define MEP_BCN_FWD_CTRL_NXT_LOC_CPU_HITME_ONCE_M GENMASK(8, 8)
#define MEP_BCN_FWD_CTRL_NXT_LOC_CPU_HITME_ONCE_X(x)\
	(((x) & GENMASK(8, 8)) >> 8)
...
#define MEP_ADV_FWD_CTRL_NXT_ADV_LOC_CPU_HITME_ONCE(x)\
	(((x) << 6) & GENMASK(6, 6))
#define MEP_ADV_FWD_CTRL_NXT_ADV_LOC_CPU_HITME_ONCE_M GENMASK(6, 6)
#define MEP_ADV_FWD_CTRL_NXT_ADV_LOC_CPU_HITME_ONCE_X(x)\
	(((x) & GENMASK(6, 6)) >> 6)
...
/*      VCAP:TCAM_BIST:BIST_DIAG_BITMAPA_STAT */
#define VCAP_BIST_DIAG_BITMAPA_STAT(t,r) TARGET_VCAP,t,3,964,0,1,124,92,r,3,4

/*      VCAP:TCAM_BIST:BIST_DIAG_BITMAPB_STAT */
#define VCAP_BIST_DIAG_BITMAPB_STAT(t,r) TARGET_VCAP,t,3,964,0,1,124,104,r,3,4
