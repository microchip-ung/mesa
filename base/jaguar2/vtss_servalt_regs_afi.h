...
#ifndef _VTSS_SERVALT_REGS_AFI_H_
#define _VTSS_SERVALT_REGS_AFI_H_
 ...
 */
#define VTSS_AFI_MISC_MISC_CTRL              VTSS_IOREG(VTSS_TO_AFI,0x505e)
 ...
 */
#define VTSS_AFI_MISC_NEW_FRM_CTRL           VTSS_IOREG(VTSS_TO_AFI,0x505f)
 ...
 */
#define VTSS_AFI_MISC_NEW_FRM_INFO           VTSS_IOREG(VTSS_TO_AFI,0x5060)
 ...
 */
#define  VTSS_F_AFI_MISC_NEW_FRM_INFO_FRM_INFO(x)  VTSS_ENCODE_BITFIELD(x,0,17)
#define  VTSS_M_AFI_MISC_NEW_FRM_INFO_FRM_INFO     VTSS_ENCODE_BITMASK(0,17)
#define  VTSS_X_AFI_MISC_NEW_FRM_INFO_FRM_INFO(x)  VTSS_EXTRACT_BITFIELD(x,0,17)
 ...
 */
#define VTSS_AFI_MISC_ERR                    VTSS_IOREG(VTSS_TO_AFI,0x5061)
 ...
 */
#define VTSS_AFI_MISC_WARN                   VTSS_IOREG(VTSS_TO_AFI,0x5062)
 ...
 */
#define VTSS_AFI_MISC_STICKY_INFO            VTSS_IOREG(VTSS_TO_AFI,0x5063)
 ...
 */
#define  VTSS_F_AFI_MISC_STICKY_INFO_TTI_PTR(x)  VTSS_ENCODE_BITFIELD(x,8,11)
#define  VTSS_M_AFI_MISC_STICKY_INFO_TTI_PTR     VTSS_ENCODE_BITMASK(8,11)
#define  VTSS_X_AFI_MISC_STICKY_INFO_TTI_PTR(x)  VTSS_EXTRACT_BITFIELD(x,8,11)
 ...
 */
#define  VTSS_F_AFI_MISC_STICKY_INFO_PORT_NUM(x)  VTSS_ENCODE_BITFIELD(x,0,4)
#define  VTSS_M_AFI_MISC_STICKY_INFO_PORT_NUM     VTSS_ENCODE_BITMASK(0,4)
#define  VTSS_X_AFI_MISC_STICKY_INFO_PORT_NUM(x)  VTSS_EXTRACT_BITFIELD(x,0,4)
 ...
 */
#define VTSS_AFI_MISC_STICKY_INFO_ENA        VTSS_IOREG(VTSS_TO_AFI,0x5064)
 ...
 *
 * @param gi Replicator: x_GAZ_AFI_FRM_TBL_DEPTH (??), 0-2047
 */
#define VTSS_AFI_FRM_TBL_FRM_NEXT_AND_TYPE(gi)  VTSS_IOREG_IX(VTSS_TO_AFI,0x4000,gi,2,0,0)
 ...
 */
#define  VTSS_F_AFI_FRM_TBL_FRM_NEXT_AND_TYPE_NEXT_PTR(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_AFI_FRM_TBL_FRM_NEXT_AND_TYPE_NEXT_PTR     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_AFI_FRM_TBL_FRM_NEXT_AND_TYPE_NEXT_PTR(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 * @param gi Replicator: x_GAZ_AFI_FRM_TBL_DEPTH (??), 0-2047
 */
#define VTSS_AFI_FRM_TBL_FRM_ENTRY_PART0(gi)  VTSS_IOREG_IX(VTSS_TO_AFI,0x4000,gi,2,0,1)
 ...
 */
#define VTSS_AFI_DTI_TBL_DTI_MODE(gi)        VTSS_IOREG_IX(VTSS_TO_AFI,0x5000,gi,4,0,0)
 ...
 */
#define  VTSS_F_AFI_DTI_TBL_DTI_MODE_DTI_NEXT(x)  VTSS_ENCODE_BITFIELD(x,24,4)
#define  VTSS_M_AFI_DTI_TBL_DTI_MODE_DTI_NEXT     VTSS_ENCODE_BITMASK(24,4)
#define  VTSS_X_AFI_DTI_TBL_DTI_MODE_DTI_NEXT(x)  VTSS_EXTRACT_BITFIELD(x,24,4)
 ...
 * @param gi Replicator: x_GAZ_AFI_DTI_TBL_DEPTH (??), 0-15
 */
#define VTSS_AFI_DTI_TBL_DTI_PORT_QU(gi)     VTSS_IOREG_IX(VTSS_TO_AFI,0x5000,gi,4,0,1)
 ...
 */
#define  VTSS_F_AFI_DTI_TBL_DTI_PORT_QU_QU_NUM(x)  VTSS_ENCODE_BITFIELD(x,8,13)
#define  VTSS_M_AFI_DTI_TBL_DTI_PORT_QU_QU_NUM     VTSS_ENCODE_BITMASK(8,13)
#define  VTSS_X_AFI_DTI_TBL_DTI_PORT_QU_QU_NUM(x)  VTSS_EXTRACT_BITFIELD(x,8,13)
 ...
 */
#define  VTSS_F_AFI_DTI_TBL_DTI_PORT_QU_PORT_NUM(x)  VTSS_ENCODE_BITFIELD(x,0,4)
#define  VTSS_M_AFI_DTI_TBL_DTI_PORT_QU_PORT_NUM     VTSS_ENCODE_BITMASK(0,4)
#define  VTSS_X_AFI_DTI_TBL_DTI_PORT_QU_PORT_NUM(x)  VTSS_EXTRACT_BITFIELD(x,0,4)
 ...
 * @param gi Replicator: x_GAZ_AFI_DTI_TBL_DEPTH (??), 0-15
 */
#define VTSS_AFI_DTI_TBL_DTI_FRM(gi)         VTSS_IOREG_IX(VTSS_TO_AFI,0x5000,gi,4,0,2)
 ...
 */
#define  VTSS_F_AFI_DTI_TBL_DTI_FRM_NEXT_FRM_PTR(x)  VTSS_ENCODE_BITFIELD(x,16,11)
#define  VTSS_M_AFI_DTI_TBL_DTI_FRM_NEXT_FRM_PTR     VTSS_ENCODE_BITMASK(16,11)
#define  VTSS_X_AFI_DTI_TBL_DTI_FRM_NEXT_FRM_PTR(x)  VTSS_EXTRACT_BITFIELD(x,16,11)
 ...
 */
#define  VTSS_F_AFI_DTI_TBL_DTI_FRM_FIRST_FRM_PTR(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_AFI_DTI_TBL_DTI_FRM_FIRST_FRM_PTR     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_AFI_DTI_TBL_DTI_FRM_FIRST_FRM_PTR(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 * @param gi Replicator: x_GAZ_AFI_DTI_TBL_DEPTH (??), 0-15
 */
#define VTSS_AFI_DTI_TBL_DTI_CNT(gi)         VTSS_IOREG_IX(VTSS_TO_AFI,0x5000,gi,4,0,3)
 ...
 * @param gi Replicator: x_GAZ_AFI_DTI_TBL_DEPTH (??), 0-15
 */
#define VTSS_AFI_DTI_MISC_DTI_FC_CNT_DOWN(gi)  VTSS_IOREG_IX(VTSS_TO_AFI,0x5065,gi,3,0,0)
 ...
 * @param gi Replicator: x_GAZ_AFI_DTI_TBL_DEPTH (??), 0-15
 */
#define VTSS_AFI_DTI_MISC_DTI_CNT_DOWN(gi)   VTSS_IOREG_IX(VTSS_TO_AFI,0x5065,gi,3,0,1)
 ...
 * @param gi Replicator: x_GAZ_AFI_DTI_TBL_DEPTH (??), 0-15
 */
#define VTSS_AFI_DTI_MISC_DTI_CTRL(gi)       VTSS_IOREG_IX(VTSS_TO_AFI,0x5065,gi,3,0,2)
 ...
 *
 * @param gi Replicator: x_GAZ_AFI_TTI_TBL_DEPTH (??), 0-2047
 */
 ...
 */
#define  VTSS_F_AFI_TTI_TBL_TTI_PORT_QU_QU_NUM(x)  VTSS_ENCODE_BITFIELD(x,8,13)
#define  VTSS_M_AFI_TTI_TBL_TTI_PORT_QU_QU_NUM     VTSS_ENCODE_BITMASK(8,13)
#define  VTSS_X_AFI_TTI_TBL_TTI_PORT_QU_QU_NUM(x)  VTSS_EXTRACT_BITFIELD(x,8,13)
 ...
 */
#define  VTSS_F_AFI_TTI_TBL_TTI_PORT_QU_PORT_NUM(x)  VTSS_ENCODE_BITFIELD(x,0,4)
#define  VTSS_M_AFI_TTI_TBL_TTI_PORT_QU_PORT_NUM     VTSS_ENCODE_BITMASK(0,4)
#define  VTSS_X_AFI_TTI_TBL_TTI_PORT_QU_PORT_NUM(x)  VTSS_EXTRACT_BITFIELD(x,0,4)
 ...
 */
#define  VTSS_F_AFI_TTI_TBL_TTI_FRM_FRM_PTR(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_AFI_TTI_TBL_TTI_FRM_FRM_PTR     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_AFI_TTI_TBL_TTI_FRM_FRM_PTR(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_AFI_TTI_TICKS_TTI_TICK_BASE     VTSS_IOREG(VTSS_TO_AFI,0x5095)
 ...
 */
#define  VTSS_F_AFI_TTI_TICKS_TTI_TICK_BASE_BASE_CNT(x)  VTSS_ENCODE_BITFIELD(x,16,13)
#define  VTSS_M_AFI_TTI_TICKS_TTI_TICK_BASE_BASE_CNT     VTSS_ENCODE_BITMASK(16,13)
#define  VTSS_X_AFI_TTI_TICKS_TTI_TICK_BASE_BASE_CNT(x)  VTSS_EXTRACT_BITFIELD(x,16,13)
 ...
 */
#define  VTSS_F_AFI_TTI_TICKS_TTI_TICK_BASE_BASE_LEN(x)  VTSS_ENCODE_BITFIELD(x,0,13)
#define  VTSS_M_AFI_TTI_TICKS_TTI_TICK_BASE_BASE_LEN     VTSS_ENCODE_BITMASK(0,13)
#define  VTSS_X_AFI_TTI_TICKS_TTI_TICK_BASE_BASE_LEN(x)  VTSS_EXTRACT_BITFIELD(x,0,13)
 ...
 */
#define VTSS_AFI_TTI_TICKS_TTI_TICK_LEN_0_3  VTSS_IOREG(VTSS_TO_AFI,0x5096)
 ...
 */
#define VTSS_AFI_TTI_TICKS_TTI_TICK_LEN_4_7  VTSS_IOREG(VTSS_TO_AFI,0x5097)
 ...
 */
#define VTSS_AFI_TTI_TICKS_TTI_TICK_STATE(ri)  VTSS_IOREG(VTSS_TO_AFI,0x5098 + (ri))
 ...
 */
#define VTSS_AFI_TTI_MISC_TTI_CAL_SLOT_PTRS(ri)  VTSS_IOREG(VTSS_TO_AFI,0x50a0 + (ri))
 ...
 */
#define  VTSS_F_AFI_TTI_MISC_TTI_CAL_SLOT_PTRS_SLOT_END_PTR(x)  VTSS_ENCODE_BITFIELD(x,16,11)
#define  VTSS_M_AFI_TTI_MISC_TTI_CAL_SLOT_PTRS_SLOT_END_PTR     VTSS_ENCODE_BITMASK(16,11)
#define  VTSS_X_AFI_TTI_MISC_TTI_CAL_SLOT_PTRS_SLOT_END_PTR(x)  VTSS_EXTRACT_BITFIELD(x,16,11)
 ...
 */
#define  VTSS_F_AFI_TTI_MISC_TTI_CAL_SLOT_PTRS_SLOT_START_PTR(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_AFI_TTI_MISC_TTI_CAL_SLOT_PTRS_SLOT_START_PTR     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_AFI_TTI_MISC_TTI_CAL_SLOT_PTRS_SLOT_START_PTR(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 * @param ri Replicator: x_GAZ_AFI_TTI_CAL_DEPTH (??), 0-3
 */
#define VTSS_AFI_TTI_MISC_TTI_CAL_SLOT_CNT(ri)  VTSS_IOREG(VTSS_TO_AFI,0x50a4 + (ri))
 ...
 * @param ri Replicator: x_GAZ_AFI_TTI_CAL_DEPTH (??), 0-3
 */
#define VTSS_AFI_TTI_MISC_TTI_CAL_STATE(ri)  VTSS_IOREG(VTSS_TO_AFI,0x50a8 + (ri))
 ...
 */
#define  VTSS_F_AFI_TTI_MISC_TTI_CAL_STATE_SLOT_TTI_TBL_PTR(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_AFI_TTI_MISC_TTI_CAL_STATE_SLOT_TTI_TBL_PTR     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_AFI_TTI_MISC_TTI_CAL_STATE_SLOT_TTI_TBL_PTR(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_AFI_TTI_MISC_TTI_CTRL           VTSS_IOREG(VTSS_TO_AFI,0x50ac)
 ...
 */
#define VTSS_AFI_TTI_MISC_TTI_CTRL2          VTSS_IOREG(VTSS_TO_AFI,0x50ad)
 ...
 */
#define VTSS_AFI_TTI_MISC_TTI_INJ_CNT        VTSS_IOREG(VTSS_TO_AFI,0x50ae)
 ...
 */
#define VTSS_AFI_TTI_MISC_TTI_RAND_STATE     VTSS_IOREG(VTSS_TO_AFI,0x50af)
 ...
 */
#define VTSS_AFI_TTI_MISC_TTI_PORT_FRM_OUT   VTSS_IOREG(VTSS_TO_AFI,0x50b0)
 ...
 *
 * @param gi Replicator: x_GAZ_AFI_PORT_CNT (??), 0-14
 */
#define VTSS_AFI_PORT_TBL_PORT_FRM_OUT(gi)   VTSS_IOREG_IX(VTSS_TO_AFI,0x5040,gi,2,0,0)
 ...
 * @param gi Replicator: x_GAZ_AFI_PORT_CNT (??), 0-14
 */
#define VTSS_AFI_PORT_TBL_PORT_CFG(gi)       VTSS_IOREG_IX(VTSS_TO_AFI,0x5040,gi,2,0,1)
 ...
 */
#define VTSS_AFI_TUPE_TUPE_MISC              VTSS_IOREG(VTSS_TO_AFI,0x50b1)
 ...
 */
#define VTSS_AFI_TUPE_TUPE_ADDR              VTSS_IOREG(VTSS_TO_AFI,0x50b2)
 ...
 */
#define  VTSS_F_AFI_TUPE_TUPE_ADDR_TUPE_END_ADDR(x)  VTSS_ENCODE_BITFIELD(x,16,11)
#define  VTSS_M_AFI_TUPE_TUPE_ADDR_TUPE_END_ADDR     VTSS_ENCODE_BITMASK(16,11)
#define  VTSS_X_AFI_TUPE_TUPE_ADDR_TUPE_END_ADDR(x)  VTSS_EXTRACT_BITFIELD(x,16,11)
 ...
 */
#define  VTSS_F_AFI_TUPE_TUPE_ADDR_TUPE_START_ADDR(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_AFI_TUPE_TUPE_ADDR_TUPE_START_ADDR     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_AFI_TUPE_TUPE_ADDR_TUPE_START_ADDR(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define VTSS_AFI_TUPE_TUPE_CRIT1             VTSS_IOREG(VTSS_TO_AFI,0x50b3)
 ...
 */
#define  VTSS_F_AFI_TUPE_TUPE_CRIT1_CRIT_QU_NUM_VAL(x)  VTSS_ENCODE_BITFIELD(x,8,13)
#define  VTSS_M_AFI_TUPE_TUPE_CRIT1_CRIT_QU_NUM_VAL     VTSS_ENCODE_BITMASK(8,13)
#define  VTSS_X_AFI_TUPE_TUPE_CRIT1_CRIT_QU_NUM_VAL(x)  VTSS_EXTRACT_BITFIELD(x,8,13)
 ...
 */
#define  VTSS_F_AFI_TUPE_TUPE_CRIT1_CRIT_PORT_NUM_VAL(x)  VTSS_ENCODE_BITFIELD(x,0,4)
#define  VTSS_M_AFI_TUPE_TUPE_CRIT1_CRIT_PORT_NUM_VAL     VTSS_ENCODE_BITMASK(0,4)
#define  VTSS_X_AFI_TUPE_TUPE_CRIT1_CRIT_PORT_NUM_VAL(x)  VTSS_EXTRACT_BITFIELD(x,0,4)
 ...
 */
#define VTSS_AFI_TUPE_TUPE_CRIT2             VTSS_IOREG(VTSS_TO_AFI,0x50b4)
 ...
 */
#define VTSS_AFI_TUPE_TUPE_CRIT3(ri)         VTSS_IOREG(VTSS_TO_AFI,0x50b5 + (ri))
 ...
 */
#define VTSS_AFI_TUPE_TUPE_CMD1              VTSS_IOREG(VTSS_TO_AFI,0x50b7)
 ...
 */
#define  VTSS_F_AFI_TUPE_TUPE_CMD1_CMD_QU_NUM_VAL(x)  VTSS_ENCODE_BITFIELD(x,8,13)
#define  VTSS_M_AFI_TUPE_TUPE_CMD1_CMD_QU_NUM_VAL     VTSS_ENCODE_BITMASK(8,13)
#define  VTSS_X_AFI_TUPE_TUPE_CMD1_CMD_QU_NUM_VAL(x)  VTSS_EXTRACT_BITFIELD(x,8,13)
 ...
 */
#define  VTSS_F_AFI_TUPE_TUPE_CMD1_CMD_PORT_NUM_VAL(x)  VTSS_ENCODE_BITFIELD(x,0,4)
#define  VTSS_M_AFI_TUPE_TUPE_CMD1_CMD_PORT_NUM_VAL     VTSS_ENCODE_BITMASK(0,4)
#define  VTSS_X_AFI_TUPE_TUPE_CMD1_CMD_PORT_NUM_VAL(x)  VTSS_EXTRACT_BITFIELD(x,0,4)


#endif /* _VTSS_SERVALT_REGS_AFI_H_ */
