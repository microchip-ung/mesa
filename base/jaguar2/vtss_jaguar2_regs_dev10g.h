 ...
 *
 * \details
 * Configuration register set for Interleave Mode (XAUI using two lanes) -
...
/** 
 * \brief
 * Interleave mode selection. In interleave mode XAUI data are sent using
 * two 5Gbps lanes
 *
 * \details 
...
/** 
 * \brief
 * Interleave mode enable. In interleave mode XAUI data are sent using two
 * 5Gbps lanes
 *
 * \details 
 * 0: Normal XAUI mode
