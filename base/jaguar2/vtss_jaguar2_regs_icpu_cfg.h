 ...
 */
#define  VTSS_F_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_CPU_BUSIF_SLEEP_DIS(x)  VTSS_ENCODE_BITFIELD(!!(x),15,1)
#define  VTSS_M_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_CPU_BUSIF_SLEEP_DIS  VTSS_BIT(15)
#define  VTSS_X_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_CPU_BUSIF_SLEEP_DIS(x)  VTSS_EXTRACT_BITFIELD(x,15,1)
 ...
 */
#define  VTSS_F_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_CPU_BUSIF_WERR_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),14,1)
#define  VTSS_M_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_CPU_BUSIF_WERR_ENA  VTSS_BIT(14)
#define  VTSS_X_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_CPU_BUSIF_WERR_ENA(x)  VTSS_EXTRACT_BITFIELD(x,14,1)
 ...
 */
#define  VTSS_F_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_CPU_8051_IROM_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),13,1)
#define  VTSS_M_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_CPU_8051_IROM_ENA  VTSS_BIT(13)
#define  VTSS_X_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_CPU_8051_IROM_ENA(x)  VTSS_EXTRACT_BITFIELD(x,13,1)
 ...
 */
#define  VTSS_F_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_CPU_MIPS_DIS(x)  VTSS_ENCODE_BITFIELD(!!(x),12,1)
#define  VTSS_M_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_CPU_MIPS_DIS  VTSS_BIT(12)
#define  VTSS_X_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_CPU_MIPS_DIS(x)  VTSS_EXTRACT_BITFIELD(x,12,1)
 ...
 */
#define  VTSS_F_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_MIIM_SLV_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),11,1)
#define  VTSS_M_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_MIIM_SLV_ENA  VTSS_BIT(11)
#define  VTSS_X_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_MIIM_SLV_ENA(x)  VTSS_EXTRACT_BITFIELD(x,11,1)
 ...
 */
#define  VTSS_F_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_PI_SLV_DONEPOL(x)  VTSS_ENCODE_BITFIELD(!!(x),10,1)
#define  VTSS_M_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_PI_SLV_DONEPOL  VTSS_BIT(10)
#define  VTSS_X_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_PI_SLV_DONEPOL(x)  VTSS_EXTRACT_BITFIELD(x,10,1)
 ...
 */
#define  VTSS_F_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_PI_MST_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),9,1)
#define  VTSS_M_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_PI_MST_ENA  VTSS_BIT(9)
#define  VTSS_X_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_PI_MST_ENA(x)  VTSS_EXTRACT_BITFIELD(x,9,1)
 ...
 */
#define  VTSS_F_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_PI_SLV_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),8,1)
#define  VTSS_M_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_PI_SLV_ENA  VTSS_BIT(8)
#define  VTSS_X_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_PI_SLV_ENA(x)  VTSS_EXTRACT_BITFIELD(x,8,1)
 ...
 */
#define  VTSS_F_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_SI_OWNER(x)  VTSS_ENCODE_BITFIELD(x,6,2)
#define  VTSS_M_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_SI_OWNER     VTSS_ENCODE_BITMASK(6,2)
#define  VTSS_X_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL_IF_SI_OWNER(x)  VTSS_EXTRACT_BITFIELD(x,6,2)
 ...
 * 2: SI Master Controller
 *
 * Field: ::VTSS_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL . IF_SI1_OWNER
 */
...
/** 
 * \brief
 * Set this field when enabling SI Master Controller for SSP protocol. See
 * SIMC::CTRLR0.FRF for more information.
 *
 * \details 
 ...
 */
#define  VTSS_F_ICPU_CFG_PI_MST_PI_SLV_CFG_DONEPOL_VAL(x)  VTSS_ENCODE_BITFIELD(!!(x),28,1)
#define  VTSS_M_ICPU_CFG_PI_MST_PI_SLV_CFG_DONEPOL_VAL  VTSS_BIT(28)
#define  VTSS_X_ICPU_CFG_PI_MST_PI_SLV_CFG_DONEPOL_VAL(x)  VTSS_EXTRACT_BITFIELD(x,28,1)
 ...
 */
#define  VTSS_F_ICPU_CFG_PI_MST_PI_SLV_CFG_DONEPOL_SET(x)  VTSS_ENCODE_BITFIELD(!!(x),27,1)
#define  VTSS_M_ICPU_CFG_PI_MST_PI_SLV_CFG_DONEPOL_SET  VTSS_BIT(27)
#define  VTSS_X_ICPU_CFG_PI_MST_PI_SLV_CFG_DONEPOL_SET(x)  VTSS_EXTRACT_BITFIELD(x,27,1)
 ...
 */
#define  VTSS_F_ICPU_CFG_PI_MST_PI_SLV_CFG_BIGENDIAN(x)  VTSS_ENCODE_BITFIELD(!!(x),26,1)
#define  VTSS_M_ICPU_CFG_PI_MST_PI_SLV_CFG_BIGENDIAN  VTSS_BIT(26)
#define  VTSS_X_ICPU_CFG_PI_MST_PI_SLV_CFG_BIGENDIAN(x)  VTSS_EXTRACT_BITFIELD(x,26,1)

/** 
 * \brief
 * Configures number of clock cycles after deasserting CS that the device
 * must still drive ndone output.
 *
 * \details 
 * 0: Release ndone immediately (async path from CS input).
 * n: Wait n+1 clocks after detecting deasserted CS before relesing drive
 * of ndone.
 *
...
/** 
 * \brief
 * Configures number of clock cycles to delay nDone indication after
 * accerss has been accepted.
 *
 * \details 
 * n: Wait n clocks after accepting read or write before setting nDone
 * indication.
 *
 ...
 *
 * \details 
 * n: Wait n+1 clocks after detecting CS before sampling control/data.
 *
 ...
 */
#define  VTSS_F_ICPU_CFG_INTR_DEV_INTR_POL_DEV_INTR_POL(x)  (x)
#define  VTSS_M_ICPU_CFG_INTR_DEV_INTR_POL_DEV_INTR_POL     0xffffffff
#define  VTSS_X_ICPU_CFG_INTR_DEV_INTR_POL_DEV_INTR_POL(x)  (x)
 ...
 *
 * \details
 * Register: \a ICPU_CFG:INTR:DEV_INTR_POL1
 */
#define VTSS_ICPU_CFG_INTR_DEV_INTR_POL1     VTSS_IOREG(VTSS_TO_CFG,0x32)

/** 
 * \brief
 * See ICPU_CFG::DEV_INTR_POL for description, this register holds bits
 * above 32.
 *
 * \details 
 * Field: ::VTSS_ICPU_CFG_INTR_DEV_INTR_POL1 . DEV_INTR_POL1
 */
 ...
 */
#define  VTSS_F_ICPU_CFG_INTR_DEV_INTR_RAW_DEV_INTR_RAW(x)  (x)
#define  VTSS_M_ICPU_CFG_INTR_DEV_INTR_RAW_DEV_INTR_RAW     0xffffffff
#define  VTSS_X_ICPU_CFG_INTR_DEV_INTR_RAW_DEV_INTR_RAW(x)  (x)
 ...
 *
 * \details
 * Register: \a ICPU_CFG:INTR:DEV_INTR_RAW1
 */
#define VTSS_ICPU_CFG_INTR_DEV_INTR_RAW1     VTSS_IOREG(VTSS_TO_CFG,0x34)

/** 
 * \brief
 * See ICPU_CFG::DEV_INTR_RAW for description, this register holds bits
 * above 32.
 *
 * \details 
 * Field: ::VTSS_ICPU_CFG_INTR_DEV_INTR_RAW1 . DEV_INTR_RAW1
 */
 ...
 */
#define  VTSS_F_ICPU_CFG_INTR_DEV_INTR_TRIGGER_DEV_INTR_TRIGGER(x)  (x)
#define  VTSS_M_ICPU_CFG_INTR_DEV_INTR_TRIGGER_DEV_INTR_TRIGGER     0xffffffff
#define  VTSS_X_ICPU_CFG_INTR_DEV_INTR_TRIGGER_DEV_INTR_TRIGGER(x)  (x)
 ...
 *
 * \details
 * Register: \a ICPU_CFG:INTR:DEV_INTR_TRIGGER1
 *
...
/** 
 * \brief
 * See ICPU_CFG::DEV_INTR_TRIGGER for description, this register holds bits
 * above 32.
 *
 * \details 
 * Field: ::VTSS_ICPU_CFG_INTR_DEV_INTR_TRIGGER1 . DEV_INTR_TRIGGER1
 */
 ...
 */
#define  VTSS_F_ICPU_CFG_INTR_DEV_INTR_STICKY_DEV_INTR_STICKY(x)  (x)
#define  VTSS_M_ICPU_CFG_INTR_DEV_INTR_STICKY_DEV_INTR_STICKY     0xffffffff
#define  VTSS_X_ICPU_CFG_INTR_DEV_INTR_STICKY_DEV_INTR_STICKY(x)  (x)
 ...
 *
 * \details
 * Register: \a ICPU_CFG:INTR:DEV_INTR_STICKY1
 */
#define VTSS_ICPU_CFG_INTR_DEV_INTR_STICKY1  VTSS_IOREG(VTSS_TO_CFG,0x3a)

/** 
 * \brief
 * See ICPU_CFG::DEV_INTR_STICKY for description, this register holds bits
 * above 32.
 *
 * \details 
 * Field: ::VTSS_ICPU_CFG_INTR_DEV_INTR_STICKY1 . DEV_INTR_STICKY1
 */
 ...
 */
#define  VTSS_F_ICPU_CFG_INTR_DEV_INTR_BYPASS_DEV_INTR_BYPASS(x)  (x)
#define  VTSS_M_ICPU_CFG_INTR_DEV_INTR_BYPASS_DEV_INTR_BYPASS     0xffffffff
#define  VTSS_X_ICPU_CFG_INTR_DEV_INTR_BYPASS_DEV_INTR_BYPASS(x)  (x)
 ...
 *
 * \details
 * Register: \a ICPU_CFG:INTR:DEV_INTR_BYPASS1
 */
#define VTSS_ICPU_CFG_INTR_DEV_INTR_BYPASS1  VTSS_IOREG(VTSS_TO_CFG,0x3c)

/** 
 * \brief
 * See ICPU_CFG::DEV_INTR_BYPASS for description, this register holds bits
 * above 32.
 *
 * \details 
 * Field: ::VTSS_ICPU_CFG_INTR_DEV_INTR_BYPASS1 . DEV_INTR_BYPASS1
 */
 ...
 */
#define  VTSS_F_ICPU_CFG_INTR_DEV_INTR_ENA_DEV_INTR_ENA(x)  (x)
#define  VTSS_M_ICPU_CFG_INTR_DEV_INTR_ENA_DEV_INTR_ENA     0xffffffff
#define  VTSS_X_ICPU_CFG_INTR_DEV_INTR_ENA_DEV_INTR_ENA(x)  (x)
 ...
 *
 * \details
 * Register: \a ICPU_CFG:INTR:DEV_INTR_ENA1
 */
#define VTSS_ICPU_CFG_INTR_DEV_INTR_ENA1     VTSS_IOREG(VTSS_TO_CFG,0x3e)

/** 
 * \brief
 * See ICPU_CFG::DEV_INTR_ENA for description, this register holds bits
 * above 32.
 *
 * \details 
 * Field: ::VTSS_ICPU_CFG_INTR_DEV_INTR_ENA1 . DEV_INTR_ENA1
 */
 ...
 */
#define  VTSS_F_ICPU_CFG_INTR_DEV_INTR_IDENT_DEV_INTR_IDENT(x)  (x)
#define  VTSS_M_ICPU_CFG_INTR_DEV_INTR_IDENT_DEV_INTR_IDENT     0xffffffff
#define  VTSS_X_ICPU_CFG_INTR_DEV_INTR_IDENT_DEV_INTR_IDENT(x)  (x)
 ...
 *
 * \details
 * Register: \a ICPU_CFG:INTR:DEV_INTR_IDENT1
 */
#define VTSS_ICPU_CFG_INTR_DEV_INTR_IDENT1   VTSS_IOREG(VTSS_TO_CFG,0x40)

/** 
 * \brief
 * See ICPU_CFG::DEV_INTR_IDENT for description, this register holds bits
 * above 32.
 *
 * \details 
 * Field: ::VTSS_ICPU_CFG_INTR_DEV_INTR_IDENT1 . DEV_INTR_IDENT1
 */
