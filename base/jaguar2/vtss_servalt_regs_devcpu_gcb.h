...
#ifndef _VTSS_SERVALT_REGS_DEVCPU_GCB_H_
#define _VTSS_SERVALT_REGS_DEVCPU_GCB_H_
...
/** 
 * \brief
 * Part ID: Part ID for identification of Vitesse Chips, contents of this
 ...
 */
#define  VTSS_F_DEVCPU_GCB_CHIP_REGS_HW_CFG_DFT_STAT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),15,1)
#define  VTSS_M_DEVCPU_GCB_CHIP_REGS_HW_CFG_DFT_STAT_ENA  VTSS_BIT(15)
#define  VTSS_X_DEVCPU_GCB_CHIP_REGS_HW_CFG_DFT_STAT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,15,1)
 ...
 *
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_CHIP_REGS_HW_CFG . PLL_STAT2_LVL
 */
#define  VTSS_F_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT2_LVL(x)  VTSS_ENCODE_BITFIELD(!!(x),14,1)
#define  VTSS_M_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT2_LVL  VTSS_BIT(14)
#define  VTSS_X_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT2_LVL(x)  VTSS_EXTRACT_BITFIELD(x,14,1)
 ...
 *
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_CHIP_REGS_HW_CFG . PLL_STAT2_MASK
 */
#define  VTSS_F_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT2_MASK(x)  VTSS_ENCODE_BITFIELD(x,10,4)
#define  VTSS_M_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT2_MASK     VTSS_ENCODE_BITMASK(10,4)
#define  VTSS_X_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT2_MASK(x)  VTSS_EXTRACT_BITFIELD(x,10,4)
 ...
 *
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_CHIP_REGS_HW_CFG . PLL_STAT1_LVL
 */
#define  VTSS_F_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT1_LVL(x)  VTSS_ENCODE_BITFIELD(!!(x),9,1)
#define  VTSS_M_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT1_LVL  VTSS_BIT(9)
#define  VTSS_X_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT1_LVL(x)  VTSS_EXTRACT_BITFIELD(x,9,1)
 ...
 *
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_CHIP_REGS_HW_CFG . PLL_STAT1_MASK
 */
#define  VTSS_F_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT1_MASK(x)  VTSS_ENCODE_BITFIELD(x,5,4)
#define  VTSS_M_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT1_MASK     VTSS_ENCODE_BITMASK(5,4)
#define  VTSS_X_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT1_MASK(x)  VTSS_EXTRACT_BITFIELD(x,5,4)

/** 
 * \brief
 * Active level of PLL_STAT0 output.
 *
 * \details 
 * 0: Active low.
 * 1: Active high.
 *
 * Field: ::VTSS_DEVCPU_GCB_CHIP_REGS_HW_CFG . PLL_STAT0_LVL
 */
#define  VTSS_F_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT0_LVL(x)  VTSS_ENCODE_BITFIELD(!!(x),4,1)
#define  VTSS_M_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT0_LVL  VTSS_BIT(4)
#define  VTSS_X_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT0_LVL(x)  VTSS_EXTRACT_BITFIELD(x,4,1)

/** 
 * \brief
 * Configure sources for PLL_STAT0 output. Possible sources are any of 4
 * PLL ALARM signals from Timex block. This field is a bit-mask, enabling
 * bits in this mask will enable the appropriate ALARM signals for output.
 *
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_CHIP_REGS_HW_CFG . PLL_STAT0_MASK
 */
#define  VTSS_F_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT0_MASK(x)  VTSS_ENCODE_BITFIELD(x,0,4)
#define  VTSS_M_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT0_MASK     VTSS_ENCODE_BITMASK(0,4)
#define  VTSS_X_DEVCPU_GCB_CHIP_REGS_HW_CFG_PLL_STAT0_MASK(x)  VTSS_EXTRACT_BITFIELD(x,0,4)
...
/** 
 * \brief
 * PLL2_CONF strapping value from GPIOs sampled after reset release.
 *
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_CHIP_REGS_HW_STAT . PLL2_CONF
 */
#define  VTSS_F_DEVCPU_GCB_CHIP_REGS_HW_STAT_PLL2_CONF(x)  VTSS_ENCODE_BITFIELD(x,5,3)
#define  VTSS_M_DEVCPU_GCB_CHIP_REGS_HW_STAT_PLL2_CONF     VTSS_ENCODE_BITMASK(5,3)
#define  VTSS_X_DEVCPU_GCB_CHIP_REGS_HW_STAT_PLL2_CONF(x)  VTSS_EXTRACT_BITFIELD(x,5,3)

/** 
 * \brief
 * PLL2_SEL strapping value from GPIO sampled after reset release.
 *
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_CHIP_REGS_HW_STAT . PLL2_SEL
 */
#define  VTSS_F_DEVCPU_GCB_CHIP_REGS_HW_STAT_PLL2_SEL(x)  VTSS_ENCODE_BITFIELD(!!(x),4,1)
#define  VTSS_M_DEVCPU_GCB_CHIP_REGS_HW_STAT_PLL2_SEL  VTSS_BIT(4)
#define  VTSS_X_DEVCPU_GCB_CHIP_REGS_HW_STAT_PLL2_SEL(x)  VTSS_EXTRACT_BITFIELD(x,4,1)
 ...
 * not be written to untill the VA_CTRL.VA_BUSY indicates that no accesses
 * is ongoing.
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_OUT_SET_G_OUT_SET(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_OUT_SET_G_OUT_SET     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_OUT_SET_G_OUT_SET(x)  (x)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_OUT_SET1   VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0xe)

/** 
 * \brief
 * Bit 32-36 of field G_OUT_SET.
 *
 * \details 
 * '0': No change
 * '1': Corresponding bit in GPIO_OUT.G_OUT is set.
 *
 * Field: ::VTSS_DEVCPU_GCB_GPIO_GPIO_OUT_SET1 . G_OUT_SET1
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_OUT_SET1_G_OUT_SET1(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_OUT_SET1_G_OUT_SET1     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_OUT_SET1_G_OUT_SET1(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_OUT_CLR    VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0xf)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_OUT_CLR_G_OUT_CLR(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_OUT_CLR_G_OUT_CLR     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_OUT_CLR_G_OUT_CLR(x)  (x)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_OUT_CLR1   VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x10)

/** 
 * \brief
 * Bit 32-36 of field G_OUT_CLR.
 *
 * \details 
 * '0': No change
 * '1': Corresponding bit in GPIO_OUT.G_OUT is cleared.
 *
 * Field: ::VTSS_DEVCPU_GCB_GPIO_GPIO_OUT_CLR1 . G_OUT_CLR1
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_OUT_CLR1_G_OUT_CLR1(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_OUT_CLR1_G_OUT_CLR1     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_OUT_CLR1_G_OUT_CLR1(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_OUT        VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x11)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_OUT_G_OUT(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_OUT_G_OUT     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_OUT_G_OUT(x)  (x)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_OUT1       VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x12)

/** 
 * \brief
 * Bit 32-36 of field G_OUT.
 *
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_GPIO_GPIO_OUT1 . G_OUT1
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_OUT1_G_OUT1(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_OUT1_G_OUT1     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_OUT1_G_OUT1(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_IN         VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x13)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_IN_G_IN(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_IN_G_IN     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_IN_G_IN(x)  (x)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_IN1        VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x14)

/** 
 * \brief
 * Bit 32-36 of field G_IN.
 *
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_GPIO_GPIO_IN1 . G_IN1
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_IN1_G_IN1(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_IN1_G_IN1     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_IN1_G_IN1(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_OE         VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x15)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_OE_G_OE(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_OE_G_OE     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_OE_G_OE(x)  (x)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_OE1        VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x16)

/** 
 * \brief
 * Bit 32-36 of field G_OE.
 *
 * \details 
 * '0': Input
 * '1': Output
 *
 * Field: ::VTSS_DEVCPU_GCB_GPIO_GPIO_OE1 . G_OE1
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_OE1_G_OE1(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_OE1_G_OE1     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_OE1_G_OE1(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_INTR       VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x17)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_INTR_G_INTR(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_INTR_G_INTR     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_INTR_G_INTR(x)  (x)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_INTR1      VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x18)

/** 
 * \brief
 * Bit 32-36 of field G_INTR.
 *
 * \details 
 * '0': No change
 * '1': GPIO has changed
 *
 * Field: ::VTSS_DEVCPU_GCB_GPIO_GPIO_INTR1 . G_INTR1
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_INTR1_G_INTR1(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_INTR1_G_INTR1     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_INTR1_G_INTR1(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_INTR_ENA   VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x19)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_INTR_ENA_G_INTR_ENA(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_INTR_ENA_G_INTR_ENA     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_INTR_ENA_G_INTR_ENA(x)  (x)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_INTR_ENA1  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x1a)

/** 
 * \brief
 * Bit 32-36 of field G_INTR_ENA.
 *
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_GPIO_GPIO_INTR_ENA1 . G_INTR_ENA1
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_INTR_ENA1_G_INTR_ENA1(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_INTR_ENA1_G_INTR_ENA1     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_INTR_ENA1_G_INTR_ENA1(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_INTR_IDENT  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x1b)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_INTR_IDENT_G_INTR_IDENT(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_INTR_IDENT_G_INTR_IDENT     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_INTR_IDENT_G_INTR_IDENT(x)  (x)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_INTR_IDENT1  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x1c)

/** 
 * \brief
 * Bit 32-36 of field G_INTR_IDENT.
 *
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_GPIO_GPIO_INTR_IDENT1 . G_INTR_IDENT1
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_INTR_IDENT1_G_INTR_IDENT1(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_INTR_IDENT1_G_INTR_IDENT1     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_INTR_IDENT1_G_INTR_IDENT1(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_ALT(ri)    VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x1d + (ri))
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_ALT_G_ALT(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_ALT_G_ALT     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_ALT_G_ALT(x)  (x)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_ALT1(ri)   VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x1f + (ri))

/** 
 * \brief
 * Bit 32-36 of field G_ALT.
 *
 * \details 
 * 00: GPIO mode
 * 01: Alternate mode 1
 ...
 * 11: Alternate mode 3
 *
 * Field: ::VTSS_DEVCPU_GCB_GPIO_GPIO_ALT1 . G_ALT1
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_ALT1_G_ALT1(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_ALT1_G_ALT1     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_ALT1_G_ALT1(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 */
#define VTSS_DEVCPU_GCB_GPIO_GPIO_SD_MAP(ri)  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x21 + (ri))
 ...
 */
#define VTSS_DEVCPU_GCB_MIIM_MII_STATUS(gi)  VTSS_IOREG_IX(VTSS_TO_DEVCPU_GCB,0x31,gi,9,0,0)
 ...
 * @param gi Replicator: x_FFL_DEVCPU_MIIM_CNT (??), 0-1
 */
#define VTSS_DEVCPU_GCB_MIIM_MII_CFG_7226(gi)  VTSS_IOREG_IX(VTSS_TO_DEVCPU_GCB,0x31,gi,9,0,1)
 ...
 * @param gi Replicator: x_FFL_DEVCPU_MIIM_CNT (??), 0-1
 */
#define VTSS_DEVCPU_GCB_MIIM_MII_CMD(gi)     VTSS_IOREG_IX(VTSS_TO_DEVCPU_GCB,0x31,gi,9,0,2)
 ...
 * @param gi Replicator: x_FFL_DEVCPU_MIIM_CNT (??), 0-1
 */
#define VTSS_DEVCPU_GCB_MIIM_MII_DATA(gi)    VTSS_IOREG_IX(VTSS_TO_DEVCPU_GCB,0x31,gi,9,0,3)
 ...
 * @param gi Replicator: x_FFL_DEVCPU_MIIM_CNT (??), 0-1
 */
#define VTSS_DEVCPU_GCB_MIIM_MII_CFG(gi)     VTSS_IOREG_IX(VTSS_TO_DEVCPU_GCB,0x31,gi,9,0,4)
 ...
 * @param gi Replicator: x_FFL_DEVCPU_MIIM_CNT (??), 0-1
 */
#define VTSS_DEVCPU_GCB_MIIM_MII_SCAN_0(gi)  VTSS_IOREG_IX(VTSS_TO_DEVCPU_GCB,0x31,gi,9,0,5)
 ...
 * @param gi Replicator: x_FFL_DEVCPU_MIIM_CNT (??), 0-1
 */
#define VTSS_DEVCPU_GCB_MIIM_MII_SCAN_1(gi)  VTSS_IOREG_IX(VTSS_TO_DEVCPU_GCB,0x31,gi,9,0,6)
 ...
 * @param gi Replicator: x_FFL_DEVCPU_MIIM_CNT (??), 0-1
 */
#define VTSS_DEVCPU_GCB_MIIM_MII_SCAN_LAST_RSLTS(gi)  VTSS_IOREG_IX(VTSS_TO_DEVCPU_GCB,0x31,gi,9,0,7)
 ...
 * @param gi Replicator: x_FFL_DEVCPU_MIIM_CNT (??), 0-1
 */
#define VTSS_DEVCPU_GCB_MIIM_MII_SCAN_LAST_RSLTS_VLD(gi)  VTSS_IOREG_IX(VTSS_TO_DEVCPU_GCB,0x31,gi,9,0,8)
 ...
 */
#define VTSS_DEVCPU_GCB_MIIM_READ_SCAN_MII_SCAN_RSLTS_STICKY(ri)  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x43 + (ri))
 ...
 */
#define VTSS_DEVCPU_GCB_MIIM_SLAVE_MIIM_SLAVE_CFG  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x45)
 ...
 */
#define VTSS_DEVCPU_GCB_PHY_PHY_CFG          VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x46)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_PHY_PHY_CFG_PHY_COMA(x)  VTSS_ENCODE_BITFIELD(!!(x),9,1)
#define  VTSS_M_DEVCPU_GCB_PHY_PHY_CFG_PHY_COMA  VTSS_BIT(9)
#define  VTSS_X_DEVCPU_GCB_PHY_PHY_CFG_PHY_COMA(x)  VTSS_EXTRACT_BITFIELD(x,9,1)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_PHY_PHY_CFG_PHY_ADDR(x)  VTSS_ENCODE_BITFIELD(x,5,4)
#define  VTSS_M_DEVCPU_GCB_PHY_PHY_CFG_PHY_ADDR     VTSS_ENCODE_BITMASK(5,4)
#define  VTSS_X_DEVCPU_GCB_PHY_PHY_CFG_PHY_ADDR(x)  VTSS_EXTRACT_BITFIELD(x,5,4)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_PHY_PHY_CFG_PHY_RESET(x)  VTSS_ENCODE_BITFIELD(x,3,2)
#define  VTSS_M_DEVCPU_GCB_PHY_PHY_CFG_PHY_RESET     VTSS_ENCODE_BITMASK(3,2)
#define  VTSS_X_DEVCPU_GCB_PHY_PHY_CFG_PHY_RESET(x)  VTSS_EXTRACT_BITFIELD(x,3,2)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_PHY_PHY_CFG_PHY_COMMON_RESET(x)  VTSS_ENCODE_BITFIELD(!!(x),2,1)
#define  VTSS_M_DEVCPU_GCB_PHY_PHY_CFG_PHY_COMMON_RESET  VTSS_BIT(2)
#define  VTSS_X_DEVCPU_GCB_PHY_PHY_CFG_PHY_COMMON_RESET(x)  VTSS_EXTRACT_BITFIELD(x,2,1)

/** 
 * \brief
 * Enable PHY interface for Device 0 and 1
 *
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_PHY_PHY_CFG . PHY_ENA
 */
#define  VTSS_F_DEVCPU_GCB_PHY_PHY_CFG_PHY_ENA(x)  VTSS_ENCODE_BITFIELD(x,0,2)
#define  VTSS_M_DEVCPU_GCB_PHY_PHY_CFG_PHY_ENA     VTSS_ENCODE_BITMASK(0,2)
#define  VTSS_X_DEVCPU_GCB_PHY_PHY_CFG_PHY_ENA(x)  VTSS_EXTRACT_BITFIELD(x,0,2)
 ...
 */
#define VTSS_DEVCPU_GCB_PHY_PHY_STAT         VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x47)

/** 
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_PHY_PHY_STAT . PHY_COMA_OE
 */
#define  VTSS_F_DEVCPU_GCB_PHY_PHY_STAT_PHY_COMA_OE(x)  VTSS_ENCODE_BITFIELD(!!(x),12,1)
#define  VTSS_M_DEVCPU_GCB_PHY_PHY_STAT_PHY_COMA_OE  VTSS_BIT(12)
#define  VTSS_X_DEVCPU_GCB_PHY_PHY_STAT_PHY_COMA_OE(x)  VTSS_EXTRACT_BITFIELD(x,12,1)

/** 
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_PHY_PHY_STAT . PHY_COMA_O
 */
#define  VTSS_F_DEVCPU_GCB_PHY_PHY_STAT_PHY_COMA_O(x)  VTSS_ENCODE_BITFIELD(!!(x),11,1)
#define  VTSS_M_DEVCPU_GCB_PHY_PHY_STAT_PHY_COMA_O  VTSS_BIT(11)
#define  VTSS_X_DEVCPU_GCB_PHY_PHY_STAT_PHY_COMA_O(x)  VTSS_EXTRACT_BITFIELD(x,11,1)

/** 
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_PHY_PHY_STAT . FAST_LINK_STATUS
 */
#define  VTSS_F_DEVCPU_GCB_PHY_PHY_STAT_FAST_LINK_STATUS(x)  VTSS_ENCODE_BITFIELD(x,9,2)
#define  VTSS_M_DEVCPU_GCB_PHY_PHY_STAT_FAST_LINK_STATUS     VTSS_ENCODE_BITMASK(9,2)
#define  VTSS_X_DEVCPU_GCB_PHY_PHY_STAT_FAST_LINK_STATUS(x)  VTSS_EXTRACT_BITFIELD(x,9,2)

/** 
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_PHY_PHY_STAT . LINK_STAT_DUPLEX
 */
#define  VTSS_F_DEVCPU_GCB_PHY_PHY_STAT_LINK_STAT_DUPLEX(x)  VTSS_ENCODE_BITFIELD(x,7,2)
#define  VTSS_M_DEVCPU_GCB_PHY_PHY_STAT_LINK_STAT_DUPLEX     VTSS_ENCODE_BITMASK(7,2)
#define  VTSS_X_DEVCPU_GCB_PHY_PHY_STAT_LINK_STAT_DUPLEX(x)  VTSS_EXTRACT_BITFIELD(x,7,2)

/** 
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_PHY_PHY_STAT . LINK_STAT_SPEED_1000
 */
#define  VTSS_F_DEVCPU_GCB_PHY_PHY_STAT_LINK_STAT_SPEED_1000(x)  VTSS_ENCODE_BITFIELD(x,5,2)
#define  VTSS_M_DEVCPU_GCB_PHY_PHY_STAT_LINK_STAT_SPEED_1000     VTSS_ENCODE_BITMASK(5,2)
#define  VTSS_X_DEVCPU_GCB_PHY_PHY_STAT_LINK_STAT_SPEED_1000(x)  VTSS_EXTRACT_BITFIELD(x,5,2)

/** 
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_PHY_PHY_STAT . LINK_STAT_SPEED_100
 */
#define  VTSS_F_DEVCPU_GCB_PHY_PHY_STAT_LINK_STAT_SPEED_100(x)  VTSS_ENCODE_BITFIELD(x,3,2)
#define  VTSS_M_DEVCPU_GCB_PHY_PHY_STAT_LINK_STAT_SPEED_100     VTSS_ENCODE_BITMASK(3,2)
#define  VTSS_X_DEVCPU_GCB_PHY_PHY_STAT_LINK_STAT_SPEED_100(x)  VTSS_EXTRACT_BITFIELD(x,3,2)

/** 
 * \details 
 * Field: ::VTSS_DEVCPU_GCB_PHY_PHY_STAT . LINK_STAT_SPEED_10
 */
#define  VTSS_F_DEVCPU_GCB_PHY_PHY_STAT_LINK_STAT_SPEED_10(x)  VTSS_ENCODE_BITFIELD(x,1,2)
#define  VTSS_M_DEVCPU_GCB_PHY_PHY_STAT_LINK_STAT_SPEED_10     VTSS_ENCODE_BITMASK(1,2)
#define  VTSS_X_DEVCPU_GCB_PHY_PHY_STAT_LINK_STAT_SPEED_10(x)  VTSS_EXTRACT_BITFIELD(x,1,2)
 ...
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_INPUT_DATA(ri)  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x48 + (ri))
 ...
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_CFG     VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x4c)
 ...
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_CLOCK   VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x4d)
 ...
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_PORT_CFG(ri)  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x4e + (ri))
 ...
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_PORT_ENA  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x6e)

/** 
 * \brief
 * Port enable vector with one enable bit for each port.
 * Port order: (portN downto port0)
 *
 * \details 
 * 0: Port is disabled
 * 1: Port is enabled
 ...
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_PWM_CFG(ri)  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x6f + (ri))
 ...
 * @param ri Replicator: x_FFL_DEVCPU_SIO_IOS_PR_PORT (??), 0-3
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_INTR_POL(ri)  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x72 + (ri))
 ...
 * @param ri Replicator: x_FFL_DEVCPU_SIO_IOS_PR_PORT (??), 0-3
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_INTR_RAW(ri)  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x76 + (ri))
 ...
 * @param ri Replicator: x_FFL_DEVCPU_SIO_IOS_PR_PORT (??), 0-3
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_INTR_TRIGGER0(ri)  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x7a + (ri))
 ...
 * @param ri Replicator: x_FFL_DEVCPU_SIO_IOS_PR_PORT (??), 0-3
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_INTR_TRIGGER1(ri)  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x7e + (ri))
 ...
 * @param ri Replicator: x_FFL_DEVCPU_SIO_IOS_PR_PORT (??), 0-3
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_INTR(ri)  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x82 + (ri))
 ...
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_INTR_ENA  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x86)
 ...
 * @param ri Replicator: x_FFL_DEVCPU_SIO_IOS_PR_PORT (??), 0-3
 */
#define VTSS_DEVCPU_GCB_SIO_CTRL_SIO_INTR_IDENT(ri)  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x87 + (ri))
 ...
 */
#define VTSS_DEVCPU_GCB_FAN_CTRL_FAN_CFG     VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x8b)
 ...
 *
 * Field: ::VTSS_DEVCPU_GCB_FAN_CTRL_FAN_CFG . CLK_PERIOD
 */
#define  VTSS_F_DEVCPU_GCB_FAN_CTRL_FAN_CFG_CLK_PERIOD(x)  VTSS_ENCODE_BITFIELD(x,7,8)
#define  VTSS_M_DEVCPU_GCB_FAN_CTRL_FAN_CFG_CLK_PERIOD     VTSS_ENCODE_BITMASK(7,8)
#define  VTSS_X_DEVCPU_GCB_FAN_CTRL_FAN_CFG_CLK_PERIOD(x)  VTSS_EXTRACT_BITFIELD(x,7,8)
 ...
 */
#define VTSS_DEVCPU_GCB_FAN_CTRL_FAN_CNT     VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x8c)
 ...
 */
#define VTSS_DEVCPU_GCB_MEMITGR_MEMITGR_DIV  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x91)
 ...
 */
#define VTSS_DEVCPU_GCB_MEMITGR_MEMITGR_DBG  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x92)
 ...
 */
#define VTSS_DEVCPU_GCB_VRAP_VRAP_ACCESS_STAT  VTSS_IOREG(VTSS_TO_DEVCPU_GCB,0x93)
...
#endif /* _VTSS_SERVALT_REGS_DEVCPU_GCB_H_ */
