...
#ifndef _VTSS_JAGUAR2C_REGS_VOP_H_
#define _VTSS_JAGUAR2C_REGS_VOP_H_
 ...
 */
#define VTSS_VOP_COMMON_LOC_CTRL             VTSS_IOREG(VTSS_TO_VOP,0x10d59)

/** 
 * \brief
 * Specifies the number of system clock cycles for each LOC base time tick.
 * The system clock is: 4 ns (250 MHz).
 * 
 ...
 */
#define VTSS_VOP_COMMON_LOC_PERIOD_CFG(ri)   VTSS_IOREG(VTSS_TO_VOP,0x10d5a + (ri))
 ...
 */
#define VTSS_VOP_COMMON_HMO_PERIOD_CFG(ri)   VTSS_IOREG(VTSS_TO_VOP,0x10d61 + (ri))
 ...
 * @param ri Replicator: x_VTSS_OAM_MEP_NUM_HMO_SCAN_CNT (??), 0-1
 */
#define VTSS_VOP_COMMON_HMO_FORCE_SLOT_CFG(ri)  VTSS_IOREG(VTSS_TO_VOP,0x10d63 + (ri))
 ...
 */
#define VTSS_VOP_COMMON_HMO_TIMER_CFG        VTSS_IOREG(VTSS_TO_VOP,0x10d65)
 ...
 */
#define VTSS_VOP_COMMON_LOC_SCAN_STICKY      VTSS_IOREG(VTSS_TO_VOP,0x10d66)
 ...
 */
#define VTSS_VOP_COMMON_MASTER_INTR_CTRL     VTSS_IOREG(VTSS_TO_VOP,0x10d67)
 ...
 */
#define VTSS_VOP_COMMON_VOE32_INTR(ri)       VTSS_IOREG(VTSS_TO_VOP,0x10d68 + (ri))
 ...
 */
#define  VTSS_F_VOP_COMMON_VOE32_INTR_VOE32_INTR(x)  (x)
#define  VTSS_M_VOP_COMMON_VOE32_INTR_VOE32_INTR     0xffffffff
#define  VTSS_X_VOP_COMMON_VOE32_INTR_VOE32_INTR(x)  (x)
 ...
 * 
 * 0 - 255 are the Service / Path VOEs
 * 256 - 266 are the Port VOEs
 * 
 ...
 *
 * @param ri Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE_DIV32_CEIL (??), 0-33
 */
#define VTSS_VOP_COMMON_INTR(ri)             VTSS_IOREG(VTSS_TO_VOP,0x10d6a + (ri))
 ...
 */
#define VTSS_VOP_COMMON_COMMON_MEP_MC_MAC_LSB  VTSS_IOREG(VTSS_TO_VOP,0x10d8c)
 ...
 */
#define VTSS_VOP_COMMON_COMMON_MEP_MC_MAC_MSB  VTSS_IOREG(VTSS_TO_VOP,0x10d8d)
 ...
 * Must point to a VOE in the pool of Service VOEs (0-255)
 *
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-1076
 */
#define VTSS_VOP_VOE_STAT_AUTO_HIT_ME_ONCE(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x20000,gi,32,0,20)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-1076
 */
#define VTSS_VOP_VOE_STAT_SYNLM_EXTRACT(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x20000,gi,32,0,21)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-1076
 */
#define VTSS_VOP_VOE_STAT_OAM_TX_STICKY(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x20000,gi,32,0,22)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-1076
 */
#define VTSS_VOP_VOE_STAT_OAM_RX_STICKY(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x20000,gi,32,0,23)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-1076
 */
#define VTSS_VOP_VOE_STAT_OAM_RX_STICKY2(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x20000,gi,32,0,24)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-1076
 */
#define VTSS_VOP_VOE_STAT_CCM_STAT(gi)       VTSS_IOREG_IX(VTSS_TO_VOP,0x20000,gi,32,0,25)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-1076
 */
#define VTSS_VOP_VOE_STAT_CCM_RX_LAST(gi)    VTSS_IOREG_IX(VTSS_TO_VOP,0x20000,gi,32,0,26)
 ...
 */
#define  VTSS_F_VOP_VOE_STAT_CCM_RX_LAST_CCM_RX_SRC_PORT(x)  VTSS_ENCODE_BITFIELD(x,13,6)
#define  VTSS_M_VOP_VOE_STAT_CCM_RX_LAST_CCM_RX_SRC_PORT     VTSS_ENCODE_BITMASK(13,6)
#define  VTSS_X_VOP_VOE_STAT_CCM_RX_LAST_CCM_RX_SRC_PORT(x)  VTSS_EXTRACT_BITFIELD(x,13,6)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-1076
 */
#define VTSS_VOP_VOE_STAT_INTR_STICKY(gi)    VTSS_IOREG_IX(VTSS_TO_VOP,0x20000,gi,32,0,27)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-1076
 */
#define VTSS_VOP_VOE_STAT_INTR_ENA(gi)       VTSS_IOREG_IX(VTSS_TO_VOP,0x20000,gi,32,0,28)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-1076
 */
#define VTSS_VOP_VOE_STAT_SLM_TX_FRM_CNT(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x20000,gi,32,0,29)
 ...
 *
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS (??), 0-52
 */
#define VTSS_VOP_VOE_CONTEXT_REW_CT_OAM_INFO_REW(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x10e00,gi,8,0,0)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS (??), 0-52
 */
#define VTSS_VOP_VOE_CONTEXT_REW_CT_OAM_STICKY_REW(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x10e00,gi,8,0,1)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS (??), 0-52
 */
#define VTSS_VOP_VOE_CONTEXT_REW_CT_CCM_TLV_INFO_REW(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x10e00,gi,8,0,2)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS (??), 0-52
 */
#define VTSS_VOP_VOE_CONTEXT_REW_CT_OAM_DATA_REW(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x10e00,gi,8,0,3)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS (??), 0-52
 */
#define VTSS_VOP_VOE_CONTEXT_REW_CT_OAM_DATA1_REW(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x10e00,gi,8,0,4)
 ...
 */
#define VTSS_VOP_VOE_CONTEXT_ANA_CT_OAM_INFO_ANA(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x11c00,gi,8,0,0)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS_x2 (??), 0-109
 */
#define VTSS_VOP_VOE_CONTEXT_ANA_CT_OAM_STICKY_ANA(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x11c00,gi,8,0,1)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS_x2 (??), 0-109
 */
#define VTSS_VOP_VOE_CONTEXT_ANA_CT_CCM_TLV_INFO_ANA(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x11c00,gi,8,0,2)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS_x2 (??), 0-109
 */
#define VTSS_VOP_VOE_CONTEXT_ANA_CT_OAM_DATA_ANA(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x11c00,gi,8,0,3)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS_x2 (??), 0-109
 */
#define VTSS_VOP_VOE_CONTEXT_ANA_CT_OAM_DATA1_ANA(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x11c00,gi,8,0,4)
 ...
 *  * Service (/Path) VOEs are indexed: 0 - 255
 *  * Port VOEs are indexed: 256 (Port 0) - 266 (Port 10)
 *
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS (??), 0-52
 */
#define VTSS_VOP_PORT_COSID_MAP_CONF_PORT_RX_COSID_MAP(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x11900,gi,4,0,0)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS (??), 0-52
 */
#define VTSS_VOP_PORT_COSID_MAP_CONF_PORT_RX_COSID_MAP1(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x11900,gi,4,0,1)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS (??), 0-52
 */
#define VTSS_VOP_PORT_COSID_MAP_CONF_PORT_TX_COSID_MAP(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x11900,gi,4,0,2)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_FRONT_PORTS (??), 0-52
 */
#define VTSS_VOP_PORT_COSID_MAP_CONF_PORT_TX_COSID_MAP1(gi)  VTSS_IOREG_IX(VTSS_TO_VOP,0x11900,gi,4,0,3)
 ...
 */
#define VTSS_VOP_RAM_CTRL_RAM_INIT           VTSS_IOREG(VTSS_TO_VOP,0x10d8e)
...
#endif /* _VTSS_JAGUAR2C_REGS_VOP_H_ */
