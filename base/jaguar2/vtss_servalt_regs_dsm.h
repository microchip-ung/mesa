...
#ifndef _VTSS_SERVALT_REGS_DSM_H_
#define _VTSS_SERVALT_REGS_DSM_H_
 ...
 *
 * \details 
 * Field: ::VTSS_DSM_COREMEM_CM_DATA . CM_DATA
 */
#define  VTSS_F_DSM_COREMEM_CM_DATA_CM_DATA(x)  (x)
#define  VTSS_M_DSM_COREMEM_CM_DATA_CM_DATA     0xffffffff
#define  VTSS_X_DSM_COREMEM_CM_DATA_CM_DATA(x)  (x)
 ...
 *
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_CFG_RATE_CTRL(ri)           VTSS_IOREG(VTSS_TO_DSM,0x10 + (ri))
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_CFG_IPG_SHRINK_CFG(ri)      VTSS_IOREG(VTSS_TO_DSM,0x1d + (ri))
 ...
 */
#define VTSS_DSM_CFG_CLR_BUF                 VTSS_IOREG(VTSS_TO_DSM,0x2a)

/** 
 * \brief
 * A write to this register clears the indicated buffer. No other buffers
 * will be influenced by clearing this buffer.
 * Encoding:
 * 1: Clears buffer for port 0
 * 2: Clears buffer for port 1
 * 2^N: Clears buffer for port N
 * 
 * If N > 31 Use respective next register.
 *
 * \details 
 * '0': No action
 * '1': Buffer is cleared (Bit is automatically cleared)
 *
 * Field: ::VTSS_DSM_CFG_CLR_BUF . CLR_BUF
 */
#define  VTSS_F_DSM_CFG_CLR_BUF_CLR_BUF(x)    VTSS_ENCODE_BITFIELD(x,0,13)
#define  VTSS_M_DSM_CFG_CLR_BUF_CLR_BUF       VTSS_ENCODE_BITMASK(0,13)
#define  VTSS_X_DSM_CFG_CLR_BUF_CLR_BUF(x)    VTSS_EXTRACT_BITFIELD(x,0,13)
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_CFG_SCH_STOP_WM_CFG(ri)     VTSS_IOREG(VTSS_TO_DSM,0x2b + (ri))
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_CFG_TX_START_WM_CFG(ri)     VTSS_IOREG(VTSS_TO_DSM,0x38 + (ri))
 ...
 * transfered immediately. If set to 0 a good default value is used.
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_CFG_DEV_TX_STOP_WM_CFG(ri)  VTSS_IOREG(VTSS_TO_DSM,0x45 + (ri))
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_CFG_RX_PAUSE_CFG(ri)        VTSS_IOREG(VTSS_TO_DSM,0x52 + (ri))
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_CFG_ETH_FC_CFG(ri)          VTSS_IOREG(VTSS_TO_DSM,0x5f + (ri))
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_CFG_ETH_PFC_CFG(ri)         VTSS_IOREG(VTSS_TO_DSM,0x6c + (ri))
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_CFG_MAC_CFG(ri)             VTSS_IOREG(VTSS_TO_DSM,0x79 + (ri))
 ...
 *
 * @param ri Replicator: x_DSM_NUM_PAUSE_FRM_MAC_ADDR (??), 0-10
 */
#define VTSS_DSM_CFG_MAC_ADDR_BASE_HIGH_CFG(ri)  VTSS_IOREG(VTSS_TO_DSM,0x86 + (ri))
 ...
 * @param ri Replicator: x_DSM_NUM_PAUSE_FRM_MAC_ADDR (??), 0-10
 */
#define VTSS_DSM_CFG_MAC_ADDR_BASE_LOW_CFG(ri)  VTSS_IOREG(VTSS_TO_DSM,0x91 + (ri))
 ...
 */
#define VTSS_DSM_CFG_DBG_CTRL                VTSS_IOREG(VTSS_TO_DSM,0x9c)
 ...
 *
 * @param ri Replicator: x_DSM_NUM_OF_TAXI (??), 0-2
 */
#define VTSS_DSM_CFG_TAXI_CAL_CFG(ri)        VTSS_IOREG(VTSS_TO_DSM,0x9d + (ri))
 ...
 *
 * \details 
 * Field: ::VTSS_DSM_CFG_TAXI_CAL_CFG . CAL_IDX
 */
#define  VTSS_F_DSM_CFG_TAXI_CAL_CFG_CAL_IDX(x)  VTSS_ENCODE_BITFIELD(x,13,6)
#define  VTSS_M_DSM_CFG_TAXI_CAL_CFG_CAL_IDX     VTSS_ENCODE_BITMASK(13,6)
#define  VTSS_X_DSM_CFG_TAXI_CAL_CFG_CAL_IDX(x)  VTSS_EXTRACT_BITFIELD(x,13,6)
 ...
 *
 * \details 
 * Field: ::VTSS_DSM_CFG_TAXI_CAL_CFG . CAL_CUR_LEN
 */
#define  VTSS_F_DSM_CFG_TAXI_CAL_CFG_CAL_CUR_LEN(x)  VTSS_ENCODE_BITFIELD(x,7,6)
#define  VTSS_M_DSM_CFG_TAXI_CAL_CFG_CAL_CUR_LEN     VTSS_ENCODE_BITMASK(7,6)
#define  VTSS_X_DSM_CFG_TAXI_CAL_CFG_CAL_CUR_LEN(x)  VTSS_EXTRACT_BITFIELD(x,7,6)
 ...
 *
 * \details 
 * Field: ::VTSS_DSM_CFG_TAXI_CAL_CFG . CAL_CUR_VAL
 */
#define  VTSS_F_DSM_CFG_TAXI_CAL_CFG_CAL_CUR_VAL(x)  VTSS_ENCODE_BITFIELD(x,4,3)
#define  VTSS_M_DSM_CFG_TAXI_CAL_CFG_CAL_CUR_VAL     VTSS_ENCODE_BITMASK(4,3)
#define  VTSS_X_DSM_CFG_TAXI_CAL_CFG_CAL_CUR_VAL(x)  VTSS_EXTRACT_BITFIELD(x,4,3)
 ...
 *
 * \details 
 * Field: ::VTSS_DSM_CFG_TAXI_CAL_CFG . CAL_PGM_VAL
 */
#define  VTSS_F_DSM_CFG_TAXI_CAL_CFG_CAL_PGM_VAL(x)  VTSS_ENCODE_BITFIELD(x,1,3)
#define  VTSS_M_DSM_CFG_TAXI_CAL_CFG_CAL_PGM_VAL     VTSS_ENCODE_BITMASK(1,3)
#define  VTSS_X_DSM_CFG_TAXI_CAL_CFG_CAL_PGM_VAL(x)  VTSS_EXTRACT_BITFIELD(x,1,3)
 ...
 *
 * \details 
 * Field: ::VTSS_DSM_CFG_TAXI_CAL_CFG . CAL_PGM_ENA
 */
#define  VTSS_F_DSM_CFG_TAXI_CAL_CFG_CAL_PGM_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_DSM_CFG_TAXI_CAL_CFG_CAL_PGM_ENA  VTSS_BIT(0)
#define  VTSS_X_DSM_CFG_TAXI_CAL_CFG_CAL_PGM_ENA(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 *
 * @param ri Replicator: x_DSM_NUM_AGED_FRM_CNTRS (??), 0-12
 */
#define VTSS_DSM_STATUS_AGED_FRMS(ri)        VTSS_IOREG(VTSS_TO_DSM,0xa0 + (ri))
 ...
 *
 * Field: ::VTSS_DSM_STATUS_AGED_FRMS . AGED_FRMS_CNT
 */
#define  VTSS_F_DSM_STATUS_AGED_FRMS_AGED_FRMS_CNT(x)  (x)
#define  VTSS_M_DSM_STATUS_AGED_FRMS_AGED_FRMS_CNT     0xffffffff
#define  VTSS_X_DSM_STATUS_AGED_FRMS_AGED_FRMS_CNT(x)  (x)
 ...
 */
#define VTSS_DSM_STATUS_CELL_BUS_STICKY      VTSS_IOREG(VTSS_TO_DSM,0xad)
 ...
 */
#define VTSS_DSM_STATUS_BUF_OFLW_STICKY      VTSS_IOREG(VTSS_TO_DSM,0xae)
 ...
 * Bit is cleared by writing a '1' to this position.
 *
 * Field: ::VTSS_DSM_STATUS_BUF_OFLW_STICKY . BUF_OFLW_STICKY
 */
#define  VTSS_F_DSM_STATUS_BUF_OFLW_STICKY_BUF_OFLW_STICKY(x)  VTSS_ENCODE_BITFIELD(x,0,13)
#define  VTSS_M_DSM_STATUS_BUF_OFLW_STICKY_BUF_OFLW_STICKY     VTSS_ENCODE_BITMASK(0,13)
#define  VTSS_X_DSM_STATUS_BUF_OFLW_STICKY_BUF_OFLW_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,0,13)
 ...
 */
#define VTSS_DSM_STATUS_BUF_UFLW_STICKY      VTSS_IOREG(VTSS_TO_DSM,0xaf)
 ...
 * Bit is cleared by writing a '1' to this position.
 *
 * Field: ::VTSS_DSM_STATUS_BUF_UFLW_STICKY . BUF_UFLW_STICKY
 */
#define  VTSS_F_DSM_STATUS_BUF_UFLW_STICKY_BUF_UFLW_STICKY(x)  VTSS_ENCODE_BITFIELD(x,0,13)
#define  VTSS_M_DSM_STATUS_BUF_UFLW_STICKY_BUF_UFLW_STICKY     VTSS_ENCODE_BITMASK(0,13)
#define  VTSS_X_DSM_STATUS_BUF_UFLW_STICKY_BUF_UFLW_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,0,13)
 ...
 */
#define VTSS_DSM_STATUS_PRE_CNT_OFLW_STICKY  VTSS_IOREG(VTSS_TO_DSM,0xb0)
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_STATUS_BUF_MAX_FILL(ri)     VTSS_IOREG(VTSS_TO_DSM,0xb1 + (ri))
 ...
 * Unit is 4 bytes.
 *
 * Field: ::VTSS_DSM_STATUS_BUF_MAX_FILL . MAX_FILL
 */
#define  VTSS_F_DSM_STATUS_BUF_MAX_FILL_MAX_FILL(x)  VTSS_ENCODE_BITFIELD(x,0,10)
#define  VTSS_M_DSM_STATUS_BUF_MAX_FILL_MAX_FILL     VTSS_ENCODE_BITMASK(0,10)
#define  VTSS_X_DSM_STATUS_BUF_MAX_FILL_MAX_FILL(x)  VTSS_EXTRACT_BITFIELD(x,0,10)
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_RATE_LIMIT_CFG_TX_RATE_LIMIT_MODE(ri)  VTSS_IOREG(VTSS_TO_DSM,0xbe + (ri))
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_RATE_LIMIT_CFG_TX_IPG_STRETCH_RATIO_CFG(ri)  VTSS_IOREG(VTSS_TO_DSM,0xcb + (ri))
 ...
 * @param ri Replicator: x_DSM_PORTS (??), 0-12
 */
#define VTSS_DSM_RATE_LIMIT_CFG_TX_FRAME_RATE_START_CFG(ri)  VTSS_IOREG(VTSS_TO_DSM,0xd8 + (ri))
 ...
 */
#define VTSS_DSM_RATE_LIMIT_CFG_TX_RATE_LIMIT_HDR_CFG  VTSS_IOREG(VTSS_TO_DSM,0xe5)
 ...
 */
#define VTSS_DSM_RATE_LIMIT_STATUS_TX_RATE_LIMIT_STICKY  VTSS_IOREG(VTSS_TO_DSM,0xe6)
 ...
 * Bit is cleared by writing a '1' to this position.
 *
 * Field: ::VTSS_DSM_RATE_LIMIT_STATUS_TX_RATE_LIMIT_STICKY . TX_RATE_LIMIT_STICKY
 */
#define  VTSS_F_DSM_RATE_LIMIT_STATUS_TX_RATE_LIMIT_STICKY_TX_RATE_LIMIT_STICKY(x)  VTSS_ENCODE_BITFIELD(x,0,13)
#define  VTSS_M_DSM_RATE_LIMIT_STATUS_TX_RATE_LIMIT_STICKY_TX_RATE_LIMIT_STICKY     VTSS_ENCODE_BITMASK(0,13)
#define  VTSS_X_DSM_RATE_LIMIT_STATUS_TX_RATE_LIMIT_STICKY_TX_RATE_LIMIT_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,0,13)


#endif /* _VTSS_SERVALT_REGS_DSM_H_ */
