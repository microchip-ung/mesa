 ...
 */
#define  VTSS_F_ANA_L2_COMMON_FWD_CFG_ISDX_DEFAULT_DLB_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),18,1)
#define  VTSS_M_ANA_L2_COMMON_FWD_CFG_ISDX_DEFAULT_DLB_ENA  VTSS_BIT(18)
#define  VTSS_X_ANA_L2_COMMON_FWD_CFG_ISDX_DEFAULT_DLB_ENA(x)  VTSS_EXTRACT_BITFIELD(x,18,1)
 ...
 * ANA_L2:PORT_LIMIT:PORT_LIMIT_CTRL) .
 * 
 * Frames are send to the CPU queue configured in
 ...
 */
#define  VTSS_F_ANA_L2_COMMON_LRN_CFG_CPU_COPY_LRN_LIMIT_EXCEED_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),19,1)
#define  VTSS_M_ANA_L2_COMMON_LRN_CFG_CPU_COPY_LRN_LIMIT_EXCEED_ENA  VTSS_BIT(19)
#define  VTSS_X_ANA_L2_COMMON_LRN_CFG_CPU_COPY_LRN_LIMIT_EXCEED_ENA(x)  VTSS_EXTRACT_BITFIELD(x,19,1)
 ...
 * 
 * Copies are send to the CPU queue specified in MAC table by means of
 ...
 * this port. Copies are send to the CPU queue specified by
 * ANA_L2::LRN_CFG.CPU_LRN_QU.
 * 
 * This does not influence the port move detection in
 * ANA_L2::MOVELOG_STICKY.
