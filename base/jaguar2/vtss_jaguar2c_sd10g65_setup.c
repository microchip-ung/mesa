                                     ...
                                     vtss_port_no_t                     port_no)
{
    ...
    if (ret_val == VTSS_RC_OK) {
        ret_val |=
            jaguar2c_sd10g_tx_register_cfg(vtss_state, &calc_results, port_no);
    }
    return ret_val;
}
                                     ...
                                     vtss_port_no_t                     port_no)
{
    ...
    if (ret_val == VTSS_RC_OK) {
        ret_val |=
            jaguar2c_sd10g_rx_register_cfg(vtss_state, &calc_results, port_no);
    }
    return ret_val;
}
                                       ...
                                       vtss_port_no_t port_no)
{
    ...
    if (ret_val == VTSS_RC_OK) {
        ret_val |=
            jaguar2c_sd10g_power_down_register_cfg(vtss_state, &calc_results,
                                                   port_no);
    }
    return ret_val;
}
                                            ...
                                            vtss_port_no_t port_no)
{
    ...
    if (res_struct->ib_cal_only[0] == 0) {
        ...
        if (res_struct->lc_smartctrl[0] == 1) {
            JR2_WRM(
                VTSS_SD10G65_DIG_SD10G65_APC_APC_LC_SOFTCTRL_CFG1(tgt_dig),
            ...
            JR2_WRM(
                VTSS_SD10G65_DIG_SD10G65_APC_APC_LC_SOFTCTRL_CFG(tgt_dig),
                VTSS_F_SD10G65_DIG_SD10G65_APC_APC_LC_SOFTCTRL_CFG_LC_SC_TIMER(
                    ...
                    VTSS_F_SD10G65_DIG_SD10G65_APC_APC_LC_SOFTCTRL_CFG_LC_SC_DFE1_THRESHOLD(
                        res_struct
                            ->apc_lc_softctrl_cfg__lc_sc_dfe1_threshold[0]) |
                    VTSS_F_SD10G65_DIG_SD10G65_APC_APC_LC_SOFTCTRL_CFG_LC_SC_DFE2_THRESHOLD(
                        res_struct
                            ->apc_lc_softctrl_cfg__lc_sc_dfe2_threshold[0]) |
                                   ...
                                   vtss_port_no_t                      port_no)
{
    ...
    if (ret_val == VTSS_RC_OK) {
        ret_val |=
            jaguar2c_apc10g_register_cfg(vtss_state, &calc_results, port_no);
    }
    return ret_val;
}
static vtss_rc jaguar2c_sd10g_df2f_register_cfg(
    ...
    vtss_port_no_t                                port_no)
{
    ...
    if (res_struct->use_par_clk[0] == 0) {
        if (res_struct->use_clk_gen[0] == 1) {
            JR2_WRM(
                VTSS_SD10G65_DIG_SD10G65_DFT_DFT_CLK_GEN_CFG(tgt_dig),
                                       ...
                                       vtss_port_no_t port_no)
{
    ...
    if (ret_val == VTSS_RC_OK) {
        ret_val |= jaguar2c_sd10g_df2f_register_cfg(vtss_state, &calc_results,
                                                    port_no);
    }
    return ret_val;
}
static vtss_rc jaguar2c_sd10g_f2df_register_cfg(
    vtss_state_t                                 *vtss_state,
    ...
    vtss_port_no_t                                port_no)
{
    ...
    // full register access
    JR2_WR(VTSS_SD10G65_SD10G65_RX_SYNTH_F2DF_CFG_STAT(tgt_ana),
           res_struct->f2df_cfg_stat[0]);
                                       ...
                                       vtss_port_no_t port_no)
{
    ...
    if (ret_val == VTSS_RC_OK) {
        ret_val |= jaguar2c_sd10g_f2df_register_cfg(vtss_state, &calc_results,
                                                    port_no);
    }
    return ret_val;
}
