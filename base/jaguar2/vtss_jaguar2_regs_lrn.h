 ...
 */
#define  VTSS_F_LRN_COMMON_SCAN_NEXT_CNT_SCAN_INC_AGE_AND_NXT_LRN_ALL_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),31,1)
#define  VTSS_M_LRN_COMMON_SCAN_NEXT_CNT_SCAN_INC_AGE_AND_NXT_LRN_ALL_ENA  VTSS_BIT(31)
#define  VTSS_X_LRN_COMMON_SCAN_NEXT_CNT_SCAN_INC_AGE_AND_NXT_LRN_ALL_ENA(x)  VTSS_EXTRACT_BITFIELD(x,31,1)
 ...
 */
#define  VTSS_F_LRN_COMMON_AUTOAGE_CFG_1_PAUSE_AUTO_AGE_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),26,1)
#define  VTSS_M_LRN_COMMON_AUTOAGE_CFG_1_PAUSE_AUTO_AGE_ENA  VTSS_BIT(26)
#define  VTSS_X_LRN_COMMON_AUTOAGE_CFG_1_PAUSE_AUTO_AGE_ENA(x)  VTSS_EXTRACT_BITFIELD(x,26,1)
...
/** 
 * \brief
 * Configures age base unit in num clk.
 *
 * \details 
 * Field: ::VTSS_LRN_COMMON_AUTOAGE_CFG_1 . BASE_UNIT_CLK_CNT
 */
