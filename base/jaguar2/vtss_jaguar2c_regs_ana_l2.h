...
#ifndef _VTSS_JAGUAR2C_REGS_ANA_L2_H_
#define _VTSS_JAGUAR2C_REGS_ANA_L2_H_
 ...
 */
#define  VTSS_F_ANA_L2_COMMON_FILTER_LOCAL_CTRL_FILTER_FRONTPORT_ENA(x)  (x)
#define  VTSS_M_ANA_L2_COMMON_FILTER_LOCAL_CTRL_FILTER_FRONTPORT_ENA     0xffffffff
#define  VTSS_X_ANA_L2_COMMON_FILTER_LOCAL_CTRL_FILTER_FRONTPORT_ENA(x)  (x)
 ...
 */
#define  VTSS_F_ANA_L2_COMMON_AUTO_LRN_CFG_AUTO_LRN_ENA(x)  (x)
#define  VTSS_M_ANA_L2_COMMON_AUTO_LRN_CFG_AUTO_LRN_ENA     0xffffffff
#define  VTSS_X_ANA_L2_COMMON_AUTO_LRN_CFG_AUTO_LRN_ENA(x)  (x)
 ...
 */
#define  VTSS_F_ANA_L2_COMMON_LRN_SECUR_CFG_DROP_UNKNOWN_SRC_ENA(x)  (x)
#define  VTSS_M_ANA_L2_COMMON_LRN_SECUR_CFG_DROP_UNKNOWN_SRC_ENA     0xffffffff
#define  VTSS_X_ANA_L2_COMMON_LRN_SECUR_CFG_DROP_UNKNOWN_SRC_ENA(x)  (x)
 ...
 */
#define  VTSS_F_ANA_L2_COMMON_LRN_SECUR_LOCKED_CFG_DROP_MOVED_LOCKED_ENA(x)  (x)
#define  VTSS_M_ANA_L2_COMMON_LRN_SECUR_LOCKED_CFG_DROP_MOVED_LOCKED_ENA     0xffffffff
#define  VTSS_X_ANA_L2_COMMON_LRN_SECUR_LOCKED_CFG_DROP_MOVED_LOCKED_ENA(x)  (x)
 ...
 */
#define  VTSS_F_ANA_L2_COMMON_LRN_COPY_CFG_CPU_LRN_COPY_ENA(x)  (x)
#define  VTSS_M_ANA_L2_COMMON_LRN_COPY_CFG_CPU_LRN_COPY_ENA     0xffffffff
#define  VTSS_X_ANA_L2_COMMON_LRN_COPY_CFG_CPU_LRN_COPY_ENA(x)  (x)
 ...
 */
#define  VTSS_F_ANA_L2_COMMON_PORT_DLB_CFG_QUEUE_DLB_IDX(x)  VTSS_ENCODE_BITFIELD(x,10,13)
#define  VTSS_M_ANA_L2_COMMON_PORT_DLB_CFG_QUEUE_DLB_IDX     VTSS_ENCODE_BITMASK(10,13)
#define  VTSS_X_ANA_L2_COMMON_PORT_DLB_CFG_QUEUE_DLB_IDX(x)  VTSS_EXTRACT_BITFIELD(x,10,13)
 ...
 */
#define  VTSS_F_ANA_L2_COMMON_PORT_DLB_CFG_PORT_DLB_IDX(x)  VTSS_ENCODE_BITFIELD(x,0,10)
#define  VTSS_M_ANA_L2_COMMON_PORT_DLB_CFG_PORT_DLB_IDX     VTSS_ENCODE_BITMASK(0,10)
#define  VTSS_X_ANA_L2_COMMON_PORT_DLB_CFG_PORT_DLB_IDX(x)  VTSS_EXTRACT_BITFIELD(x,0,10)
 ...
 */
#define  VTSS_F_ANA_L2_COMMON_MOVELOG_STICKY_PORTMOVE_LOG_STICKY(x)  (x)
#define  VTSS_M_ANA_L2_COMMON_MOVELOG_STICKY_PORTMOVE_LOG_STICKY     0xffffffff
#define  VTSS_X_ANA_L2_COMMON_MOVELOG_STICKY_PORTMOVE_LOG_STICKY(x)  (x)
 ...
 */
#define  VTSS_F_ANA_L2_ISDX_PORT_MASK_CFG_PORT_MASK(x)  (x)
#define  VTSS_M_ANA_L2_ISDX_PORT_MASK_CFG_PORT_MASK     0xffffffff
#define  VTSS_X_ANA_L2_ISDX_PORT_MASK_CFG_PORT_MASK(x)  (x)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_SDX (??), 0-4095
 */
#define VTSS_ANA_L2_ISDX_QGRP_CFG(gi)        VTSS_IOREG_IX(VTSS_TO_ANA_L2,0x0,gi,32,0,3)
 ...
 */
#define  VTSS_F_ANA_L2_ISDX_QGRP_CFG_QGRP_IDX(x)  VTSS_ENCODE_BITFIELD(x,2,10)
#define  VTSS_M_ANA_L2_ISDX_QGRP_CFG_QGRP_IDX     VTSS_ENCODE_BITMASK(2,10)
#define  VTSS_X_ANA_L2_ISDX_QGRP_CFG_QGRP_IDX(x)  VTSS_EXTRACT_BITFIELD(x,2,10)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_SDX (??), 0-4095
 */
#define VTSS_ANA_L2_ISDX_MISC_CFG(gi)        VTSS_IOREG_IX(VTSS_TO_ANA_L2,0x0,gi,32,0,4)
 ...
 */
#define  VTSS_F_ANA_L2_ISDX_MISC_CFG_PIPELINE_PT(x)  VTSS_ENCODE_BITFIELD(x,21,4)
#define  VTSS_M_ANA_L2_ISDX_MISC_CFG_PIPELINE_PT     VTSS_ENCODE_BITMASK(21,4)
#define  VTSS_X_ANA_L2_ISDX_MISC_CFG_PIPELINE_PT(x)  VTSS_EXTRACT_BITFIELD(x,21,4)
 ...
 */
#define  VTSS_F_ANA_L2_ISDX_MISC_CFG_BUM_SLB_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),20,1)
#define  VTSS_M_ANA_L2_ISDX_MISC_CFG_BUM_SLB_ENA  VTSS_BIT(20)
#define  VTSS_X_ANA_L2_ISDX_MISC_CFG_BUM_SLB_ENA(x)  VTSS_EXTRACT_BITFIELD(x,20,1)
 ...
 */
#define  VTSS_F_ANA_L2_ISDX_MISC_CFG_BUM_SLB_IDX(x)  VTSS_ENCODE_BITFIELD(x,10,10)
#define  VTSS_M_ANA_L2_ISDX_MISC_CFG_BUM_SLB_IDX     VTSS_ENCODE_BITMASK(10,10)
#define  VTSS_X_ANA_L2_ISDX_MISC_CFG_BUM_SLB_IDX(x)  VTSS_EXTRACT_BITFIELD(x,10,10)
 ...
 */
#define  VTSS_F_ANA_L2_ISDX_MISC_CFG_BDLB_IDX(x)  VTSS_ENCODE_BITFIELD(x,0,10)
#define  VTSS_M_ANA_L2_ISDX_MISC_CFG_BDLB_IDX     VTSS_ENCODE_BITMASK(0,10)
#define  VTSS_X_ANA_L2_ISDX_MISC_CFG_BDLB_IDX(x)  VTSS_EXTRACT_BITFIELD(x,0,10)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_SDX (??), 0-4095
 */
#define VTSS_ANA_L2_ISDX_DLB_CFG(gi)         VTSS_IOREG_IX(VTSS_TO_ANA_L2,0x0,gi,32,0,5)
 ...
 */
#define  VTSS_F_ANA_L2_ISDX_DLB_CFG_DLB_IDX(x)  VTSS_ENCODE_BITFIELD(x,0,13)
#define  VTSS_M_ANA_L2_ISDX_DLB_CFG_DLB_IDX     VTSS_ENCODE_BITMASK(0,13)
#define  VTSS_X_ANA_L2_ISDX_DLB_CFG_DLB_IDX(x)  VTSS_EXTRACT_BITFIELD(x,0,13)
 ...
 */
#define VTSS_ANA_L2_ISDX_DLB_COS_CFG(gi,ri)  VTSS_IOREG_IX(VTSS_TO_ANA_L2,0x0,gi,32,ri,6)
 ...
 * @param gi Replicator: x_FFL_CHIP_NUM_SDX (??), 0-4095
 */
#define VTSS_ANA_L2_ISDX_ISDX_BASE_CFG(gi)   VTSS_IOREG_IX(VTSS_TO_ANA_L2,0x0,gi,32,0,14)
 ...
 */
#define VTSS_ANA_L2_ISDX_ISDX_COS_CFG(gi,ri)  VTSS_IOREG_IX(VTSS_TO_ANA_L2,0x0,gi,32,ri,15)
...
#endif /* _VTSS_JAGUAR2C_REGS_ANA_L2_H_ */
