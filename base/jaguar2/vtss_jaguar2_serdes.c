                     ...
                     u32                addr)
{
    ...
    u32 ob_amp_ctrl = 0, cpmd_sel = 0, mbtr_ctrl = 2, des_bw_ana = 6, ob_idle = 0, test_mode = 0,
        test_pattern = 0;
    u32 cmv_term = 1;
    ...
    JR2_WRM(VTSS_HSIO_SERDES1G_ANA_CFG_SERDES1G_SER_CFG,
            VTSS_F_HSIO_SERDES1G_ANA_CFG_SERDES1G_SER_CFG_SER_IDLE(ob_idle) |
                VTSS_F_HSIO_SERDES1G_ANA_CFG_SERDES1G_SER_CFG_SER_ENALI(lb ==
                                                                        VTSS_PORT_LB_FACILITY),
    ...
    JR2_WRM(VTSS_HSIO_SERDES1G_ANA_CFG_SERDES1G_COMMON_CFG,
            VTSS_F_HSIO_SERDES1G_ANA_CFG_SERDES1G_COMMON_CFG_ENA_LANE(ena_lane) |
                VTSS_F_HSIO_SERDES1G_ANA_CFG_SERDES1G_COMMON_CFG_ENA_FLOOP(lb ==
                                                                           VTSS_PORT_LB_FACILITY) |
                VTSS_F_HSIO_SERDES1G_ANA_CFG_SERDES1G_COMMON_CFG_ENA_ELOOP(lb ==
                                                                           VTSS_PORT_LB_EQUIPMENT),
                     ...
                     u32                addr)
{
    ...
    JR2_WRM(VTSS_HSIO_SERDES6G_ANA_CFG_SERDES6G_COMMON_CFG,
            VTSS_F_HSIO_SERDES6G_ANA_CFG_SERDES6G_COMMON_CFG_ENA_FLOOP(lb ==
                                                                       VTSS_PORT_LB_FACILITY) |
                VTSS_F_HSIO_SERDES6G_ANA_CFG_SERDES6G_COMMON_CFG_ENA_ELOOP(lb ==
                                                                           VTSS_PORT_LB_EQUIPMENT) |
