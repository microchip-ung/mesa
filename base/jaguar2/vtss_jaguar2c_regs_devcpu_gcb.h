...
#ifndef _VTSS_JAGUAR2C_REGS_DEVCPU_GCB_H_
#define _VTSS_JAGUAR2C_REGS_DEVCPU_GCB_H_
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_OUT_SET1_G_OUT_SET1(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_OUT_SET1_G_OUT_SET1     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_OUT_SET1_G_OUT_SET1(x)  (x)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_OUT_CLR1_G_OUT_CLR1(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_OUT_CLR1_G_OUT_CLR1     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_OUT_CLR1_G_OUT_CLR1(x)  (x)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_OUT1_G_OUT1(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_OUT1_G_OUT1     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_OUT1_G_OUT1(x)  (x)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_IN1_G_IN1(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_IN1_G_IN1     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_IN1_G_IN1(x)  (x)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_OE1_G_OE1(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_OE1_G_OE1     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_OE1_G_OE1(x)  (x)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_INTR1_G_INTR1(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_INTR1_G_INTR1     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_INTR1_G_INTR1(x)  (x)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_INTR_ENA1_G_INTR_ENA1(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_INTR_ENA1_G_INTR_ENA1     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_INTR_ENA1_G_INTR_ENA1(x)  (x)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_INTR_IDENT1_G_INTR_IDENT1(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_INTR_IDENT1_G_INTR_IDENT1     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_INTR_IDENT1_G_INTR_IDENT1(x)  (x)
 ...
 */
#define  VTSS_F_DEVCPU_GCB_GPIO_GPIO_ALT1_G_ALT1(x)  (x)
#define  VTSS_M_DEVCPU_GCB_GPIO_GPIO_ALT1_G_ALT1     0xffffffff
#define  VTSS_X_DEVCPU_GCB_GPIO_GPIO_ALT1_G_ALT1(x)  (x)
...
#endif /* _VTSS_JAGUAR2C_REGS_DEVCPU_GCB_H_ */
