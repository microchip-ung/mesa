 ...
 * APC_COMMON_CFG.OFFSCAL_READ_CNT_SEL. Please notice that for EQZ and DFE
 ...
 *
 * \details
 * Configuration register for controlled EQZ_OFFS parameter. Please note,
 * for parameters larger than 8 bits, ini/min/max values are shifted to the
 ...
 *
 * \details
 * Configuration register for controlled EQZ_C parameter. Please note, for
 ...
 *
 * \details
 * Configuration register for controlled EQZ_L parameter. Please note, for
 * parameters larger than 8 bits, ini/min/max values are shifted to the
 * left. For parameters smaller than 8 bits only the lower bits of
 * ini/min/max are used.
 *
 ...
 *
 * \details
 * Configuration register for controlled EQZ_AGC parameter. Please note,
 * for parameters larger than 8 bits, ini/min/max values are shifted to the
 * left. For parameters smaller than 8 bits only the lower bits of
 * ini/min/max are used.
 *
 ...
 *
 * \details
 * Configuration register for controlled DFE1 parameter. Please note, for
 * parameters larger than 8 bits, ini/min/max values are shifted to the
 * left. For parameters smaller than 8 bits only the lower bits of
 * ini/min/max are used.
 *
 ...
 *
 * \details
 * Configuration register for controlled DFE2 parameter. Please note, for
 * parameters larger than 8 bits, ini/min/max values are shifted to the
 * left. For parameters smaller than 8 bits only the lower bits of
 * ini/min/max are used.
 *
 ...
 *
 * \details
 * Configuration register for controlled DFE3 parameter. Please note, for
 * parameters larger than 8 bits, ini/min/max values are shifted to the
 * left. For parameters smaller than 8 bits only the lower bits of
 * ini/min/max are used.
 *
 ...
 *
 * \details
 * Configuration register for controlled DFE4 parameter. Please note, for
 * parameters larger than 8 bits, ini/min/max values are shifted to the
 * left. For parameters smaller than 8 bits only the lower bits of
 * ini/min/max are used.
 *
...
/** 
 * \brief
 * Counter output depending on cnt_cfg_i
 *
 * \details 
 ...
 *
 * \details 
 * Field: ::VTSS_SD10G65_DIG_SD10G65_DFT_DFT_MAIN_STAT . STUCK_AT
 */
#define  VTSS_F_SD10G65_DIG_SD10G65_DFT_DFT_MAIN_STAT_STUCK_AT(x)  VTSS_ENCODE_BITFIELD(!!(x),4,1)
#define  VTSS_M_SD10G65_DIG_SD10G65_DFT_DFT_MAIN_STAT_STUCK_AT  VTSS_BIT(4)
#define  VTSS_X_SD10G65_DIG_SD10G65_DFT_DFT_MAIN_STAT_STUCK_AT(x)  VTSS_EXTRACT_BITFIELD(x,4,1)
 ...
 * @param target A \a ::vtss_target_SD10G65_DIG_e target
 */
#define VTSS_SD10G65_DIG_SD10G65_RCPLL_BIST_SD10G65_RCPLL_BIST_CFG0(target)  VTSS_IOREG(target,0x44)
 ...
 * @param target A \a ::vtss_target_SD10G65_DIG_e target
 */
#define VTSS_SD10G65_DIG_SD10G65_RCPLL_BIST_SD10G65_RCPLL_BIST_CFG1(target)  VTSS_IOREG(target,0x45)
 ...
 * @param target A \a ::vtss_target_SD10G65_DIG_e target
 */
#define VTSS_SD10G65_DIG_SD10G65_RCPLL_BIST_SD10G65_RCPLL_BIST_CFG2(target)  VTSS_IOREG(target,0x46)
 ...
 * @param target A \a ::vtss_target_SD10G65_DIG_e target
 */
#define VTSS_SD10G65_DIG_SD10G65_RCPLL_BIST_SD10G65_RCPLL_BIST_CFG3(target)  VTSS_IOREG(target,0x47)
 ...
 * @param target A \a ::vtss_target_SD10G65_DIG_e target
 */
#define VTSS_SD10G65_DIG_SD10G65_RCPLL_BIST_SD10G65_RX_RCPLL_BIST_CFG4(target)  VTSS_IOREG(target,0x48)
 ...
 * @param target A \a ::vtss_target_SD10G65_DIG_e target
 */
#define VTSS_SD10G65_DIG_SD10G65_RCPLL_BIST_SD10G65_RCPLL_BIST_STAT0(target)  VTSS_IOREG(target,0x49)
 ...
 * @param target A \a ::vtss_target_SD10G65_DIG_e target
 */
#define VTSS_SD10G65_DIG_SD10G65_RCPLL_BIST_SD10G65_RCPLL_BIST_STAT1(target)  VTSS_IOREG(target,0x4a)
