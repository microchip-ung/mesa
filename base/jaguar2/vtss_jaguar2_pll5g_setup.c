...
#ifndef VTSS_JAGUAR2__API_PLL5G_UTE
#define VTSS_JAGUAR2__API_PLL5G_UTE
...
static vtss_rc jaguar2_pll5g_register_cfg(vtss_state_t                    *vtss_state,
...
vtss_rc vtss_jaguar2_pll5g_setup(vtss_state_t                 *vtss_state,
