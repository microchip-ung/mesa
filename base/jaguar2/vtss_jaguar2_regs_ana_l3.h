...
/** 
 * \brief
 * Enable/disable VLAN ingress filtering per port. 
 * 
 ...
 */
#define  VTSS_F_ANA_L3_L3_STICKY_MASK_ROUT_STICKY_MASK_WRONG_SIP_LPM_ACTION_TYPE_STICKY_MASK(x)  VTSS_ENCODE_BITFIELD(!!(x),19,1)
#define  VTSS_M_ANA_L3_L3_STICKY_MASK_ROUT_STICKY_MASK_WRONG_SIP_LPM_ACTION_TYPE_STICKY_MASK  VTSS_BIT(19)
#define  VTSS_X_ANA_L3_L3_STICKY_MASK_ROUT_STICKY_MASK_WRONG_SIP_LPM_ACTION_TYPE_STICKY_MASK(x)  VTSS_EXTRACT_BITFIELD(x,19,1)
 ...
 */
#define  VTSS_F_ANA_L3_L3_STICKY_MASK_ROUT_STICKY_MASK_WRONG_DIP_LPM_ACTION_TYPE_STICKY_MASK(x)  VTSS_ENCODE_BITFIELD(!!(x),18,1)
#define  VTSS_M_ANA_L3_L3_STICKY_MASK_ROUT_STICKY_MASK_WRONG_DIP_LPM_ACTION_TYPE_STICKY_MASK  VTSS_BIT(18)
#define  VTSS_X_ANA_L3_L3_STICKY_MASK_ROUT_STICKY_MASK_WRONG_DIP_LPM_ACTION_TYPE_STICKY_MASK(x)  VTSS_EXTRACT_BITFIELD(x,18,1)
