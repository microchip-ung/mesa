                                   ...
                                   vtss_phys_port_no_t port)
{
    ...
    while (1) {
        ...
        if (delay_cnt++ == 2000) {
            ...
            cnt =
                VTSS_SNPRINTF(buf, sizeof(buf) - 1,
                              "QRES:RES_CTRL[chip-port = %u]:RES_STAT\n", port);
                                  ...
                                  char               *buf)
{
    ...
    case VTSS_CHIP_PORT_VD0: VTSS_STRCPY(buf, "VD0"); break;

    case VTSS_CHIP_PORT_VD1: VTSS_STRCPY(buf, "VD1"); break;
