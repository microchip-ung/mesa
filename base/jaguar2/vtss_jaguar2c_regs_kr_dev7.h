...
#ifndef _VTSS_JAGUAR2C_REGS_KR_DEV7_H_
#define _VTSS_JAGUAR2C_REGS_KR_DEV7_H_
 ...
 *
 * \details 
 * Field: ::VTSS_KR_DEV7_AN_CFG0_AN_CFG0 . ABDET_CLR
 */
#define  VTSS_F_KR_DEV7_AN_CFG0_AN_CFG0_ABDET_CLR(x)  VTSS_ENCODE_BITFIELD(!!(x),6,1)
#define  VTSS_M_KR_DEV7_AN_CFG0_AN_CFG0_ABDET_CLR  VTSS_BIT(6)
#define  VTSS_X_KR_DEV7_AN_CFG0_AN_CFG0_ABDET_CLR(x)  VTSS_EXTRACT_BITFIELD(x,6,1)
 ...
 *
 * \details 
 * Field: ::VTSS_KR_DEV7_AN_SM_AN_SM . ABDET_CNT
 */
#define  VTSS_F_KR_DEV7_AN_SM_AN_SM_ABDET_CNT(x)  VTSS_ENCODE_BITFIELD(x,4,4)
#define  VTSS_M_KR_DEV7_AN_SM_AN_SM_ABDET_CNT     VTSS_ENCODE_BITMASK(4,4)
#define  VTSS_X_KR_DEV7_AN_SM_AN_SM_ABDET_CNT(x)  VTSS_EXTRACT_BITFIELD(x,4,4)
...
#endif /* _VTSS_JAGUAR2C_REGS_KR_DEV7_H_ */
