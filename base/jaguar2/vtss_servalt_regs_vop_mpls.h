...
#ifndef _VTSS_SERVALT_REGS_VOP_MPLS_H_
#define _VTSS_SERVALT_REGS_VOP_MPLS_H_
 ...
 * PDU processing.
 * This CSR target us used for configuring VOEs configured for MPLS-TP
 * processing.
 * 
 * The VOP includes the following:
 * 
 *  * 192 Service / Path VOEs
 *  * 11 Port VOEs (11 front ports)
 * 
 * VOEs are configured for either Ethernet or MPLS-TP support using the
 * following register:
 *  * VOP:VOE_CONF_REG:VOE_MISC_CONFIG.MPLS_OAM_ENA
 * 
 * Use CSR target VOP_MPLS to configure VOEs configured for MPLS_TP.
 * To configure VOEs configured for Ethernet use CSR target: VOP.
 * 
 * For VOEs configured for Ethernet, the following register groups are
 * invalid:
 * 
 *  * VOP:CONF_MPLS:*
 *  * VOP:STAT_MPLS:*
 * 
 * Note that the VOP_MPLS CSR target shares the same physical RAM as VOP
 * CSR target. The RAM is initialized to the VOP CSR target values
 * (Ethernet VOE).
 * Hence the initial values listed in the VOP_MPLS are not valid.
 * Prior to using a VOE configured for MPLS, all REGISTERS MUST BE
 * INITIALIZED.
 *
 ***********************************************************************/
 ...
 */
#define VTSS_VOP_MPLS_VOE_CONF_MPLS_VOE_CTRL_MPLS(gi)  VTSS_IOREG_IX(VTSS_TO_VOP_MPLS,0x2000,gi,16,0,0)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_VOE_CTRL_MPLS_VOE_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),2,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_VOE_CTRL_MPLS_VOE_ENA  VTSS_BIT(2)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_VOE_CTRL_MPLS_VOE_ENA(x)  VTSS_EXTRACT_BITFIELD(x,2,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_VOE_CTRL_MPLS_UPMEP_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_VOE_CTRL_MPLS_UPMEP_ENA  VTSS_BIT(1)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_VOE_CTRL_MPLS_UPMEP_ENA(x)  VTSS_EXTRACT_BITFIELD(x,1,1)
 ...
 * configuration:
 * 
 *  * VOP_MPLS:VOE_CONF_MPLS:PATH_VOE_MPLS.PATH_VOEID
 *  * VOP_MPLS:VOE_CONF_MPLS:PATH_VOE_MPLS.PATH_VOE_ENA
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_VOE_CTRL_MPLS_VOE_IS_PATH(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_VOE_CTRL_MPLS_VOE_IS_PATH  VTSS_BIT(0)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_VOE_CTRL_MPLS_VOE_IS_PATH(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 * 
 * The PDU will be extsracted to the extraction queue configured for the
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-202
 */
#define VTSS_VOP_MPLS_VOE_CONF_MPLS_CPU_COPY_CTRL_MPLS(gi)  VTSS_IOREG_IX(VTSS_TO_VOP_MPLS,0x2000,gi,16,0,1)

/** 
 * \brief
 * This bit field contains 8 bits each of which represent one of the
 * Generic G-ACH Channel Types.
 * 
 * If the bit representing a specific Generic G-ACH Channel Type is
 * asserted, all valid PDUs received by the VOE of that type are extracted
 * to the CPU queue configured in the following bit fields:
 * 
 ...
 * should be extracted to the CPU.
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_CPU_COPY_CTRL_MPLS_UNK_CPT_CPU_COPY_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),2,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_CPU_COPY_CTRL_MPLS_UNK_CPT_CPU_COPY_ENA  VTSS_BIT(2)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_CPU_COPY_CTRL_MPLS_UNK_CPT_CPU_COPY_ENA(x)  VTSS_EXTRACT_BITFIELD(x,2,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_CPU_COPY_CTRL_MPLS_BFD_CC_CPU_COPY_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_CPU_COPY_CTRL_MPLS_BFD_CC_CPU_COPY_ENA  VTSS_BIT(1)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_CPU_COPY_CTRL_MPLS_BFD_CC_CPU_COPY_ENA(x)  VTSS_EXTRACT_BITFIELD(x,1,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_CPU_COPY_CTRL_MPLS_BFD_CV_CPU_COPY_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_CPU_COPY_CTRL_MPLS_BFD_CV_CPU_COPY_ENA  VTSS_BIT(0)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_CPU_COPY_CTRL_MPLS_BFD_CV_CPU_COPY_ENA(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-202
 */
#define VTSS_VOP_MPLS_VOE_CONF_MPLS_OAM_HW_CTRL_MPLS(gi)  VTSS_IOREG_IX(VTSS_TO_VOP_MPLS,0x2000,gi,16,0,2)
 ...
 * 
 * If this is disabled, no verification of the YourDiscriminator is done of
 * the incoming BFD CC PDUs. All Rx PDUs will be processed as belonging to
 * the Coordinated Mode.
 * 
 * I.e. a BFD CC PDUs will never be processed as belonging to the FEIS
 * Session.
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_CONF_MPLS_OAM_HW_CTRL_MPLS . BFD_CC_ENA
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_OAM_HW_CTRL_MPLS_BFD_CC_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_OAM_HW_CTRL_MPLS_BFD_CC_ENA  VTSS_BIT(1)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_OAM_HW_CTRL_MPLS_BFD_CC_ENA(x)  VTSS_EXTRACT_BITFIELD(x,1,1)
 ...
 * 
 * If this is disabled, no verification of the YourDiscriminator is done of
 * the incoming BFD CV PDUs. All Rx PDUs will be processed as belonging to
 * the Coordinated Mode.
 * 
 * I.e. a BFD CV PDUs will never be processed as belonging to the FEIS
 * Session.
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_CONF_MPLS_OAM_HW_CTRL_MPLS . BFD_CV_ENA
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_OAM_HW_CTRL_MPLS_BFD_CV_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_OAM_HW_CTRL_MPLS_BFD_CV_ENA  VTSS_BIT(0)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_OAM_HW_CTRL_MPLS_BFD_CV_ENA(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-202
 */
#define VTSS_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_SEL_MPLS(gi)  VTSS_IOREG_IX(VTSS_TO_VOP_MPLS,0x2000,gi,16,0,3)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_SEL_MPLS_UNK_CPT_CNT_SEL_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),2,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_SEL_MPLS_UNK_CPT_CNT_SEL_ENA  VTSS_BIT(2)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_SEL_MPLS_UNK_CPT_CNT_SEL_ENA(x)  VTSS_EXTRACT_BITFIELD(x,2,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_SEL_MPLS_BFD_CC_CNT_SEL_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_SEL_MPLS_BFD_CC_CNT_SEL_ENA  VTSS_BIT(1)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_SEL_MPLS_BFD_CC_CNT_SEL_ENA(x)  VTSS_EXTRACT_BITFIELD(x,1,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_SEL_MPLS_BFD_CV_CNT_SEL_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_SEL_MPLS_BFD_CV_CNT_SEL_ENA  VTSS_BIT(0)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_SEL_MPLS_BFD_CV_CNT_SEL_ENA(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-202
 */
#define VTSS_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_DATA_MPLS(gi)  VTSS_IOREG_IX(VTSS_TO_VOP_MPLS,0x2000,gi,16,0,4)

/** 
 * \brief
 * Enable / disable that valid MPLS-TP OAM PDUs with Generic G-ACH Channel
 * Type are counted by the VOE LM counters.
 * 
 * This bit field contains a separate bit for each of the possible 8
 * Generic G-ACH Channel Types.
 *
 ...
 * processed as an UNKNOWN G-ACH Channel Type.
 * 
 * This bit field configures if OAM frames with UNKNOWN G-ACH Channel Type
 * are counted as data in the LM counters.
 *
 * \details 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_DATA_MPLS_UNK_CPT_CNT_DATA_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),2,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_DATA_MPLS_UNK_CPT_CNT_DATA_ENA  VTSS_BIT(2)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_DATA_MPLS_UNK_CPT_CNT_DATA_ENA(x)  VTSS_EXTRACT_BITFIELD(x,2,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_DATA_MPLS_BFD_CC_CNT_DATA_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_DATA_MPLS_BFD_CC_CNT_DATA_ENA  VTSS_BIT(1)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_DATA_MPLS_BFD_CC_CNT_DATA_ENA(x)  VTSS_EXTRACT_BITFIELD(x,1,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_DATA_MPLS_BFD_CV_CNT_DATA_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_DATA_MPLS_BFD_CV_CNT_DATA_ENA  VTSS_BIT(0)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_OAM_CNT_DATA_MPLS_BFD_CV_CNT_DATA_ENA(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 * 
 * Assigning a Path VOE to a Service VOE implies that all frames received
 * by this VOE, will also be counted by the Path VOE. The VOE index of the
 * Path VOE is configured by the following bit field:
 * 
 *  * PATH_VOEID
 * 
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-202
 */
#define VTSS_VOP_MPLS_VOE_CONF_MPLS_PATH_VOE_MPLS(gi)  VTSS_IOREG_IX(VTSS_TO_VOP_MPLS,0x2000,gi,16,0,5)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_PATH_VOE_MPLS_PATH_VOE_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),8,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_PATH_VOE_MPLS_PATH_VOE_ENA  VTSS_BIT(8)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_PATH_VOE_MPLS_PATH_VOE_ENA(x)  VTSS_EXTRACT_BITFIELD(x,8,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_PATH_VOE_MPLS_PATH_VOEID(x)  VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_PATH_VOE_MPLS_PATH_VOEID     VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_PATH_VOE_MPLS_PATH_VOEID(x)  VTSS_EXTRACT_BITFIELD(x,0,8)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-202
 */
#define VTSS_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG(gi)  VTSS_IOREG_IX(VTSS_TO_VOP_MPLS,0x2000,gi,16,0,6)

/** 
 * \brief
 * The VOE can accept two different G-ACH Channel Types as being valid BFD
 * CC PDUs, depending of the setting of this register.
 * 
 * If the VOE receives a MPLS-TP with the G-ACH Channel Type which is not
 * the one configured for BFD CC, the PDU will be classified as either
 * Generic or Unknown G-ACH Channel Type.
 * 
 * I.e. if BFD_CC_RFC6428 = 1, MPLS-TP PDUs with G-ACH Channel Type =
 * 0x0007 will be classified as either Generic or UNKNOWN G-ACH Channel
 * Type.
 *
 * \details 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_CC_RFC6428(x)  VTSS_ENCODE_BITFIELD(!!(x),22,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_CC_RFC6428  VTSS_BIT(22)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_CC_RFC6428(x)  VTSS_EXTRACT_BITFIELD(x,22,1)

/** 
 * \brief
 * The configuration of this bit field specifies the LOC timeout counter to
 * be used for LOC scan for this VOE.
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_SAMPLE_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),18,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_SAMPLE_ENA  VTSS_BIT(18)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_SAMPLE_ENA(x)  VTSS_EXTRACT_BITFIELD(x,18,1)

/** 
 * \brief
 * If enabled, the VOE will update the following fields in the outgoing
 * PDUs when transmitting BFD CC / CV PDUs
 *  * BFD.STATE
 *  * BFD.DIAG
 *  * BFD.DM
 *
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_TX_UPDATE_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),17,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_TX_UPDATE_ENA  VTSS_BIT(17)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_TX_UPDATE_ENA(x)  VTSS_EXTRACT_BITFIELD(x,17,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_COORDINATED_MODE_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),16,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_COORDINATED_MODE_ENA  VTSS_BIT(16)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_COORDINATED_MODE_ENA(x)  VTSS_EXTRACT_BITFIELD(x,16,1)
 ...
 * HW.
 * 
 * Deasserting this field will disable all Rx validation of BFD CC PDUs.
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG . BFD_RX_VERIFY_CC_ENA
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_CC_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),15,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_CC_ENA  VTSS_BIT(15)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_CC_ENA(x)  VTSS_EXTRACT_BITFIELD(x,15,1)
 ...
 * HW.
 * 
 * Deasserting this field will disable all Rx validation of BFD CV PDUs.
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG . BFD_RX_VERIFY_CV_ENA
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_CV_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),14,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_CV_ENA  VTSS_BIT(14)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_CV_ENA(x)  VTSS_EXTRACT_BITFIELD(x,14,1)

/** 
 * \brief
 * If not enabled, the VERSION test will not be done as part of the BFD Rx
 * verification of BFD CC/CV PDUs.
 * 
 ...
 *  * BFD_CV_AUTH_ENA
 * 
 * When an Rx PDU fails the VERSION test, the following sticky bit is
 * asserted:
 * 
 *  * VOP_MPLS:VOE_STAT_MPLS:BFD_RX_STICKY.VERSION_ERR_STICKY
 * 
 * The VERSION test is disabled if:
 * 
 *  * BFD_RX_VERIFY_CC_ENA = 0
 *  * BFD_RX_VERIFY_CV_ENA = 0
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_VERSION_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),13,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_VERSION_ENA  VTSS_BIT(13)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_VERSION_ENA(x)  VTSS_EXTRACT_BITFIELD(x,13,1)
 ...
 *  * BFD_CV_AUTH_ENA
 * 
 * When an Rx PDU fails the MIN_LEN test, the following sticky bit is
 * asserted:
 * 
 *  * VOP_MPLS:VOE_STAT_MPLS:BFD_RX_STICKY.MIN_LEN_ERR_STICKY
 * 
 * The MIN_LEN test is disabled if:
 * 
 *  * BFD_RX_VERIFY_CC_ENA = 0
 *  * BFD_RX_VERIFY_CV_ENA = 0
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_MIN_LEN_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),12,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_MIN_LEN_ENA  VTSS_BIT(12)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_MIN_LEN_ENA(x)  VTSS_EXTRACT_BITFIELD(x,12,1)

/** 
 * \brief
 * When disabled, the Your/My Discriminator fields of incoming BFD CC/CV
 * PDUs are not verified of BFD CC/CV PDUs.
 * 
 * The BFD PDU is assumed to  belong to the Coordinated / NEIS session.
 * 
 * When an Rx PDU does not match any of the configured discriminators, the
 * following sticky bit is asserted:
 * 
 *  * VOP_MPLS:VOE_STAT_MPLS:BFD_RX_STICKY.YOUR_DISCR_ERR_STICKY
 * 
 * This test is disabled if:
 * 
 *  * BFD_RX_VERIFY_CC_ENA = 0
 *  * BFD_RX_VERIFY_CV_ENA = 0
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_DISCR_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),11,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_DISCR_ENA  VTSS_BIT(11)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_DISCR_ENA(x)  VTSS_EXTRACT_BITFIELD(x,11,1)
 ...
 * * Demand bit is asserted
 * * F and P bits are not set in the same frame.
 * 
 * If any of the above test fails, the corresponding sticky bit is asserted
 * (VOP_MPLS:VOE_STAT_MPLS:BFD_RX_STICKY.*):
 * 
 *  * DM_ZERO_ERR_STICKY
 *  * M_BIT_SET_ERR_STICKY
 *  * AUTH_MISMATCH_ERR_STICKY
 *  * D_BIT_SET_ERR_STICKY
 *  * P_AND_F_BIT_SET_ERR_STICKY
 * 
 * The AUTH-bit testing is further dependent on the following bit fields:
 * 
 *  * BFD_CC_AUTH_ENA
 *  * BFD_CV_AUTH_ENA
 * 
 * The FLAGS test is disabled if:
 * 
 *  * BFD_RX_VERIFY_CC_ENA = 0
 *  * BFD_RX_VERIFY_CV_ENA = 0
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_FLAGS_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),10,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_FLAGS_ENA  VTSS_BIT(10)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_RX_VERIFY_FLAGS_ENA(x)  VTSS_EXTRACT_BITFIELD(x,10,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_CC_AUTH_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),9,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_CC_AUTH_ENA  VTSS_BIT(9)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_CC_AUTH_ENA(x)  VTSS_EXTRACT_BITFIELD(x,9,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_CV_AUTH_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),8,1)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_CV_AUTH_ENA  VTSS_BIT(8)
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_CONFIG_BFD_CV_AUTH_ENA(x)  VTSS_EXTRACT_BITFIELD(x,8,1)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-202
 */
#define VTSS_VOP_MPLS_VOE_CONF_MPLS_BFD_LOCAL_DISCR_SRC(gi)  VTSS_IOREG_IX(VTSS_TO_VOP_MPLS,0x2000,gi,16,0,7)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_CONF_MPLS_BFD_LOCAL_DISCR_SRC . BFD_LOCAL_DISCR_SRC
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_LOCAL_DISCR_SRC_BFD_LOCAL_DISCR_SRC(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_LOCAL_DISCR_SRC_BFD_LOCAL_DISCR_SRC     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_LOCAL_DISCR_SRC_BFD_LOCAL_DISCR_SRC(x)  (x)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-202
 */
#define VTSS_VOP_MPLS_VOE_CONF_MPLS_BFD_REMOTE_DISCR_SRC(gi)  VTSS_IOREG_IX(VTSS_TO_VOP_MPLS,0x2000,gi,16,0,8)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_CONF_MPLS_BFD_REMOTE_DISCR_SRC . BFD_REMOTE_DISCR_SRC
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_REMOTE_DISCR_SRC_BFD_REMOTE_DISCR_SRC(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_REMOTE_DISCR_SRC_BFD_REMOTE_DISCR_SRC     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_REMOTE_DISCR_SRC_BFD_REMOTE_DISCR_SRC(x)  (x)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-202
 */
#define VTSS_VOP_MPLS_VOE_CONF_MPLS_BFD_LOCAL_DISCR_SINK(gi)  VTSS_IOREG_IX(VTSS_TO_VOP_MPLS,0x2000,gi,16,0,9)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_CONF_MPLS_BFD_LOCAL_DISCR_SINK . BFD_LOCAL_DISCR_SINK
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_LOCAL_DISCR_SINK_BFD_LOCAL_DISCR_SINK(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_LOCAL_DISCR_SINK_BFD_LOCAL_DISCR_SINK     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_LOCAL_DISCR_SINK_BFD_LOCAL_DISCR_SINK(x)  (x)
 ...
 * @param gi Replicator: x_VTSS_OAM_MEP_NUM_TOTAL_VOE (??), 0-202
 */
#define VTSS_VOP_MPLS_VOE_CONF_MPLS_BFD_REMOTE_DISCR_SINK(gi)  VTSS_IOREG_IX(VTSS_TO_VOP_MPLS,0x2000,gi,16,0,10)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_CONF_MPLS_BFD_REMOTE_DISCR_SINK . BFD_REMOTE_DISCR_SINK
 */
#define  VTSS_F_VOP_MPLS_VOE_CONF_MPLS_BFD_REMOTE_DISCR_SINK_BFD_REMOTE_DISCR_SINK(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_CONF_MPLS_BFD_REMOTE_DISCR_SINK_BFD_REMOTE_DISCR_SINK     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_CONF_MPLS_BFD_REMOTE_DISCR_SINK_BFD_REMOTE_DISCR_SINK(x)  (x)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_STAT_MPLS_RX_CNT_SEL_OAM_MPLS . RX_CNT_SEL_OAM_MPLS
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_RX_CNT_SEL_OAM_MPLS_RX_CNT_SEL_OAM_MPLS(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_RX_CNT_SEL_OAM_MPLS_RX_CNT_SEL_OAM_MPLS     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_RX_CNT_SEL_OAM_MPLS_RX_CNT_SEL_OAM_MPLS(x)  (x)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_STAT_MPLS_RX_CNT_NON_SEL_OAM_MPLS . RX_CNT_NON_SEL_OAM_MPLS
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_RX_CNT_NON_SEL_OAM_MPLS_RX_CNT_NON_SEL_OAM_MPLS(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_RX_CNT_NON_SEL_OAM_MPLS_RX_CNT_NON_SEL_OAM_MPLS     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_RX_CNT_NON_SEL_OAM_MPLS_RX_CNT_NON_SEL_OAM_MPLS(x)  (x)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_STAT_MPLS_TX_CNT_SEL_OAM_MPLS . TX_CNT_SEL_OAM_MPLS
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_TX_CNT_SEL_OAM_MPLS_TX_CNT_SEL_OAM_MPLS(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_TX_CNT_SEL_OAM_MPLS_TX_CNT_SEL_OAM_MPLS     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_TX_CNT_SEL_OAM_MPLS_TX_CNT_SEL_OAM_MPLS(x)  (x)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_STAT_MPLS_TX_CNT_NON_SEL_OAM_MPLS . TX_CNT_NON_SEL_OAM_MPLS
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_TX_CNT_NON_SEL_OAM_MPLS_TX_CNT_NON_SEL_OAM_MPLS(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_TX_CNT_NON_SEL_OAM_MPLS_TX_CNT_NON_SEL_OAM_MPLS     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_TX_CNT_NON_SEL_OAM_MPLS_TX_CNT_NON_SEL_OAM_MPLS(x)  (x)
 ...
 * 
 * The VOE will generate a LOC event when the BFD_MISS_CNT is equal to the
 * value in the relevant Detect Multiplier.
 * 
 * Which Detect Multiplier is used depends on whether the BFD session is
 * configured for "Coordinated Mode" or "Independent Mode".
 *
 * \details 
...
/** 
 * \brief
 * Contains the current LOC state.
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_LAST_BFD_LOC_DEFECT(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_LAST_BFD_LOC_DEFECT  VTSS_BIT(0)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_LAST_BFD_LOC_DEFECT(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 * detection).
 *  * A valid BFD CC/CV PDU is received by the VOE which is in LOC state.

 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS . BFD_LOC_CHANGE_STICKY
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_LOC_CHANGE_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),10,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_LOC_CHANGE_STICKY  VTSS_BIT(10)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_LOC_CHANGE_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,10,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_DM_CHANGE_SRC_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),9,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_DM_CHANGE_SRC_STICKY  VTSS_BIT(9)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_DM_CHANGE_SRC_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,9,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_STATE_CHANGE_SRC_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),8,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_STATE_CHANGE_SRC_STICKY  VTSS_BIT(8)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_STATE_CHANGE_SRC_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,8,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_DIAG_CHANGE_SRC_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),7,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_DIAG_CHANGE_SRC_STICKY  VTSS_BIT(7)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_DIAG_CHANGE_SRC_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,7,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_P_SET_SRC_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),6,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_P_SET_SRC_STICKY  VTSS_BIT(6)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_P_SET_SRC_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,6,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_F_SET_SRC_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),5,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_F_SET_SRC_STICKY  VTSS_BIT(5)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_F_SET_SRC_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,5,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_DM_CHANGE_SINK_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),4,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_DM_CHANGE_SINK_STICKY  VTSS_BIT(4)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_DM_CHANGE_SINK_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,4,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_STATE_CHANGE_SINK_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),3,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_STATE_CHANGE_SINK_STICKY  VTSS_BIT(3)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_STATE_CHANGE_SINK_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,3,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_DIAG_CHANGE_SINK_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),2,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_DIAG_CHANGE_SINK_STICKY  VTSS_BIT(2)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_DIAG_CHANGE_SINK_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,2,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_P_SET_SINK_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_P_SET_SINK_STICKY  VTSS_BIT(1)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_P_SET_SINK_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,1,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_F_SET_SINK_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_F_SET_SINK_STICKY  VTSS_BIT(0)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_STICKY_MPLS_BFD_RX_F_SET_SINK_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_LOC_CHANGE_INT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),10,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_LOC_CHANGE_INT_ENA  VTSS_BIT(10)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_LOC_CHANGE_INT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,10,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_DM_CHANGE_SRC_INT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),9,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_DM_CHANGE_SRC_INT_ENA  VTSS_BIT(9)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_DM_CHANGE_SRC_INT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,9,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_STATE_CHANGE_SRC_INT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),8,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_STATE_CHANGE_SRC_INT_ENA  VTSS_BIT(8)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_STATE_CHANGE_SRC_INT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,8,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_DIAG_CHANGE_SRC_INT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),7,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_DIAG_CHANGE_SRC_INT_ENA  VTSS_BIT(7)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_DIAG_CHANGE_SRC_INT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,7,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_P_SET_SRC_INT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),6,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_P_SET_SRC_INT_ENA  VTSS_BIT(6)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_P_SET_SRC_INT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,6,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_F_SET_SRC_INT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),5,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_F_SET_SRC_INT_ENA  VTSS_BIT(5)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_F_SET_SRC_INT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,5,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_DM_CHANGE_SINK_INT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),4,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_DM_CHANGE_SINK_INT_ENA  VTSS_BIT(4)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_DM_CHANGE_SINK_INT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,4,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_STATE_CHANGE_SINK_INT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),3,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_STATE_CHANGE_SINK_INT_ENA  VTSS_BIT(3)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_STATE_CHANGE_SINK_INT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,3,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_DIAG_CHANGE_SINK_INT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),2,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_DIAG_CHANGE_SINK_INT_ENA  VTSS_BIT(2)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_DIAG_CHANGE_SINK_INT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,2,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_P_SET_SINK_INT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_P_SET_SINK_INT_ENA  VTSS_BIT(1)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_P_SET_SINK_INT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,1,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_F_SET_SINK_INT_ENA(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_F_SET_SINK_INT_ENA  VTSS_BIT(0)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_INTR_ENA_MPLS_BFD_RX_F_SET_SINK_INT_ENA(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 * register:
 * 
 *  * VOP::MPLS_GENERIC_CODEPOINT.GENERIC_CODEPOINT_VAL
 * 
 * There is a separate bit to indicate the reception of each of the
 * configured Generic G-ACH Channel Types.
 *
 * \details 
 * x0x: No CPU copy
 * x1x: Copy to CPU
 ...
 * Type which is detected as UNKNOWN.
 * 
 * UNKNOWN G-ACH Channel Type is used for OAM PDU types which do not have
 * dedicated HW support and which is not encoded as a Generic G-ACH Channel
 * Type.
 *
 * \details 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_CPT_RX_STICKY_MPLS_UNK_CPT_RX_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),2,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_CPT_RX_STICKY_MPLS_UNK_CPT_RX_STICKY  VTSS_BIT(2)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_CPT_RX_STICKY_MPLS_UNK_CPT_RX_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,2,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_CPT_RX_STICKY_MPLS_BFD_CC_RX_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_CPT_RX_STICKY_MPLS_BFD_CC_RX_STICKY  VTSS_BIT(1)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_CPT_RX_STICKY_MPLS_BFD_CC_RX_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,1,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_CPT_RX_STICKY_MPLS_BFD_CV_RX_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_CPT_RX_STICKY_MPLS_BFD_CV_RX_STICKY  VTSS_BIT(0)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_CPT_RX_STICKY_MPLS_BFD_CV_RX_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_CC_RX_NEXT_GOOD_EXTR(x)  VTSS_ENCODE_BITFIELD(!!(x),7,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_CC_RX_NEXT_GOOD_EXTR  VTSS_BIT(7)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_CC_RX_NEXT_GOOD_EXTR(x)  VTSS_EXTRACT_BITFIELD(x,7,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_CV_RX_NEXT_GOOD_EXTR(x)  VTSS_ENCODE_BITFIELD(!!(x),6,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_CV_RX_NEXT_GOOD_EXTR  VTSS_BIT(6)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_CV_RX_NEXT_GOOD_EXTR(x)  VTSS_EXTRACT_BITFIELD(x,6,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_EXTRACT_HIT_ME_ONCE(x)  VTSS_ENCODE_BITFIELD(!!(x),5,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_EXTRACT_HIT_ME_ONCE  VTSS_BIT(5)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_EXTRACT_HIT_ME_ONCE(x)  VTSS_EXTRACT_BITFIELD(x,5,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_RX_PARAM_CHANGE_EXTR(x)  VTSS_ENCODE_BITFIELD(!!(x),4,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_RX_PARAM_CHANGE_EXTR  VTSS_BIT(4)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_RX_PARAM_CHANGE_EXTR(x)  VTSS_EXTRACT_BITFIELD(x,4,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_RX_P_SET_EXTR(x)  VTSS_ENCODE_BITFIELD(!!(x),3,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_RX_P_SET_EXTR  VTSS_BIT(3)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_RX_P_SET_EXTR(x)  VTSS_EXTRACT_BITFIELD(x,3,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_RX_F_SET_EXTR(x)  VTSS_ENCODE_BITFIELD(!!(x),2,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_RX_F_SET_EXTR  VTSS_BIT(2)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_RX_F_SET_EXTR(x)  VTSS_EXTRACT_BITFIELD(x,2,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_RX_ERR_EXTR(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_RX_ERR_EXTR  VTSS_BIT(1)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_RX_ERR_EXTR(x)  VTSS_EXTRACT_BITFIELD(x,1,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_TX_ERR_EXTR(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_TX_ERR_EXTR  VTSS_BIT(0)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_PDU_EXTRACT_MPLS_BFD_TX_ERR_EXTR(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 * 
 * PDUs faling the Rx verification can optionally be extracted by
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_VERSION_ERR_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),9,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_VERSION_ERR_STICKY  VTSS_BIT(9)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_VERSION_ERR_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,9,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_MIN_LEN_ERR_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),8,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_MIN_LEN_ERR_STICKY  VTSS_BIT(8)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_MIN_LEN_ERR_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,8,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_MAX_LEN_ERR_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),7,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_MAX_LEN_ERR_STICKY  VTSS_BIT(7)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_MAX_LEN_ERR_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,7,1)

/** 
 * \brief
 * Sticky bit asserted if an incoming Rx BFD PDU fails the DM_ZERO test:
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_DM_ZERO_ERR_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),6,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_DM_ZERO_ERR_STICKY  VTSS_BIT(6)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_DM_ZERO_ERR_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,6,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_M_BIT_SET_ERR_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),5,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_M_BIT_SET_ERR_STICKY  VTSS_BIT(5)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_M_BIT_SET_ERR_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,5,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_MY_DISCR_ERR_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),4,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_MY_DISCR_ERR_STICKY  VTSS_BIT(4)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_MY_DISCR_ERR_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,4,1)

/** 
 * \brief
 * Sticky bit asserted if an incoming BFD PDU fails the YOUR_DISCR test.
 * 
 * The YOUR_DISCR test will match the Your Discriminator field of the Rx
 * BFD PDU against the values configured in the following registers, to
 * determine which session the BFD PDU belongs to:
 * 
 * Coordinated or NEIS session:
 *  * VOP_MPLS:VOE_CONF_MPLS:BFD_LOCAL_DISCR_SRC.BFD_LOCAL_DISCR_SRC
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_YOUR_DISCR_ERR_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),3,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_YOUR_DISCR_ERR_STICKY  VTSS_BIT(3)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_YOUR_DISCR_ERR_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,3,1)

/** 
 * \brief
 * Sticky bit asserted if an incoming BFD PDU fails the AUTH_MISMATCH test.
 * 
 * The VOE is configured with the expected value of the incoming BFD PDUs:
 * 
 * BFD CC:
 *  * VOP_MPLS:VOE_CONF_MPLS:BFD_CONFIG.BFD_CC_AUTH_ENA
 * 
 * BFD CV:
 *  * VOP_MPLS:VOE_CONF_MPLS:BFD_CONFIG.BFD_CV_AUTH_ENA
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_AUTH_MISMATCH_ERR_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),2,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_AUTH_MISMATCH_ERR_STICKY  VTSS_BIT(2)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_AUTH_MISMATCH_ERR_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,2,1)

/** 
 * \brief
 * Sticky bit is asserted if an Rx BFD PDU fails the D_BIT_SET test.
 * Frames failing this test are discarded.
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_D_BIT_SET_ERR_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_D_BIT_SET_ERR_STICKY  VTSS_BIT(1)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_D_BIT_SET_ERR_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,1,1)

/** 
 * \brief
 * Sticky bit is asserted if an Rx BFD PDU fails the P_AND_F_BIT_SET test.
 * Frames failing this test are discarded.
 * 
 * 
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_P_AND_F_BIT_SET_ERR_STICKY(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_P_AND_F_BIT_SET_ERR_STICKY  VTSS_BIT(0)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_RX_STICKY_P_AND_F_BIT_SET_ERR_STICKY(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_TX_STICKY_TX_MY_DISCR_MISMATCH(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_TX_STICKY_TX_MY_DISCR_MISMATCH  VTSS_BIT(0)
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_TX_STICKY_TX_MY_DISCR_MISMATCH(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_STAT_MPLS_BFD_CC_TX_CNT_REG . BFD_CC_TX_CNT
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_CC_TX_CNT_REG_BFD_CC_TX_CNT(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_CC_TX_CNT_REG_BFD_CC_TX_CNT     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_CC_TX_CNT_REG_BFD_CC_TX_CNT(x)  (x)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_STAT_MPLS_BFD_CV_TX_CNT_REG . BFD_CV_TX_CNT
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_CV_TX_CNT_REG_BFD_CV_TX_CNT(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_CV_TX_CNT_REG_BFD_CV_TX_CNT     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_CV_TX_CNT_REG_BFD_CV_TX_CNT(x)  (x)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_STAT_MPLS_BFD_CC_RX_VLD_CNT_REG . BFD_CC_RX_VLD_CNT
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_CC_RX_VLD_CNT_REG_BFD_CC_RX_VLD_CNT(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_CC_RX_VLD_CNT_REG_BFD_CC_RX_VLD_CNT     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_CC_RX_VLD_CNT_REG_BFD_CC_RX_VLD_CNT(x)  (x)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_STAT_MPLS_BFD_CV_RX_VLD_CNT_REG . BFD_CV_RX_VLD_CNT
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_CV_RX_VLD_CNT_REG_BFD_CV_RX_VLD_CNT(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_CV_RX_VLD_CNT_REG_BFD_CV_RX_VLD_CNT     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_CV_RX_VLD_CNT_REG_BFD_CV_RX_VLD_CNT(x)  (x)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_STAT_MPLS_BFD_CC_RX_INVLD_CNT_REG . BFD_CC_RX_INVLD_CNT
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_CC_RX_INVLD_CNT_REG_BFD_CC_RX_INVLD_CNT(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_CC_RX_INVLD_CNT_REG_BFD_CC_RX_INVLD_CNT     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_CC_RX_INVLD_CNT_REG_BFD_CC_RX_INVLD_CNT(x)  (x)
 ...
 *
 * \details 
 * Field: ::VTSS_VOP_MPLS_VOE_STAT_MPLS_BFD_CV_RX_INVLD_CNT_REG . BFD_CV_RX_INVLD_CNT
 */
#define  VTSS_F_VOP_MPLS_VOE_STAT_MPLS_BFD_CV_RX_INVLD_CNT_REG_BFD_CV_RX_INVLD_CNT(x)  (x)
#define  VTSS_M_VOP_MPLS_VOE_STAT_MPLS_BFD_CV_RX_INVLD_CNT_REG_BFD_CV_RX_INVLD_CNT     0xffffffff
#define  VTSS_X_VOP_MPLS_VOE_STAT_MPLS_BFD_CV_RX_INVLD_CNT_REG_BFD_CV_RX_INVLD_CNT(x)  (x)


#endif /* _VTSS_SERVALT_REGS_VOP_MPLS_H_ */
