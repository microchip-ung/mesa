...
#ifndef _VTSS_SERVALT_REGS_QRES_H_
#define _VTSS_SERVALT_REGS_QRES_H_
 ...
 */
#define  VTSS_F_QRES_RES_WRED_WRED_PROFILE_WM_RED_LOW(x)  VTSS_ENCODE_BITFIELD(x,9,9)
#define  VTSS_M_QRES_RES_WRED_WRED_PROFILE_WM_RED_LOW     VTSS_ENCODE_BITMASK(9,9)
#define  VTSS_X_QRES_RES_WRED_WRED_PROFILE_WM_RED_LOW(x)  VTSS_EXTRACT_BITFIELD(x,9,9)
 ...
 */
#define  VTSS_F_QRES_RES_WRED_WRED_PROFILE_WM_RED_HIGH(x)  VTSS_ENCODE_BITFIELD(x,0,9)
#define  VTSS_M_QRES_RES_WRED_WRED_PROFILE_WM_RED_HIGH     VTSS_ENCODE_BITMASK(0,9)
#define  VTSS_X_QRES_RES_WRED_WRED_PROFILE_WM_RED_HIGH(x)  VTSS_EXTRACT_BITFIELD(x,0,9)
 ...
 */
#define VTSS_QRES_RES_QOS_ADV_RES_QOS_MODE   VTSS_IOREG(VTSS_TO_QRES,0x5057)
 ...
 * @param ri Replicator: x_PORT_CNT (??), 0-14
 */
#define VTSS_QRES_RES_QOS_ADV_PFC_CFG(ri)    VTSS_IOREG(VTSS_TO_QRES,0x5058 + (ri))
...
/** 
 * \brief Select mapped configuration
 *
 * \details
 * Register: \a QRES:RES_QOS_ADV:RES_CFG_MODE
 */
#define VTSS_QRES_RES_QOS_ADV_RES_CFG_MODE   VTSS_IOREG(VTSS_TO_QRES,0x5067)

/** 
 * \brief
 * Set to map SE resources into the configuration space.
 *
 * \details 
 * 0: Resources accessed as described for the RES_CTRL group.
 * 1: Resources accessed per scheduling element
 *
 * Field: ::VTSS_QRES_RES_QOS_ADV_RES_CFG_MODE . RES_CFG_MODE_VAL
 */
#define  VTSS_F_QRES_RES_QOS_ADV_RES_CFG_MODE_RES_CFG_MODE_VAL(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_QRES_RES_QOS_ADV_RES_CFG_MODE_RES_CFG_MODE_VAL  VTSS_BIT(0)
#define  VTSS_X_QRES_RES_QOS_ADV_RES_CFG_MODE_RES_CFG_MODE_VAL(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 */
#define VTSS_QRES_RES_QOS_ADV_RES_DLB_OFFSET  VTSS_IOREG(VTSS_TO_QRES,0x5068)
 ...
 */
#define  VTSS_F_QRES_RES_CTRL_RES_CFG_WM_HIGH(x)  VTSS_ENCODE_BITFIELD(x,0,10)
#define  VTSS_M_QRES_RES_CTRL_RES_CFG_WM_HIGH     VTSS_ENCODE_BITMASK(0,10)
#define  VTSS_X_QRES_RES_CTRL_RES_CFG_WM_HIGH(x)  VTSS_EXTRACT_BITFIELD(x,0,10)
 ...
 */
#define  VTSS_F_QRES_RES_CTRL_RES_STAT_MAXUSE(x)  VTSS_ENCODE_BITFIELD(x,0,17)
#define  VTSS_M_QRES_RES_CTRL_RES_STAT_MAXUSE     VTSS_ENCODE_BITMASK(0,17)
#define  VTSS_X_QRES_RES_CTRL_RES_STAT_MAXUSE(x)  VTSS_EXTRACT_BITFIELD(x,0,17)
 ...
 */
#define  VTSS_F_QRES_RES_CTRL_RES_STAT_CUR_INUSE(x)  VTSS_ENCODE_BITFIELD(x,0,17)
#define  VTSS_M_QRES_RES_CTRL_RES_STAT_CUR_INUSE     VTSS_ENCODE_BITMASK(0,17)
#define  VTSS_X_QRES_RES_CTRL_RES_STAT_CUR_INUSE(x)  VTSS_EXTRACT_BITFIELD(x,0,17)


#endif /* _VTSS_SERVALT_REGS_QRES_H_ */
