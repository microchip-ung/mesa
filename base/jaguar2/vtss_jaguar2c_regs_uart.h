...
#ifndef _VTSS_JAGUAR2C_REGS_UART_H_
#define _VTSS_JAGUAR2C_REGS_UART_H_
 ...
 * register.
 * 0111; type: Busy detect indication, priortiy: Fifth. Master has tried to
...
#endif /* _VTSS_JAGUAR2C_REGS_UART_H_ */
