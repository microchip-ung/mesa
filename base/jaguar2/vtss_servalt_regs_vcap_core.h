...
#ifndef _VTSS_SERVALT_REGS_VCAP_CORE_H_
#define _VTSS_SERVALT_REGS_VCAP_CORE_H_
...
/** 
 * \brief
 * Configure ownership of core n (defined by VCAP_SUPER::VCAP_CORE_IDX).
 ...
 * VCAP_SUPER::CORE_CNT for number of cores.
 *
 * \details 
 ...
 * configured directly via VCAP_SUPER::VCAP_ENTRY_DAT and
 * VCAP_SUPER::VCAP_MASK_DAT.
 *
 * \details 
 ...
 * (see VCAP_SUPER::IF_CNT); this field returns the total number of
 ...
 * per entry sub-word (see VCAP_SUPER::ENTRY_SWCNT for number of subwords.)
 *
 * \details 
...
#endif /* _VTSS_SERVALT_REGS_VCAP_CORE_H_ */
