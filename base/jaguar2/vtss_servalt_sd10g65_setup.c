                                             ...
                                             vtss_port_no_t port_no)
{
    ...
    if (VTSS_X_SD10G65_SD10G65_TX_RCPLL_SD10G65_TX_RCPLL_STAT0_PLLF_LOCK_STAT(
        ...
        VTSS_D(
            "SD10G65::SD10G65_TX_RCPLL_STAT0.PLLF_LOCK_STAT is read as expected with value 1!\n");
    }
    ...
    if (VTSS_X_SD10G65_SD10G65_TX_RCPLL_SD10G65_TX_RCPLL_STAT1_PLLF_FSM_STAT(
        ...
        VTSS_D(
            "SD10G65::SD10G65_TX_RCPLL_STAT1.PLLF_FSM_STAT is read as expected with value 13!\n");
    }
                                    ...
                                    vtss_port_no_t                     port_no)
{
    ...
    if (ret_val == VTSS_RC_OK) {
        ret_val |=
            servalt_sd10g_tx_register_cfg(vtss_state, &calc_results, port_no);
    }
    return ret_val;
}
                                             ...
                                             vtss_port_no_t port_no)
{
    ...
    if (VTSS_X_SD10G65_SD10G65_RX_RCPLL_SD10G65_RX_RCPLL_STAT0_PLLF_LOCK_STAT(
        ...
        VTSS_D(
            "SD10G65::SD10G65_RX_RCPLL_STAT0.PLLF_LOCK_STAT is read as expected with value 1!\n");
    }
    ...
    if (VTSS_X_SD10G65_SD10G65_RX_RCPLL_SD10G65_RX_RCPLL_STAT1_PLLF_FSM_STAT(
        ...
        VTSS_D(
            "SD10G65::SD10G65_RX_RCPLL_STAT1.PLLF_FSM_STAT is read as expected with value 13!\n");
    }
                                    ...
                                    vtss_port_no_t                     port_no)
{
    ...
    if (ret_val == VTSS_RC_OK) {
        ret_val |=
            servalt_sd10g_rx_register_cfg(vtss_state, &calc_results, port_no);
    }
    return ret_val;
}
                                      ...
                                      vtss_port_no_t port_no)
{
    ...
    if (ret_val == VTSS_RC_OK) {
        ret_val |=
            servalt_sd10g_power_down_register_cfg(vtss_state, &calc_results,
                                                  port_no);
    }
    return ret_val;
}
                                  ...
                                  vtss_port_no_t                      port_no)
{
    ...
    if (ret_val == VTSS_RC_OK) {
        ret_val |=
            servalt_apc10g_register_cfg(vtss_state, &calc_results, port_no);
    }
    return ret_val;
}
static vtss_rc servalt_sd10g_df2f_register_cfg(
                                      ...
                                      vtss_port_no_t port_no)
{
    ...
    if (ret_val == VTSS_RC_OK) {
        ret_val |=
            servalt_sd10g_df2f_register_cfg(vtss_state, &calc_results, port_no);
    }
    return ret_val;
}
static vtss_rc servalt_sd10g_f2df_register_cfg(
    vtss_state_t                                 *vtss_state,
                                      ...
                                      vtss_port_no_t port_no)
{
    ...
    if (ret_val == VTSS_RC_OK) {
        ret_val |=
            servalt_sd10g_f2df_register_cfg(vtss_state, &calc_results, port_no);
    }
    return ret_val;
}
#endif
