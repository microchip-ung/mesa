...
static vtss_rc servalt_sd10g_tx_register_cfg(vtss_state_t                               *vtss_state,
...
static vtss_rc servalt_sd10g_rx_register_cfg(vtss_state_t                               *vtss_state,
...
static vtss_rc servalt_sd10g_power_down_register_cfg(vtss_state_t *vtss_state,
                                                     const vtss_sd10g65_pwr_down_t *const res_struct,
                                                     vtss_port_no_t port_no)
{
    u32 tgt_ana;
...
static vtss_rc servalt_apc10g_register_cfg(vtss_state_t                                *vtss_state,
    ...
    if (res_struct->skip_cal[0] != 1) {
        ...
        if (res_struct->incl_ld_cal[0] == 1) {
            ...
            if (VTSS_X_SD10G65_DIG_SD10G65_APC_APC_LD_CAL_CFG_DETLEV_CAL_DONE(value) != 1) {
                ...
                VTSS_D(
                    "SD10G65_DIG::APC_LD_CAL_CFG.DETLEV_CAL_DONE is read as expected with value 1!\n");
            }
            ...
            if (VTSS_X_SD10G65_DIG_SD10G65_APC_APC_IS_CAL_CFG1_OFFSCAL_DONE(value) != 1) {
                ...
                VTSS_D(
                    "SD10G65_DIG::APC_IS_CAL_CFG1.OFFSCAL_DONE is read as expected with value 1!\n");
            }
...
static vtss_rc servalt_sd10g_df2f_register_cfg(vtss_state_t *vtss_state,
...
static vtss_rc servalt_sd10g_f2df_register_cfg(vtss_state_t *vtss_state,
                                               ...
                                               vtss_port_no_t port_no)
{
    ...
    JR2_WRM(VTSS_SD10G65_SD10G65_RX_SYNTH_F2DF_CFG_STAT(tgt_ana),
            VTSS_F_SD10G65_SD10G65_RX_SYNTH_F2DF_CFG_STAT_F2DF_SIDE_DET_BIT_SEL(
                ...
                VTSS_F_SD10G65_SD10G65_RX_SYNTH_F2DF_CFG_STAT_F2DF_SAMPLE_DIV(
