...
#define VTSS_CHIP_PORT_VD0                                                     \
    (VTSS_CHIP_PORT_CPU + 2) /* Port 13/55, used for IPMC */
#define VTSS_CHIP_PORT_VD1                                                     \
    (VTSS_CHIP_PORT_CPU + 3) /* Port 14/56, used for OAM */
#define VTSS_CHIP_PORTS_ALL                                                    \
    (VTSS_CHIP_PORT_CPU + 4) /* Total 15/57 ports, including CPU/VD ports */
...
#define VTSS_TO_DEV1G(port)                                                    \
    (VTSS_TO_DEV2G5_0 + (port) * (VTSS_TO_DEV2G5_1 - VTSS_TO_DEV2G5_0))
#define VTSS_TO_DEV(port)                                                      \
    (VTSS_PORT_IS_10G(port)                                                    \
         ? (VTSS_TO_DEV10G_0 + ((port) - VTSS_PORT_10G_START) *                \
...
#define VTSS_TO_DEV(port)                                                      \
    (VTSS_PORT_IS_10G(port)                                                    \
     ...
     : (port) < 32  ? (VTSS_TO_DEV2G5_0 +                                      \
                      ((port) - 8) * (VTSS_TO_DEV2G5_1 - VTSS_TO_DEV2G5_0))   \
     : (port) == 48 ? VTSS_TO_DEV2G5_24                                        \
                    : (VTSS_TO_DEV1G_0 +                                       \
                       ((port) - 24) * (VTSS_TO_DEV1G_1 - VTSS_TO_DEV1G_0)))
#define VTSS_TO_DEV1G(port)                                                    \
    (VTSS_PORT_IS_10G(port)                                                    \
         ? (VTSS_TO_DEV2G5_25 + ((port) - VTSS_PORT_10G_START) *               \
...
#define JR2_SFLOW_MIN_SAMPLE_RATE                                              \
    1 /**< Minimum allowable sampling rate for sFlow */
#define JR2_SFLOW_MAX_SAMPLE_RATE                                              \
...
#define JR2_DEBUG_REG(pr, tgt, addr)                                           \
    vtss_jr2_debug_reg(vtss_state, pr, VTSS_##tgt##_##addr, #addr)
...
#define VTSS_M_HSCH_HSCH_MISC_HSCH_CFG_CFG_CFG_SE_IDX                          \
    VTSS_M_HSCH_HSCH_MISC_HSCH_CFG_CFG_DWRR_IDX
...
#define VTSS_TO_10G_APC_TGT(port)                                              \
    (VTSS_TO_XGDIG_0 +                                                         \
     ((VTSS_PORT_IS_1G(port) ? (port - 7)                                      \
                             : (port - VTSS_PORT_10G_START) + 2) *             \
...
#define VTSS_TO_10G_KR_DEV1_TGT(port)                                          \
    (VTSS_TO_XGKR0_2 +                                                         \
     ((port - VTSS_PORT_10G_START) * (VTSS_TO_XGKR0_3 - VTSS_TO_XGKR0_2)))
#define VTSS_TO_10G_KR_DEV7_TGT(port)                                          \
    (VTSS_TO_XGKR1_2 +                                                         \
     ((port - VTSS_PORT_10G_START) * (VTSS_TO_XGKR1_3 - VTSS_TO_XGKR1_2)))
#define VTSS_TO_10G_PCS10G_BR(port)                                            \
    (VTSS_TO_PCS10G_BR_0 + ((port - VTSS_PORT_10G_START) *                     \
                            (VTSS_TO_PCS10G_BR_1 - VTSS_TO_PCS10G_BR_0)))
#else
#define VTSS_TO_10G_APC_TGT(port)                                              \
    (VTSS_TO_XGDIG_0 +                                                         \
     ((port - VTSS_PORT_10G_START) * (VTSS_TO_XGDIG_1 - VTSS_TO_XGDIG_0)))
#define VTSS_TO_10G_SRD_TGT(port)                                              \
    (VTSS_TO_XGANA_0 +                                                         \
     ((port - VTSS_PORT_10G_START) * (VTSS_TO_XGANA_1 - VTSS_TO_XGANA_0)))
#define VTSS_TO_10G_XFI_TGT(port)                                              \
    (VTSS_TO_XGXFI_0 +                                                         \
     ((port - VTSS_PORT_10G_START) * (VTSS_TO_XGXFI_1 - VTSS_TO_XGXFI_0)))
#define VTSS_TO_10G_KR_DEV1_TGT(port)                                          \
    (VTSS_TO_XGKR0_0 +                                                         \
     ((port - VTSS_PORT_10G_START) * (VTSS_TO_XGKR0_1 - VTSS_TO_XGKR0_0)))
#define VTSS_TO_10G_KR_DEV7_TGT(port)                                          \
    (VTSS_TO_XGKR1_0 +                                                         \
     ((port - VTSS_PORT_10G_START) * (VTSS_TO_XGKR1_1 - VTSS_TO_XGKR1_0)))
#define VTSS_TO_10G_PCS10G_BR(port)                                            \
    (VTSS_TO_PCS10G_BR_0 + ((port - VTSS_PORT_10G_START) *                     \
                            (VTSS_TO_PCS10G_BR_1 - VTSS_TO_PCS10G_BR_0)))
#endif
