 ...
 *
 * \details 
 * 0-52: Use this port number for ES0 lookup
 * 53-63: Do not map port number
 *
 ...
 * EPID=0x0007 are inserted in front of the IFH:
 *	 [FRM_DMAC][FRM_SMAC][0x8880][0x0007][IFH][FRAME]
 ...
 * 
 * CPU queue redirection is enabled in QSYS::FRAME_COPY_CFG:FRMC_PORT_VAL
 * 
 ...
 */
#define  VTSS_F_REW_ENCAP_MPLS_REMARK_CFG_SBIT_SEL(x)  VTSS_ENCODE_BITFIELD(!!(x),1,1)
#define  VTSS_M_REW_ENCAP_MPLS_REMARK_CFG_SBIT_SEL  VTSS_BIT(1)
#define  VTSS_X_REW_ENCAP_MPLS_REMARK_CFG_SBIT_SEL(x)  VTSS_EXTRACT_BITFIELD(x,1,1)
 ...
 */
#define  VTSS_F_REW_ENCAP_MPLS_REMARK_CFG_TTL_SEL(x)  VTSS_ENCODE_BITFIELD(!!(x),0,1)
#define  VTSS_M_REW_ENCAP_MPLS_REMARK_CFG_TTL_SEL  VTSS_BIT(0)
#define  VTSS_X_REW_ENCAP_MPLS_REMARK_CFG_TTL_SEL(x)  VTSS_EXTRACT_BITFIELD(x,0,1)
 ...
 * [LL_DMAC][LL_SMAC][0x8880][0x0007]
 * 
 * Optionally one VLAN tag can be added if LL_TAG_CFG.TAG_CFG = 1
 * [LL_DMAC][LL_SMAC][LL_TAG:0][0x8880][0x0007]
 * 
...
/**
 * Register Group: \a REW:ENCAP_ID
 *
 * Encapsulation RAM lookup configuration
 */


/** 
 * \brief Configure ENCAP_ID generation
 *
 * \details
 * Based on configuration and the IFH.DST.ENCAP.PROT_ACTIVE field set by
 * ANA it is possible to change the ENCAP_ID.
 *
 * Register: \a REW:ENCAP_ID:ENCAP_ID_CFG
 *
 * @param gi Replicator: x_REW_NUM_ENCAP_ID (??), 0-1023
 */
#define VTSS_REW_ENCAP_ID_ENCAP_ID_CFG(gi)   VTSS_IOREG_IX(VTSS_TO_REW,0x10000,gi,1,0,0)

/** 
 * \brief
 * Replace ENCAP_ID with ENCAP_ID_P if enabled by ENCAP_PROT_CFG. 
 * The ENCAP_ID_P is be used for lookup in the MPLS Encapsulation Table
 * (REW:ENCAP).
 ...
 * n: Encapsulation ID
 *
 * Field: ::VTSS_REW_ENCAP_ID_ENCAP_ID_CFG . ENCAP_ID_P
 */
...
/** 
 * \brief
 * Configure mapping of encapsulation ID from ES0.
 *
 * \details 
 * 0: No protection. Do not remap ENCAP_ID
 * 1: Use ENCAP_ID_P if ifh.encap.prot_active = '1'
 * 2: Use ENCAP_ID_P if ifh.encap.prot_active = '0'
 * 3: Reserved

 *
 * Field: ::VTSS_REW_ENCAP_ID_ENCAP_ID_CFG . ENCAP_PROT_CFG
 */
