...
typedef struct {
    ...
    vtss_rc (*npi_conf_set)(struct vtss_state_s         *vtss_state,
...
vtss_rc vtss_cmn_logical_to_chip_port_mask(const struct vtss_state_s
                                               *const      state,
...
vtss_port_no_t vtss_cmn_chip_to_logical_port(const struct vtss_state_s
                                                 *const           state,
                                             const vtss_chip_no_t chip_no,
                                             const vtss_phys_port_no_t
                                                 chip_port);
