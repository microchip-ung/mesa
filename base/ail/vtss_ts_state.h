...
#ifndef VTSS_TS_STATE_H
#define VTSS_TS_STATE_H

#if defined(VTSS_FEATURE_TIMESTAMP)

#if defined(VTSS_ARCH_LUTON26) || defined(VTSS_ARCH_OCELOT)
#define VTSS_TS_ID_SIZE        63U
#define TS_IDS_RESERVED_FOR_SW 10U
...
typedef struct {
    ...
    void (*cb[VTSS_PORT_ARRAY_SIZE])(void                *context,
                                     u32                  port_no,
                                     vtss_ts_timestamp_t *ts); /* timestamp callback functions */
