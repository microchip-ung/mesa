...
typedef struct {
    ...
    vtss_rc (* rd)(struct vtss_state_s  *vtss_state,
                   const u32            addr,
                   u32                  *const value);
    vtss_rc (* wr)(struct vtss_state_s  *vtss_state,
                   const u32            addr,
                   const u32            value);
    vtss_rc (* wrm)(struct vtss_state_s  *vtss_state,
                    const u32            addr,
                    const u32            value,
                    const u32            mask);
    ...
    vtss_rc (* global_enable_get)(struct vtss_state_s                 *vtss_state,
    ...
    vtss_rc (* output_filter_bw_get)(struct vtss_state_s              *vtss_state,
                                     const u8                         clock_output,
                                     u32                              *bw_100uhz);
    vtss_rc (* output_filter_lock_fast_set)(struct vtss_state_s       *vtss_state,
                                            const u8                  clock_output);
    ...
    vtss_rc (* adj_frequency_get)(struct vtss_state_s                 *vtss_state,
                                  const u8                            clock_output,
                                  i64                                 *const adj);
    vtss_rc (* adj_phase_set)(struct vtss_state_s                     *vtss_state,
                              const u8                                clock_output,
                              const i32                               adj);
    vtss_rc (* adj_phase_get)(struct vtss_state_s                     *vtss_state,
    ...
    /* Paramters where validation my find better values or they might even get configuration options */
