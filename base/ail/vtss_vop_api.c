...
vtss_rc vtss_vop_conf_set(const vtss_inst_t inst, const vtss_vop_conf_t *const conf)
{
    ...
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        ...
        rc = vtss_cil_vop_conf_set(vtss_state, conf);
    }
    VTSS_EXIT();
    return rc;
}

vtss_rc vtss_vop_conf_get(const vtss_inst_t inst, vtss_vop_conf_t *const conf)
{
    vtss_state_t *vtss_state;
    vtss_rc       rc;
                       ...
                       vtss_voe_idx_t *const              voe_idx)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_alloc(vtss_state, type, param->port, direction, voe_idx);
    }
    VTSS_EXIT();
    return rc;
}

static vtss_rc vtss_inst_voe_check(const vtss_inst_t    inst,
                                   vtss_state_t       **vtss_state,
...
vtss_rc vtss_voe_free(const vtss_inst_t inst, const vtss_voe_idx_t voe_idx)
{
    vtss_state_t *vtss_state;
    vtss_rc       rc;
    ...
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_free(vtss_state, voe_idx);
    }
    VTSS_EXIT();
    return rc;
}
                          ...
                          const vtss_voe_conf_t *const conf)
{
    ...
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        ...
        rc = vtss_cil_voe_conf_set(vtss_state, voe_idx, conf);
    }
    VTSS_EXIT();
                             ...
                             const vtss_voe_cc_conf_t *const conf)
{
    ...
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        ...
        rc = vtss_cil_voe_cc_conf_set(vtss_state, voe_idx, conf);
    }
    VTSS_EXIT();
    return rc;
}
...
vtss_rc vtss_voe_cc_rdi_set(const vtss_inst_t inst, const vtss_voe_idx_t voe_idx, const BOOL rdi)
{
    ...
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        ...
        rc = vtss_cil_voe_cc_rdi_set(vtss_state, voe_idx, rdi);
    }
    VTSS_EXIT();
    return rc;
}
...
vtss_rc vtss_voe_cc_cpu_copy_next_set(const vtss_inst_t inst, const vtss_voe_idx_t voe_idx)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_cc_cpu_copy_next_set(vtss_state, voe_idx);
    }
    VTSS_EXIT();
    return rc;
}
                             ...
                             const vtss_voe_lt_conf_t *const conf)
{
    ...
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        ...
        rc = vtss_cil_voe_lt_conf_set(vtss_state, voe_idx, conf);
    }
    VTSS_EXIT();
    return rc;
}
                             ...
                             const vtss_voe_lb_conf_t *const conf)
{
    ...
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        ...
        rc = vtss_cil_voe_lb_conf_set(vtss_state, voe_idx, conf);
    }
    VTSS_EXIT();
    return rc;
}
                               ...
                               const vtss_voe_laps_conf_t *const conf)
{
    ...
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        ...
        rc = vtss_cil_voe_laps_conf_set(vtss_state, voe_idx, conf);
    }
    VTSS_EXIT();
    return rc;
}
                            ...
                            vtss_voe_status_t *const status)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_status_get(vtss_state, voe_idx, status);
    }
    VTSS_EXIT();
    return rc;
}
                              ...
                              vtss_voe_counters_t *counters)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_counters_get(vtss_state, voe_idx, counters);
    }
    VTSS_EXIT();
    return rc;
}
...
vtss_rc vtss_voe_counters_clear(const vtss_inst_t inst, const vtss_voe_idx_t voe_idx)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_counters_clear(vtss_state, voe_idx);
    }
    VTSS_EXIT();
    return rc;
}
                               ...
                               vtss_voe_cc_status_t *status)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_cc_status_get(vtss_state, voe_idx, status);
    }
    VTSS_EXIT();
    return rc;
}
                                 ...
                                 vtss_voe_cc_counters_t *counters)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_cc_counters_get(vtss_state, voe_idx, counters);
    }
    VTSS_EXIT();
    return rc;
}
...
vtss_rc vtss_voe_cc_counters_clear(const vtss_inst_t inst, const vtss_voe_idx_t voe_idx)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_cc_counters_clear(vtss_state, voe_idx);
    }
    VTSS_EXIT();
    return rc;
}
                               ...
                               vtss_voe_lt_status_t *status)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_lt_status_get(vtss_state, voe_idx, status);
    }
    VTSS_EXIT();
    return rc;
}
                               ...
                               vtss_voe_lb_status_t *status)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_lb_status_get(vtss_state, voe_idx, status);
    }
    VTSS_EXIT();
    return rc;
}
                                 ...
                                 vtss_voe_lb_counters_t *counters)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_lb_counters_get(vtss_state, voe_idx, counters);
    }
    VTSS_EXIT();
    return rc;
}
...
vtss_rc vtss_voe_lb_counters_clear(const vtss_inst_t inst, const vtss_voe_idx_t voe_idx)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_lb_counters_clear(vtss_state, voe_idx);
    }
    VTSS_EXIT();
    return rc;
}
                                 ...
                                 vtss_voe_laps_status_t *status)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_laps_status_get(vtss_state, voe_idx, status);
    }
    VTSS_EXIT();
    return rc;
}
...
vtss_rc vtss_voe_event_active_get(const vtss_inst_t inst, const u32 active_size, u32 *const active)
{
    ...
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        if (active_size != VTSS_EVENT_MASK_ARRAY_SIZE) {
            ...
            rc = vtss_cil_voe_event_active_get(vtss_state, active_size, active);
        }
    }
    VTSS_EXIT();
    return rc;
                                ...
                                const BOOL           enable)
{
    ...
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        ...
        rc = vtss_cil_voe_event_mask_set(vtss_state, voe_idx, mask, enable);
    }
    VTSS_EXIT();
    return rc;
}
...
vtss_rc vtss_voe_event_get(const vtss_inst_t inst, const vtss_voe_idx_t voe_idx, u32 *const mask)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_voe_check(inst, &vtss_state, voe_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voe_event_get(vtss_state, voe_idx, mask);
    }
    VTSS_EXIT();
    return rc;
}
                       ...
                       vtss_voi_idx_t                    *voi_idx)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_voi_alloc(vtss_state, param->port, param->direction, voi_idx);
    }
    VTSS_EXIT();
    return rc;
}

static vtss_rc vtss_inst_voi_check(const vtss_inst_t    inst,
                                   vtss_state_t       **vtss_state,
...
vtss_rc vtss_voi_free(const vtss_inst_t inst, const vtss_voi_idx_t voi_idx)
{
    vtss_state_t *vtss_state;
    vtss_rc       rc;
    ...
    if ((rc = vtss_inst_voi_check(inst, &vtss_state, voi_idx)) == VTSS_RC_OK) {
        rc = vtss_cil_voi_free(vtss_state, voi_idx);
    }
    VTSS_EXIT();
    return rc;
}
                          ...
                          const vtss_voi_conf_t *const conf)
{
    ...
    if ((rc = vtss_inst_voi_check(inst, &vtss_state, voi_idx)) == VTSS_RC_OK) {
        ...
        rc = vtss_cil_voi_conf_set(vtss_state, voi_idx, conf);
    }
    VTSS_EXIT();
    return rc;
}
...
char (*__kaboom)[((sizeof( vtss_voe_conf_t ) + sizeof( vtss_voe_cc_conf_t ) +
                   ...
                   sizeof( vtss_voe_laps_conf_t ) + sizeof( u32 )) *
VTSS_VOE_CNT) + (sizeof( vtss_voi_conf_t ) * VTSS_VOI_CNT) +
            ...
            if (info->full || vtss_state->oam.voe_alloc_data[i].allocated) {
                ...
                if (info->full || voe_laps_conf->enable) {
                    pr("LAPS enable:%4s  cpu_copy:%s  count_as_selected:%s\n",
                       YN(voe_laps_conf->enable), YN(voe_laps_conf->cpu_copy),
    ...
    if (!info->has_action || status) { /* VOE status must be printed */
        ...
        for (i = 0; i < VTSS_VOE_CNT; ++i) {
            ...
            if (info->full || vtss_state->oam.voe_alloc_data[i].allocated) {
                ...
                if (vtss_cil_voe_status_get(vtss_state, i, &voe_status) == VTSS_RC_OK &&
                    vtss_cil_voe_counters_get(vtss_state, i, &voe_counters) == VTSS_RC_OK) {
                    pr("VOE status:\n");
#if defined(VTSS_FEATURE_VOP_V2)
                ...
                if (vtss_cil_voe_cc_status_get(vtss_state, i, &cc_status) == VTSS_RC_OK &&
                    vtss_cil_voe_cc_counters_get(vtss_state, i, &cc_counters) == VTSS_RC_OK) {
                    pr("CC status:\n");
#if defined(VTSS_FEATURE_VOP_V2)
...
#if defined(VTSS_FEATURE_VOP_CFM)
                if (vtss_cil_voe_lt_status_get(vtss_state, i, &lt_status) == VTSS_RC_OK) {
                    pr("LT status:\n");
                ...
                if (vtss_cil_voe_lb_status_get(vtss_state, i, &lb_status) == VTSS_RC_OK &&
                    vtss_cil_voe_lb_counters_get(vtss_state, i, &lb_counters) == VTSS_RC_OK) {
                    pr("LB status:\n");
#if defined(VTSS_FEATURE_VOP_V2)
                ...
                if (vtss_cil_voe_laps_status_get(vtss_state, i, &laps_status) == VTSS_RC_OK) {
                    pr("LAPS status:\n");
                    pr("seen %s\n", YN(laps_status.seen));
                    pr("-----\n");
                }
