                     ...
                     const vtss_mrp_conf_t *const conf)
{
    ...
    rc = vtss_cil_mrp_add(vtss_state, mrp_idx, conf);
...
vtss_rc vtss_mrp_del(const vtss_inst_t inst, const vtss_mrp_idx_t mrp_idx)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_del(vtss_state, mrp_idx);
    }
    VTSS_EXIT();
    return rc;
}
                               ...
                               const vtss_mrp_ring_role_t role)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_ring_role_set(vtss_state, mrp_idx, role);
    }
    VTSS_EXIT();
    return rc;
}
                                  ...
                                  const vtss_port_no_t port_no)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_primary_port_set(vtss_state, mrp_idx, port_no);
    }
    VTSS_EXIT();
    return rc;
}
                                ...
                                const vtss_mrp_ring_state_t state)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_ring_state_set(vtss_state, mrp_idx, state);
    }
    VTSS_EXIT();
    return rc;
}
                                   ...
                                   const vtss_mrp_ring_state_t state)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_in_ring_state_set(vtss_state, mrp_idx, state);
    }
    VTSS_EXIT();
    return rc;
}
                                ...
                                const vtss_mrp_port_state_t state)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_port_state_set(vtss_state, mrp_idx, port, state);
    }
    VTSS_EXIT();
    return rc;
}
                              ...
                              const vtss_mrp_best_mrm_t *const best)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        if ((rc = vtss_cil_mrp_best_mrm_set(vtss_state, mrp_idx, best)) == VTSS_RC_OK) {
                                  ...
                                  const vtss_mrp_tst_loc_conf_t *const conf)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_tst_loc_conf_set(vtss_state, mrp_idx, conf);
    }
    VTSS_EXIT();
    return rc;
}
...
vtss_rc vtss_mrp_tst_hitme_once(const vtss_inst_t inst, const vtss_mrp_idx_t mrp_idx)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_tst_hitme_once(vtss_state, mrp_idx);
    }
    VTSS_EXIT();
    return rc;
}
...
vtss_rc vtss_mrp_itst_hitme_once(const vtss_inst_t inst, const vtss_mrp_idx_t mrp_idx)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_itst_hitme_once(vtss_state, mrp_idx);
    }
    VTSS_EXIT();
    return rc;
}
                                   ...
                                   const vtss_mrp_tst_copy_conf_t *const copy)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_tst_copy_conf_set(vtss_state, mrp_idx, copy);
    }
    VTSS_EXIT();
    return rc;
}
                            ...
                            vtss_mrp_status_t *const status)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_status_get(vtss_state, mrp_idx, status);
    }
    VTSS_EXIT();
    return rc;
}
                              ...
                              vtss_mrp_counters_t *const counters)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_counters_get(vtss_state, mrp_idx, counters);
    }
    VTSS_EXIT();
    return rc;
}
...
vtss_rc vtss_mrp_counters_clear(const vtss_inst_t inst, const vtss_mrp_idx_t mrp_idx)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_counters_clear(vtss_state, mrp_idx);
    }
    VTSS_EXIT();
    return rc;
}
                                ...
                                const BOOL           enable)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        if ((rc = vtss_cil_mrp_event_mask_set(vtss_state, mrp_idx, mask, enable)) == VTSS_RC_OK) {
            if (enable) {
                           ...
                           vtss_mrp_event_t *const events)
{
    ...
    VTSS_ENTER();
    if ((rc = vtss_inst_check(inst, &vtss_state)) == VTSS_RC_OK) {
        rc = vtss_cil_mrp_event_get(vtss_state, mrp_idx, events);
    }
    VTSS_EXIT();
    return rc;
}
    ...
    if (!info->has_action || status) { /* MRP status must be printed */
        ...
        for (i = 0; i < VTSS_MRP_CNT; ++i) {
            ...
            if (info->full || vtss_state->mrp.data[i].active) {
                ...
                if (vtss_cil_mrp_status_get(vtss_state, i, &mrp_status) == VTSS_RC_OK) {
                    pr("MRP status:\n");
                ...
                if (vtss_cil_mrp_counters_get(vtss_state, i, &mrp_counters) == VTSS_RC_OK) {
                    pr("MRP counters:\n");
