...
#ifndef _VTSS_LUTON26_REGS_DEV_H_
#define _VTSS_LUTON26_REGS_DEV_H_
...
/**
 * Register Group: \a DEV:DEV_CFG_STATUS
 *
 * Not documented
 */
 ...
 *
 * Register: \a DEV:DEV_CFG_STATUS:DEV_IF_CFG
 *
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_DEV_CFG_STATUS_DEV_IF_CFG(target)  VTSS_IOREG(target,0x0)

/** 
 * \brief
 * This register is only applicable to ports 10 and 11. Ports 10 and 11
 * have the option to connect to either internal PHYs using a GMII
 * interface or to SERDES1G macros. If GMII_DIS is set, the GMII interface
 * is disabled. 
 * Note that DEVCPU_GCB::MISC_CFG.SW_MODE must be set accordingly to
 * control the overall I/O muxing.
 *
 * \details 
 * Field: ::VTSS_DEV_DEV_CFG_STATUS_DEV_IF_CFG . GMII_DIS
 */
#define  VTSS_F_DEV_DEV_CFG_STATUS_DEV_IF_CFG_GMII_DIS  VTSS_BIT(0)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PORT_MODE_CLOCK_CFG(target)  VTSS_IOREG(target,0x1)
...
/** 
 * \brief
 * Selects the link speed. For ports 10 and 11, LINK_SPEED is ignored when
 * DEV_IF_CFG.GMII_DIS is cleared.
 *
 * \details 
 * 0: No link
 * 1: 1000/2500 Mbps
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PORT_MODE_PORT_MISC(target)  VTSS_IOREG(target,0x2)
 ...
 */
#define  VTSS_F_DEV_PORT_MODE_PORT_MISC_FWD_PAUSE_ENA  VTSS_BIT(2)
 ...
 */
#define  VTSS_F_DEV_PORT_MODE_PORT_MISC_FWD_CTRL_ENA  VTSS_BIT(1)
 ...
 *
 * \details
 * Register: \a DEV:MAC_CFG_STATUS:MAC_FC_CFG
 *
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_MAC_CFG_STATUS_MAC_FC_CFG(target)  VTSS_IOREG(target,0xc)
 ...
 *
 * Field: ::VTSS_DEV_MAC_CFG_STATUS_MAC_FC_CFG . ZERO_PAUSE_ENA
 */
#define  VTSS_F_DEV_MAC_CFG_STATUS_MAC_FC_CFG_ZERO_PAUSE_ENA  VTSS_BIT(18)
 ...
 *
 * Field: ::VTSS_DEV_MAC_CFG_STATUS_MAC_FC_CFG . TX_FC_ENA
 */
#define  VTSS_F_DEV_MAC_CFG_STATUS_MAC_FC_CFG_TX_FC_ENA  VTSS_BIT(17)
 ...
 *
 * Field: ::VTSS_DEV_MAC_CFG_STATUS_MAC_FC_CFG . RX_FC_ENA
 */
#define  VTSS_F_DEV_MAC_CFG_STATUS_MAC_FC_CFG_RX_FC_ENA  VTSS_BIT(16)
 ...
 *
 * Field: ::VTSS_DEV_MAC_CFG_STATUS_MAC_FC_CFG . PAUSE_VAL_CFG
 */
#define  VTSS_F_DEV_MAC_CFG_STATUS_MAC_FC_CFG_PAUSE_VAL_CFG(x)  VTSS_ENCODE_BITFIELD(x,0,16)
#define  VTSS_M_DEV_MAC_CFG_STATUS_MAC_FC_CFG_PAUSE_VAL_CFG     VTSS_ENCODE_BITMASK(0,16)
#define  VTSS_X_DEV_MAC_CFG_STATUS_MAC_FC_CFG_PAUSE_VAL_CFG(x)  VTSS_EXTRACT_BITFIELD(x,0,16)
 ...
 *
 * \details 
 * Field: ::VTSS_DEV_MAC_CFG_STATUS_MAC_FC_CFG . FC_LATENCY_CFG
 */
#define  VTSS_F_DEV_MAC_CFG_STATUS_MAC_FC_CFG_FC_LATENCY_CFG(x)  VTSS_ENCODE_BITFIELD(x,19,6)
#define  VTSS_M_DEV_MAC_CFG_STATUS_MAC_FC_CFG_FC_LATENCY_CFG     VTSS_ENCODE_BITMASK(19,6)
#define  VTSS_X_DEV_MAC_CFG_STATUS_MAC_FC_CFG_FC_LATENCY_CFG(x)  VTSS_EXTRACT_BITFIELD(x,19,6)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_MAC_CFG_STATUS_MAC_FC_MAC_LOW_CFG(target)  VTSS_IOREG(target,0xd)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_MAC_CFG_STATUS_MAC_FC_MAC_HIGH_CFG(target)  VTSS_IOREG(target,0xe)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_MAC_CFG_STATUS_MAC_STICKY(target)  VTSS_IOREG(target,0xf)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_CFG(target)  VTSS_IOREG(target,0x10)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_MODE_CFG(target)  VTSS_IOREG(target,0x11)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_SD_CFG(target)  VTSS_IOREG(target,0x12)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_ANEG_CFG(target)  VTSS_IOREG(target,0x13)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_ANEG_NP_CFG(target)  VTSS_IOREG(target,0x14)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_LB_CFG(target)  VTSS_IOREG(target,0x15)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_ANEG_STATUS(target)  VTSS_IOREG(target,0x18)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_ANEG_NP_STATUS(target)  VTSS_IOREG(target,0x19)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_LINK_STATUS(target)  VTSS_IOREG(target,0x1a)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_LINK_DOWN_CNT(target)  VTSS_IOREG(target,0x1b)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_STICKY(target)  VTSS_IOREG(target,0x1c)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_LPI_CFG(target)  VTSS_IOREG(target,0x1e)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_LPI_WAKE_ERROR_CNT(target)  VTSS_IOREG(target,0x1f)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_CFG_STATUS_PCS1G_LPI_STATUS(target)  VTSS_IOREG(target,0x20)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_TSTPAT_CFG_STATUS_PCS1G_TSTPAT_MODE_CFG(target)  VTSS_IOREG(target,0x21)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS1G_TSTPAT_CFG_STATUS_PCS1G_TSTPAT_STATUS(target)  VTSS_IOREG(target,0x22)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS_FX100_CONFIGURATION_PCS_FX100_CFG(target)  VTSS_IOREG(target,0x23)
 ...
 * @param target A \a ::vtss_target_DEV_e target
 */
#define VTSS_DEV_PCS_FX100_STATUS_PCS_FX100_STATUS(target)  VTSS_IOREG(target,0x24)
...
#endif /* _VTSS_LUTON26_REGS_DEV_H_ */
