...
/** 
 * \brief Receive Buffer / Transmit Holding Register / Divisor (Low)
 *
 * \details
...
/** 
 * \brief Interrupt Enable Register / Divisor (High)
 *
 * \details
...
/** 
 * \brief Interrupt Identification Register / FIFO Control Register
 *
 * \details
