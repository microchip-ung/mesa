...
#ifndef _VTSS_LUTON26_REGS_TWI_H_
#define _VTSS_LUTON26_REGS_TWI_H_
 ...
 * Target: \a TWI
 *
 * VCore Two-Wire Interface Configuration
 *
 ***********************************************************************/
...
/** 
 * \brief
 * Controls whether the TWI controller responds to 7- or 10-bit addresses
 * in slave mode. In 7-bit mode; transactions that involve 10-bit
 ...
 * RAW_INTR_STAT.TX_ABRT. The TWI controller remains in General Call mode
 * until the TAR.SPECIAL field is cleared.
 * '1': START BYTE
 *
...
#endif /* _VTSS_LUTON26_REGS_TWI_H_ */
