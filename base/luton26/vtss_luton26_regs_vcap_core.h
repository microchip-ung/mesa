...
#ifndef _VTSS_LUTON26_REGS_VCAP_CORE_H_
#define _VTSS_LUTON26_REGS_VCAP_CORE_H_
 ...
 */
#define  VTSS_F_VCAP_CORE_VCAP_CONST_ENTRY_CNT_ENTRY_CNT(x)  VTSS_ENCODE_BITFIELD(x,0,10)
#define  VTSS_M_VCAP_CORE_VCAP_CONST_ENTRY_CNT_ENTRY_CNT     VTSS_ENCODE_BITMASK(0,10)
#define  VTSS_X_VCAP_CORE_VCAP_CONST_ENTRY_CNT_ENTRY_CNT(x)  VTSS_EXTRACT_BITFIELD(x,0,10)
 ...
 * @param target A \a ::vtss_target_VCAP_CORE_e target
 */
#define VTSS_VCAP_CORE_TCAM_BIST_TCAM_STAT(target)  VTSS_IOREG(target,0x8e)
...
#endif /* _VTSS_LUTON26_REGS_VCAP_CORE_H_ */
