...
#define VTSS_TO_SD10G65(channel)                                               \
    (VTSS_TO_XGANA_0 + (channel * (VTSS_TO_XGANA_1 - VTSS_TO_XGANA_0)))
#define VTSS_TO_SD10G65_DIG(channel)                                           \
    (VTSS_TO_XGDIG_0 + (channel * (VTSS_TO_XGDIG_1 - VTSS_TO_XGDIG_0)))
#define VTSS_TO_PLL_XFI(channel)                                               \
    (VTSS_TO_XGXFI_0 + (channel * (VTSS_TO_XGXFI_1 - VTSS_TO_XGXFI_0)))

#else
#define VTSS_TO_SD10G65(channel)                                               \
    (VTSS_TO_SD10G65_0 + (channel * (VTSS_TO_SD10G65_1 - VTSS_TO_SD10G65_0)))
#define VTSS_TO_SD10G65_DIG(channel)                                           \
    (VTSS_TO_SD10G65_DIG_0 +                                                   \
     (channel * (VTSS_TO_SD10G65_DIG_1 - VTSS_TO_SD10G65_DIG_0)))
#endif

/* Concatenations */
#define ES6514_ADDR(tgt, addr)      VTSS_##tgt##_##addr
#define ES6514_ADDR_X(tgt, addr, x) VTSS_##tgt##_##addr(x)
#define ES6514_GET_FLD(tgt, addr, fld, value)                                  \
    VTSS_X_##tgt##_##addr##_##fld(value)
#if defined(VTSS_ARCH_SERVAL_T)
#define ES6514_GET_BIT(tgt, addr, fld, value)                                  \
    (VTSS_X_##tgt##_##addr##_##fld(value))
#else
#define ES6514_GET_BIT(tgt, addr, fld, value)                                  \
    (VTSS_F_##tgt##_##addr##_##fld & (value) ? 1 : 0)
#endif
#define ES6514_PUT_FLD(tgt, addr, fld, value)                                  \
    VTSS_F_##tgt##_##addr##_##fld(value)
#if defined(VTSS_ARCH_SERVAL_T)
#define ES6514_PUT_BIT(tgt, addr, fld, value)                                  \
    (VTSS_F_##tgt##_##addr##_##fld(value))
#else
#define ES6514_PUT_BIT(tgt, addr, fld, value)                                  \
    ((value) ? VTSS_F_##tgt##_##addr##_##fld : 0)
#endif
...
/* ============================== */
/* Read register */
#define ES6514_RD_REG(reg, value)                                              \
    VTSS_RC(vtss_es6514_rd(vtss_state, reg, value));
...
/* Write register */
#define ES6514_WR_REG(reg, value)                                              \
    VTSS_RC(vtss_es6514_wr(vtss_state, reg, value));

/* Write register masked */
#define ES6514_WR_MSK(reg, value, mask)                                        \
    VTSS_RC(vtss_es6514_wrm(vtss_state, reg, value, mask));

/* Write non-replicated register field */
#define ES6514_WR_FLD(reg, tgt, addr, fld, value)                              \
    ES6514_WR_MSK(reg, ES6514_PUT_FLD(tgt, addr, fld, value),                  \
                  ES6514_MSK(tgt, addr, fld))

/* Write register bit field */
#define ES6514_WR_BIT(reg, tgt, addr, fld, value)                              \
    ES6514_WR_MSK(reg, ES6514_PUT_BIT(tgt, addr, fld, value),                  \
                  ES6514_PUT_BIT(tgt, addr, fld, 1))
...
/* Write register */
#define ES6514_WR(tgt, addr, value)                                            \
    ES6514_WR_REG(ES6514_ADDR(tgt, addr), value);
...
#define ES6514_WRM(tgt, addr, value, mask)                                     \
    ES6514_WR_MSK(ES6514_ADDR(tgt, addr), value, mask)
...
#define ES6514_RDX(tgt, addr, x, value)                                        \
    ES6514_RD_REG(ES6514_ADDR_X(tgt, addr, x), value)
...
#define ES6514_WRX(tgt, addr, x, value)                                        \
    ES6514_WR_REG(ES6514_ADDR_X(tgt, addr, x), value)
...
#define ES6514_WRXM_SET(tgt, addr, x, mask)                                    \
    ES6514_WRXM(tgt, addr, x, mask, mask)
