...
#ifndef _VTSS_MALIBU_REGS_LINE_PLL5G_H_
#define _VTSS_MALIBU_REGS_LINE_PLL5G_H_
...
/** 
 * \brief
 * fine tune of bandgap voltage distribution, 0: highest voltage, 15:
 * lowest voltage
 *
 * \details 
...
/** 
 * \brief
 * Settings for LREFCK reference clock input buffer.
...
/** 
 * \brief
 * Settings for LREFCK reference clock input buffer BIAS.
 ...
 */
#define VTSS_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS0  VTSS_IOREG(0x1e, 0, 0x820e)
...
/** 
 * \brief L_PLL5G Status 1A
 *
 * \details
 * Status register 1A for the L_PLL5G
 *
 * Register: \a LINE_PLL5G:L_PLL5G:L_PLL5G_STATUS1A
 */
#define VTSS_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1A  VTSS_IOREG(0x1e, 0, 0x820f)
 ...
 *
 * \details 
 * Field: VTSS_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1A . FSM_LOCK
 */
#define  VTSS_F_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1A_FSM_LOCK  VTSS_BIT(0)
 ...
 *
 * \details 
 * Field: VTSS_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1A . FSM_STAT
 */
#define  VTSS_F_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1A_FSM_STAT(x)  VTSS_ENCODE_BITFIELD(x,1,3)
#define  VTSS_M_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1A_FSM_STAT     VTSS_ENCODE_BITMASK(1,3)
#define  VTSS_X_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1A_FSM_STAT(x)  VTSS_EXTRACT_BITFIELD(x,1,3)
 ...
 *
 * \details 
 * Field: VTSS_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1A . FBCNT_DIF
 */
#define  VTSS_F_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1A_FBCNT_DIF(x)  VTSS_ENCODE_BITFIELD(x,4,10)
#define  VTSS_M_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1A_FBCNT_DIF     VTSS_ENCODE_BITMASK(4,10)
#define  VTSS_X_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1A_FBCNT_DIF(x)  VTSS_EXTRACT_BITFIELD(x,4,10)


/** 
 * \brief L_PLL5G Status 1B
 *
 * \details
 * Status register 1B for the L_PLL5G
 *
 * Register: \a LINE_PLL5G:L_PLL5G:L_PLL5G_STATUS1B
 */
#define VTSS_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1B  VTSS_IOREG(0x1e, 0, 0x8210)
 ...
 *
 * \details 
 * Field: VTSS_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1B . GAIN_STAT
 */
#define  VTSS_F_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1B_GAIN_STAT(x)  VTSS_ENCODE_BITFIELD(x,0,5)
#define  VTSS_M_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1B_GAIN_STAT     VTSS_ENCODE_BITMASK(0,5)
#define  VTSS_X_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1B_GAIN_STAT(x)  VTSS_EXTRACT_BITFIELD(x,0,5)
 ...
 *
 * \details 
 * Field: VTSS_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1B . SIG_DEL
 */
#define  VTSS_F_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1B_SIG_DEL(x)  VTSS_ENCODE_BITFIELD(x,5,8)
#define  VTSS_M_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1B_SIG_DEL     VTSS_ENCODE_BITMASK(5,8)
#define  VTSS_X_LINE_PLL5G_L_PLL5G_L_PLL5G_STATUS1B_SIG_DEL(x)  VTSS_EXTRACT_BITFIELD(x,5,8)


/** 
 * \brief L_PLL5G Interrupts
 *
 * \details
 * Interrupt registers for L_PLL5G
 *
 * Register: \a LINE_PLL5G:L_PLL5G:L_PLL5G_INTR
 */
#define VTSS_LINE_PLL5G_L_PLL5G_L_PLL5G_INTR  VTSS_IOREG(0x1e, 0, 0x8211)

/** 
 * \brief
 * PLL LOCK_STATUS Interrupt Register
 * 1:  L_PLL5G_STATUS0::LOCK_STATUS has changed state since the last time
 * this interrupt bit was cleared.
 * 0:  L_PLL5G_STATUS0::LOCK_STATUS has not changed state since the last
 * time this interrupt bit was cleared.
 *
 * \details 
 * Field: VTSS_LINE_PLL5G_L_PLL5G_L_PLL5G_INTR . LOCK_STATUS_INTR
 */
#define  VTSS_F_LINE_PLL5G_L_PLL5G_L_PLL5G_INTR_LOCK_STATUS_INTR  VTSS_BIT(0)


/** 
 * \brief L_PLL5G Interrupt Masks
 *
 * \details
 * Interrupt masks for L_PLL5G
 *
 * Register: \a LINE_PLL5G:L_PLL5G:L_PLL5G_INTR_MASK
 */
#define VTSS_LINE_PLL5G_L_PLL5G_L_PLL5G_INTR_MASK  VTSS_IOREG(0x1e, 0, 0x8212)

/** 
 * \brief
 * Interrupt mask for PLL LOCK_STATUS.	L_PLL5G_INTR::LOCK_STATUS_INTR
 * contributes to the chip's interrupt output pin when enabled.
 * 1: Interrupt enabled
 * 0: Interrupt disabled
 *
 * \details 
 * Field: VTSS_LINE_PLL5G_L_PLL5G_L_PLL5G_INTR_MASK . LOCK_STATUS_INTR_MASK
 */
#define  VTSS_F_LINE_PLL5G_L_PLL5G_L_PLL5G_INTR_MASK_LOCK_STATUS_INTR_MASK  VTSS_BIT(0)
...
#endif /* _VTSS_MALIBU_REGS_LINE_PLL5G_H_ */
