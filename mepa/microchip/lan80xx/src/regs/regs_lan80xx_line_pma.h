...
#ifndef LAN80XX_MALIBU25G_REGS_LINE_PMA_H_
#define LAN80XX_MALIBU25G_REGS_LINE_PMA_H_
 ...
 */
#define LAN80XX_LINE_PMA_PMA_PMD_DEVICE_ID_1                                                        (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x2))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_PMA_PMD_DEVICE_ID_1 . PMA_DEVICE_ID_1
 */
#define  LAN80XX_F_LINE_PMA_PMA_PMD_DEVICE_ID_1_PMA_DEVICE_ID_1(x)                                  (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_PMA_PMD_DEVICE_ID_1_PMA_DEVICE_ID_1                                     (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_PMA_PMD_DEVICE_ID_1_PMA_DEVICE_ID_1(x)                                  (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_PMA_PMD_DEVICE_ID_2                                                        (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x3))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_PMA_PMD_DEVICE_ID_2 . PMA_DEVICE_ID_2
 */
#define  LAN80XX_F_LINE_PMA_PMA_PMD_DEVICE_ID_2_PMA_DEVICE_ID_2(x)                                  (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_PMA_PMD_DEVICE_ID_2_PMA_DEVICE_ID_2                                     (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_PMA_PMD_DEVICE_ID_2_PMA_DEVICE_ID_2(x)                                  (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_PMA_PMD_SPEED_ABILITY                                                      (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x4))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_PMA_PMD_SPEED_ABILITY . SPEED_25G
 */
#define  LAN80XX_F_LINE_PMA_PMA_PMD_SPEED_ABILITY_SPEED_25G(x)                                      (LAN80XX_ENCODE_BITFIELD(!!(x),11,1))
#define  LAN80XX_M_LINE_PMA_PMA_PMD_SPEED_ABILITY_SPEED_25G                                         (LAN80XX_BIT(11))
#define  LAN80XX_X_LINE_PMA_PMA_PMD_SPEED_ABILITY_SPEED_25G(x)                                      (LAN80XX_EXTRACT_BITFIELD(x,11,1))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_PMA_PMD_SPEED_ABILITY . SPEED_1G
 */
#define  LAN80XX_F_LINE_PMA_PMA_PMD_SPEED_ABILITY_SPEED_1G(x)                                       (LAN80XX_ENCODE_BITFIELD(!!(x),4,1))
#define  LAN80XX_M_LINE_PMA_PMA_PMD_SPEED_ABILITY_SPEED_1G                                          (LAN80XX_BIT(4))
#define  LAN80XX_X_LINE_PMA_PMA_PMD_SPEED_ABILITY_SPEED_1G(x)                                       (LAN80XX_EXTRACT_BITFIELD(x,4,1))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_PMA_PMD_SPEED_ABILITY . SPEED_10G
 */
#define  LAN80XX_F_LINE_PMA_PMA_PMD_SPEED_ABILITY_SPEED_10G(x)                                      (LAN80XX_ENCODE_BITFIELD(!!(x),0,1))
#define  LAN80XX_M_LINE_PMA_PMA_PMD_SPEED_ABILITY_SPEED_10G                                         (LAN80XX_BIT(0))
#define  LAN80XX_X_LINE_PMA_PMA_PMD_SPEED_ABILITY_SPEED_10G(x)                                      (LAN80XX_EXTRACT_BITFIELD(x,0,1))
 ...
 */
#define LAN80XX_LINE_PMA_PMA_PMD_DEV_IN_PACKAGE_1                                                   (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x5))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_PMA_PMD_DEV_IN_PACKAGE_1 . PCS_PRESENT
 */
#define  LAN80XX_F_LINE_PMA_PMA_PMD_DEV_IN_PACKAGE_1_PCS_PRESENT(x)                                 (LAN80XX_ENCODE_BITFIELD(!!(x),3,1))
#define  LAN80XX_M_LINE_PMA_PMA_PMD_DEV_IN_PACKAGE_1_PCS_PRESENT                                    (LAN80XX_BIT(3))
#define  LAN80XX_X_LINE_PMA_PMA_PMD_DEV_IN_PACKAGE_1_PCS_PRESENT(x)                                 (LAN80XX_EXTRACT_BITFIELD(x,3,1))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_PMA_PMD_DEV_IN_PACKAGE_1 . PMD_PMA_PRESENT
 */
#define  LAN80XX_F_LINE_PMA_PMA_PMD_DEV_IN_PACKAGE_1_PMD_PMA_PRESENT(x)                             (LAN80XX_ENCODE_BITFIELD(!!(x),1,1))
#define  LAN80XX_M_LINE_PMA_PMA_PMD_DEV_IN_PACKAGE_1_PMD_PMA_PRESENT                                (LAN80XX_BIT(1))
#define  LAN80XX_X_LINE_PMA_PMA_PMD_DEV_IN_PACKAGE_1_PMD_PMA_PRESENT(x)                             (LAN80XX_EXTRACT_BITFIELD(x,1,1))
 ...
 */
#define LAN80XX_LINE_PMA_PMA_PMD_CONTROL_2                                                          (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x7))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_PMA_PMD_CONTROL_2 . PMA_PMD_TYPE_SELECTION
 */
#define  LAN80XX_F_LINE_PMA_PMA_PMD_CONTROL_2_PMA_PMD_TYPE_SELECTION(x)                             (LAN80XX_ENCODE_BITFIELD(x,0,7))
#define  LAN80XX_M_LINE_PMA_PMA_PMD_CONTROL_2_PMA_PMD_TYPE_SELECTION                                (LAN80XX_ENCODE_BITMASK(0,7))
#define  LAN80XX_X_LINE_PMA_PMA_PMD_CONTROL_2_PMA_PMD_TYPE_SELECTION(x)                             (LAN80XX_EXTRACT_BITFIELD(x,0,7))
 ...
 */
#define LAN80XX_LINE_PMA_PMA_PMD_PACKAGE_ID_1                                                       (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0xe))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_PMA_PMD_PACKAGE_ID_1 . PMA_PMD_PACKAGE_ID_1
 */
#define  LAN80XX_F_LINE_PMA_PMA_PMD_PACKAGE_ID_1_PMA_PMD_PACKAGE_ID_1(x)                            (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_PMA_PMD_PACKAGE_ID_1_PMA_PMD_PACKAGE_ID_1                               (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_PMA_PMD_PACKAGE_ID_1_PMA_PMD_PACKAGE_ID_1(x)                            (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_PMA_PMD_PACKAGE_ID_2                                                       (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0xf))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_PMA_PMD_PACKAGE_ID_2 . PMA_PMD_PACKAGE_ID_2
 */
#define  LAN80XX_F_LINE_PMA_PMA_PMD_PACKAGE_ID_2_PMA_PMD_PACKAGE_ID_2(x)                            (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_PMA_PMD_PACKAGE_ID_2_PMA_PMD_PACKAGE_ID_2                               (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_PMA_PMD_PACKAGE_ID_2_PMA_PMD_PACKAGE_ID_2(x)                            (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 * 0: Reset inactive
 *
 * Field: ::LAN80XX_LINE_PMA_SD_SER_RST . PCS_KR_TX_RST
 */
 ...
 * 0: Reset inactive
 *
 * Field: ::LAN80XX_LINE_PMA_SD_DES_RST . PCS_KR_RX_RST
 */
 ...
 * 0: disable
 *
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_1 . PCS_ISCAN_EN
 */
#define  LAN80XX_F_LINE_PMA_SD_LANE_CFG_1_PCS_ISCAN_EN(x)                                           (LAN80XX_ENCODE_BITFIELD(!!(x),6,1))
#define  LAN80XX_M_LINE_PMA_SD_LANE_CFG_1_PCS_ISCAN_EN                                              (LAN80XX_BIT(6))
#define  LAN80XX_X_LINE_PMA_SD_LANE_CFG_1_PCS_ISCAN_EN(x)                                           (LAN80XX_EXTRACT_BITFIELD(x,6,1))
 ...
 * 0: disable
 *
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_1 . PCS_EN_FAST_ISCAN
 */
#define  LAN80XX_F_LINE_PMA_SD_LANE_CFG_1_PCS_EN_FAST_ISCAN(x)                                      (LAN80XX_ENCODE_BITFIELD(!!(x),7,1))
#define  LAN80XX_M_LINE_PMA_SD_LANE_CFG_1_PCS_EN_FAST_ISCAN                                         (LAN80XX_BIT(7))
#define  LAN80XX_X_LINE_PMA_SD_LANE_CFG_1_PCS_EN_FAST_ISCAN(x)                                      (LAN80XX_EXTRACT_BITFIELD(x,7,1))
 ...
 * 1: low swing
 *
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_1 . PCS2PMA_TXSWING
 */
#define  LAN80XX_F_LINE_PMA_SD_LANE_CFG_1_PCS2PMA_TXSWING(x)                                        (LAN80XX_ENCODE_BITFIELD(!!(x),8,1))
#define  LAN80XX_M_LINE_PMA_SD_LANE_CFG_1_PCS2PMA_TXSWING                                           (LAN80XX_BIT(8))
#define  LAN80XX_X_LINE_PMA_SD_LANE_CFG_1_PCS2PMA_TXSWING(x)                                        (LAN80XX_EXTRACT_BITFIELD(x,8,1))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_1 . PCS2PMA_TXEI
 */
#define  LAN80XX_F_LINE_PMA_SD_LANE_CFG_1_PCS2PMA_TXEI(x)                                           (LAN80XX_ENCODE_BITFIELD(!!(x),9,1))
#define  LAN80XX_M_LINE_PMA_SD_LANE_CFG_1_PCS2PMA_TXEI                                              (LAN80XX_BIT(9))
#define  LAN80XX_X_LINE_PMA_SD_LANE_CFG_1_PCS2PMA_TXEI(x)                                           (LAN80XX_EXTRACT_BITFIELD(x,9,1))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_1 . PCS2PMA_TXMARGIN
 */
#define  LAN80XX_F_LINE_PMA_SD_LANE_CFG_1_PCS2PMA_TXMARGIN(x)                                       (LAN80XX_ENCODE_BITFIELD(x,10,3))
#define  LAN80XX_M_LINE_PMA_SD_LANE_CFG_1_PCS2PMA_TXMARGIN                                          (LAN80XX_ENCODE_BITMASK(10,3))
#define  LAN80XX_X_LINE_PMA_SD_LANE_CFG_1_PCS2PMA_TXMARGIN(x)                                       (LAN80XX_EXTRACT_BITFIELD(x,10,3))

/**
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_1 . PCS2PMA_TX_SPEED
 */
#define  LAN80XX_F_LINE_PMA_SD_LANE_CFG_1_PCS2PMA_TX_SPEED(x)                                       (LAN80XX_ENCODE_BITFIELD(x,13,2))
#define  LAN80XX_M_LINE_PMA_SD_LANE_CFG_1_PCS2PMA_TX_SPEED                                          (LAN80XX_ENCODE_BITMASK(13,2))
#define  LAN80XX_X_LINE_PMA_SD_LANE_CFG_1_PCS2PMA_TX_SPEED(x)                                       (LAN80XX_EXTRACT_BITFIELD(x,13,2))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_2 . RXFIFO_CK_DIV
 */
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_2 . TXFIFO_CK_DIV
 */
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_2 . PMA_TXCK_SEL
 */
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_2 . PMA_RXDIV_SEL
 */
 ...
 * 111: Reserved
 *
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_2 . DATA_WIDTH_SEL
 */
...
/**
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_3 . HWT_PRE_DIVSEL
 */
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_3 . HWT_VCO_DIV_SEL
 */
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_3 . HWT_CFG_SEL_DIV
 */
 ...
 * 11: 1/8
 *
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_3 . TXRATE_SEL
 */
 ...
 * 11: 1/8
 *
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_CFG_3 . RXRATE_SEL
 */
 ...
 * 0:  Reset pending or in progress
 *
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_STAT_0 . LANE_RST_DONE
 */
 ...
 */
#define LAN80XX_LINE_PMA_SD_LANE_STAT_1                                                             (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x8007))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_LANE_STAT_1 . DBG_OBS
 */
#define  LAN80XX_F_LINE_PMA_SD_LANE_STAT_1_DBG_OBS(x)                                               (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_SD_LANE_STAT_1_DBG_OBS                                                  (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_SD_LANE_STAT_1_DBG_OBS(x)                                               (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_SD_CFG                                                                     (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x8008))
 ...
 * detected
 *
 * Field: ::LAN80XX_LINE_PMA_SD_CFG . SD_ENA
 */
#define  LAN80XX_F_LINE_PMA_SD_CFG_SD_ENA(x)                                                        (LAN80XX_ENCODE_BITFIELD(!!(x),0,1))
#define  LAN80XX_M_LINE_PMA_SD_CFG_SD_ENA                                                           (LAN80XX_BIT(0))
#define  LAN80XX_X_LINE_PMA_SD_CFG_SD_ENA(x)                                                        (LAN80XX_EXTRACT_BITFIELD(x,0,1))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_SD_CFG . SD_POL
 */
#define  LAN80XX_F_LINE_PMA_SD_CFG_SD_POL(x)                                                        (LAN80XX_ENCODE_BITFIELD(!!(x),1,1))
#define  LAN80XX_M_LINE_PMA_SD_CFG_SD_POL                                                           (LAN80XX_BIT(1))
#define  LAN80XX_X_LINE_PMA_SD_CFG_SD_POL(x)                                                        (LAN80XX_EXTRACT_BITFIELD(x,1,1))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_SD_CFG . SD_SEL
 */
#define  LAN80XX_F_LINE_PMA_SD_CFG_SD_SEL(x)                                                        (LAN80XX_ENCODE_BITFIELD(!!(x),2,1))
#define  LAN80XX_M_LINE_PMA_SD_CFG_SD_SEL                                                           (LAN80XX_BIT(2))
#define  LAN80XX_X_LINE_PMA_SD_CFG_SD_SEL(x)                                                        (LAN80XX_EXTRACT_BITFIELD(x,2,1))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_SD_CFG . HWT_REFCLK_R_SEL
 */
#define  LAN80XX_F_LINE_PMA_SD_CFG_HWT_REFCLK_R_SEL(x)                                              (LAN80XX_ENCODE_BITFIELD(!!(x),5,1))
#define  LAN80XX_M_LINE_PMA_SD_CFG_HWT_REFCLK_R_SEL                                                 (LAN80XX_BIT(5))
#define  LAN80XX_X_LINE_PMA_SD_CFG_HWT_REFCLK_R_SEL(x)                                              (LAN80XX_EXTRACT_BITFIELD(x,5,1))
 ...
 */
#define LAN80XX_LINE_PMA_SD_KR_ANEG_MODE                                                            (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x8010))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_SD_KR_ANEG_MODE . TX_ANEG_MODE
 */
#define  LAN80XX_F_LINE_PMA_SD_KR_ANEG_MODE_TX_ANEG_MODE(x)                                         (LAN80XX_ENCODE_BITFIELD(x,0,2))
#define  LAN80XX_M_LINE_PMA_SD_KR_ANEG_MODE_TX_ANEG_MODE                                            (LAN80XX_ENCODE_BITMASK(0,2))
#define  LAN80XX_X_LINE_PMA_SD_KR_ANEG_MODE_TX_ANEG_MODE(x)                                         (LAN80XX_EXTRACT_BITFIELD(x,0,2))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_SD_EXTCFG_CFG . CLK_DIV
 */
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_SD_EXTCFG_CFG . WS_SETUP_WR
 */
#define  LAN80XX_F_LINE_PMA_SD_EXTCFG_CFG_WS_SETUP_WR(x)                                            (LAN80XX_ENCODE_BITFIELD(x,4,2))
#define  LAN80XX_M_LINE_PMA_SD_EXTCFG_CFG_WS_SETUP_WR                                               (LAN80XX_ENCODE_BITMASK(4,2))
#define  LAN80XX_X_LINE_PMA_SD_EXTCFG_CFG_WS_SETUP_WR(x)                                            (LAN80XX_EXTRACT_BITFIELD(x,4,2))
 ...
 * clock signal.
 *
 * Field: ::LAN80XX_LINE_PMA_SD_EXTCFG_CFG . WS_EXEC_WR
 */
#define  LAN80XX_F_LINE_PMA_SD_EXTCFG_CFG_WS_EXEC_WR(x)                                             (LAN80XX_ENCODE_BITFIELD(x,8,2))
#define  LAN80XX_M_LINE_PMA_SD_EXTCFG_CFG_WS_EXEC_WR                                                (LAN80XX_ENCODE_BITMASK(8,2))
#define  LAN80XX_X_LINE_PMA_SD_EXTCFG_CFG_WS_EXEC_WR(x)                                             (LAN80XX_EXTRACT_BITFIELD(x,8,2))
 ...
 * clock signal.
 *
 * Field: ::LAN80XX_LINE_PMA_SD_EXTCFG_CFG . WS_HOLD_WR
 */
#define  LAN80XX_F_LINE_PMA_SD_EXTCFG_CFG_WS_HOLD_WR(x)                                             (LAN80XX_ENCODE_BITFIELD(x,12,2))
#define  LAN80XX_M_LINE_PMA_SD_EXTCFG_CFG_WS_HOLD_WR                                                (LAN80XX_ENCODE_BITMASK(12,2))
#define  LAN80XX_X_LINE_PMA_SD_EXTCFG_CFG_WS_HOLD_WR(x)                                             (LAN80XX_EXTRACT_BITFIELD(x,12,2))
 ...
 * clock signal.
 *
 * Field: ::LAN80XX_LINE_PMA_SD_EXTCFG_CFG . WS_EXEC_RD
 */
#define  LAN80XX_F_LINE_PMA_SD_EXTCFG_CFG_WS_EXEC_RD(x)                                             (LAN80XX_ENCODE_BITFIELD(x,14,2))
#define  LAN80XX_M_LINE_PMA_SD_EXTCFG_CFG_WS_EXEC_RD                                                (LAN80XX_ENCODE_BITMASK(14,2))
#define  LAN80XX_X_LINE_PMA_SD_EXTCFG_CFG_WS_EXEC_RD(x)                                             (LAN80XX_EXTRACT_BITFIELD(x,14,2))
 ...
 */
#define LAN80XX_LINE_PMA_SD_DELAY_CFG                                                               (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x8012))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_DELAY_CFG . SAMPLE_TIME
 */
#define  LAN80XX_F_LINE_PMA_SD_DELAY_CFG_SAMPLE_TIME(x)                                             (LAN80XX_ENCODE_BITFIELD(x,0,3))
#define  LAN80XX_M_LINE_PMA_SD_DELAY_CFG_SAMPLE_TIME                                                (LAN80XX_ENCODE_BITMASK(0,3))
#define  LAN80XX_X_LINE_PMA_SD_DELAY_CFG_SAMPLE_TIME(x)                                             (LAN80XX_EXTRACT_BITFIELD(x,0,3))
 ...
 */
#define LAN80XX_LINE_PMA_SD_RX_DELAY_VAR                                                            (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x8013))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_RX_DELAY_VAR . RX_DELAY_VAR
 */
#define  LAN80XX_F_LINE_PMA_SD_RX_DELAY_VAR_RX_DELAY_VAR(x)                                         (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_SD_RX_DELAY_VAR_RX_DELAY_VAR                                            (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_SD_RX_DELAY_VAR_RX_DELAY_VAR(x)                                         (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_SD_TX_DELAY_VAR                                                            (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x8014))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_SD_TX_DELAY_VAR . TX_DELAY_VAR
 */
#define  LAN80XX_F_LINE_PMA_SD_TX_DELAY_VAR_TX_DELAY_VAR(x)                                         (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_SD_TX_DELAY_VAR_TX_DELAY_VAR                                            (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_SD_TX_DELAY_VAR_TX_DELAY_VAR(x)                                         (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_KR_DATA_CFG                                                                (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x8016))
 ...
 * 0 : Default bit order
 *
 * Field: ::LAN80XX_LINE_PMA_KR_DATA_CFG . REVERT_10B
 */
#define  LAN80XX_F_LINE_PMA_KR_DATA_CFG_REVERT_10B(x)                                               (LAN80XX_ENCODE_BITFIELD(!!(x),0,1))
#define  LAN80XX_M_LINE_PMA_KR_DATA_CFG_REVERT_10B                                                  (LAN80XX_BIT(0))
#define  LAN80XX_X_LINE_PMA_KR_DATA_CFG_REVERT_10B(x)                                               (LAN80XX_EXTRACT_BITFIELD(x,0,1))
 ...
 * 0 : Default bit order
 *
 * Field: ::LAN80XX_LINE_PMA_KR_DATA_CFG . REVERT_64B_TX
 */
#define  LAN80XX_F_LINE_PMA_KR_DATA_CFG_REVERT_64B_TX(x)                                            (LAN80XX_ENCODE_BITFIELD(!!(x),1,1))
#define  LAN80XX_M_LINE_PMA_KR_DATA_CFG_REVERT_64B_TX                                               (LAN80XX_BIT(1))
#define  LAN80XX_X_LINE_PMA_KR_DATA_CFG_REVERT_64B_TX(x)                                            (LAN80XX_EXTRACT_BITFIELD(x,1,1))
 ...
 * 0 : Default bit order
 *
 * Field: ::LAN80XX_LINE_PMA_KR_DATA_CFG . REVERT_64B_RX
 */
#define  LAN80XX_F_LINE_PMA_KR_DATA_CFG_REVERT_64B_RX(x)                                            (LAN80XX_ENCODE_BITFIELD(!!(x),2,1))
#define  LAN80XX_M_LINE_PMA_KR_DATA_CFG_REVERT_64B_RX                                               (LAN80XX_BIT(2))
#define  LAN80XX_X_LINE_PMA_KR_DATA_CFG_REVERT_64B_RX(x)                                            (LAN80XX_EXTRACT_BITFIELD(x,2,1))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_KR_DATA_CFG . KR_DATA_BUS_MODE
 */
#define  LAN80XX_F_LINE_PMA_KR_DATA_CFG_KR_DATA_BUS_MODE(x)                                         (LAN80XX_ENCODE_BITFIELD(!!(x),3,1))
#define  LAN80XX_M_LINE_PMA_KR_DATA_CFG_KR_DATA_BUS_MODE                                            (LAN80XX_BIT(3))
#define  LAN80XX_X_LINE_PMA_KR_DATA_CFG_KR_DATA_BUS_MODE(x)                                         (LAN80XX_EXTRACT_BITFIELD(x,3,1))
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_PMA_IRQ_VEC . PMA_RXEI_FILTERED_INT
 */
 ...
 *
 * Field: ::LAN80XX_LINE_PMA_PMA_IRQ_VEC . PMA_RESET_DONE
 */
 ...
 */
#define LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_7                                                       (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x80f8))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_7 . LINE_PMA_DBG_REG_7
 */
#define  LAN80XX_F_LINE_PMA_LINE_PMA_DEBUG_REG_7_LINE_PMA_DBG_REG_7(x)                              (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_LINE_PMA_DEBUG_REG_7_LINE_PMA_DBG_REG_7                                 (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_LINE_PMA_DEBUG_REG_7_LINE_PMA_DBG_REG_7(x)                              (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_6                                                       (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x80f9))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_6 . LINE_PMA_DBG_REG_6
 */
#define  LAN80XX_F_LINE_PMA_LINE_PMA_DEBUG_REG_6_LINE_PMA_DBG_REG_6(x)                              (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_LINE_PMA_DEBUG_REG_6_LINE_PMA_DBG_REG_6                                 (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_LINE_PMA_DEBUG_REG_6_LINE_PMA_DBG_REG_6(x)                              (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_5                                                       (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x80fa))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_5 . LINE_PMA_DBG_REG_5
 */
#define  LAN80XX_F_LINE_PMA_LINE_PMA_DEBUG_REG_5_LINE_PMA_DBG_REG_5(x)                              (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_LINE_PMA_DEBUG_REG_5_LINE_PMA_DBG_REG_5                                 (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_LINE_PMA_DEBUG_REG_5_LINE_PMA_DBG_REG_5(x)                              (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_4                                                       (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x80fb))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_4 . LINE_PMA_DBG_REG_4
 */
#define  LAN80XX_F_LINE_PMA_LINE_PMA_DEBUG_REG_4_LINE_PMA_DBG_REG_4(x)                              (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_LINE_PMA_DEBUG_REG_4_LINE_PMA_DBG_REG_4                                 (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_LINE_PMA_DEBUG_REG_4_LINE_PMA_DBG_REG_4(x)                              (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_3                                                       (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x80fc))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_3 . LINE_PMA_DBG_REG_3
 */
#define  LAN80XX_F_LINE_PMA_LINE_PMA_DEBUG_REG_3_LINE_PMA_DBG_REG_3(x)                              (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_LINE_PMA_DEBUG_REG_3_LINE_PMA_DBG_REG_3                                 (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_LINE_PMA_DEBUG_REG_3_LINE_PMA_DBG_REG_3(x)                              (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_2                                                       (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x80fd))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_2 . LINE_PMA_DBG_REG_2
 */
#define  LAN80XX_F_LINE_PMA_LINE_PMA_DEBUG_REG_2_LINE_PMA_DBG_REG_2(x)                              (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_LINE_PMA_DEBUG_REG_2_LINE_PMA_DBG_REG_2                                 (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_LINE_PMA_DEBUG_REG_2_LINE_PMA_DBG_REG_2(x)                              (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_1                                                       (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x80fe))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_1 . LINE_PMA_DBG_REG_1
 */
#define  LAN80XX_F_LINE_PMA_LINE_PMA_DEBUG_REG_1_LINE_PMA_DBG_REG_1(x)                              (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_LINE_PMA_DEBUG_REG_1_LINE_PMA_DBG_REG_1                                 (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_LINE_PMA_DEBUG_REG_1_LINE_PMA_DBG_REG_1(x)                              (LAN80XX_EXTRACT_BITFIELD(x,0,16))
 ...
 */
#define LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_0                                                       (LAN80XX_IOREG(LAN80XX_TO_LINE_PMA,0x80ff))
 ...
 *
 * \details
 * Field: ::LAN80XX_LINE_PMA_LINE_PMA_DEBUG_REG_0 . LINE_PMA_DBG_REG_0
 */
#define  LAN80XX_F_LINE_PMA_LINE_PMA_DEBUG_REG_0_LINE_PMA_DBG_REG_0(x)                              (LAN80XX_ENCODE_BITFIELD(x,0,16))
#define  LAN80XX_M_LINE_PMA_LINE_PMA_DEBUG_REG_0_LINE_PMA_DBG_REG_0                                 (LAN80XX_ENCODE_BITMASK(0,16))
#define  LAN80XX_X_LINE_PMA_LINE_PMA_DEBUG_REG_0_LINE_PMA_DBG_REG_0(x)                              (LAN80XX_EXTRACT_BITFIELD(x,0,16))
...
#endif /* _LAN80XX_MALIBU25G_REGS_LINE_PMA_H_ */
