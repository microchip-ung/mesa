...
#define LAN80XX_GPIO_INTR0_LINE_SRC_SELECT(x)   (1 << 8) << (x * 2)  /* Enable INTR0 of Channel Level LINE Interrupts */
#define LAN80XX_GPIO_INTR1_LINE_SRC_SELECT(x)   (1 << 9) << (x * 2)  /* Enable INTR1 of Channel Level LINE Interrupts */
#define LAN80XX_GPIO_INTR1_HOST_SRC_SELECT(x)   (1 << 1) << (x * 2)  /* Enable INTR1 of Channel Level HOST side Interrupts */
#define LAN80XX_GPIO_INTR0_HOST_SRC_SELECT(x)    1 << (x * 2)        /* Enable INTR0 of channel Level HOST Side Interrupts */
...
#define LAN80XX_DISABLE_GPIO_INTERRUPT_FOR_EVENT(port, sel, intr) \
            LAN80XX_CSR_WRM(port, LAN80XX_GPIO_CTRL_INTR_SRC_EN(sel), 0, intr)
...
#define LAN80XX_DISABLE_INTERRUPT_FOR_EVENT(port, sel, ch, line) \
        line ? (LAN80XX_CSR_WRM(port, LAN80XX_GPIO_CTRL_INTR_SRC_EN(sel), \
        0, sel ? LAN80XX_GPIO_INTR1_LINE_SRC_SELECT(ch) : LAN80XX_GPIO_INTR0_LINE_SRC_SELECT(ch))) : \
        (LAN80XX_CSR_WRM(port, LAN80XX_GPIO_CTRL_INTR_SRC_EN(sel), \
        0, sel ? LAN80XX_GPIO_INTR1_HOST_SRC_SELECT(ch) : LAN80XX_GPIO_INTR0_HOST_SRC_SELECT(ch)))
                                            ...
                                            phy25g_events_t       *const evt)
{
    ...
    LAN80XX_CSR_RD(dev, port_no,  LAN80XX_GPIO_CTRL_GPIO_CHANGEX_SLOT(1), &reg_val0);
    LAN80XX_CSR_RD(dev, port_no,  LAN80XX_GPIO_CTRL_GPIO_CHANGEX_SLOT(0), &reg_val1);
    if ((!(reg_val0 & mask0)) && (!(reg_val1 & mask1))) {
        return MEPA_RC_OK;
    }
    LAN80XX_CSR_WRM(port_no, LAN80XX_GPIO_CTRL_GPIO_CHANGEX_SLOT(1), reg_val0, mask0);
    LAN80XX_CSR_WRM(port_no, LAN80XX_GPIO_CTRL_GPIO_CHANGEX_SLOT(0), (reg_val1 & mask1), mask0);
    *evt = (*evt | intr);
                                               ...
                                               phy25g_ext_events_t   *const evt)
{
    ...
    if (is_intr2) {
        /* Crossconnect INTR */
        mask = ((intr == LAN80XX_WPS1_FC_ACK_TIMER_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR2_WPS1_FC_ACK_TIMER_STICKY : 0) |
               ((intr == LAN80XX_WPS0_FC_ACK_TIMER_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR2_WPS0_FC_ACK_TIMER_STICKY : 0) |
               ((intr == LAN80XX_WPS1_CONN_FAULT_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR2_WPS1_CONN_FAULT_STICKY : 0) |
               ((intr == LAN80XX_WPS0_CONN_FAULT_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR2_WPS0_CONN_FAULT_STICKY : 0) |
               ((intr == LAN80XX_WPS1_FAILOVER_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR2_WPS1_FAILOVER_STICKY : 0) |
               ((intr == LAN80XX_WPS0_FAILOVER_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR2_WPS0_FAILOVER_STICKY : 0);

        io_reg = LAN80XX_CROSS_CONNECT_INTR2;
    } else {
        /* Crossconnect INTR */
        mask = ((intr == LAN80XX_H0_SWITCH_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H0_SWITCH_STICKY : 0) |
               ((intr == LAN80XX_H1_SWITCH_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H1_SWITCH_STICKY : 0) |
               ((intr == LAN80XX_H2_SWITCH_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H2_SWITCH_STICKY : 0) |
               ((intr == LAN80XX_H3_SWITCH_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H3_SWITCH_STICKY : 0) |
               ((intr == LAN80XX_L0_SWITCH_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L0_SWITCH_STICKY : 0) |
               ((intr == LAN80XX_L1_SWITCH_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L1_SWITCH_STICKY : 0) |
               ((intr == LAN80XX_L2_SWITCH_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L2_SWITCH_STICKY : 0) |
               ((intr == LAN80XX_L3_SWITCH_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L3_SWITCH_STICKY : 0) |
               ((intr == LAN80XX_H0_COND_ALT_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H0_COND_ALT_DET_STICKY : 0) |
               ((intr == LAN80XX_H1_COND_ALT_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H1_COND_ALT_DET_STICKY : 0) |
               ((intr == LAN80XX_H2_COND_ALT_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H2_COND_ALT_DET_STICKY : 0) |
               ((intr == LAN80XX_H3_COND_ALT_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H3_COND_ALT_DET_STICKY : 0) |
               ((intr == LAN80XX_L0_COND_ALT_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L0_COND_ALT_DET_STICKY : 0) |
               ((intr == LAN80XX_L1_COND_ALT_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L1_COND_ALT_DET_STICKY : 0) |
               ((intr == LAN80XX_L2_COND_ALT_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L2_COND_ALT_DET_STICKY : 0) |
               ((intr == LAN80XX_L3_COND_ALT_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L3_COND_ALT_DET_STICKY : 0) |
               ((intr == LAN80XX_H0_COND_ALT_UNF_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H0_COND_ALT_UNF_DET_STICKY : 0) |
               ((intr == LAN80XX_H1_COND_ALT_UNF_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H1_COND_ALT_UNF_DET_STICKY : 0) |
               ((intr == LAN80XX_H2_COND_ALT_UNF_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H2_COND_ALT_UNF_DET_STICKY : 0) |
               ((intr == LAN80XX_H3_COND_ALT_UNF_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H3_COND_ALT_UNF_DET_STICKY : 0) |
               ((intr == LAN80XX_L0_COND_ALT_UNF_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L0_COND_ALT_UNF_DET_STICKY : 0) |
               ((intr == LAN80XX_L1_COND_ALT_UNF_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L1_COND_ALT_UNF_DET_STICKY : 0) |
               ((intr == LAN80XX_L2_COND_ALT_UNF_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L2_COND_ALT_UNF_DET_STICKY : 0) |
               ((intr == LAN80XX_L3_COND_ALT_UNF_DET_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L3_COND_ALT_UNF_DET_STICKY : 0) |
               ((intr == LAN80XX_H0_FIFO_ERROR_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H0_FIFO_ERROR_STICKY : 0) |
               ((intr == LAN80XX_H1_FIFO_ERROR_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H1_FIFO_ERROR_STICKY : 0) |
               ((intr == LAN80XX_H2_FIFO_ERROR_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H2_FIFO_ERROR_STICKY : 0) |
               ((intr == LAN80XX_H3_FIFO_ERROR_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_H3_FIFO_ERROR_STICKY : 0) |
               ((intr == LAN80XX_L0_FIFO_ERROR_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L0_FIFO_ERROR_STICKY : 0) |
               ((intr == LAN80XX_L1_FIFO_ERROR_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L1_FIFO_ERROR_STICKY : 0) |
               ((intr == LAN80XX_L2_FIFO_ERROR_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L2_FIFO_ERROR_STICKY : 0) |
               ((intr == LAN80XX_L3_FIFO_ERROR_INTR) ? LAN80XX_M_CROSS_CONNECT_INTR_L3_FIFO_ERROR_STICKY : 0);
                                      ...
                                      phy25g_ext_events_t   *const evt)
{
    ...
    if (is_line) {
        /* LINE PMA Interrupt */
        mask = ((intr == LAN80XX_LINE_PMA_RXEI_FILTERED_INTR) ? LAN80XX_M_LINE_PMA_PMA_IRQ_VEC_PMA_RXEI_FILTERED_INT : 0) |
               ((intr == LAN80XX_LINE_PMA_RESET_DONE_INTR) ? LAN80XX_M_LINE_PMA_PMA_IRQ_VEC_PMA_RESET_DONE : 0 );

        io_reg = LAN80XX_LINE_PMA_PMA_IRQ_VEC;
    } else {
        /* HOST PMA Interrupt */
        mask = ((intr == LAN80XX_HOST_PMA_RXEI_FILTERED_INTR) ? LAN80XX_M_HOST_PMA_PMA_IRQ_VEC_PMA_RXEI_FILTERED_INT : 0) |
               ((intr == LAN80XX_HOST_PMA_RESET_DONE_INTR) ? LAN80XX_M_HOST_PMA_PMA_IRQ_VEC_PMA_RESET_DONE : 0 );
                                      ...
                                      mepa_bool_t           enable)
{
    ...
    if (is_line) {
        /* LINE PMA */
        mask = ((intr == LAN80XX_LINE_PMA_RESET_DONE_INTR) ?  LAN80XX_M_LINE_PMA_PMA_IRQ_MASK_PMA_RESET_DONE_INT_EN : 0)    |
               ((intr == LAN80XX_LINE_PMA_RXEI_FILTERED_INTR) ? LAN80XX_M_LINE_PMA_PMA_IRQ_MASK_PMA_RXEI_FILTERED_INT_EN : 0);
    } else {
        /* HOST PMA */
        mask = ((intr == LAN80XX_HOST_PMA_RESET_DONE_INTR) ?  LAN80XX_M_HOST_PMA_PMA_IRQ_MASK_PMA_RESET_DONE_INT_EN : 0)    |
               ((intr == LAN80XX_HOST_PMA_RXEI_FILTERED_INTR) ? LAN80XX_M_HOST_PMA_PMA_IRQ_MASK_PMA_RXEI_FILTERED_INT_EN : 0);
    }
    ...
    if (is_line) {
        LAN80XX_CSR_WRM(port_no, LAN80XX_LINE_INTR_CTRL_LINE_INTR_EN(0),
                        LAN80XX_F_LINE_INTR_CTRL_LINE_INTR_EN_LPMA_INTR_EN(enable),
                        LAN80XX_M_LINE_INTR_CTRL_LINE_INTR_EN_LPMA_INTR_EN);
    } else {
        LAN80XX_CSR_WRM(port_no, LAN80XX_HOST_INTR_CTRL_HOST_INTR_EN(0),
                                         ...
                                         phy25g_ext_events_t   *const evt)
{
    ...
    ioreg_blk *io_reg;
    if (is_line) {
        mask = ((intr == LAN80XX_LINE_MAC_MM_PRMPT_UNEXP_TX_PFRM_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_MM_STATUS_UNEXP_TX_PFRM_STICKY : 0) |
               ((intr == LAN80XX_LINE_MAC_MM_PRMPT_UNEXP_RX_PFRM_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MM_STATUS_UNEXP_RX_PFRM_STICKY : 0) |
               ((intr == LAN80XX_LINE_MAC_MM_PRMPT_ACTIVE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MM_STATUS_PRMPT_ACTIVE_STICKY : 0);

        io_reg = LAN80XX_LINE_MAC_LINE_MAC_MM_STATUS;
    } else {
        mask = ((intr == LAN80XX_HOST_MAC_MM_PRMPT_UNEXP_TX_PFRM_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_MM_STATUS_UNEXP_TX_PFRM_STICKY : 0) |
               ((intr == LAN80XX_HOST_MAC_MM_PRMPT_UNEXP_RX_PFRM_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MM_STATUS_UNEXP_RX_PFRM_STICKY : 0) |
               ((intr == LAN80XX_HOST_MAC_MM_PRMPT_ACTIVE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MM_STATUS_PRMPT_ACTIVE_STICKY : 0);
                                         ...
                                         mepa_bool_t           enable)
{
    ...
    if (!is_host) {
        /* LINE MM MAC */
        mask = ((intr == LAN80XX_LINE_MAC_MM_PRMPT_UNEXP_TX_PFRM_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_MM_STATUS_UNEXP_TX_PFRM_STICKY_MASK : 0) |
               ((intr == LAN80XX_LINE_MAC_MM_PRMPT_UNEXP_RX_PFRM_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MM_STATUS_UNEXP_RX_PFRM_STICKY_MASK : 0) |
               ((intr == LAN80XX_LINE_MAC_MM_PRMPT_ACTIVE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MM_STATUS_PRMPT_ACTIVE_STICKY_MASK : 0);

        sticky = ((intr == LAN80XX_LINE_MAC_MM_PRMPT_UNEXP_TX_PFRM_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_MM_STATUS_UNEXP_TX_PFRM_STICKY : 0) |
                 ((intr == LAN80XX_LINE_MAC_MM_PRMPT_UNEXP_RX_PFRM_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MM_STATUS_UNEXP_RX_PFRM_STICKY : 0) |
                 ((intr == LAN80XX_LINE_MAC_MM_PRMPT_ACTIVE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MM_STATUS_PRMPT_ACTIVE_STICKY : 0);

    } else {
        /* HOST MM MAC */
        mask = ((intr == LAN80XX_HOST_MAC_MM_PRMPT_UNEXP_TX_PFRM_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_MM_STATUS_UNEXP_TX_PFRM_STICKY_MASK : 0)    |
               ((intr == LAN80XX_HOST_MAC_MM_PRMPT_UNEXP_RX_PFRM_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MM_STATUS_UNEXP_RX_PFRM_STICKY_MASK : 0) |
               ((intr == LAN80XX_HOST_MAC_MM_PRMPT_ACTIVE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MM_STATUS_PRMPT_ACTIVE_STICKY_MASK : 0);

        sticky = ((intr == LAN80XX_HOST_MAC_MM_PRMPT_UNEXP_TX_PFRM_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_MM_STATUS_UNEXP_TX_PFRM_STICKY : 0) |
                 ((intr == LAN80XX_HOST_MAC_MM_PRMPT_UNEXP_RX_PFRM_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MM_STATUS_UNEXP_RX_PFRM_STICKY : 0) |
                 ((intr == LAN80XX_HOST_MAC_MM_PRMPT_ACTIVE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MM_STATUS_PRMPT_ACTIVE_STICKY : 0);
    }
                                             ...
                                             phy25g_ext_events_t   *const evt)
{
    ...
    if (is_line) {
        /* LINE P-MAC */
        mask = ((intr == LAN80XX_LINE_PMAC_RX_PREAMBLE_SHRINK) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_STICKY_PMAC_RX_PREAM_SHRINK_STICKY : 0)    |
               ((intr == LAN80XX_LINE_PMAC_RX_PREAMBLE_MISMATCH) ? LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_STICKY_PMAC_RX_PREAM_MISMATCH_STICKY : 0) |
               ((intr == LAN80XX_LINE_PMAC_RX_PREAMBLE_ERR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_STICKY_PMAC_RX_PREAM_ERR_STICKY : 0)    |
               ((intr == LAN80XX_LINE_PMAC_RX_NON_STD_PREAMBLE_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_STICKY_PMAC_RX_NON_STD_PREAM_STICKY : 0)    |
               ((intr == LAN80XX_LINE_PMAC_RX_MPLS_MC_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_STICKY_PMAC_RX_MPLS_MC_STICKY : 0)    |
               ((intr == LAN80XX_LINE_PMAC_RX_MPLS_UC_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_STICKY_PMAC_RX_MPLS_UC_STICKY : 0)    |
               ((intr == LAN80XX_LINE_PMAC_TX_UNDERFLOW_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_STICKY_PMAC_TX_UFLW_STICKY : 0)    |
               ((intr == LAN80XX_LINE_PMAC_TX_ABORT_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_STICKY_PMAC_TX_ABORT_STICKY : 0);

        io_reg = LAN80XX_LINE_MAC_LINE_MAC_PMAC_STICKY;
    } else {
        /* HOST P-MAC */
        mask = ((intr == LAN80XX_HOST_PMAC_RX_PREAMBLE_SHRINK) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_STICKY_PMAC_RX_PREAM_SHRINK_STICKY : 0)    |
               ((intr == LAN80XX_HOST_PMAC_RX_PREAMBLE_MISMATCH) ? LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_STICKY_PMAC_RX_PREAM_MISMATCH_STICKY : 0) |
               ((intr == LAN80XX_HOST_PMAC_RX_PREAMBLE_ERR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_STICKY_PMAC_RX_PREAM_ERR_STICKY : 0)    |
               ((intr == LAN80XX_HOST_PMAC_RX_NON_STD_PREAMBLE_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_STICKY_PMAC_RX_NON_STD_PREAM_STICKY : 0)    |
               ((intr == LAN80XX_HOST_PMAC_RX_MPLS_MC_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_STICKY_PMAC_RX_MPLS_MC_STICKY : 0)    |
               ((intr == LAN80XX_HOST_PMAC_RX_MPLS_UC_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_STICKY_PMAC_RX_MPLS_UC_STICKY : 0)    |
               ((intr == LAN80XX_HOST_PMAC_TX_UNDERFLOW_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_STICKY_PMAC_TX_UFLW_STICKY : 0)    |
               ((intr == LAN80XX_HOST_PMAC_TX_ABORT_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_STICKY_PMAC_TX_ABORT_STICKY : 0);
                                             ...
                                             mepa_bool_t           enable)
{
    ...
    if (!is_host) {
        /* LINE P-MAC */
        mask = ((intr == LAN80XX_LINE_PMAC_RX_PREAMBLE_SHRINK) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_MAC_STICKY_MASK_PMAC_RX_PREAM_SHRINK_STICKY_MASK : 0)    |
               ((intr == LAN80XX_LINE_PMAC_RX_PREAMBLE_MISMATCH) ? LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_MAC_STICKY_MASK_PMAC_RX_PREAM_MISMATCH_STICKY_MASK : 0) |
               ((intr == LAN80XX_LINE_PMAC_RX_PREAMBLE_ERR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_MAC_STICKY_MASK_PMAC_RX_PREAM_ERR_STICKY_MASK : 0)    |
               ((intr == LAN80XX_LINE_PMAC_RX_NON_STD_PREAMBLE_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_MAC_STICKY_MASK_PMAC_RX_NON_STD_PREAM_STICKY_MASK : 0)    |
               ((intr == LAN80XX_LINE_PMAC_RX_MPLS_MC_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_MAC_STICKY_MASK_PMAC_RX_MPLS_MC_STICKY_MASK : 0)    |
               ((intr == LAN80XX_LINE_PMAC_RX_MPLS_UC_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_MAC_STICKY_MASK_PMAC_RX_MPLS_UC_STICKY_MASK : 0)    |
               ((intr == LAN80XX_LINE_PMAC_TX_UNDERFLOW_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_MAC_STICKY_MASK_PMAC_TX_UFLW_STICKY_MASK : 0)    |
               ((intr == LAN80XX_LINE_PMAC_TX_ABORT_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_PMAC_MAC_STICKY_MASK_PMAC_TX_ABORT_STICKY_MASK : 0);
    } else {
        /* HOST P-MAC */
        mask = ((intr == LAN80XX_HOST_PMAC_RX_PREAMBLE_SHRINK) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_MAC_STICKY_MASK_PMAC_RX_PREAM_SHRINK_STICKY_MASK : 0)    |
               ((intr == LAN80XX_HOST_PMAC_RX_PREAMBLE_MISMATCH) ? LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_MAC_STICKY_MASK_PMAC_RX_PREAM_MISMATCH_STICKY_MASK : 0) |
               ((intr == LAN80XX_HOST_PMAC_RX_PREAMBLE_ERR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_MAC_STICKY_MASK_PMAC_RX_PREAM_ERR_STICKY_MASK : 0)    |
               ((intr == LAN80XX_HOST_PMAC_RX_NON_STD_PREAMBLE_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_MAC_STICKY_MASK_PMAC_RX_NON_STD_PREAM_STICKY_MASK : 0)    |
               ((intr == LAN80XX_HOST_PMAC_RX_MPLS_MC_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_MAC_STICKY_MASK_PMAC_RX_MPLS_MC_STICKY_MASK : 0)    |
               ((intr == LAN80XX_HOST_PMAC_RX_MPLS_UC_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_MAC_STICKY_MASK_PMAC_RX_MPLS_UC_STICKY_MASK : 0)    |
               ((intr == LAN80XX_HOST_PMAC_TX_UNDERFLOW_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_MAC_STICKY_MASK_PMAC_TX_UFLW_STICKY_MASK : 0)    |
               ((intr == LAN80XX_HOST_PMAC_TX_ABORT_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_PMAC_MAC_STICKY_MASK_PMAC_TX_ABORT_STICKY_MASK : 0);
    }
                                         ...
                                         mepa_bool_t           enable)
{
    ...
    if (is_line) {
        /* LINE PCS 1G */
        mask = ((intr == LAN80XX_LINE_PCS1G_LINK_DOWN_INTR) ? LAN80XX_M_LINE_PCS_CFG_PCS1G_STICKY_MASK_LINK_DOWN_STICKY_INTR_EN : 0)    |
               ((intr == LAN80XX_LINE_PCS1G_OUT_OF_SYNC_INTR) ? LAN80XX_M_LINE_PCS_CFG_PCS1G_STICKY_MASK_OUT_OF_SYNC_STICKY_INTR_EN : 0);
    ...
    /* HOST PCS1G */
    mask = ((intr == LAN80XX_HOST_PCS1G_LINK_DOWN_INTR) ? LAN80XX_M_HOST_PCS_CFG_PCS1G_STICKY_MASK_LINK_DOWN_STICKY_INTR_EN : 0) |
           ((intr == LAN80XX_HOST_PCS1G_OUT_OF_SYNC_INTR) ?  LAN80XX_M_HOST_PCS_CFG_PCS1G_STICKY_MASK_OUT_OF_SYNC_STICKY_INTR_EN : 0);
                                          ...
                                          phy25g_events_t       *const evt)
{
    ...
    if (is_line) {
        mask = (((intr == LAN80XX_LINE_PCS25G_ALIGN_DONE_INTR) ? LAN80XX_M_LINE_PCS_CFG_PCS25G_STICKY_SIG_ALIGN_DONE_STICKY : 0) |
                ((intr  == LAN80XX_LINE_PCS25G_BLOCK_LOCK_INTR) ? LAN80XX_M_LINE_PCS_CFG_PCS25G_STICKY_SIG_BLOCK_LOCK_STICKY : 0) |
                ((intr  == LAN80XX_LINE_PCS25G_HI_BER_INTR) ? LAN80XX_M_LINE_PCS_CFG_PCS25G_STICKY_SIG_HI_BER_STICKY  : 0));

        io_reg = LAN80XX_LINE_PCS_CFG_PCS25G_STICKY_SIG;
    } else {
        mask = (((intr == LAN80XX_HOST_PCS25G_ALIGN_DONE_INTR) ? LAN80XX_M_HOST_PCS_CFG_PCS25G_STICKY_SIG_ALIGN_DONE_STICKY : 0) |
                ((intr  == LAN80XX_HOST_PCS25G_BLOCK_LOCK_INTR) ? LAN80XX_M_HOST_PCS_CFG_PCS25G_STICKY_SIG_BLOCK_LOCK_STICKY : 0) |
                ((intr  == LAN80XX_HOST_PCS25G_HI_BER_INTR) ? LAN80XX_M_HOST_PCS_CFG_PCS25G_STICKY_SIG_HI_BER_STICKY : 0));
                                          ...
                                          mepa_bool_t           enable)
{
    ...
    if (is_line) {
        /* Line PCS 25G */
        mask = ((intr == LAN80XX_LINE_PCS25G_ALIGN_DONE_INTR) ? LAN80XX_M_LINE_PCS_CFG_PCS25G_STICKY_SIG_MASK_ALIGN_DONE_STICKY_MASK : 0) |
               ((intr == LAN80XX_LINE_PCS25G_BLOCK_LOCK_INTR) ? LAN80XX_M_LINE_PCS_CFG_PCS25G_STICKY_SIG_MASK_BLOCK_LOCK_STICKY_MASK : 0) |
               ((intr == LAN80XX_LINE_PCS25G_HI_BER_INTR) ? LAN80XX_M_LINE_PCS_CFG_PCS25G_STICKY_SIG_MASK_HI_BER_STICKY_MASK : 0);
    ...
    /* HOST PCS 25G */
    mask = ((intr == LAN80XX_HOST_PCS25G_ALIGN_DONE_INTR) ? LAN80XX_M_HOST_PCS_CFG_PCS25G_STICKY_SIG_MASK_ALIGN_DONE_STICKY_MASK : 0) |
           ((intr == LAN80XX_HOST_PCS25G_BLOCK_LOCK_INTR) ? LAN80XX_M_HOST_PCS_CFG_PCS25G_STICKY_SIG_MASK_BLOCK_LOCK_STICKY_MASK : 0) |
           ((intr == LAN80XX_HOST_PCS25G_HI_BER_INTR) ? LAN80XX_M_HOST_PCS_CFG_PCS25G_STICKY_SIG_MASK_HI_BER_STICKY_MASK : 0);
                                      ...
                                      phy25g_events_t       *const evt)
{
    ...
    if (is_line) {
        mask = (((intr == LAN80XX_LINE_MAC_TX_ABORT_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_TX_ABORT_STICKY : 0)     |
                ((intr == LAN80XX_LINE_MAC_TX_UNDERFLOW_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_TX_UFLW_STICKY : 0)   |
                ((intr == LAN80XX_LINE_MAC_RX_TAG_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_RX_TAG_STICKY : 0)          |
                ((intr == LAN80XX_LINE_MAC_RX_MPLS_UC_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_RX_MPLS_UC_STICKY : 0)  |
                ((intr == LAN80XX_LINE_MAC_RX_MPLS_MC_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_RX_MPLS_MC_STICKY : 0)  |
                ((intr == LAN80XX_LINE_MAC_RX_NON_STD_PREAMBLE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_RX_NON_STD_PREAM_STICKY : 0)   |
                ((intr == LAN80XX_LINE_MAC_RX_PREAM_ERR_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_RX_PREAM_ERR_STICKY : 0)              |
                ((intr == LAN80XX_LINE_MAC_RX_PREAMBLE_MISMATCH_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_RX_PREAM_MISMATCH_STICKY : 0) |
                ((intr == LAN80XX_LINE_MAC_RX_PREAMBLE_SHRINK_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_RX_PREAM_SHRINK_STICKY : 0)     |
                ((intr == LAN80XX_LINE_MAC_RX_IPG_SHRINK_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_RX_IPG_SHRINK_STICKY : 0));

        io_reg = LAN80XX_LINE_MAC_LINE_MAC_MAC_STICKY;
    } else {
        mask = (((intr == LAN80XX_HOST_MAC_TX_ABORT_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_TX_ABORT_STICKY : 0)       |
                ((intr == LAN80XX_HOST_MAC_TX_UNDERFLOW_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_TX_UFLW_STICKY : 0)    |
                ((intr == LAN80XX_HOST_MAC_RX_TAG_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_RX_TAG_STICKY : 0)           |
                ((intr == LAN80XX_HOST_MAC_RX_MPLS_UC_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_RX_MPLS_UC_STICKY : 0)   |
                ((intr == LAN80XX_HOST_MAC_RX_MPLS_MC_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_RX_MPLS_MC_STICKY : 0)   |
                ((intr == LAN80XX_HOST_MAC_RX_NON_STD_PREAMBLE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_RX_NON_STD_PREAM_STICKY : 0)   |
                ((intr == LAN80XX_HOST_MAC_RX_PREAM_ERR_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_RX_PREAM_ERR_STICKY : 0)              |
                ((intr == LAN80XX_HOST_MAC_RX_PREAMBLE_MISMATCH_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_RX_PREAM_MISMATCH_STICKY : 0) |
                ((intr == LAN80XX_HOST_MAC_RX_PREAMBLE_SHRINK_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_RX_PREAM_SHRINK_STICKY : 0)     |
                ((intr == LAN80XX_HOST_MAC_RX_IPG_SHRINK_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_RX_IPG_SHRINK_STICKY : 0));
                                      ...
                                      mepa_bool_t           enable)
{
    ...
    if (is_line) {
        /* LINE MAC Interrupts */
        mask = ((intr == LAN80XX_LINE_MAC_TX_ABORT_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_MASK_TX_ABORT_STICKY_MASK : 0)         |
               ((intr == LAN80XX_LINE_MAC_TX_UNDERFLOW_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_MASK_TX_UFLW_STICKY_MASK : 0)      |
               ((intr == LAN80XX_LINE_MAC_RX_TAG_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_MASK_RX_TAG_STICKY_MASK : 0)             |
               ((intr == LAN80XX_LINE_MAC_RX_MPLS_UC_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_MASK_RX_MPLS_UC_STICKY_MASK : 0)     |
               ((intr == LAN80XX_LINE_MAC_RX_MPLS_MC_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_MASK_RX_MPLS_MC_STICKY_MASK : 0)     |
               ((intr == LAN80XX_LINE_MAC_RX_NON_STD_PREAMBLE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_MASK_RX_NON_STD_PREAM_STICKY_MASK : 0)   |
               ((intr == LAN80XX_LINE_MAC_RX_PREAM_ERR_INTR) ?  LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_MASK_RX_PREAM_ERR_STICKY_MASK : 0)             |
               ((intr == LAN80XX_LINE_MAC_RX_PREAMBLE_MISMATCH_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_MASK_RX_PREAM_MISMATCH_STICKY_MASK : 0) |
               ((intr == LAN80XX_LINE_MAC_RX_PREAMBLE_SHRINK_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_MASK_RX_PREAM_SHRINK_STICKY_MASK : 0)     |
               ((intr == LAN80XX_LINE_MAC_RX_IPG_SHRINK_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_STICKY_MASK_RX_IPG_SHRINK_STICKY_MASK : 0);
    ...
    /* HOST MAC Interrupts */
    mask = ((intr == LAN80XX_HOST_MAC_TX_ABORT_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_MASK_TX_ABORT_STICKY_MASK : 0)         |
           ((intr == LAN80XX_HOST_MAC_TX_UNDERFLOW_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_MASK_TX_UFLW_STICKY_MASK : 0)      |
           ((intr == LAN80XX_HOST_MAC_RX_TAG_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_MASK_RX_TAG_STICKY_MASK : 0)             |
           ((intr == LAN80XX_HOST_MAC_RX_MPLS_UC_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_MASK_RX_MPLS_UC_STICKY_MASK : 0)     |
           ((intr == LAN80XX_HOST_MAC_RX_MPLS_MC_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_MASK_RX_MPLS_MC_STICKY_MASK : 0)     |
           ((intr == LAN80XX_HOST_MAC_RX_NON_STD_PREAMBLE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_MASK_RX_NON_STD_PREAM_STICKY_MASK : 0)   |
           ((intr == LAN80XX_HOST_MAC_RX_PREAM_ERR_INTR) ?  LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_MASK_RX_PREAM_ERR_STICKY_MASK : 0)             |
           ((intr == LAN80XX_HOST_MAC_RX_PREAMBLE_MISMATCH_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_MASK_RX_PREAM_MISMATCH_STICKY_MASK : 0) |
           ((intr == LAN80XX_HOST_MAC_RX_PREAMBLE_SHRINK_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_MASK_RX_PREAM_SHRINK_STICKY_MASK : 0)     |
           ((intr == LAN80XX_HOST_MAC_RX_IPG_SHRINK_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_STICKY_MASK_RX_IPG_SHRINK_STICKY_MASK : 0);
                                                 ...
                                                 phy25g_events_t       *const evt)
{
    ...
    if (is_line) {
        mask = ((intr == LAN80XX_LINE_MAC_DIS_STATE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_TX_MONITOR_STICKY_DIS_STATE_STICKY : 0)       |
               ((intr == LAN80XX_LINE_MAC_IDLE_STATE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_TX_MONITOR_STICKY_IDLE_STATE_STICKY : 0)     |
               ((intr == LAN80XX_LINE_MAC_REMOTE_ERR_STATE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_TX_MONITOR_STICKY_REMOTE_ERR_STATE_STICKY : 0) |
               ((intr == LAN80XX_LINE_MAC_LOCAL_ERR_STATE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_TX_MONITOR_STICKY_LOCAL_ERR_STATE_STICKY : 0);

        io_reg = LAN80XX_LINE_MAC_LINE_MAC_MAC_TX_MONITOR_STICKY;
    } else {
        mask = ((intr == LAN80XX_HOST_MAC_DIS_STATE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_TX_MONITOR_STICKY_DIS_STATE_STICKY : 0)       |
               ((intr == LAN80XX_HOST_MAC_IDLE_STATE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_TX_MONITOR_STICKY_IDLE_STATE_STICKY : 0)     |
               ((intr == LAN80XX_HOST_MAC_REMOTE_ERR_STATE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_TX_MONITOR_STICKY_REMOTE_ERR_STATE_STICKY : 0) |
               ((intr == LAN80XX_HOST_MAC_LOCAL_ERR_STATE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_TX_MONITOR_STICKY_LOCAL_ERR_STATE_STICKY : 0);
...

{
    ...
    if (is_line) {
        ...
        mask = ((intr == LAN80XX_LINE_MAC_DIS_STATE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_TX_MONITOR_STICKY_MASK_DIS_STATE_STICKY_MASK : 0) |
               ((intr == LAN80XX_LINE_MAC_IDLE_STATE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_TX_MONITOR_STICKY_MASK_IDLE_STATE_STICKY_MASK : 0) |
               ((intr == LAN80XX_LINE_MAC_REMOTE_ERR_STATE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_TX_MONITOR_STICKY_MASK_REMOTE_ERR_STATE_STICKY_MASK : 0) |
               ((intr == LAN80XX_LINE_MAC_LOCAL_ERR_STATE_INTR) ? LAN80XX_M_LINE_MAC_LINE_MAC_MAC_TX_MONITOR_STICKY_MASK_LOCAL_ERR_STATE_STICKY_MASK : 0);
    ...
    mask = ((intr == LAN80XX_HOST_MAC_DIS_STATE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_TX_MONITOR_STICKY_MASK_DIS_STATE_STICKY_MASK : 0) |
           ((intr == LAN80XX_HOST_MAC_IDLE_STATE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_TX_MONITOR_STICKY_MASK_IDLE_STATE_STICKY_MASK : 0) |
           ((intr == LAN80XX_HOST_MAC_REMOTE_ERR_STATE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_TX_MONITOR_STICKY_MASK_REMOTE_ERR_STATE_STICKY_MASK : 0) |
           ((intr == LAN80XX_HOST_MAC_LOCAL_ERR_STATE_INTR) ? LAN80XX_M_HOST_MAC_HOST_MAC_MAC_TX_MONITOR_STICKY_MASK_LOCAL_ERR_STATE_STICKY_MASK : 0);
                                          ...
                                          phy25g_events_t       *const evt)
{
    ...
    if (is_l2h) {
        mask = (((intr == LAN80XX_L2H_RA_FIFO_UNDERFLOW_INTR) ? LAN80XX_M_LINE_SLICE_L2H_RA_FIFO_STATUS_L2H_RA_FIFO_UNDERFLOW : 0) |
                ((intr == LAN80XX_L2H_RA_FIFO_OVERFLOW_INTR) ? LAN80XX_M_LINE_SLICE_L2H_RA_FIFO_STATUS_L2H_RA_FIFO_OVERFLOW : 0));

        io_reg = LAN80XX_LINE_SLICE_L2H_RA_FIFO_STATUS;
    } else {
        mask = (((intr == LAN80XX_H2L_RA_FIFO_UNDERFLOW_INTR) ? LAN80XX_M_LINE_SLICE_H2L_RA_FIFO_STATUS_H2L_RA_FIFO_UNDERFLOW : 0) |
                ((intr == LAN80XX_H2L_RA_FIFO_OVERFLOW_INTR) ? LAN80XX_M_LINE_SLICE_H2L_RA_FIFO_STATUS_H2L_RA_FIFO_OVERFLOW : 0));
                                          ...
                                          mepa_bool_t           enable)
{
    ...
    if (is_l2h) {
        /* L2H Interrupt */
        mask = ((intr == LAN80XX_L2H_RA_FIFO_UNDERFLOW_INTR) ? LAN80XX_M_LINE_SLICE_L2H_RA_FIFO_INT_MASK_L2H_RA_FIFO_UNDERFLOW_INTR_EN : 0) |
               ((intr == LAN80XX_L2H_RA_FIFO_OVERFLOW_INTR) ? LAN80XX_M_LINE_SLICE_L2H_RA_FIFO_INT_MASK_L2H_RA_FIFO_OVERFLOW_INTR_EN : 0);
    ...
    mask = ((intr == LAN80XX_H2L_RA_FIFO_UNDERFLOW_INTR) ? LAN80XX_M_LINE_SLICE_H2L_RA_FIFO_INT_MASK_H2L_RA_FIFO_UNDERFLOW_INTR_EN : 0) |
           ((intr == LAN80XX_H2L_RA_FIFO_OVERFLOW_INTR) ? LAN80XX_M_LINE_SLICE_H2L_RA_FIFO_INT_MASK_H2L_RA_FIFO_OVERFLOW_INTR_EN : 0);
                                              ...
                                              phy25g_events_t       *const evt)
{
    ...
    mask = ((intr == LAN80XX_XOFF_PAUSE_GEN_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_XOFF_PAUSE_GEN_STICKY_MASK : 0) |
           ((intr == LAN80XX_XON_PAUSE_GEN_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_XON_PAUSE_GEN_STICKY_MASK : 0)   |
           ((intr == LAN80XX_TX_UNCORRECTED_FRM_DROP_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_TX_UNCORRECTED_FRM_DROP_STICKY_MASK : 0) |
           ((intr == LAN80XX_RX_UNCORRECTED_FRM_DROP_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_RX_UNCORRECTED_FRM_DROP_STICKY_MASK : 0) |
           ((intr == LAN80XX_TX_CTRL_QUEUE_OVERFLOW_DROP_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_TX_CTRL_QUEUE_OVERFLOW_DROP_STICKY_MASK : 0) |
           ((intr == LAN80XX_TX_CTRL_QUEUE_UNDERFLOW_DROP_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_TX_CTRL_QUEUE_UNDERFLOW_DROP_STICKY_MASK : 0) |
           ((intr == LAN80XX_TX_DATA_QUEUE_OVERFLOW_DROP_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_TX_DATA_QUEUE_OVERFLOW_DROP_STICKY_MASK : 0) |
           ((intr == LAN80XX_TX_DATA_QUEUE_UNDERFLOW_DROP_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_TX_DATA_QUEUE_UNDERFLOW_DROP_STICKY_MASK : 0) |
           ((intr == LAN80XX_RX_OVERFLOW_DROP_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_RX_OVERFLOW_DROP_STICKY_MASK : 0)              |
           ((intr == LAN80XX_RX_UNDERFLOW_DROP_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_RX_UNDERFLOW_DROP_STICKY_MASK : 0)            |
           ((intr == LAN80XX_INGR_ECC_INTERRUPT_STATUS_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_INGR_ECC_INTERRUPT_STATUS_MASK : 0)   |
           ((intr == LAN80XX_EGR_ECC_INTERRUPT_STATUS_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_EGR_ECC_INTERRUPT_STATUS_MASK : 0);
                                                ...
                                                mepa_bool_t           enable)
{
    ...
    mask = ((intr == LAN80XX_TX_DATA_QUEUE_OVERFLOW_DROP_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_TX_DATA_QUEUE_OVERFLOW_DROP_STICKY_MASK : 0) |
           ((intr == LAN80XX_TX_DATA_QUEUE_UNDERFLOW_DROP_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_TX_DATA_QUEUE_UNDERFLOW_DROP_STICKY_MASK : 0) |
           ((intr == LAN80XX_RX_OVERFLOW_DROP_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_RX_OVERFLOW_DROP_STICKY_MASK : 0)              |
           ((intr == LAN80XX_RX_UNDERFLOW_DROP_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_RX_UNDERFLOW_DROP_STICKY_MASK : 0)            |
           ((intr == LAN80XX_INGR_ECC_INTERRUPT_STATUS_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_STICKY_MASK_INGR_ECC_INTERRUPT_STATUS_MASK : 0)   |
                                             ...
                                             phy25g_events_t       *const evt)
{
    ...
    ioreg_blk *io_reg;
    if (is_egr) {
        mask = ((intr == LAN80XX_EGR_FC_BUFFER_FAULT_READ) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_EGR_FC_BUFFER_ECC_INTR_STS_EGR_FC_BUFFER_FAULT_READ_INTR_STICKY : 0) |
               ((intr == LAN80XX_EGR_FC_BUFFER_SEC_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_EGR_FC_BUFFER_ECC_INTR_STS_EGR_FC_BUFFER_SEC_INTR_STICKY : 0)   |
               ((intr == LAN80XX_EGR_FC_BUFFER_DED_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_EGR_FC_BUFFER_ECC_INTR_STS_EGR_FC_BUFFER_DED_INTR_STICKY : 0);

        io_reg = LAN80XX_MAC_FC_BUFFER_MAC_FC_BUFFER_EGR_FC_BUFFER_ECC_INTR_STS;
    } else {
        mask = ((intr == LAN80XX_INGR_FC_BUFFER_FAULT_READ_INTR) ?
                LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_INGR_FC_BUFFER_ECC_INTR_STS_INGR_FC_BUFFER_FAULT_READ_INTR_STICKY : 0) |
               ((intr == LAN80XX_INGR_FC_BUFFER_SEC_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_INGR_FC_BUFFER_ECC_INTR_STS_INGR_FC_BUFFER_SEC_INTR_STICKY : 0) |
               ((intr == LAN80XX_INGR_FC_BUFFER_DED_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_INGR_FC_BUFFER_ECC_INTR_STS_INGR_FC_BUFFER_DED_INTR_STICKY : 0);
                                             ...
                                             mepa_bool_t           enable)
{
    ...
    if (is_egr) {
        mask = ((intr == LAN80XX_EGR_FC_BUFFER_FAULT_READ) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_EGR_FC_BUFFER_ECC_INTR_EN_EGR_FC_BUFFER_FAULT_READ_INTR_EN : 0) |
               ((intr == LAN80XX_EGR_FC_BUFFER_SEC_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_EGR_FC_BUFFER_ECC_INTR_EN_EGR_FC_BUFFER_SEC_INTR_EN : 0)   |
               ((intr == LAN80XX_EGR_FC_BUFFER_DED_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_EGR_FC_BUFFER_ECC_INTR_EN_EGR_FC_BUFFER_DED_INTR_EN : 0);
    ...
    mask = ((intr == LAN80XX_INGR_FC_BUFFER_FAULT_READ_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_INGR_FC_BUFFER_ECC_INTR_EN_INGR_FC_BUFFER_FAULT_READ_INTR_EN : 0) |
           ((intr == LAN80XX_INGR_FC_BUFFER_SEC_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_INGR_FC_BUFFER_ECC_INTR_EN_INGR_FC_BUFFER_SEC_INTR_EN : 0) |
           ((intr == LAN80XX_INGR_FC_BUFFER_DED_INTR) ? LAN80XX_M_MAC_FC_BUFFER_MAC_FC_BUFFER_INGR_FC_BUFFER_ECC_INTR_EN_INGR_FC_BUFFER_DED_INTR_EN : 0);
