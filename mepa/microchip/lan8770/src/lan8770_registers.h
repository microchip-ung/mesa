...
#define LAN8770_MISC_WKP_COM_CTL0_WK_OUT_AUTO_FWD_EN        LAN8770_BIT(7) /* Wake Out Auto-Forwarding Enable */
#define LAN8770_MISC_WKP_COM_CTL0_WK_IN_POL_ACTIVE_LOW      LAN8770_BIT(12)
#define LAN8770_MISC_WKP_COM_CTL0_WK_OUT_POL_ACTIVE_LOW     LAN8770_BIT(11)
#define LAN8770_MISC_WKP_COM_CTL0_WK_OUT_MODE_SET(x)        LAN8770_ENCODE_BITFIELD(x, 9, 2)
#define LAN8770_MISC_WKP_COM_CTL0_WK_OUT_MODE_PUSH_PULL     (0)
#define LAN8770_MISC_WKP_COM_CTL0_WK_OUT_MODE_OPEN_SOURCE   (1)
#define LAN8770_MISC_WKP_COM_CTL0_WK_OUT_MODE_OPEN_DRAIN    (2)
#define LAN8770_MISC_WKP_COM_CTL0_INH_MODE_OPEN_DRAIN       LAN8770_BIT(8)
...
#define LAN8770_MISC_WKP_DBG_STS_TC10_STATE_START           (0)
#define LAN8770_MISC_WKP_DBG_STS_TC10_STATE_NORMAL          (1)
#define LAN8770_MISC_WKP_DBG_STS_TC10_STATE_SLEEP_ACK       (2)
#define LAN8770_MISC_WKP_DBG_STS_TC10_STATE_SLEEP_REQ       (3)
#define LAN8770_MISC_WKP_DBG_STS_TC10_STATE_SLEEP_FAIL      (4)
#define LAN8770_MISC_WKP_DBG_STS_TC10_STATE_SLEEP_SILENT    (5)
#define LAN8770_MISC_WKP_DBG_STS_TC10_STATE_SLEEP           (6)
...
#define LAN8770_MISC_WKP_PTR_CTL1_WUP_AUTO_FWD_EN    LAN8770_BIT(12)
...
#define LAN8770_PCS_SLEEP_WAKE_CTL_OFFSET   (0x1B)      /* Sleep Wake Control Register */
#define LAN8770_PCS_SLEEP_WAKE_CTL_SLEEP_REJECT_EN LAN8770_BIT(4)
