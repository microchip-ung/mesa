 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_ETH1_NXT_PROTOCOL_A_ETH1_NXT_PROTOCOL_A . ETH1_FRAME_SIG_OFFSET_A
 */
#define  VTSS_F_ANA_OAM_ETH1_NXT_PROTOCOL_A_ETH1_NXT_PROTOCOL_A_ETH1_FRAME_SIG_OFFSET_A(x)  VTSS_ENCODE_BITFIELD(x,16,5)
#define  VTSS_M_ANA_OAM_ETH1_NXT_PROTOCOL_A_ETH1_NXT_PROTOCOL_A_ETH1_FRAME_SIG_OFFSET_A     VTSS_ENCODE_BITMASK(16,5)
#define  VTSS_X_ANA_OAM_ETH1_NXT_PROTOCOL_A_ETH1_NXT_PROTOCOL_A_ETH1_FRAME_SIG_OFFSET_A(x)  VTSS_EXTRACT_BITFIELD(x,16,5)
 ...
 *
 * Field: VTSS_ANA_OAM_ETH1_NXT_PROTOCOL_A_ETH1_ETYPE_MATCH_A . ETH1_ETYPE_MATCH_ENA_A
 */
#define  VTSS_F_ANA_OAM_ETH1_NXT_PROTOCOL_A_ETH1_ETYPE_MATCH_A_ETH1_ETYPE_MATCH_ENA_A  VTSS_BIT(16)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_ETH1_NXT_PROTOCOL_B_ETH1_NXT_PROTOCOL_B . ETH1_FRAME_SIG_OFFSET_B
 */
#define  VTSS_F_ANA_OAM_ETH1_NXT_PROTOCOL_B_ETH1_NXT_PROTOCOL_B_ETH1_FRAME_SIG_OFFSET_B(x)  VTSS_ENCODE_BITFIELD(x,16,5)
#define  VTSS_M_ANA_OAM_ETH1_NXT_PROTOCOL_B_ETH1_NXT_PROTOCOL_B_ETH1_FRAME_SIG_OFFSET_B     VTSS_ENCODE_BITMASK(16,5)
#define  VTSS_X_ANA_OAM_ETH1_NXT_PROTOCOL_B_ETH1_NXT_PROTOCOL_B_ETH1_FRAME_SIG_OFFSET_B(x)  VTSS_EXTRACT_BITFIELD(x,16,5)
 ...
 * \brief
 * This bit enables the presence of PBB.
 * The I-tag match bits are programmed in the ETH1_VLAN_TAG_RANGE registers. The mask bits are progrogrammed in the ETH1_VLAN_TAG2
 * registers. A B-tag if present is configured in the ETH1_VLAN_TAG1 registers.
 *
 * \details
 * 0: PBB not enabled
 * 1: Always expect PBB, last tag is always an I-tag
 ...
 * 1: Enable Ethertype verification
 *
 * Field: VTSS_ANA_OAM_ETH1_NXT_PROTOCOL_B_ETH1_ETYPE_MATCH_B . ETH1_ETYPE_MATCH_ENA_B
 */
#define  VTSS_F_ANA_OAM_ETH1_NXT_PROTOCOL_B_ETH1_ETYPE_MATCH_B_ETH1_ETYPE_MATCH_ENA_B  VTSS_BIT(16)
...
/**
 * \brief
 * Indicates which next-protocol configuration group is valid with this flow
 *
 * \details
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_ETH2_NXT_PROTOCOL_A_ETH2_NXT_PROTOCOL_A . ETH2_FRAME_SIG_OFFSET_A
 */
#define  VTSS_F_ANA_OAM_ETH2_NXT_PROTOCOL_A_ETH2_NXT_PROTOCOL_A_ETH2_FRAME_SIG_OFFSET_A(x)  VTSS_ENCODE_BITFIELD(x,16,5)
#define  VTSS_M_ANA_OAM_ETH2_NXT_PROTOCOL_A_ETH2_NXT_PROTOCOL_A_ETH2_FRAME_SIG_OFFSET_A     VTSS_ENCODE_BITMASK(16,5)
#define  VTSS_X_ANA_OAM_ETH2_NXT_PROTOCOL_A_ETH2_NXT_PROTOCOL_A_ETH2_FRAME_SIG_OFFSET_A(x)  VTSS_EXTRACT_BITFIELD(x,16,5)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_ETH2_NXT_PROTOCOL_A_ETH2_ETYPE_MATCH_A . ETH2_ETYPE_MATCH_ENA_A
 */
#define  VTSS_F_ANA_OAM_ETH2_NXT_PROTOCOL_A_ETH2_ETYPE_MATCH_A_ETH2_ETYPE_MATCH_ENA_A  VTSS_BIT(16)
 ...
 * \details
 * 0: Only Ethernet type II supported, no SNAP/LLC
 * 1: Ethernet type II and Ethernet type I with SNAP/LLC, determine if SNAP/LLC is present. Type I always assumes that SNAP/LLC is present
 *
 ...
 * MPLS_REF_PNT. The following table maps bits to stack depths:
 *
 * \details
...
/**
 * \brief
 * Indicates which next protocol groups that this flow is valid for. For each next protocol group, if the bit is 1, then this flow is valid
 * for that goup. If it is 0, then it is not valid for the group.
 *
 * \details
 ...
 *
 * \details
 * 0: Do not signal the rewriter to update the value of the Modified Frame Status bit
 * 1: Signal the rewriter to update the value of the Modified Frame Status bit
 *
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_PTP_FLOW_PTP_ZERO_FIELD_CTL . PTP_RSVD_CHK_EN
 */
#define  VTSS_F_ANA_OAM_PTP_FLOW_PTP_ZERO_FIELD_CTL_PTP_RSVD_CHK_EN  VTSS_BIT(14)
...
/**
 * Register Group: \a ANA_OAM:FRAME_SIG_CFG
 *
 ...
 *
 * \details
 * Register: \a ANA_OAM:FRAME_SIG_CFG:FSB_CFG
 *
 * @param target A \a ::vtss_target_ANA_OAM_e target
 */
#define VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_CFG   VTSS_IOREG(0x240)
 ...
 * 3: Reserved
 *
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_CFG . FSB_ADR_SEL
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_CFG_FSB_ADR_SEL(x)  VTSS_ENCODE_BITFIELD(x,0,2)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_CFG_FSB_ADR_SEL     VTSS_ENCODE_BITMASK(0,2)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_CFG_FSB_ADR_SEL(x)  VTSS_EXTRACT_BITFIELD(x,0,2)
 ...
 *
 * Register: \a ANA_OAM:FRAME_SIG_CFG:FSB_MAP_REG_0
 *
 * @param target A \a ::vtss_target_ANA_OAM_e target
 */
#define VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0  VTSS_IOREG(0x241)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0 . FSB_MAP_4
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_4(x)  VTSS_ENCODE_BITFIELD(x,24,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_4     VTSS_ENCODE_BITMASK(24,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_4(x)  VTSS_EXTRACT_BITFIELD(x,24,6)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0 . FSB_MAP_3
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_3(x)  VTSS_ENCODE_BITFIELD(x,18,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_3     VTSS_ENCODE_BITMASK(18,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_3(x)  VTSS_EXTRACT_BITFIELD(x,18,6)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0 . FSB_MAP_2
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_2(x)  VTSS_ENCODE_BITFIELD(x,12,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_2     VTSS_ENCODE_BITMASK(12,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_2(x)  VTSS_EXTRACT_BITFIELD(x,12,6)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0 . FSB_MAP_1
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_1(x)  VTSS_ENCODE_BITFIELD(x,6,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_1     VTSS_ENCODE_BITMASK(6,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_1(x)  VTSS_EXTRACT_BITFIELD(x,6,6)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0 . FSB_MAP_0
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_0(x)  VTSS_ENCODE_BITFIELD(x,0,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_0     VTSS_ENCODE_BITMASK(0,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_0_FSB_MAP_0(x)  VTSS_EXTRACT_BITFIELD(x,0,6)
 ...
 *
 * \details
 * Register: \a ANA_OAM:FRAME_SIG_CFG:FSB_MAP_REG_1
 *
 * @param target A \a ::vtss_target_ANA_OAM_e target
 */
#define VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1  VTSS_IOREG(0x242)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1 . FSB_MAP_9
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_9(x)  VTSS_ENCODE_BITFIELD(x,24,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_9     VTSS_ENCODE_BITMASK(24,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_9(x)  VTSS_EXTRACT_BITFIELD(x,24,6)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1 . FSB_MAP_8
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_8(x)  VTSS_ENCODE_BITFIELD(x,18,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_8     VTSS_ENCODE_BITMASK(18,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_8(x)  VTSS_EXTRACT_BITFIELD(x,18,6)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1 . FSB_MAP_7
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_7(x)  VTSS_ENCODE_BITFIELD(x,12,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_7     VTSS_ENCODE_BITMASK(12,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_7(x)  VTSS_EXTRACT_BITFIELD(x,12,6)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1 . FSB_MAP_6
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_6(x)  VTSS_ENCODE_BITFIELD(x,6,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_6     VTSS_ENCODE_BITMASK(6,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_6(x)  VTSS_EXTRACT_BITFIELD(x,6,6)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1 . FSB_MAP_5
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_5(x)  VTSS_ENCODE_BITFIELD(x,0,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_5     VTSS_ENCODE_BITMASK(0,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_1_FSB_MAP_5(x)  VTSS_EXTRACT_BITFIELD(x,0,6)
 ...
 *
 * \details
 * Register: \a ANA_OAM:FRAME_SIG_CFG:FSB_MAP_REG_2
 *
 * @param target A \a ::vtss_target_ANA_OAM_e target
 */
#define VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2  VTSS_IOREG(0x243)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2 . FSB_MAP_14
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_14(x)  VTSS_ENCODE_BITFIELD(x,24,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_14     VTSS_ENCODE_BITMASK(24,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_14(x)  VTSS_EXTRACT_BITFIELD(x,24,6)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2 . FSB_MAP_13
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_13(x)  VTSS_ENCODE_BITFIELD(x,18,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_13     VTSS_ENCODE_BITMASK(18,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_13(x)  VTSS_EXTRACT_BITFIELD(x,18,6)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2 . FSB_MAP_12
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_12(x)  VTSS_ENCODE_BITFIELD(x,12,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_12     VTSS_ENCODE_BITMASK(12,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_12(x)  VTSS_EXTRACT_BITFIELD(x,12,6)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2 . FSB_MAP_11
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_11(x)  VTSS_ENCODE_BITFIELD(x,6,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_11     VTSS_ENCODE_BITMASK(6,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_11(x)  VTSS_EXTRACT_BITFIELD(x,6,6)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2 . FSB_MAP_10
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_10(x)  VTSS_ENCODE_BITFIELD(x,0,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_10     VTSS_ENCODE_BITMASK(0,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_2_FSB_MAP_10(x)  VTSS_EXTRACT_BITFIELD(x,0,6)
 ...
 *
 * \details
 * Register: \a ANA_OAM:FRAME_SIG_CFG:FSB_MAP_REG_3
 *
 * @param target A \a ::vtss_target_ANA_OAM_e target
 */
#define VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_3  VTSS_IOREG(0x244)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_3 . FSB_MAP_15
 */
#define  VTSS_F_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_3_FSB_MAP_15(x)  VTSS_ENCODE_BITFIELD(x,0,6)
#define  VTSS_M_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_3_FSB_MAP_15     VTSS_ENCODE_BITMASK(0,6)
#define  VTSS_X_ANA_OAM_FRAME_SIG_CFG_FSB_MAP_REG_3_FSB_MAP_15(x)  VTSS_EXTRACT_BITFIELD(x,0,6)

/**
 * Register Group: \a ANA_OAM:ACH_COMPARATOR_A
 *
 ...
 *
 * Register: \a ANA_OAM:ACH_COMPARATOR_A:ACH_PROT_MATCH_UPPER_A
 *
 * @param target A \a ::vtss_target_ANA_OAM_e target
 */
#define VTSS_ANA_OAM_ACH_COMPARATOR_A_ACH_PROT_MATCH_UPPER_A  VTSS_IOREG(0x245)
 ...
 *
 * Register: \a ANA_OAM:ACH_COMPARATOR_A:ACH_PROT_MATCH_LOWER_A
 *
 * @param target A \a ::vtss_target_ANA_OAM_e target
 */
#define VTSS_ANA_OAM_ACH_COMPARATOR_A_ACH_PROT_MATCH_LOWER_A  VTSS_IOREG(0x246)
 ...
 *
 * Register: \a ANA_OAM:ACH_COMPARATOR_A:ACH_PROT_MASK_UPPER_A
 *
 * @param target A \a ::vtss_target_ANA_OAM_e target
 */
#define VTSS_ANA_OAM_ACH_COMPARATOR_A_ACH_PROT_MASK_UPPER_A  VTSS_IOREG(0x247)
 ...
 *
 * Register: \a ANA_OAM:ACH_COMPARATOR_A:ACH_PROT_MASK_LOWER_A
 *
 * @param target A \a ::vtss_target_ANA_OAM_e target
 */
#define VTSS_ANA_OAM_ACH_COMPARATOR_A_ACH_PROT_MASK_LOWER_A  VTSS_IOREG(0x248)
 ...
 *
 * Register: \a ANA_OAM:ACH_COMPARATOR_A:ACH_PROT_OFFSET_A
 *
 * @param target A \a ::vtss_target_ANA_OAM_e target
 */
#define VTSS_ANA_OAM_ACH_COMPARATOR_A_ACH_PROT_OFFSET_A  VTSS_IOREG(0x249)
 ...
 *
 * \details
 * Field: VTSS_ANA_OAM_ACH_COMPARATOR_A_ACH_PROT_OFFSET_A . ACH_NXT_PROTOCOL_A
 */
#define  VTSS_F_ANA_OAM_ACH_COMPARATOR_A_ACH_PROT_OFFSET_A_ACH_NXT_PROTOCOL_A(x)  VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_ANA_OAM_ACH_COMPARATOR_A_ACH_PROT_OFFSET_A_ACH_NXT_PROTOCOL_A     VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_ANA_OAM_ACH_COMPARATOR_A_ACH_PROT_OFFSET_A_ACH_NXT_PROTOCOL_A(x)  VTSS_EXTRACT_BITFIELD(x,0,8)

/**
 * \brief
 * Set to scan for ACH control word. This is mutually exclusive with mpls_ctl_word. Both can't be set at the same time
 *
 * \details
 * Field: VTSS_ANA_OAM_ACH_COMPARATOR_A_ACH_PROT_OFFSET_A . ACH_CTL_WORD_A
 */
#define  VTSS_F_ANA_OAM_ACH_COMPARATOR_A_ACH_PROT_OFFSET_A_ACH_CTL_WORD_A  VTSS_BIT(8)
