...
// LSD Source          : /home/p34x/p34x_chip/v_emouchel.priv.p34x_chip.registers/ipg_lsd/lsd_sys/source_32b/xml/reg_files/chip_interface/gpio_pdi_registers_def.xml
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO_DIR_RST 0x0000FC1Fu
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO_ALTSEL0_RST 0x0000FFF0u
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO_ALTSEL1_RST 0x0000FFF0u
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO_OD_RST 0x0000FFFFu
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO_PUDEN_RST 0x0000FFFFu
...
//! Field GPIO - GPIO Output Value
#define GPIO_PDI_REGISTERS_GPIO2_OUT_GPIO_MASK 0x3FFu
//! Constant LOW - LOW
#define CONST_GPIO_PDI_REGISTERS_GPIO2_OUT_GPIO_LOW 0x000u
//! Constant HIGH - HIGH
#define CONST_GPIO_PDI_REGISTERS_GPIO2_OUT_GPIO_HIGH 0x001u
...
//! Field GPIO - GPIO Input Value
#define GPIO_PDI_REGISTERS_GPIO2_IN_GPIO_MASK 0x3FFu
//! Constant LOW - LOW
#define CONST_GPIO_PDI_REGISTERS_GPIO2_IN_GPIO_LOW 0x000u
//! Constant HIGH - HIGH
#define CONST_GPIO_PDI_REGISTERS_GPIO2_IN_GPIO_HIGH 0x001u
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_DIR_RST 0x000003BFu

//! Field GPIO - GPIO Direction Control
#define GPIO_PDI_REGISTERS_GPIO2_DIR_GPIO_POS 0
//! Field GPIO - GPIO Direction Control
#define GPIO_PDI_REGISTERS_GPIO2_DIR_GPIO_MASK 0x3FFu
//! Constant IN - Input
#define CONST_GPIO_PDI_REGISTERS_GPIO2_DIR_GPIO_IN 0x000u
//! Constant OUT - Output
#define CONST_GPIO_PDI_REGISTERS_GPIO2_DIR_GPIO_OUT 0x001u
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_ALTSEL0_RST 0x000003FFu

//! Field GPIO - GPIO Alternate Function Selection LSB
#define GPIO_PDI_REGISTERS_GPIO2_ALTSEL0_GPIO_POS 0
//! Field GPIO - GPIO Alternate Function Selection LSB
#define GPIO_PDI_REGISTERS_GPIO2_ALTSEL0_GPIO_MASK 0x3FFu
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_ALTSEL1_RST 0x000003FFu

//! Field GPIO - GPIO Alternate Function Selection MSB
#define GPIO_PDI_REGISTERS_GPIO2_ALTSEL1_GPIO_POS 0
//! Field GPIO - GPIO Alternate Function Selection MSB
#define GPIO_PDI_REGISTERS_GPIO2_ALTSEL1_GPIO_MASK 0x3FFu
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_OD_RST 0x000003FFu

//! Field GPIO - GPIO Open Drain Mode
#define GPIO_PDI_REGISTERS_GPIO2_OD_GPIO_POS 0
//! Field GPIO - GPIO Open Drain Mode
#define GPIO_PDI_REGISTERS_GPIO2_OD_GPIO_MASK 0x3FFu
//! Constant OD - Open Drain Mode
#define CONST_GPIO_PDI_REGISTERS_GPIO2_OD_GPIO_OD 0x000u
//! Constant PP - Normal Mode
#define CONST_GPIO_PDI_REGISTERS_GPIO2_OD_GPIO_PP 0x001u
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_PUDSEL_RST 0x000003FFu

//! Field GPIO - GPIO Pull Up/Down Mode
#define GPIO_PDI_REGISTERS_GPIO2_PUDSEL_GPIO_POS 0
//! Field GPIO - GPIO Pull Up/Down Mode
#define GPIO_PDI_REGISTERS_GPIO2_PUDSEL_GPIO_MASK 0x3FFu
//! Constant PD - Pull Down
#define CONST_GPIO_PDI_REGISTERS_GPIO2_PUDSEL_GPIO_PD 0x000u
//! Constant PU - Pull Up
#define CONST_GPIO_PDI_REGISTERS_GPIO2_PUDSEL_GPIO_PU 0x001u
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_PUDEN_RST 0x000003FFu

//! Field GPIO - GPIO Pull Up/Down Enable
#define GPIO_PDI_REGISTERS_GPIO2_PUDEN_GPIO_POS 0
//! Field GPIO - GPIO Pull Up/Down Enable
#define GPIO_PDI_REGISTERS_GPIO2_PUDEN_GPIO_MASK 0x3FFu
//! Constant DIS - Disable
#define CONST_GPIO_PDI_REGISTERS_GPIO2_PUDEN_GPIO_DIS 0x000u
//! Constant EN - Enable
#define CONST_GPIO_PDI_REGISTERS_GPIO2_PUDEN_GPIO_EN 0x001u
...
//! Field PAD_VOL - GPIO PAD Voltage Supply Level
#define GPIO_PDI_REGISTERS_GPIO_VOL_CFG_PAD_VOL_MASK 0x7u
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_DRIVE0_CFG_RST 0x000003FFu

//! Field GPIO2 - GPIO2 PAD Drive Strength Bit 0
#define GPIO_PDI_REGISTERS_GPIO2_DRIVE0_CFG_GPIO2_POS 0
//! Field GPIO2 - GPIO2 PAD Drive Strength Bit 0
#define GPIO_PDI_REGISTERS_GPIO2_DRIVE0_CFG_GPIO2_MASK 0x3FFu
//! Constant V2MA - 2mA
#define CONST_GPIO_PDI_REGISTERS_GPIO2_DRIVE0_CFG_GPIO2_V2MA 0x000u
//! Constant V4MA - 4mA
#define CONST_GPIO_PDI_REGISTERS_GPIO2_DRIVE0_CFG_GPIO2_V4MA 0x001u
//! Constant V8MA - 8mA
#define CONST_GPIO_PDI_REGISTERS_GPIO2_DRIVE0_CFG_GPIO2_V8MA 0x002u
//! Constant V12MA - 12mA
#define CONST_GPIO_PDI_REGISTERS_GPIO2_DRIVE0_CFG_GPIO2_V12MA 0x003u
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_DRIVE1_CFG_RST 0x000003FFu

//! Field GPIO2 - GPIO2 PAD Drive Strength Bit 1
#define GPIO_PDI_REGISTERS_GPIO2_DRIVE1_CFG_GPIO2_POS 0
//! Field GPIO2 - GPIO2 PAD Drive Strength Bit 1
#define GPIO_PDI_REGISTERS_GPIO2_DRIVE1_CFG_GPIO2_MASK 0x3FFu
//! Constant V2MA - 2mA
#define CONST_GPIO_PDI_REGISTERS_GPIO2_DRIVE1_CFG_GPIO2_V2MA 0x000u
//! Constant V4MA - 4mA
#define CONST_GPIO_PDI_REGISTERS_GPIO2_DRIVE1_CFG_GPIO2_V4MA 0x001u
//! Constant V8MA - 8mA
#define CONST_GPIO_PDI_REGISTERS_GPIO2_DRIVE1_CFG_GPIO2_V8MA 0x002u
//! Constant V12MA - 12mA
#define CONST_GPIO_PDI_REGISTERS_GPIO2_DRIVE1_CFG_GPIO2_V12MA 0x003u
...
//! Register Reset Value
#define GPIO_PDI_REGISTERS_GPIO2_SLEW_CFG_RST 0x000003FFu

//! Field GPIO2 - GPIO PAD Slew Control
#define GPIO_PDI_REGISTERS_GPIO2_SLEW_CFG_GPIO2_POS 0
//! Field GPIO2 - GPIO PAD Slew Control
#define GPIO_PDI_REGISTERS_GPIO2_SLEW_CFG_GPIO2_MASK 0x3FFu
//! Constant SLOW - Slow
#define CONST_GPIO_PDI_REGISTERS_GPIO2_SLEW_CFG_GPIO2_SLOW 0x000u
//! Constant FAST - Fast
#define CONST_GPIO_PDI_REGISTERS_GPIO2_SLEW_CFG_GPIO2_FAST 0x001u
