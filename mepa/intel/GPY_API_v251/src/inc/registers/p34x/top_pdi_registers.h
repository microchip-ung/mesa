...
//! Field RES - res
#define TOP_STATUS_RES_POS 0
//! Field RES - res
#define TOP_STATUS_RES_MASK 0xFFFFu
...
//! Field MDINT_SLICE - Indicates which slice has asserted an MDINT
#define TOP_SLICE_IF_MDINT_SLICE_POS 0
//! Field MDINT_SLICE - Indicates which slice has asserted an MDINT
#define TOP_SLICE_IF_MDINT_SLICE_MASK 0x3u
//! Constant SLICE0 - Slice 0
#define CONST_TOP_SLICE_IF_MDINT_SLICE_SLICE0 0x0
//! Constant SLICE1 - Slice 1
#define CONST_TOP_SLICE_IF_MDINT_SLICE_SLICE1 0x1
//! Constant SLICE2 - Slice 2
#define CONST_TOP_SLICE_IF_MDINT_SLICE_SLICE2 0x2
//! Constant SLICE3 - Slice 3
#define CONST_TOP_SLICE_IF_MDINT_SLICE_SLICE3 0x3

//! Field IF_SLICE - Select Slice redirection of top interface
#define TOP_SLICE_IF_IF_SLICE_POS 2
//! Field IF_SLICE - Select Slice redirection of top interface
#define TOP_SLICE_IF_IF_SLICE_MASK 0xCu
//! Constant SLICE0 - Slice 0
...
#define TOP_SLICE_IF_MASTER_SLICE_POS 4
//! Field MASTER_SLICE - Master Slice Number
#define TOP_SLICE_IF_MASTER_SLICE_MASK 0x30u
//! Constant SLICE0 - Slice 0
#define CONST_TOP_SLICE_IF_MASTER_SLICE_SLICE0 0x0
//! Constant SLICE1 - Slice 1
#define CONST_TOP_SLICE_IF_MASTER_SLICE_SLICE1 0x1
//! Constant SLICE2 - Slice 2
#define CONST_TOP_SLICE_IF_MASTER_SLICE_SLICE2 0x2
//! Constant SLICE3 - Slice 3
#define CONST_TOP_SLICE_IF_MASTER_SLICE_SLICE3 0x3

//! Field LP_SLICE0 - LP status Slice 0
#define TOP_SLICE_IF_LP_SLICE0_POS 6
//! Field LP_SLICE0 - LP status Slice 0
#define TOP_SLICE_IF_LP_SLICE0_MASK 0x40u
//! Constant NORMAL - Slice is not in LP mode
#define CONST_TOP_SLICE_IF_LP_SLICE0_NORMAL 0x0
//! Constant LP - Slice is in LP mode
#define CONST_TOP_SLICE_IF_LP_SLICE0_LP 0x1

//! Field LP_SLICE1 - LP status Slice 1
#define TOP_SLICE_IF_LP_SLICE1_POS 7
//! Field LP_SLICE1 - LP status Slice 1
#define TOP_SLICE_IF_LP_SLICE1_MASK 0x80u
//! Constant NORMAL - Slice is not in LP mode
#define CONST_TOP_SLICE_IF_LP_SLICE1_NORMAL 0x0
//! Constant LP - Slice is in LP mode
#define CONST_TOP_SLICE_IF_LP_SLICE1_LP 0x1

//! Field LP_SLICE2 - LP status Slice 2
#define TOP_SLICE_IF_LP_SLICE2_POS 8
//! Field LP_SLICE2 - LP status Slice 2
#define TOP_SLICE_IF_LP_SLICE2_MASK 0x100u
//! Constant NORMAL - Slice is not in LP mode
#define CONST_TOP_SLICE_IF_LP_SLICE2_NORMAL 0x0
//! Constant LP - Slice is in LP mode
#define CONST_TOP_SLICE_IF_LP_SLICE2_LP 0x1

//! Field LP_SLICE3 - LP status Slice 3
#define TOP_SLICE_IF_LP_SLICE3_POS 9
//! Field LP_SLICE3 - LP status Slice 3
#define TOP_SLICE_IF_LP_SLICE3_MASK 0x200u
//! Constant NORMAL - Slice is not in LP mode
#define CONST_TOP_SLICE_IF_LP_SLICE3_NORMAL 0x0
//! Constant LP - Slice is in LP mode
#define CONST_TOP_SLICE_IF_LP_SLICE3_LP 0x1

//! Field LP_WAKE0 - Wake-up Slice 0 from LP
#define TOP_SLICE_IF_LP_WAKE0_POS 10
//! Field LP_WAKE0 - Wake-up Slice 0 from LP
#define TOP_SLICE_IF_LP_WAKE0_MASK 0x400u
...
#define TOP_SLICE_IF_LP_WAKE1_POS 11
//! Field LP_WAKE1 - Wake-up Slice 1 from LP
#define TOP_SLICE_IF_LP_WAKE1_MASK 0x800u
//! Constant NOWAKE - Wake-up event is not asserted
...
#define TOP_SLICE_IF_LP_WAKE2_POS 12
//! Field LP_WAKE2 - Wake-up Slice 2 from LP
#define TOP_SLICE_IF_LP_WAKE2_MASK 0x1000u
//! Constant NOWAKE - Wake-up event is not asserted
...
#define TOP_SLICE_IF_LP_WAKE3_POS 13
//! Field LP_WAKE3 - Wake-up Slice 3 from LP
#define TOP_SLICE_IF_LP_WAKE3_MASK 0x2000u
//! Constant NOWAKE - Wake-up event is not asserted
