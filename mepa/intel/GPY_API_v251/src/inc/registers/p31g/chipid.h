...
//! Field RES - RES
#define CHIPID_ID_CFG_RES_POS 4
//! Field RES - RES
#define CHIPID_ID_CFG_RES_MASK 0x10u

//! Field RES_FXVL - Reserved for FXVL
#define CHIPID_ID_CFG_RES_FXVL_POS 5
//! Field RES_FXVL - Reserved for FXVL
#define CHIPID_ID_CFG_RES_FXVL_MASK 0x7E0u
...
//! Field RES2 - Reserved
#define CHIPID_ID_CFG_RES2_POS 12
//! Field RES2 - Reserved
#define CHIPID_ID_CFG_RES2_MASK 0xF000u
...
//! Constant FXVL_LM - FXVL LM
#define CONST_CHIPID_CTRL_JTAG_ID_FXVL_LM 0x0
//! Constant P31G - Swanville SGMII
#define CONST_CHIPID_CTRL_JTAG_ID_P31G 0x1
//! Constant N31G - Swanville PCIe
#define CONST_CHIPID_CTRL_JTAG_ID_N31G 0x2
//! Constant FXVL_V - FXVL V
#define CONST_CHIPID_CTRL_JTAG_ID_FXVL_V 0x3

//! Field CHIP_LOCK - Locks the CHIPID register files in RO by firmware
#define CHIPID_CTRL_CHIP_LOCK_POS 2
//! Field CHIP_LOCK - Locks the CHIPID register files in RO by firmware
#define CHIPID_CTRL_CHIP_LOCK_MASK 0x4u
...
//! Field FXVL_FUSE_SEL - Selects the input of the CHIPID register load from OTP QRR
#define CHIPID_CTRL_FXVL_FUSE_SEL_POS 3
//! Field FXVL_FUSE_SEL - Selects the input of the CHIPID register load from OTP QRR
#define CHIPID_CTRL_FXVL_FUSE_SEL_MASK 0x8u
//! Constant QRR - FXVL CHIPID loaded from OTP QRR
#define CONST_CHIPID_CTRL_FXVL_FUSE_SEL_QRR 0x0
//! Constant FW - FXVL CHIPID write-able by FW
#define CONST_CHIPID_CTRL_FXVL_FUSE_SEL_FW 0x1
