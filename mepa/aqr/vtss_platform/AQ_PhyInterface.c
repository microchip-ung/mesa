...
{
    PHY_ID.dev->callout->mmd_write(PHY_ID.dev->callout_ctx, (uint16_t)MMD, (uint16_t)address, (uint16_t)data);
}
...
)
{
    ...
    PHY_ID.dev->callout->mmd_read(PHY_ID.dev->callout_ctx, (uint16_t)MMD, (uint16_t)address, &reg_value[0]);
