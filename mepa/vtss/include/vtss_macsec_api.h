...
#define VTSS_MACSEC_CP_RULES   (8 + 16 + 2 + 1 + 1) /**< DMAC + ETYPE + DMAC/ETYPE + BPDUs + CDP/UDLD */
...
#define VTSS_MACSEC_MATCH_BPDU           MEPA_MACSEC_MATCH_BPDU
#define VTSS_MACSEC_MATCH_CDP_UDLD       MEPA_MACSEC_MATCH_CDP_UDLD
#define VTSS_MACSEC_MATCH_SCI            MEPA_MACSEC_MATCH_SCI
