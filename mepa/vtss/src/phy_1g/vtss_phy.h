...
// Register 6 + Bit fields
#define  VTSS_PHY_AUTONEGOTIATION_EXPANSION VTSS_PHY_PAGE_STANDARD, 6
#define  VTSS_PHY_AUTONEGOTIATION_EXPANSION_LOCAL_PHY_NXT_PG_CAPABLE   VTSS_PHY_BIT(2)
#define  VTSS_PHY_AUTONEGOTIATION_EXPANSION_PAGE_RECEIVED              VTSS_PHY_BIT(1)
#define  VTSS_PHY_AUTONEGOTIATION_EXPANSION_PAGE_LP_ANEG_CAPABLE       VTSS_PHY_BIT(0)
...
// Register 25E3
#define VTSS_PHY_MEDIA_SERDES_CL37_ADV_ABILITY VTSS_PHY_PAGE_EXTENDED_3, 25
...
#define VTSS_MAC_CONFIGURATION_QSGMII	0x01
