...
#ifndef _VTSS_VENICE_F2DF__API_SD10G65_UTE
#define _VTSS_VENICE_F2DF__API_SD10G65_UTE
...
#if defined(VTSS_ARCH_VENICE)
#include "vtss_venice_inc.h"
...
static vtss_rc venice_f2df_sd10g_f2df_register_cfg(vtss_state_t *vtss_state, const vtss_sd10g65_setup_f2df_struct_t *const res_struct, vtss_port_no_t port_no) {
    u32 value;
    ...
    CSR_WARM_WRM(port_no, VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_CFG0,
        (res_struct->rx_synth_cfg0__synth_hrate_ena[0] ? VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_CFG0_SYNTH_HRATE_ENA : 0),
    ...
    CSR_WARM_WRM(port_no, VTSS_VENICE_GLOBAL32_F2DF_IB_F2DF_IB_CFG0,
        (res_struct->ib_cfg0__ib_dfe_ena[2] ? VTSS_F_VENICE_GLOBAL32_F2DF_IB_F2DF_IB_CFG0_IB_DFE_ENA : 0),
        VTSS_F_VENICE_GLOBAL32_F2DF_IB_F2DF_IB_CFG0_IB_DFE_ENA);
    ...
    CSR_WARM_WRM(port_no, VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_CFG_STAT,
        (res_struct->f2df_cfg_stat__f2df_sample_mode_div[0] ? VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_CFG_STAT_F2DF_SAMPLE_MODE : 0),
        VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_CFG_STAT_F2DF_SAMPLE_MODE);
...
vtss_rc vtss_venice_f2df_sd10g_setup_f2df(vtss_state_t *vtss_state, const vtss_sd10g65_setup_f2df_args_t config, vtss_port_no_t port_no) {
    ...
    if(ret_val == VTSS_RC_OK) {
        ret_val |= venice_f2df_sd10g_f2df_register_cfg(vtss_state, &calc_results, port_no);
    }
    return ret_val;
}
#endif
