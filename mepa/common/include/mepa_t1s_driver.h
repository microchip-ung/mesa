 ...
 **/
typedef mepa_rc (*mepa_t1s_set_plca_config_t)(struct mepa_device *dev,
 ...
 *   MEPA_RC_ERROR on error.
 **/
typedef mepa_rc (*mepa_t1s_get_plca_config_t)(struct mepa_device *dev,
                                                 mepa_t1s_plca_cfg_t *const cfg);


/** \brief PHY T1S Driver */
typedef struct mepa_t1s_driver {
    mepa_t1s_set_plca_config_t             mepa_t1s_set_plca_config;
    mepa_t1s_get_plca_config_t             mepa_t1s_get_plca_config;
} mepa_t1s_driver_t;
