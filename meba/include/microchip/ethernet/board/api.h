...
struct meba_inst {
    ...
    int                    phy_device_cnt;  /**< Total number of phy devices/ports available in
                                               board (needed for phy API) */
 ...
 **/
typedef struct meba_inst *(*meba_initialize_t)(size_t                        callouts_size,
 ...
 * \return The board instance (or NULL)
 **/
struct meba_inst *meba_initialize(size_t callouts_size, const meba_board_interface_t *callouts);
