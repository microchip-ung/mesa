...
meba_poe_parameters_t tPoE_parameters =
{
    ...
    .indv_mask_AT_ignore_higher_priority_default     = LAN9668_INDV_MASK_AT_IGNORE_HIGHER_PRIORITY_DEFAULT,     // power higher priority port.
    .indv_mask_AT_supports_legact_detection_default  = LAN9668_INDV_MASK_AT_SUPPORTS_LEGACY_DETECTION_DEFAULT,  // En/Dis support of legacy detection.
    .indv_mask_AT_message_ready_notify_default       = LAN9668_INDV_MASK_AT_MESSAGE_READY_NOTIFY_DEFAULT,       // en/Dis MESSAGE_READY pin notification.
    .indv_mask_AT_layer2_lldp_enable_default         = LAN9668_INDV_MASK_AT_LAYER2_LLDP_ENABLE_DEFAULT,         // En/Dis Layer 2 PD commands.
    .indv_mask_AT_layer2_priority_by_PD_default      = LAN9668_INDV_MASK_AT_LAYER2_PRIORITY_BY_PD_DEFAULT,      // accept/ignored Port Priority recived from the PD
    .indv_mask_AT_matrix_support_4P_default          = LAN9668_INDV_MASK_AT_MATRIX_SUPPORT_4P_DEFAULT,          // use 4-pair matrix commands.
    ...
    .AT_pm1_default = LAN9668_PM1_AT_DEFAULT,     // Selects the method of calculating total power consumption.
    .AT_PM2_default = LAN9668_PM2_AT_DEFAULT,     // Selects the power limit at the port (maximum or according to class or predefined).
    .AT_PM3_default = LAN9668_PM3_AT_DEFAULT      // Selects the start condition. (Not recommended for new designs, keep 0x00).
};
    ...
    meba_poe_init_params_t *tPoe_init_params)
{
    ...
    if(tPoe_init_params->use_poe_static_parameters) {
        tPoe_init_params->PwrSupply_MaxPwr              = LAN9668_POE_UNIT_MAX_POWER_W_DEFAULT;
        ...
        lan9668_power_supplies->def_w = tPoe_init_params->PwrSupply_MaxPwr;
        lan9668_power_supplies->max_w = tPoe_init_params->PwrSupply_MaxPwr;
    }
    ...
    if(tPoe_init_params->eMEBA_POE_FIRMWARE_TYPE == MEBA_POE_FIRMWARE_TYPE_BT) {
        ...
        // overide tMeba_poe_init_params params if using H file parameters
        if(tPoe_init_params->use_poe_static_parameters) {
            tPoe_init_params->Max_POE_Ch              = sizeof(lan9668_pd69200BT_port_map)/sizeof(meba_poe_port_properties_t);
        }
        ...
        meba_pd69200bt_driver_init(&lan9668_pd69200_system.controllers[0],
                                 ...
                                 lan9668_pd69200BT_port_map,
                                 sizeof(lan9668_pd69200BT_port_map)/sizeof(meba_poe_port_properties_t),
