...
#define JR2_INDV_MASK_BT_IGNORE_HIGHER_PRIORITY_DEFAULT     1
...
#define JR2_INDV_MASK_PREBT_IGNORE_HIGHER_PRIORITY_DEFAULT     1
...
#define JR2_INDV_MASK_PREBT_MATRIX_SUPPORT_4P_DEFAULT     1
