...
#define JR2_POE_PD692x0_CONTROLLER_TYPE_DEFAULT                                \
    MEBA_POE_PD692X0_CONTROLLER_TYPE_AUTO_DETECTION
...
#define JR2_POE_POWER_SUPPLY_MAX_POWER_USER_CONFIG_DEFAULT 1

// Power Suply maximum Power (W)
#define JR2_POE_POWER_SUPPLY_MAX_POWER_W_DEFAULT 100

// Power Suply default-Capability Power (W)
#define JR2_POE_POWER_SUPPLY_DEF_POWER_W_DEFAULT 100
...
#define JR2_BT_NON_COMPLIANT_15W_DEFAULT                                       \
    0x13 // BT Non Compliant 4P 15w 2P 15w Legacy
#define JR2_BT_NON_COMPLIANT_30W_DEFAULT                                       \
    0x12 // BT Non Compliant 4P 30w 2P 30w Legacy
#define JR2_BT_NON_COMPLIANT_60W_DEFAULT                                       \
    0x11 // BT Non Compliant 4P 60w 2P 30w Legacy
#define JR2_BT_NON_COMPLIANT_90W_DEFAULT                                       \
...
#define JR2_INDV_MASK_BT_SUPPORT_HIGH_RES_DETECTION_DEFAULT 0
...
// blinks.
#define JR2_INDV_MASK_BT_PORT_LED_BLINKS_AT_INVALID_SIGNATURE_OR_CONNECTION_CHECK_ERROR_DEFAULT \
    0
...
#define JR2_INDV_MASK_PREBT_IGNORE_HIGHER_PRIORITY_DEFAULT 0
...
#define JR2_INDV_MASK_PREBT_MESSAGE_READY_NOTIFY_DEFAULT 0
...
// processed.
#define JR2_INDV_MASK_PREBT_LAYER2_LLDP_ENABLE_DEFAULT 1
...
// '1').
#define JR2_INDV_MASK_PREBT_LAYER2_PRIORITY_BY_PD_DEFAULT 1
...
#define JR2_INDV_MASK_PREBT_MATRIX_SUPPORT_4P_DEFAULT 0
...
#define JR2_PM1_PREBT_DEFAULT 0x05
...
#define JR2_PM2_PREBT_DEFAULT 0x01
