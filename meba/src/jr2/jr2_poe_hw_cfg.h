...
#define POE_UNIT_MAX_POWER_W_DEFAULT                   100


// Power Suply default-Capability Power (W)
#define POE_UNIT_DEF_POWER_W_DEFAULT                   100


// set the PoE MCU controllers I2C address (0x1 - 0xFE)
#define POE_CONTROLLER_1_I2C_ADDRESS                   0x14
#define POE_CONTROLLER_2_I2C_ADDRESS                   0x28
