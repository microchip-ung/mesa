...
mepa_rc meba_ts_pps_conf_get(meba_inst_t inst, mepa_port_no_t port_no,
...
mepa_rc meba_ts_pps_conf_set(meba_inst_t inst, mepa_port_no_t port_no,
...
mepa_rc meba_ts_stats_get(meba_inst_t inst, mepa_port_no_t port_no,
...
mepa_rc meba_ts_event_get(meba_inst_t inst, mepa_port_no_t port_no,
