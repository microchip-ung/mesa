...
mepa_rc meba_phy_ts_init_conf_get(meba_inst_t                inst,
                                  mepa_port_no_t             port_no,
                                  mepa_ts_init_conf_t *const ts_init_conf)
{
...
mepa_rc meba_phy_ts_init_conf_set(meba_inst_t                inst,
                                  mepa_port_no_t             port_no,
...
mepa_rc meba_phy_ts_path_delay_get(meba_inst_t                inst,
                                   mepa_port_no_t             port_no,
                                   mepa_timeinterval_t *const path_delay)
{
    mesa_rc rc = MESA_RC_ERROR;
...
mepa_rc meba_phy_ts_path_delay_set(meba_inst_t                      inst,
                                   mepa_port_no_t                   port_no,
                                   const mepa_timeinterval_t *const path_delay)
{
    mesa_rc rc = MESA_RC_ERROR;
...
mepa_rc meba_phy_ts_pps_conf_set(meba_inst_t                     inst,
                                 mepa_port_no_t                  port_no,
...
mepa_rc meba_phy_ts_stats_get(meba_inst_t            inst,
                              mepa_port_no_t         port_no,
...
mepa_rc meba_phy_ts_event_get(meba_inst_t            inst,
                              mepa_port_no_t         port_no,
...
mepa_rc meba_phy_ts_event_set(meba_inst_t           inst,
                              mepa_port_no_t        port_no,
...
mepa_rc meba_phy_ts_event_poll(meba_inst_t            inst,
                               mepa_port_no_t         port_no,
...
mepa_rc meba_phy_ts_test_config(meba_inst_t    inst,
                                mepa_port_no_t port_no,
                                uint16_t       test_id,
...
mepa_rc meba_phy_ts_fifo_read_install(meba_inst_t         inst,
                                      mepa_port_no_t      port_no,
...
mepa_rc meba_phy_ts_fifo_get(meba_inst_t          inst,
                             mepa_port_no_t       port_no,
