                                      ...
                                      mepa_macsec_port_t *const       found_macsec_port)
{
    ...
    return mepa_macsec_port_get_next(inst->phy_devices[port_no], port_no, search_macsec_port,
                                     found_macsec_port);
}
                                    ...
                                    mepa_macsec_ssci_t *const      ssci)
{
    ...
    return mepa_macsec_rx_seca_get(inst->phy_devices[port_no], port, sci, an, lowest_pn, sak,
                                   active, ssci);
}
                                                 ...
                                                 const mepa_macsec_pkt_num_t    lowest_pn)
{
    ...
    return mepa_macsec_rx_seca_lowest_pn_update(inst->phy_devices[port_no], port, sci, an,
                                                lowest_pn);
}
                                  ...
                                  const mepa_macsec_sak_t *const sak)
{
    ...
    return mepa_macsec_tx_sa_set(inst->phy_devices[port_no], port, an, next_pn, confidentiality,
                                 sak);
}
                                  ...
                                  mepa_bool_t *const       active)
{
    ...
    return mepa_macsec_tx_sa_get(inst->phy_devices[port_no], port, an, next_pn, confidentiality,
                                 sak, active);
}
                                    ...
                                    const mepa_macsec_ssci_t *const ssci)
{
    ...
    return mepa_macsec_tx_seca_set(inst->phy_devices[port_no], port, an, next_pn, confidentiality,
                                   sak, ssci);
}
                                    ...
                                    mepa_macsec_ssci_t *const    ssci)
{
    ...
    return mepa_macsec_tx_seca_get(inst->phy_devices[port_no], port, an, next_pn, confidentiality,
                                   sak, active, ssci);
}
...
mepa_rc meba_phy_macsec_uncontrolled_counters_get(meba_inst_t          inst,
                                                  const mepa_port_no_t port_no,
...
mepa_rc meba_phy_macsec_control_frame_match_conf_set(meba_inst_t          inst,
                                                     const mepa_port_no_t port_no,
                                                     const mepa_macsec_control_frame_match_conf_t
                                                         *const      conf,
                                                     uint32_t *const rule_id)
{
    ...
    return mepa_macsec_control_frame_match_conf_set(inst->phy_devices[port_no], port_no, conf,
                                                    rule_id);
}
...
mepa_rc meba_phy_macsec_control_frame_match_conf_get(meba_inst_t          inst,
                                                     const mepa_port_no_t port_no,
                                                     ...
                                                     uint32_t   rule_id)
{
    ...
    return mepa_macsec_control_frame_match_conf_get(inst->phy_devices[port_no], port_no, conf,
                                                    rule_id);
}
...
mepa_rc meba_phy_macsec_default_action_set(meba_inst_t                                      inst,
                                           const mepa_port_no_t                             port_no,
                                  ...
                                  uint8_t *const       frame)
{
    ...
    return mepa_macsec_frame_get(inst->phy_devices[port_no], port_no, buf_length, return_length,
                                 frame);
}
...
mepa_rc meba_phy_macsec_dbg_frm_match_handling_ctrl_reg_dump(meba_inst_t              inst,
                                                             const mepa_port_no_t     port_no,
                                                             const mepa_debug_print_t pr)
{
    mesa_rc rc = MESA_RC_ERROR;
    ...
    return mepa_macsec_dbg_frm_match_handling_ctrl_reg_dump(inst->phy_devices[port_no], port_no,
                                                            pr);
}
