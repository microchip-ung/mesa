...
#define phy_mux_1_port_in_4                                                    \
    MESA_SYNCE_DEV_MUX_PHY(201, MESA_SYNCE_DEV_INPUT | 4)
#define phy_mux_1_port_in_5                                                    \
    MESA_SYNCE_DEV_MUX_PHY(201, MESA_SYNCE_DEV_INPUT | 5)
#define phy_mux_1_port_in_6                                                    \
    MESA_SYNCE_DEV_MUX_PHY(201, MESA_SYNCE_DEV_INPUT | 6)
#define phy_mux_1_port_in_7                                                    \
    MESA_SYNCE_DEV_MUX_PHY(201, MESA_SYNCE_DEV_INPUT | 7)
...
#define switch_mux_port_in_0                                                   \
    MESA_SYNCE_DEV_MUX_SWITCH(300, MESA_SYNCE_DEV_INPUT | 0)
#define switch_mux_port_in_1                                                   \
    MESA_SYNCE_DEV_MUX_SWITCH(300, MESA_SYNCE_DEV_INPUT | 1)
#define switch_mux_port_in_2                                                   \
    MESA_SYNCE_DEV_MUX_SWITCH(300, MESA_SYNCE_DEV_INPUT | 2)
#define switch_mux_port_in_3                                                   \
    MESA_SYNCE_DEV_MUX_SWITCH(300, MESA_SYNCE_DEV_INPUT | 3)
#define switch_mux_port_in_4                                                   \
    MESA_SYNCE_DEV_MUX_SWITCH(300, MESA_SYNCE_DEV_INPUT | 4)
#define switch_mux_port_in_5                                                   \
    MESA_SYNCE_DEV_MUX_SWITCH(300, MESA_SYNCE_DEV_INPUT | 5)
#define switch_mux_port_in_6                                                   \
    MESA_SYNCE_DEV_MUX_SWITCH(300, MESA_SYNCE_DEV_INPUT | 6)
#define switch_mux_port_in_7                                                   \
    MESA_SYNCE_DEV_MUX_SWITCH(300, MESA_SYNCE_DEV_INPUT | 7)
...
static const meba_synce_graph_element_t
    synce_graph_elements_ocelot10_ref_board[] = {
        ...
        MESA_SYNCE_GRAPH_CONNECTION(phy_mux_port_out_0,
                                    divider_switch_mux_port_0_in),
        MESA_SYNCE_GRAPH_CONNECTION(divider_switch_mux_port_0_out,
                                    switch_mux_port_in_0),
        MESA_SYNCE_GRAPH_CONNECTION(phy_mux_port_out_1,
                                    divider_switch_mux_port_1_in),
...
static const meba_synce_terminal_attr_t attr_ocelot10_ref_board[] = {
    ...
    MESA_SYNCE_ATTR(phy_mux_port_out_0,
                    MEBA_ATTR_FREQ,
                    MEBA_SYNCE_CLOCK_FREQ_125MHZ),
    MESA_SYNCE_ATTR(phy_mux_port_out_1,
                    MEBA_ATTR_FREQ,
                    MEBA_SYNCE_CLOCK_FREQ_125MHZ),
...
static const meba_synce_graph_element_t
    synce_graph_elements_ocelot10_w_zls30772_board[] = {
...
static const meba_synce_terminal_attr_t
    attr_ocelot10_ref_board_defaults_dpll[] = {
        MESA_SYNCE_ATTR(dpll_port_7,
                        MEBA_ATTR_FREQ,
                        MEBA_SYNCE_CLOCK_FREQ_125MHZ),
};
...
static const meba_synce_graph_element_t
    synce_graph_elements_ocelot8_ref_board[] = {
        // type                               source destination
        MESA_SYNCE_GRAPH_CONNECTION(eth_port_0, phy_mux_port_in_0),
        MESA_SYNCE_GRAPH_CONNECTION(eth_port_1, phy_mux_port_in_1),
        MESA_SYNCE_GRAPH_CONNECTION(eth_port_2, phy_mux_port_in_2),
                             ...
                             const meba_synce_graph_t **const g)
{
    ...
    static meba_synce_terminal_attr_t
        attr[MEBA_ARRSZ(attr_ocelot10_ref_board) +
             MEBA_MAX(MEBA_ARRSZ(attr_ocelot10_ref_board_defaults_dpll),
                      MEBA_ARRSZ(attr_ocelot10_ref_board_zarlink_dpll))];
    ...
    if (board_type == VTSS_BOARD_OCELOT_PCB123_REF) { // PCB123
        ...
        case MEBA_SYNCE_CLOCK_HW_SI_5328:
            synce_graph.graph_length =
                MEBA_ARRSZ(synce_graph_elements_ocelot10_ref_board);
            synce_graph.graph = synce_graph_elements_ocelot10_ref_board;
            memcpy(attr, attr_ocelot10_ref_board,
                   sizeof(attr_ocelot10_ref_board));
            synce_graph.attr_length = MEBA_ARRSZ(attr_ocelot10_ref_board);
            memcpy(&attr[synce_graph.attr_length],
                   attr_ocelot10_ref_board_defaults_dpll,
                   sizeof(attr_ocelot10_ref_board_defaults_dpll));
            synce_graph.attr_length +=
                MEBA_ARRSZ(attr_ocelot10_ref_board_defaults_dpll);
            break;
        case MEBA_SYNCE_CLOCK_HW_ZL_30771:
        case MEBA_SYNCE_CLOCK_HW_ZL_30772:
        case MEBA_SYNCE_CLOCK_HW_ZL_30773:
            synce_graph.graph_length =
                MEBA_ARRSZ(synce_graph_elements_ocelot10_w_zls30772_board);
            synce_graph.graph = synce_graph_elements_ocelot10_w_zls30772_board;
            memcpy(attr, attr_ocelot10_w_zls30772_board,
                   sizeof(attr_ocelot10_w_zls30772_board));
            synce_graph.attr_length =
                MEBA_ARRSZ(attr_ocelot10_w_zls30772_board);
            break;
        ...
        default:
            ...
            synce_graph.attr_length = MEBA_ARRSZ(attr_ocelot10_ref_board);
            memcpy(&attr[synce_graph.attr_length],
                   attr_ocelot10_ref_board_zarlink_dpll,
                   sizeof(attr_ocelot10_ref_board_zarlink_dpll));
            synce_graph.attr_length +=
                MEBA_ARRSZ(attr_ocelot10_ref_board_zarlink_dpll);
            break;
        }
        ...
        synce_graph.graph_length =
            MEBA_ARRSZ(synce_graph_elements_ocelot8_ref_board);
