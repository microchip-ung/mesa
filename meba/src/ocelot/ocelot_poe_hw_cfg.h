...
#define OCELOT_POE_FIRMWARE_TYPE_DEFAULT     MEBA_POE_FIRMWARE_TYPE_PREBT
...
#define OCELOT_INDV_MASK_PREBT_IGNORE_HIGHER_PRIORITY_DEFAULT     1
...
#define OCELOT_INDV_MASK_PREBT_MATRIX_SUPPORT_4P_DEFAULT     1
