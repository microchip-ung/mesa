...
#define eth_port_0                                                             \
    MESA_SYNCE_DEV_PORT(0, 0) // On Caracal1 boards eth_port_0 to eth_port_9 are
                              // used
#define eth_port_1                                                             \
    MESA_SYNCE_DEV_PORT(1, 0) // On Caracal Lite boards eth_port_0 to eth_port_6
                              // are used
...
#define phy_mux_0_port_in_0                                                    \
    MESA_SYNCE_DEV_MUX_PHY(100, MESA_SYNCE_DEV_INPUT |                         \
                                    0) // On Caracal1 boards phy_mux_0_port_in_0
                                       // to phy_mux_0_port_in_7 are used
#define phy_mux_0_port_in_1                                                    \
    MESA_SYNCE_DEV_MUX_PHY(100,                                                \
                           MESA_SYNCE_DEV_INPUT |                              \
                               1) // On Caracal Lite boards phy_mux_0_port_in_0
                                  // to phy_mux_0_port_in_4 are used
...
#define switch_mux_port_in_0                                                   \
    MESA_SYNCE_DEV_MUX_SWITCH(200, MESA_SYNCE_DEV_INPUT | 0)
#define switch_mux_port_in_1                                                   \
    MESA_SYNCE_DEV_MUX_SWITCH(200, MESA_SYNCE_DEV_INPUT | 1)
...
#define board_mux_port_in_0                                                    \
    MESA_SYNCE_DEV_MUX_BOARD(300, MESA_SYNCE_DEV_INPUT |                       \
                                      MESA_SYNCE_TRI_STATE_FROM_SWITCH | 0)
#define board_mux_port_in_1                                                    \
    MESA_SYNCE_DEV_MUX_BOARD(300, MESA_SYNCE_DEV_INPUT |                       \
                                      MESA_SYNCE_TRI_STATE_FROM_SWITCH | 1)
#define board_mux_port_in_2                                                    \
    MESA_SYNCE_DEV_MUX_BOARD(300, MESA_SYNCE_DEV_INPUT |                       \
                                      MESA_SYNCE_TRI_STATE_FROM_PHY | 2)
#define board_mux_port_in_3                                                    \
    MESA_SYNCE_DEV_MUX_BOARD(300, MESA_SYNCE_DEV_INPUT |                       \
                                      MESA_SYNCE_TRI_STATE_FROM_PHY | 3)
...
#define phy_mux_1_port_in_0                                                    \
    MESA_SYNCE_DEV_MUX_PHY(400,                                                \
                           MESA_SYNCE_DEV_INPUT | 0) // Only used on Luton26 ref
                                                     // boards e.g. Caracal2
...
static const meba_synce_graph_element_t synce_graph_elements_caracal1_board[] = {
    ...
    MESA_SYNCE_GRAPH_INVALID_CONNECTION(board_mux_port_in_0,
                                        board_mux_port_out_1),
    MESA_SYNCE_GRAPH_INVALID_CONNECTION(board_mux_port_in_1,
...
static const meba_synce_graph_element_t
    synce_graph_elements_caracal_lite_board[] = {
        // type                               source destination
        MESA_SYNCE_GRAPH_CONNECTION(eth_port_0, phy_mux_0_port_in_0),
        MESA_SYNCE_GRAPH_CONNECTION(eth_port_1, phy_mux_0_port_in_1),
        MESA_SYNCE_GRAPH_CONNECTION(eth_port_2, phy_mux_0_port_in_2),
        ...
        MESA_SYNCE_GRAPH_CONNECTION(board_mux_port_out_0, dpll_port_0),
        MESA_SYNCE_GRAPH_CONNECTION(board_mux_port_out_1, dpll_port_1),
        MESA_SYNCE_GRAPH_CONNECTION(station_clock_port_caracal_lite,
                                    dpll_port_7),
        MESA_SYNCE_GRAPH_INVALID_CONNECTION(board_mux_port_in_0,
                                            board_mux_port_out_1),
        MESA_SYNCE_GRAPH_INVALID_CONNECTION(board_mux_port_in_1,
                             ...
                             const meba_synce_graph_t **const g)
{
    ...
    static meba_synce_terminal_attr_t
        attr[MEBA_MAX(MEBA_ARRSZ(attr_caracal1_board),
                      MEBA_MAX(MEBA_ARRSZ(attr_caracal_lite_board),
                               MEBA_ARRSZ(attr_caracal2_board))) +
             MEBA_MAX(MEBA_MAX(MEBA_ARRSZ(attr_defaults_dpll),
                               MEBA_ARRSZ(attr_zarlink_dpll)),
                      MEBA_MAX(MEBA_ARRSZ(attr_caracal2_defaults_dpll),
                               MEBA_ARRSZ(attr_caracal2_zarlink_dpll)))];
    ...
    if (board_type == VTSS_BOARD_LUTON10_REF) {
        if (inst->props.target == MESA_TARGET_CARACAL_LITE) {
            synce_graph.graph_length =
                MEBA_ARRSZ(synce_graph_elements_caracal_lite_board);
            ...
            synce_graph.graph_length =
                MEBA_ARRSZ(synce_graph_elements_caracal1_board);
        ...
        case MEBA_SYNCE_CLOCK_HW_SI_5328:
            memcpy(&attr[synce_graph.attr_length], attr_defaults_dpll,
                   sizeof(attr_defaults_dpll));
        ...
        default:
            // Note: In the case that no DPLL is present, we still set up DPLL
            // frequency attributes to avoid a problem
            //       with the PHY output frequencies otherwise being unknown.
            //       Alternatively, the PHY output frequencies could be
            //       specified explicitly.
            memcpy(&attr[synce_graph.attr_length], attr_zarlink_dpll,
                   sizeof(attr_zarlink_dpll));
        ...
        if (inst->props.target == MESA_TARGET_CARACAL_2) {
            synce_graph.graph_length =
                MEBA_ARRSZ(synce_graph_elements_caracal2_board);
        ...
        case MEBA_SYNCE_CLOCK_HW_SI_5326:
        case MEBA_SYNCE_CLOCK_HW_SI_5328:
            memcpy(&attr[synce_graph.attr_length], attr_caracal2_defaults_dpll,
                   sizeof(attr_caracal2_defaults_dpll));
        ...
        default:
            ...
            //       Alternatively, the PHY output frequencies could be
            //       specified explicitly.
            memcpy(&attr[synce_graph.attr_length], attr_caracal2_zarlink_dpll,
                   sizeof(attr_caracal2_zarlink_dpll));
