...
#ifndef _CARACAL_POE_HW_CFG_H_
#define _CARACAL_POE_HW_CFG_H_
...
// poe gpio reset pin number (applicable for PDS408G or CARACAL)
// 0xFF   - no gpio use for reset poe ports.
// 0-0xFE - GPIO number used for reset poe ports.
#define RESET_POE_GPIO_NUMBER     0xFF


//--------------------------------------------------------------------------------------//
//-------------------------   PDS408G general parameters   -----------------------------//
//--------------------------------------------------------------------------------------//
...
#define PDS408G_POE_FIRMWARE_TYPE_DEFAULT     MEBA_POE_FIRMWARE_TYPE_BT
...
#define PDS408G_BT_COMPLIANT_30W_DEFAULT        9           // Type3 BT compliant up to 60W (replaced by AT Compliant 30w)
...
#define PDS408G_BT_OPERATION_MODE_LEGACY_90W_POH_DEFAULT              0x25  // Lagacy + PoH 45/90W + BT. No demotion in class 4 or 4,4
#define PDS408G_BT_OPERATION_MODE_LEGACY_60W_IGNORE_PD_CLASS_DEFAULT  0x21  // Lagacy + IGNORE_PD_CLASS 60W
#define PDS408G_BT_OPERATION_MODE_LEGACY_90W_IGNORE_PD_CLASS_DEFAULT  0x26  // Lagacy + IGNORE_PD_CLASS 90W
...
#define PDS408G_INDV_MASK_BT_IGNORE_HIGHER_PRIORITY_DEFAULT     0
...
#define PDS408G_INDV_MASK_BT_SUPPORT_HIGH_RES_DETECTION_DEFAULT     0
...
#define PDS408G_INDV_MASK_BT_I2C_RESTART_ENABLE_DEFAULT     1
...
#define PDS408G_INDV_MASK_BT_PSE_POWERING_PSE_CHECKING_DEFAULT     1
...
#define PDS408G_INDV_MASK_BT_LED_STREAM_TYPE_DEFAULT     2
...
#define PDS408G_INDV_MASK_BT_LAYER2_POWER_ALLOCATION_LIMIT_DEFAULT     1
...
#define PDS408G_INDV_MASK_BT_PORT_LED_BLINKS_AT_INVALID_SIGNATURE_OR_CONNECTION_CHECK_ERROR_DEFAULT     0
...
#define PDS408G_INDV_MASK_BT_SUPPORT_ADDING_LLDP_HALF_PRIORITY_DEFAULT     1
...
#define PDS408G_INDV_MASK_BT_HOCPP_DEFAULT     2
...
#define PDS408G_PD69200_PREBT_CAP MEBA_POE_PORT_CAP_POE    | \
                                  MEBA_POE_PORT_CAP_TYPE_1 | \
                                  MEBA_POE_PORT_CAP_TYPE_2 | \
                                  MEBA_POE_PORT_CAP_4PAIR  | \
                                  MEBA_POE_PORT_CAP_FORCE_ON

#define PDS408G_PD69200_CAP ((PDS408G_POE_FIRMWARE_TYPE_DEFAULT == MEBA_POE_FIRMWARE_TYPE_BT) ? PDS408G_PD69200_BT_CAP : PDS408G_PD69200_PREBT_CAP)
...
#define CARACAL_INDV_MASK_PREBT_IGNORE_HIGHER_PRIORITY_DEFAULT     0
...
#define CARACAL_INDV_MASK_PREBT_SUPPORTS_LEGACY_DETECTION_DEFAULT     0
...
#define CARACAL_INDV_MASK_PREBT_SUPPORTS_BACKOFF_DEFAULT     0
...
#define CARACAL_INDV_MASK_PREBT_LED_STREAM_TYPE_DEFAULT     1
...
#define CARACAL_INDV_MASK_PREBT_MESSAGE_READY_NOTIFY_DEFAULT     0
...
#define CARACAL_INDV_MASK_PREBT_LAYER2_LLDP_ENABLE_DEFAULT     1
...
#define CARACAL_INDV_MASK_PREBT_LAYER2_PRIORITY_BY_PD_DEFAULT     1
...
#define CARACAL_INDV_MASK_PREBT_MATRIX_SUPPORT_4P_DEFAULT     0
...
#define CARACAL_PM1_PREBT_DEFAULT     0x05
...
#define CARACAL_PM2_PREBT_DEFAULT     0x01
...
#define CARACAL_PM3_PREBT_DEFAULT     0x00
...
#define CARACAL_PD69200_PREBT_CAP MEBA_POE_PORT_CAP_POE    | \
                                  MEBA_POE_PORT_CAP_TYPE_1 | \
                                  MEBA_POE_PORT_CAP_TYPE_2 | \
                                  MEBA_POE_PORT_CAP_FORCE_ON

#define CARACAL_PD69200_CAP ((CARACAL_POE_FIRMWARE_TYPE_DEFAULT == MEBA_POE_FIRMWARE_TYPE_BT) ? CARACAL_PD69200_BT_CAP : CARACAL_PD69200_PREBT_CAP)
