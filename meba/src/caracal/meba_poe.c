...
{
    {
        ...
        .max_mW = (CARACAL_POE_UNIT_MAX_POWER_W_DEFAULT * 1000),  // PwrSuply Max-Pwr
        .def_mW = (CARACAL_POE_UNIT_DEF_POWER_W_DEFAULT * 1000),  // PwrSuply Def-Capab
...
{
    {
        .id = MEBA_POE_CTRL_PSU_ALL,                              // PowerSupply-ID
        .min_mW = 0,                                              // PwrSuply Min-Pwr
        .max_mW = (PDS408G_POE_UNIT_MAX_POWER_W_DEFAULT * 1000),  // PwrSuply Max-Pwr
        .def_mW = (PDS408G_POE_UNIT_DEF_POWER_W_DEFAULT * 1000),  // PwrSuply Def-Capab
        .system_consumed = 0 ,                                    // System PwrUsage
