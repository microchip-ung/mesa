...
#define POE_UNIT_MAX_POWER_W_DEFAULT                   5000


// Power Suply default-Capability Power (W)
#define POE_UNIT_DEF_POWER_W_DEFAULT                   10


// set the PoE MCU controller I2C address (0x1 - 0xFE)
#define POE__CONTROLLER_1_I2C_ADDRESS                  0x14
#define POE__CONTROLLER_2_I2C_ADDRESS                  0x28
