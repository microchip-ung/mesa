...
#define SPARX5_POE_PD692x0_CONTROLLER_TYPE_DEFAULT                                                 \
    MEBA_POE_GEN6_PD692X0_CONTROLLER_TYPE_AUTO_DETECTION
...
#define SPARX5_POE_FIRMWARE_TYPE_DEFAULT MEBA_POE_FIRMWARE_TYPE_GEN7_BT

// Set the number of PoE controllers (can be 1 or 2):
// MEBA_POE_ONE_CONTROLLER
// MEBA_POE_TWO_CONTROLLERS
#define SPARX5_POE_CONTROLLERS_COUNT MEBA_POE_ONE_CONTROLLER
...
#define POE_BOARD_GEN6_NXP_VERSION_CONTROLLER_1_I2C_ADDRESS 0x14
#define POE_BOARD_GEN6_NXP_VERSION_CONTROLLER_2_I2C_ADDRESS 0x28

// poe boards version 2 controllers i2c address
#define POE_BOARD_GEN6_D21_VERSION_CONTROLLER_1_I2C_ADDRESS 0x2C
#define POE_BOARD_GEN6_D21_VERSION_CONTROLLER_2_I2C_ADDRESS 0x3C

// set the Gen6 PoE MCU controller I2C address (0x1 - 0xFE)
#define SPARX5_POE_GEN6_CONTROLLER_1_I2C_ADDRESS POE_BOARD_GEN6_D21_VERSION_CONTROLLER_1_I2C_ADDRESS
#define SPARX5_POE_GEN6_CONTROLLER_2_I2C_ADDRESS POE_BOARD_GEN6_D21_VERSION_CONTROLLER_2_I2C_ADDRESS
...
#define SPARX5_GEN6_BT_PORT_MAX_POWER_DEFAULT MEBA_POE_PORT_MAX_POWER_60W
...
#define PD69200_CAP                                                                                \
    ((SPARX5_POE_FIRMWARE_TYPE_DEFAULT == MEBA_POE_FIRMWARE_TYPE_GEN6_PREBT) ? PD69200_PREBT_CAP   \
                                                                             : PD69200_BT_CAP)
...
meba_poe_port_properties_t sparx5_pd69777_4pairs_port_map[] = {
    ...
    // Capability|MAX PWR|Logical |Logical |Pair-A  |Pair-B
    // ------------------------------------------------------
    {PD69200_CAP, 24000, 0,  0,  0,   1  },
    {PD69200_CAP, 24000, 1,  1,  2,   3  },
    {PD69200_CAP, 24000, 2,  2,  4,   5  },
    {PD69200_CAP, 24000, 3,  3,  6,   7  },
    {PD69200_CAP, 24000, 4,  4,  24,  25 },
    {PD69200_CAP, 24000, 5,  5,  26,  27 },
    {PD69200_CAP, 24000, 6,  6,  28,  29 },
    {PD69200_CAP, 24000, 7,  7,  30,  31 },
    {PD69200_CAP, 24000, 8,  8,  8,   9  },
    {PD69200_CAP, 24000, 9,  9,  10,  11 },
    {PD69200_CAP, 24000, 10, 10, 32,  33 },
    {PD69200_CAP, 24000, 11, 11, 34,  35 },
    {PD69200_CAP, 24000, 12, 12, 12,  13 },
    {PD69200_CAP, 24000, 13, 13, 14,  15 },
    {PD69200_CAP, 24000, 14, 14, 36,  37 },
    {PD69200_CAP, 24000, 15, 15, 38,  39 },
    {PD69200_CAP, 24000, 16, 16, 16,  17 },
    {PD69200_CAP, 24000, 17, 17, 18,  19 },
    {PD69200_CAP, 24000, 18, 18, 20,  21 },
    {PD69200_CAP, 24000, 19, 19, 22,  23 },
    {PD69200_CAP, 24000, 20, 20, 40,  41 },
    {PD69200_CAP, 24000, 21, 21, 42,  43 },
    {PD69200_CAP, 24000, 22, 22, 44,  45 },
    {PD69200_CAP, 24000, 23, 23, 46,  47 },
    {PD69200_CAP, 24000, 24, 24, 64,  65 },
    {PD69200_CAP, 24000, 25, 25, 66,  67 },
    {PD69200_CAP, 24000, 26, 26, 68,  69 },
    {PD69200_CAP, 24000, 27, 27, 70,  71 },
    {PD69200_CAP, 24000, 28, 28, 88,  89 },
    {PD69200_CAP, 24000, 29, 29, 90,  91 },
    {PD69200_CAP, 24000, 30, 30, 92,  93 },
    {PD69200_CAP, 24000, 31, 31, 94,  95 },
    {PD69200_CAP, 24000, 32, 32, 72,  73 },
    {PD69200_CAP, 24000, 33, 33, 74,  75 },
    {PD69200_CAP, 24000, 34, 34, 96,  97 },
    {PD69200_CAP, 24000, 35, 35, 98,  99 },
    {PD69200_CAP, 24000, 36, 36, 76,  77 },
    {PD69200_CAP, 24000, 37, 37, 78,  79 },
    {PD69200_CAP, 24000, 38, 38, 100, 101},
    {PD69200_CAP, 24000, 39, 39, 102, 103},
    {PD69200_CAP, 24000, 40, 40, 80,  81 },
    {PD69200_CAP, 24000, 41, 41, 82,  83 },
    {PD69200_CAP, 24000, 42, 42, 84,  85 },
    {PD69200_CAP, 24000, 43, 43, 86,  87 },
    {PD69200_CAP, 24000, 44, 44, 104, 105},
    {PD69200_CAP, 24000, 45, 45, 106, 107},
    {PD69200_CAP, 24000, 46, 46, 108, 109},
    {PD69200_CAP, 24000, 47, 47, 110, 111}
};
