...
meba_poe_parameters_t tPoE_parameters = {
    .ePoE_Controller_Type_default = SPARX5_POE_PD692x0_CONTROLLER_TYPE_DEFAULT, // PD692x0 family
                                                                                // detection method
    ...
    .indv_mask_BT_HOCPP_default = SPARX5_INDV_MASK_BT_HOCPP_DEFAULT, // HOCPP - high_over Current
                                                                     // Pulse Protection
    ...
    // ----------------------//
    .prebt_pm1_default = SPARX5_PM1_PREBT_DEFAULT, // Selects the method of calculating total
                                                   // power consumption.
    .prebt_pm2_default = SPARX5_PM2_PREBT_DEFAULT, // Selects the power limit at the port (maximum
                                                   // or according to class or predefined).
    .prebt_pm3_default = SPARX5_PM3_PREBT_DEFAULT  // Selects the start condition. (Not
...
meba_poe_psu_input_prob_t sparx5_power_supplies[] = {
    {
     .id = MEBA_POE_CTRL_PSU_ALL,                          // PowerSupply-ID
        ...
        .user_configurable = SPARX5_POE_POWER_SUPPLY_MAX_POWER_USER_CONFIG_DEFAULT // User Conig
                                                                                   // 1=Yes,0=No
    }
};
                                                 ...
                                                 meba_poe_init_params_t *tPoe_init_params)
{
    ...
    sparx5_pd69200_system.controllers =
        malloc(sizeof(meba_poe_ctrl_inst_t) * sparx5_pd69200_system.controller_count);
    ...
    if (tPoe_init_params->eMeba_poe_firmware_type == MEBA_POE_FIRMWARE_TYPE_BT) {
        ...
        meba_pd69200bt_driver_init(&sparx5_pd69200_system.controllers[1], "pd69x00-2",
        ...
        sparx5_pd69200_system.controllers[0].index = 0;
        meba_pd69200_driver_init(&sparx5_pd69200_system.controllers[0], "pd69x00",
                                 meba_pd69200_i2c_adapter_open(sparx5_i2c_config[0].i2c_device,
                                                               poe_12c0),
                                 MEBA_POE_CTRL_CAP_POWER_MANAGEMENT |
        ...
        sparx5_pd69200_system.controllers[1].index = 1;
        meba_pd69200_driver_init(&sparx5_pd69200_system.controllers[1], "pd69x00-2",
                                 meba_pd69200_i2c_adapter_open(sparx5_i2c_config[1].i2c_device,
                                                               poe_12c1),
                                 MEBA_POE_CTRL_CAP_POWER_MANAGEMENT |
                                     MEBA_POE_CTRL_CAP_PD_LEGACY_DETECTION |
                                                   ...
                                                   meba_poe_init_params_t *tPoe_init_params)
{
    ...
    sparx5_pd69200_system.controllers[0].index = 0;
    meba_pd69200bt_driver_init(&sparx5_pd69200_system.controllers[0], "pd69x00",
                               meba_pd69200_i2c_adapter_open(lan969_i2c_config[0].i2c_device,
                                                             poe_12c0),
                               MEBA_POE_CTRL_CAP_POWER_MANAGEMENT |
                                   MEBA_POE_CTRL_INTERRUPTIBLE_POWER |
                                   MEBA_POE_CTRL_PD_AUTO_CLASS_REQUEST |
...
mesa_rc meba_poe_sparx5_do_detection(meba_inst_t inst)
{
    ...
    for (int i = 0; i < sparx5_pd69200_system.controller_count; ++i) {
        if (sparx5_pd69200_system.controllers[i]
                .api->meba_poe_ctrl_do_detection(&sparx5_pd69200_system.controllers[i]) ==
            MESA_RC_ERROR) {
