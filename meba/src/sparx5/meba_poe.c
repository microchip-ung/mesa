...
meba_poe_parameters_t tPoE_parameters =
{
    ...
    .bt_operation_mode_none_compliant_15w_default = SPARX5_BT_NON_COMPLIANT_15W_DEFAULT,
    .bt_operation_mode_none_compliant_30w_default = SPARX5_BT_NON_COMPLIANT_30W_DEFAULT,
    .bt_operation_mode_none_compliant_60w_default = SPARX5_BT_NON_COMPLIANT_60W_DEFAULT,
    .bt_operation_mode_none_compliant_90w_default = SPARX5_BT_NON_COMPLIANT_90W_DEFAULT,
    ...
    .indv_mask_prebt_led_stream_type_default            = SPARX5_INDV_MASK_PREBT_LED_STREAM_TYPE_DEFAULT,           // prebt led stream type
    .indv_mask_prebt_ignore_higher_priority_default     = SPARX5_INDV_MASK_PREBT_IGNORE_HIGHER_PRIORITY_DEFAULT,    // power higher priority port
    .indv_mask_prebt_supports_legact_detection_default  = SPARX5_INDV_MASK_PREBT_SUPPORTS_LEGACY_DETECTION_DEFAULT, // En/Dis support of legacy detection
    .indv_mask_prebt_supports_backoff_default           = SPARX5_INDV_MASK_PREBT_SUPPORTS_BACKOFF_DEFAULT,          // En/Dis supports backoff
    .indv_mask_prebt_message_ready_notify_default       = SPARX5_INDV_MASK_PREBT_MESSAGE_READY_NOTIFY_DEFAULT,      // en/Dis MESSAGE_READY pin notification.
    .indv_mask_prebt_layer2_lldp_enable_default         = SPARX5_INDV_MASK_PREBT_LAYER2_LLDP_ENABLE_DEFAULT,        // En/Dis Layer 2 PD commands
    .indv_mask_prebt_layer2_priority_by_PD_default      = SPARX5_INDV_MASK_PREBT_LAYER2_PRIORITY_BY_PD_DEFAULT,     // accept/ignored Port Priority recived from the PD
    .indv_mask_prebt_matrix_support_4P_default          = SPARX5_INDV_MASK_PREBT_MATRIX_SUPPORT_4P_DEFAULT,         // use 4-pair matrix commands
    ...
    .indv_mask_BT_HOCPP_default                         = SPARX5_INDV_MASK_BT_HOCPP_DEFAULT,                        // HOCPP - high_over Current Pulse Protection
    .indv_mask_BT_PSE_powering_PSE_checking_default     = SPARX5_INDV_MASK_BT_PSE_POWERING_PSE_CHECKING_DEFAULT,               // PSE powering PSE checking
    .indv_mask_BT_layer2_power_allocation_limit_default = SPARX5_INDV_MASK_BT_LAYER2_POWER_ALLOCATION_LIMIT_DEFAULT,           // Layer2 Power Allocation Limit
    .indv_mask_BT_Port_LED_blinks_at_invalid_signature_or_connection_check_error_default = SPARX5_INDV_MASK_BT_PORT_LED_BLINKS_AT_INVALID_SIGNATURE_OR_CONNECTION_CHECK_ERROR_DEFAULT,  // Port LED Blinks at invalid signature or connection-check error
    .indv_mask_BT_support_adding_lldp_half_priority_default = SPARX5_INDV_MASK_BT_SUPPORT_ADDING_LLDP_HALF_PRIORITY_DEFAULT,   // Support adding lldp half priority

    // -----------  PREBT Power Management mode of operation  ----------------------//
    .prebt_pm1_default = SPARX5_PM1_PREBT_DEFAULT,     // Selects the method of calculating total power consumption.
    .prebt_pm2_default = SPARX5_PM2_PREBT_DEFAULT,     // Selects the power limit at the port (maximum or according to class or predefined).
    .prebt_pm3_default = SPARX5_PM3_PREBT_DEFAULT      // Selects the start condition. (Not recommended for new designs, keep 0x00).
};
...
{
    {
        ...
        .max_w = SPARX5_POE_POWER_SUPPLY_MAX_POWER_W_DEFAULT, // PwrSuply Max-Pwr
        .def_w = SPARX5_POE_POWER_SUPPLY_DEF_POWER_W_DEFAULT, // PwrSuply Def-Capab
        .system_pwr_usage_w = SPARX5_POE_POWER_SUPPLY_SYSTEM_POWER_USAGE_DEFAULT,   // System PwrUsage
        .user_configurable  = SPARX5_POE_POWER_SUPPLY_MAX_POWER_USER_CONFIG_DEFAULT // User Conig 1=Yes,0=No
    }
};
...
mesa_rc meba_poe_sparx5_pcb135_system_initialize(
        meba_inst_t            inst,
...
mesa_rc meba_poe_lan969x_pcb8398_system_initialize(
    meba_inst_t            inst,
    meba_poe_init_params_t *tPoe_init_params)
{
    // Do poe chip detection and fill
        ...
        meba_poe_init_params_t *tPoe_init_params)
{
    ...
    switch (inst->props.board_type) {
        ...
        case BOARD_TYPE_LAGUNA_PCB8398:
            return meba_poe_lan969x_pcb8398_system_initialize(inst, tPoe_init_params);
        default:
            return MESA_RC_OK;
    }
}
