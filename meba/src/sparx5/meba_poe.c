...
void set_sparx_parameters(meba_poe_firmware_type_t poe_type)
{
    ...
    // poe_default_parameters.ePoE_gen6_controller_detection_type =
    // SPARX5_POE_GEN6_PD692x0_CONTROLLER_TYPE_DEFAULT;

    if (poe_type == MEBA_POE_FIRMWARE_TYPE_GEN6_BT) {
        // BT complient port operation Mode
        poe_default_parameters.bt_operation_mode_compliant_15w_default =
            SPARX5_GEN6_BT_COMPLIANT_15W_DEFAULT;
        poe_default_parameters.bt_operation_mode_compliant_30w_default =
            SPARX5_GEN6_BT_COMPLIANT_30W_DEFAULT;
        poe_default_parameters.bt_operation_mode_compliant_60w_default =
            SPARX5_GEN6_BT_COMPLIANT_60W_DEFAULT;
        poe_default_parameters.bt_operation_mode_compliant_90w_default =
            SPARX5_GEN6_BT_COMPLIANT_90W_DEFAULT;

        // BT none complient port operation Mode
        poe_default_parameters.bt_operation_mode_none_compliant_15w_default =
            SPARX5_GEN6_BT_NON_COMPLIANT_15W_DEFAULT;
        poe_default_parameters.bt_operation_mode_none_compliant_30w_default =
            SPARX5_GEN6_BT_NON_COMPLIANT_30W_DEFAULT;
        poe_default_parameters.bt_operation_mode_none_compliant_60w_default =
            SPARX5_GEN6_BT_NON_COMPLIANT_60W_DEFAULT;
        poe_default_parameters.bt_operation_mode_none_compliant_90w_default =
            SPARX5_GEN6_BT_NON_COMPLIANT_90W_DEFAULT;
        ...
        poe_default_parameters.indv_mask_BT_i2c_restart_enable_default =
            SPARX5_INDV_MASK_GEN6_BT_I2C_RESTART_ENABLE_DEFAULT;
        // led stream type
        poe_default_parameters.indv_mask_BT_led_stream_type_default =
            SPARX5_INDV_MASK_GEN6_BT_LED_STREAM_TYPE_DEFAULT;
        ...
        // BT complient port operation Mode
        poe_default_parameters.bt_operation_mode_compliant_15w_default =
            SPARX5_GEN7_BT_COMPLIANT_15W_DEFAULT;
        poe_default_parameters.bt_operation_mode_compliant_30w_default =
            SPARX5_GEN7_BT_COMPLIANT_30W_DEFAULT;
        poe_default_parameters.bt_operation_mode_compliant_60w_default =
            SPARX5_GEN7_BT_COMPLIANT_60W_DEFAULT;
        poe_default_parameters.bt_operation_mode_compliant_90w_default =
            SPARX5_GEN7_BT_COMPLIANT_90W_DEFAULT;

        // BT none complient port operation Mode
        poe_default_parameters.bt_operation_mode_none_compliant_15w_default =
            SPARX5_GEN7_BT_NON_COMPLIANT_15W_DEFAULT;
        poe_default_parameters.bt_operation_mode_none_compliant_30w_default =
            SPARX5_GEN7_BT_NON_COMPLIANT_30W_DEFAULT;
        poe_default_parameters.bt_operation_mode_none_compliant_60w_default =
            SPARX5_GEN7_BT_NON_COMPLIANT_60W_DEFAULT;
        poe_default_parameters.bt_operation_mode_none_compliant_90w_default =
            SPARX5_GEN7_BT_NON_COMPLIANT_90W_DEFAULT;

        // led stream type
        poe_default_parameters.indv_mask_BT_led_stream_type_default =
            SPARX5_INDV_MASK_GEN7_BT_LED_STREAM_TYPE_DEFAULT;
        // Support adding lldp half priority
        poe_default_parameters.indv_mask_BT_support_adding_lldp_half_priority_default =
    ...
    poe_default_parameters.indv_mask_prebt_led_stream_type_default =
        SPARX5_INDV_MASK_PREBT_LED_STREAM_TYPE_DEFAULT;
    // power higher priority port
    ...
    poe_default_parameters.indv_mask_prebt_supports_backoff_default =
        SPARX5_INDV_MASK_PREBT_SUPPORTS_BACKOFF_DEFAULT;
    ...
    poe_default_parameters.indv_mask_prebt_layer2_lldp_enable_default =
        SPARX5_INDV_MASK_PREBT_LAYER2_LLDP_ENABLE_DEFAULT;
    ...
    poe_default_parameters.indv_mask_prebt_matrix_support_4P_default =
        SPARX5_INDV_MASK_PREBT_MATRIX_SUPPORT_4P_DEFAULT;
...
void set_laguna_default_parameters(meba_poe_firmware_type_t poe_type)
{
    ...
    // LAGUNA_POE_GEN6_PD692x0_CONTROLLER_TYPE_DEFAULT;

    if (poe_type == MEBA_POE_FIRMWARE_TYPE_GEN6_BT) {
        // BT complient port operation Mode
        poe_default_parameters.bt_operation_mode_compliant_15w_default =
            LAGUNA_GEN6_BT_COMPLIANT_15W_DEFAULT;
        poe_default_parameters.bt_operation_mode_compliant_30w_default =
            LAGUNA_GEN6_BT_COMPLIANT_30W_DEFAULT;
        poe_default_parameters.bt_operation_mode_compliant_60w_default =
            LAGUNA_GEN6_BT_COMPLIANT_60W_DEFAULT;
        poe_default_parameters.bt_operation_mode_compliant_90w_default =
            LAGUNA_GEN6_BT_COMPLIANT_90W_DEFAULT;

        // BT none complient port operation Mode
        poe_default_parameters.bt_operation_mode_none_compliant_15w_default =
            LAGUNA_GEN6_BT_NON_COMPLIANT_15W_DEFAULT;
        poe_default_parameters.bt_operation_mode_none_compliant_30w_default =
            LAGUNA_GEN6_BT_NON_COMPLIANT_30W_DEFAULT;
        poe_default_parameters.bt_operation_mode_none_compliant_60w_default =
            LAGUNA_GEN6_BT_NON_COMPLIANT_60W_DEFAULT;
        poe_default_parameters.bt_operation_mode_none_compliant_90w_default =
            LAGUNA_GEN6_BT_NON_COMPLIANT_90W_DEFAULT;
        ...
        // Initialization of the I2C module system after 10 seconds of inactivity
        poe_default_parameters.indv_mask_BT_i2c_restart_enable_default =
            LAGUNA_INDV_MASK_GEN6_BT_I2C_RESTART_ENABLE_DEFAULT;
        // led stream type
        poe_default_parameters.indv_mask_BT_led_stream_type_default =
            LAGUNA_INDV_MASK_GEN6_BT_LED_STREAM_TYPE_DEFAULT;
        // HOCPP - high_over Current Pulse Protection
        ...
        // BT complient port operation Mode
        poe_default_parameters.bt_operation_mode_compliant_15w_default =
            LAGUNA_GEN7_BT_COMPLIANT_15W_DEFAULT;
        poe_default_parameters.bt_operation_mode_compliant_30w_default =
            LAGUNA_GEN7_BT_COMPLIANT_30W_DEFAULT;
        poe_default_parameters.bt_operation_mode_compliant_60w_default =
            LAGUNA_GEN7_BT_COMPLIANT_60W_DEFAULT;
        poe_default_parameters.bt_operation_mode_compliant_90w_default =
            LAGUNA_GEN7_BT_COMPLIANT_90W_DEFAULT;

        // BT none complient port operation Mode
        poe_default_parameters.bt_operation_mode_none_compliant_15w_default =
            LAGUNA_GEN7_BT_NON_COMPLIANT_15W_DEFAULT;
        poe_default_parameters.bt_operation_mode_none_compliant_30w_default =
            LAGUNA_GEN7_BT_NON_COMPLIANT_30W_DEFAULT;
        poe_default_parameters.bt_operation_mode_none_compliant_60w_default =
            LAGUNA_GEN7_BT_NON_COMPLIANT_60W_DEFAULT;
        poe_default_parameters.bt_operation_mode_none_compliant_90w_default =
            LAGUNA_GEN7_BT_NON_COMPLIANT_90W_DEFAULT;

        // led stream type
        poe_default_parameters.indv_mask_BT_led_stream_type_default =
            LAGUNA_INDV_MASK_GEN7_BT_LED_STREAM_TYPE_DEFAULT;
        // Support adding lldp half priority
        poe_default_parameters.indv_mask_BT_support_adding_lldp_half_priority_default =
    ...
    // prebt led stream type
    poe_default_parameters.indv_mask_prebt_led_stream_type_default =
        LAGUNA_INDV_MASK_PREBT_LED_STREAM_TYPE_DEFAULT;
    // power higher priority port
    poe_default_parameters.indv_mask_prebt_ignore_higher_priority_default =
    ...
    // En/Dis supports backoff
    poe_default_parameters.indv_mask_prebt_supports_backoff_default =
        LAGUNA_INDV_MASK_PREBT_SUPPORTS_BACKOFF_DEFAULT;
    // en/Dis MESSAGE_READY pin notification
    poe_default_parameters.indv_mask_prebt_message_ready_notify_default =
        LAGUNA_INDV_MASK_PREBT_MESSAGE_READY_NOTIFY_DEFAULT;
    // En/Dis Layer 2 PD commands
    poe_default_parameters.indv_mask_prebt_layer2_lldp_enable_default =
        LAGUNA_INDV_MASK_PREBT_LAYER2_LLDP_ENABLE_DEFAULT;
    // accept/ignored Port Priority recived from the PD
    poe_default_parameters.indv_mask_prebt_layer2_priority_by_PD_default =
        LAGUNA_INDV_MASK_PREBT_LAYER2_PRIORITY_BY_PD_DEFAULT;
    // use 4-pair matrix commands
    poe_default_parameters.indv_mask_prebt_matrix_support_4P_default =
        LAGUNA_INDV_MASK_PREBT_MATRIX_SUPPORT_4P_DEFAULT;
